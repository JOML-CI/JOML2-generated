...
public final class Double2x3RawOpsApi implements Double2x3RawOps {
    ...
    public Double2x3 loadCMUnsafe(Double2x3Impl self, long address, int stride) {
        self.loadCM(0L, VIRTUAL_MEMORY.asSlice(address, (long) 8 * ((2) * stride + 2)), stride);
        return self;
    }
    ...
    public Double2x3 loadCMFloatUnsafe(Double2x3Impl self, long address, int stride) {
        self.loadCMFloat(0L, VIRTUAL_MEMORY.asSlice(address, (long) 4 * ((2) * stride + 2)), stride);
        return self;
    }
    ...
    public Double2x3 loadRMUnsafe(Double2x3Impl self, long address, int stride) {
        self.loadRM(0L, VIRTUAL_MEMORY.asSlice(address, (long) 8 * ((1) * stride + 3)), stride);
        return self;
    }
    ...
    public Double2x3 loadRMFloatUnsafe(Double2x3Impl self, long address, int stride) {
        self.loadRMFloat(0L, VIRTUAL_MEMORY.asSlice(address, (long) 4 * ((1) * stride + 3)), stride);
        return self;
    }
