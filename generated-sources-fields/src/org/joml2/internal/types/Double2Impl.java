...
public final class Double2Impl implements Double2 {
    ...
    private void slerp_s3e62c569_c0(Double2Impl _dst, double _t10, double _t39, double _sp0, double _t27, double _t13, double _t28) {
        _dst.x = Math.fma(_t10, _t39, _sp0 * _t27);
        _dst.y = Math.fma(_t13, _t39, _sp0 * _t28);
    }

    /** Private tail of {@code slerp}; reached only through it. */
    private void slerp_s3e62c569_tail(Double2Impl _dst, double _t16, double _t36, double _t35, double _t10, double _sp0, double _t27, double _t13, double _t28) {
        double _t39 = _t16 * Math.cosFromSin(_t36, _t35);
        slerp_s3e62c569_c0(_dst, _t10, _t39, _sp0, _t27, _t13, _t28);
    }
    ...
    public Double2 slerp(double otherX, double otherY, double t, @Mutated Double2 dest) {
        ...
        double _r0 = this.x;
        double _r1 = this.y;
        double _ct0 = Math.fma(_r0, _r0, _r1 * _r1);
        ...
        slerp_s3e62c569_tail(d, _t16, _t36, _t35, _t10, _sp0, _t27, _t13, _t28);
        return d;
    }
    ...
    private void slerp_degenerate_s3e62c569_c0(Double2Impl _dst, double _t24, double _t54, double _t48, double _t50, double _t45, double _t23, double _t56, double _t21, double t, double otherX, double _r0, double _t46, double otherY, double _r1) {
        _dst.x = _t24 > 0.0 ? Math.fma(_t54, _t48 > 0.0 ? _t50 * _t45 : -_t23, _t56 * _t21) : Math.fma(t, otherX - _r0, _r0);
        _dst.y = _t24 > 0.0 ? Math.fma(_t54, _t48 > 0.0 ? _t50 * _t46 : _t21, _t56 * _t23) : Math.fma(t, otherY - _r1, _r1);
    }

    /** Private tail of {@code slerp_degenerate}; reached only through it. */
    private void slerp_degenerate_s3e62c569_tail(Double2Impl _dst, double _t38, double _t39, double t, double _t28, double _t27, double _t24, double _t23, double _t21, double otherX, double _r0, double otherY, double _r1) {
        ...
        slerp_degenerate_s3e62c569_c0(_dst, _t24, _t54, _t48, _t50, _t45, _t23, _t56, _t21, t, otherX, _r0, _t46, otherY, _r1);
    }
    ...
    private Double2 slerp_degenerate(double otherX, double otherY, double t, @Mutated Double2 dest) {
        ...
        slerp_degenerate_s3e62c569_tail(d, _t38, _t39, t, _t28, _t27, _t24, _t23, _t21, otherX, _r0, otherY, _r1);
        return d;
    }
    ...
    public Double2 smoothstep(double edge0, double edge1, @Mutated Double2 dest) {
        ...
        d.x = Math.fma(-2.0, _t7, 3.0) * _t7 * _t7;
        d.y = Math.fma(-2.0, _t8, 3.0) * _t8 * _t8;
        return d;
    }
    ...
    public Double2 smoothstep(double edge0X, double edge0Y, double edge1X, double edge1Y, @Mutated Double2 dest) {
        ...
        d.x = Math.fma(-2.0, _t8, 3.0) * _t8 * _t8;
        d.y = Math.fma(-2.0, _t9, 3.0) * _t9 * _t9;
        return d;
    }
    ...
    public Double2 preMul(Double2x2R mat, @Mutated Double2 dest) {
        Double2Impl d = (Double2Impl) dest;
        double _buf0 = Math.fma(mat.m00(), this.x, mat.m01() * this.y);
    ...
    public Double2 preMulPosition(Double4x4R mat, @Mutated Double2 dest) {
        Double2Impl d = (Double2Impl) dest;
        double _buf0 = Math.fma(mat.m00(), this.x, Math.fma(mat.m01(), this.y, mat.m03()));
    ...
    public Double2 preMulPosition(Double2x3R mat, @Mutated Double2 dest) {
        Double2Impl d = (Double2Impl) dest;
        double _buf0 = Math.fma(mat.m00(), this.x, Math.fma(mat.m01(), this.y, mat.m02()));
