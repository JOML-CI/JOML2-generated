...
public final class FloatDualQuatImpl implements FloatDualQuat {
    ...
    public FloatDualQuat sclerp(float otherRX, float otherRY, float otherRZ, float otherRW, float otherDX, float otherDY, float otherDZ, float otherDW, float t, @Mutated FloatDualQuat dest) {
        ...
        float _buf0 = Math.fma(this.rX, _t135, this.rW * _t144) + Math.fma(this.rY, _t145, -(this.rZ * _t146));
        float _buf1 = Math.fma(this.rY, _t135, this.rZ * _t144) + Math.fma(this.rW, _t146, -(this.rX * _t145));
        float _buf2 = Math.fma(this.rX, _t146, this.rW * _t145) + Math.fma(this.rZ, _t135, -(this.rY * _t144));
        float _buf3 = Math.fma(this.rW, _t135, -(this.rX * _t144)) - Math.fma(this.rY, _t146, this.rZ * _t145);
        float _buf4 = Math.fma(this.rX, _t153, this.rW * _t160) + Math.fma(this.rY, _t161, -(this.rZ * _t162)) + (Math.fma(this.dX, _t135, this.dW * _t144) + Math.fma(this.dY, _t145, -(this.dZ * _t146)));
        float _buf5 = Math.fma(this.rY, _t153, this.rZ * _t160) + Math.fma(this.rW, _t162, -(this.rX * _t161)) + (Math.fma(this.dY, _t135, this.dZ * _t144) + Math.fma(this.dW, _t146, -(this.dX * _t145)));
    ...
    public Float3x3 toMatrix3x3(@Mutated Float3x3 dest) {
        ...
        float _buf1 = 2.0f * Math.fma(this.rX, this.rY, _t2);
        d.m20 = Math.fma(-2.0f, _t3, (this.rX + this.rX) * this.rZ);
        d.m01 = Math.fma(-2.0f, _t2, (this.rX + this.rX) * this.rY);
