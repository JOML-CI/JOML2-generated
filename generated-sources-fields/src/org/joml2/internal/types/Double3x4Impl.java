...
public class Double3x4Impl implements Double3x4 {
    ...
    @Mutated public Double3x4 composeTRS(double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ) {
        ...
        this.m00 = Math.fma(-Math.fma(rotationY, rotationY, _t3), _t0, scaleX);
        this.m01 = Math.fma(rotationX, rotationY, -_t4) * _t1;
        this.m02 = Math.fma(rotationX, rotationZ, _t5) * _t2;
        this.m03 = translationX;
        this.m10 = Math.fma(rotationX, rotationY, _t4) * _t0;
        this.m11 = Math.fma(-Math.fma(rotationX, rotationX, _t3), _t1, scaleY);
        this.m12 = Math.fma(rotationY, rotationZ, -(rotationX * rotationW)) * _t2;
        this.m13 = translationY;
        this.m20 = Math.fma(rotationX, rotationZ, -_t5) * _t0;
        this.m21 = Math.fma(rotationX, rotationW, rotationY * rotationZ) * _t1;
        this.m22 = Math.fma(-Math.fma(rotationX, rotationX, rotationY * rotationY), _t2, scaleZ);
    ...
    private Double3x4 preRotateAround_identity(double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ, @Mutated Double3x4 dest) {
        ...
        d.m00 = Math.fma(_t0, _t4, _t14);
        d.m01 = _t18;
        d.m02 = _t15;
        d.m03 = Math.fma(_t2, _t15, Math.fma(pivotX, Math.fma(rotY, _t4, _t9), -(pivotY * _t18)));
        d.m10 = _t16;
        d.m11 = Math.fma(_t3, _t6, _t14);
        d.m12 = _t19;
        d.m13 = Math.fma(_t2, _t19, Math.fma(pivotY, Math.fma(rotX, _t6, _t9), -(pivotX * _t16)));
        d.m20 = _t20;
        d.m21 = _t17;
        d.m22 = Math.fma(_t3, _t6, Math.fma(_t0, _t4, 1.0));
        d.m23 = Math.fma(-pivotY, _t17, Math.fma(pivotZ, Math.fma(rotX, _t6, rotY * _t4), -(pivotX * _t20)));
        d.properties = Joml.BIT_ORTHOGONAL;
        return d;
    }
    ...
    private Double3x4 preRotateQuat_identity(double qX, double qY, double qZ, double qW, @Mutated Double3x4 dest) {
        ...
        d.m00 = Math.fma(_t0, _t3, _t9);
        d.m01 = Math.fma(qY, _t5, -_t6);
        d.m02 = Math.fma(qZ, _t5, _t7);
        d.m03 = 0.0;
        d.m10 = Math.fma(qY, _t5, _t6);
        d.m11 = Math.fma(_t2, _t5, _t9);
        d.m12 = Math.fma(qZ, _t3, -_t8);
        d.m13 = 0.0;
        d.m20 = Math.fma(qZ, _t5, -_t7);
        d.m21 = Math.fma(qZ, _t3, _t8);
        d.m22 = Math.fma(_t2, _t5, Math.fma(_t0, _t3, 1.0));
        d.m23 = 0.0;
        d.properties = Joml.BIT_ORTHOGONAL;
        return d;
    }
    ...
    private Double3x4 preRotateQuat_translation(double qX, double qY, double qZ, double qW, @Mutated Double3x4 dest) {
        ...
        d.m01 = _t17;
        d.m02 = _t14;
        double _buf0 = Math.fma(this.m23, _t14, Math.fma(this.m03, _t20, this.m13 * _t17));
        d.m10 = _t15;
        d.m11 = _t21;
        d.m12 = _t18;
        double _buf1 = Math.fma(this.m23, _t18, Math.fma(this.m03, _t15, this.m13 * _t21));
        d.m20 = _t19;
        d.m21 = _t16;
        d.m22 = _t22;
