...
public final class Double3Impl implements Double3 {
    ...
    private void slerp_degenerate_s56f5a5dd_c0(Double3Impl _dst, double _t36, double _t82, double _t76, double _t78, double _t72, double _t59, double _t40, double _t84, double _t29, double t, double otherX, double _r0, double _t73, double _t43, double _t31, double otherY, double _r1, double _t71, double _t41, double _t27, double otherZ, double _r2) {
        _dst.x = _t36 > 0.0 ? Math.fma(_t82, _t76 > 0.0 ? _t78 * _t72 : _t59 * _t40, _t84 * _t29) : Math.fma(t, otherX - _r0, _r0);
        _dst.y = _t36 > 0.0 ? Math.fma(_t82, _t76 > 0.0 ? _t78 * _t73 : _t59 * _t43, _t84 * _t31) : Math.fma(t, otherY - _r1, _r1);
        _dst.z = _t36 > 0.0 ? Math.fma(_t82, _t76 > 0.0 ? _t78 * _t71 : _t59 * _t41, _t84 * _t27) : Math.fma(t, otherZ - _r2, _r2);
    }

    /** Private tail of {@code slerp_degenerate}; reached only through it. */
    private void slerp_degenerate_s56f5a5dd_tail(Double3Impl _dst, double _t32, double _t33, double _t31, double _t29, double _t27, double _t22, double _t8, double _t9, double _t10, double t, double _t39, double _t36, double otherX, double _r0, double otherY, double _r1, double otherZ, double _r2) {
        ...
        slerp_degenerate_s56f5a5dd_tail2(_dst, _t63, _t65, _t64, _t71, t, _t44, _t39, _t36, _t59, _t40, _t29, otherX, _r0, _t43, _t31, otherY, _r1, _t41, _t27, otherZ, _r2);
    }

    /** Private tail of {@code slerp_degenerate}; reached only through it. */
    private void slerp_degenerate_s56f5a5dd_tail2(Double3Impl _dst, double _t63, double _t65, double _t64, double _t71, double t, double _t44, double _t39, double _t36, double _t59, double _t40, double _t29, double otherX, double _r0, double _t43, double _t31, double otherY, double _r1, double _t41, double _t27, double otherZ, double _r2) {
        ...
        slerp_degenerate_s56f5a5dd_c0(_dst, _t36, _t82, _t76, _t78, _t72, _t59, _t40, _t84, _t29, t, otherX, _r0, _t73, _t43, _t31, otherY, _r1, _t71, _t41, _t27, otherZ, _r2);
    }
    ...
    private Double3 slerp_degenerate(double otherX, double otherY, double otherZ, double t, @Mutated Double3 dest) {
        ...
        slerp_degenerate_s56f5a5dd_tail(d, _t32, _t33, _t31, _t29, _t27, _t22, _t8, _t9, _t10, t, _t39, _t36, otherX, _r0, otherY, _r1, otherZ, _r2);
        return d;
    }
    ...
    public Double3 cross(double otherX, double otherY, double otherZ, @Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _buf0 = Math.fma(otherZ, this.y, -(otherY * this.z));
        double _buf1 = Math.fma(otherX, this.z, -(otherZ * this.x));
    ...
    public Double3 smoothstep(double edge0, double edge1, @Mutated Double3 dest) {
        ...
        d.x = Math.fma(-2.0, _t10, 3.0) * _t10 * _t10;
        d.y = Math.fma(-2.0, _t11, 3.0) * _t11 * _t11;
        d.z = Math.fma(-2.0, _t12, 3.0) * _t12 * _t12;
        return d;
    }
    ...
    public Double3 smoothstep(double edge0X, double edge0Y, double edge0Z, double edge1X, double edge1Y, double edge1Z, @Mutated Double3 dest) {
        ...
        d.x = Math.fma(-2.0, _t12, 3.0) * _t12 * _t12;
        d.y = Math.fma(-2.0, _t13, 3.0) * _t13 * _t13;
        d.z = Math.fma(-2.0, _t14, 3.0) * _t14 * _t14;
        return d;
    }
    ...
    public Double3 preMul(Double3x3R mat, @Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _buf0 = Math.fma(mat.m02(), this.z, Math.fma(mat.m00(), this.x, mat.m01() * this.y));
        double _buf1 = Math.fma(mat.m12(), this.z, Math.fma(mat.m10(), this.x, mat.m11() * this.y));
    ...
    public Double3 preMulPosition(Double3x4R mat, @Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _buf0 = Math.fma(mat.m00(), this.x, Math.fma(mat.m01(), this.y, Math.fma(mat.m02(), this.z, mat.m03())));
        double _buf1 = Math.fma(mat.m10(), this.x, Math.fma(mat.m11(), this.y, Math.fma(mat.m12(), this.z, mat.m13())));
    ...
    public Double3 preMulProject(Double4x4R mat, @Mutated Double3 dest) {
        ...
        double _buf0 = Math.fma(mat.m00(), this.x, Math.fma(mat.m01(), this.y, Math.fma(mat.m02(), this.z, mat.m03()))) * _t2_inv;
        double _buf1 = Math.fma(mat.m10(), this.x, Math.fma(mat.m11(), this.y, Math.fma(mat.m12(), this.z, mat.m13()))) * _t2_inv;
    ...
    public Double3 rotateAxis(double angle, double axisX, double axisY, double axisZ, @Mutated Double3 dest) {
        ...
        double _buf0 = Math.fma(_t3, axisX * _t5, Math.fma(this.x, _t1, Math.fma(axisY, this.z, -(axisZ * this.y)) * _t0));
        double _buf1 = Math.fma(_t3, axisY * _t5, Math.fma(this.y, _t1, Math.fma(axisZ, this.x, -(axisX * this.z)) * _t0));
    ...
    public Double3 rotateX(double angle, @Mutated Double3 dest) {
        ...
        double _t1 = Math.cosFromSin(_t0, angle);
        d.x = this.x;
        double _buf0 = Math.fma(this.y, _t1, -(this.z * _t0));
    ...
    public Double3 rotateY(double angle, @Mutated Double3 dest) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _buf0 = Math.fma(this.x, _t1, this.z * _t0);
        d.y = this.y;
    ...
    public Double3 rotateZ(double angle, @Mutated Double3 dest) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _buf0 = Math.fma(this.x, _t1, -(this.y * _t0));
