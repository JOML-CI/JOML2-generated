...
public final class DoubleTransformImpl implements DoubleTransform {
    ...
    public DoubleTransform rotateAxis(double angle, double axisX, double axisY, double axisZ, @Mutated DoubleTransform dest) {
        ...
        d.tY = this.tY;
        d.tZ = this.tZ;
        double _buf0 = Math.fma(this.rX, _t5, this.rW * _t2) + Math.fma(this.rY, _t3, -(this.rZ * _t4));
        double _buf1 = Math.fma(this.rY, _t5, this.rW * _t4) + Math.fma(this.rZ, _t2, -(this.rX * _t3));
        double _buf2 = Math.fma(this.rZ, _t5, this.rW * _t3) + Math.fma(this.rX, _t4, -(this.rY * _t2));
