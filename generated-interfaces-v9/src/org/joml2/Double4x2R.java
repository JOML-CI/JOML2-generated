...
/**
 * Read-only view of a 4x2 matrix of double-precision {@code double} components.
 * <p>
 * Declares the accessors, queries, store methods and dest-form operations that read but never
 * mutate the receiver; the mutable counterpart is {@link Double4x2}. APIs that only read a 4x2
 * matrix should accept {@code Double4x2R}, so callers can pass mutable instances without exposing
 * them to modification.
 * <p>
 * Arguments of type {@code Double4x2R} must be instances created by the library ({@link Joml}
...
public interface Double4x2R {
    ...
    public static Double4x2R IDENTITY() { return Holder.IDENTITY; }
    /** {@return a shared all-zero matrix} Never mutate it - it is returned as the read-only view for that reason. */
    public static Double4x2R ZERO() { return Holder.ZERO; }
     ...
     * @return dest
     */
    Double4x2 add(Double4x2R other, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 add(double m00, double m01, double m10, double m11, double m20, double m21, double m30, double m31, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 mul(double scalar, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 sub(Double4x2R other, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 sub(double m00, double m01, double m10, double m11, double m20, double m21, double m30, double m31, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 toFloat(@Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 lerp(Double4x2R other, double t, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 lerp(double m00, double m01, double m10, double m11, double m20, double m21, double m30, double m31, double t, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 mul(Double2x2R right, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 preMul(Double4x4R other, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 addScaled(Double4x2R other, double weight, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 addScaled(double m00, double m01, double m10, double m11, double m20, double m21, double m30, double m31, double weight, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4 mul(Double2R v, @Mutated Double4 dest);
     ...
     * @return dest
     */
    Double4 mul(double x, double y, @Mutated Double4 dest);
     ...
     *        variants only)
     */
    Double4x2 storeCMUnsafe(long address);
     ...
     *        variants only)
     */
    Double4x2 storeCMFloatUnsafe(long address);
     ...
     *        variants only)
     */
    Double4x2 storeRMUnsafe(long address);
     ...
     *        variants only)
     */
    Double4x2 storeRMFloatUnsafe(long address);
     ...
     *        variants only)
     */
    Double4x2 storeCMUnsafe(long address, int stride);
     ...
     *        variants only)
     */
    Double4x2 storeCMFloatUnsafe(long address, int stride);
     ...
     *        variants only)
     */
    Double4x2 storeRMUnsafe(long address, int stride);
     ...
     *        variants only)
     */
    Double4x2 storeRMFloatUnsafe(long address, int stride);
     ...
     */
    boolean equalsEpsilon(Double4x2R other, double epsilon);
     ...
     *        variants only)
     */
    default Double4x2 storeUnsafe(long address) { return storeCMUnsafe(address); }
     ...
     *        variants only)
     */
    default Double4x2 storeUnsafe(long address, int stride) { return storeCMUnsafe(address, stride); }
    ...
    final class Holder {
        private Holder() {}
        static final Double4x2R IDENTITY = Joml.double4x2();
        static final Double4x2R ZERO = Joml.double4x2(0, 0, 0, 0, 0, 0, 0, 0);
    }
}
