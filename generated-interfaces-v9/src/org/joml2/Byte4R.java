 ...
 * modification.
 * <p>
 * Arguments of type {@code Byte4R} must be instances created by the library ({@link Joml} factories
...
public interface Byte4R {
     ...
     * @return dest
     */
    Byte4 cross(Byte4R v, Byte4R w, @Mutated Byte4 dest);
     ...
     * @return dest
     */
    Short4 cross(Byte4R v, Byte4R w, @Mutated Short4 dest);
     ...
     * @return dest
     */
    Int4 cross(Byte4R v, Byte4R w, @Mutated Int4 dest);
     ...
     * @return dest
     */
    Long4 cross(Byte4R v, Byte4R w, @Mutated Long4 dest);
     ...
     * @return dest
     */
    Double4 cross(Byte4R v, Byte4R w, @Mutated Double4 dest);
     ...
     * @return dest
     */
    Byte4 cross(byte vX, byte vY, byte vZ, byte vW, byte wX, byte wY, byte wZ, byte wW, @Mutated Byte4 dest);
     ...
     * @return dest
     */
    Short4 cross(byte vX, byte vY, byte vZ, byte vW, byte wX, byte wY, byte wZ, byte wW, @Mutated Short4 dest);
     ...
     * @return dest
     */
    Int4 cross(byte vX, byte vY, byte vZ, byte vW, byte wX, byte wY, byte wZ, byte wW, @Mutated Int4 dest);
     ...
     * @return dest
     */
    Long4 cross(byte vX, byte vY, byte vZ, byte vW, byte wX, byte wY, byte wZ, byte wW, @Mutated Long4 dest);
     ...
     * @return dest
     */
    Double4 cross(byte vX, byte vY, byte vZ, byte vW, byte wX, byte wY, byte wZ, byte wW, @Mutated Double4 dest);
     ...
     */
    int distanceSquared(Byte4R other);
     ...
     *        {@code w})
     */
    int distanceSquared(byte x, byte y, byte z, byte w);
     ...
     */
    int dot(byte x, byte y, byte z, byte w);
     ...
     */
    int manhattanDistance(Byte4R other);
     ...
     *        {@code w})
     */
    int manhattanDistance(byte x, byte y, byte z, byte w);
