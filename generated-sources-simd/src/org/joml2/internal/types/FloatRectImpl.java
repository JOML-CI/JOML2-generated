...
public final class FloatRectImpl implements FloatRect {
    ...
    private FloatRect lerp_fma(float otherMINX, float otherMINY, float otherMAXX, float otherMAXY, float t, @Mutated FloatRect dest) {
        ...
        float[] dd = ((FloatRectImpl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = FloatVector.broadcast(COL_SPECIES, t).fma(FloatVector.zero(COL_SPECIES).withLane(0, otherMINX).withLane(1, otherMINY).withLane(2, otherMAXX).withLane(3, otherMAXY).sub(_sv0), _sv0);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private FloatRect lerp_mulAdd(float otherMINX, float otherMINY, float otherMAXX, float otherMAXY, float t, @Mutated FloatRect dest) {
        ...
        float[] dd = ((FloatRectImpl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = FloatVector.broadcast(COL_SPECIES, t).mul(FloatVector.zero(COL_SPECIES).withLane(0, otherMINX).withLane(1, otherMINY).withLane(2, otherMAXX).withLane(3, otherMAXY).sub(_sv0)).add(_sv0);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public FloatRect scale(float sx, float sy, @Mutated FloatRect dest) {
        float[] sd = this.data;
        float[] dd = ((FloatRectImpl) dest).data;
        var _col0 = FloatVector.broadcast(COL_SPECIES, sx).blend(FloatVector.broadcast(COL_SPECIES, sy), MASK_0).mul(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public FloatRect translate(Float2R delta, @Mutated FloatRect dest) {
        ...
        float[] dd = ((FloatRectImpl) dest).data;
        var _col0 = FloatVector.broadcast(COL_SPECIES, deltaData[0]).blend(FloatVector.broadcast(COL_SPECIES, deltaData[1]), MASK_0).add(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public FloatRect translate(float deltaX, float deltaY, @Mutated FloatRect dest) {
        float[] sd = this.data;
        float[] dd = ((FloatRectImpl) dest).data;
        var _col0 = FloatVector.broadcast(COL_SPECIES, deltaX).blend(FloatVector.broadcast(COL_SPECIES, deltaY), MASK_0).add(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
