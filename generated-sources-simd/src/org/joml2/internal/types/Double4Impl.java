...
public final class Double4Impl implements Double4 {
    ...
    private Double4 bezier2_fma(Double4R p1, Double4R p2, double t, @Mutated Double4 dest) {
        ...
        double[] dd = ((Double4Impl) dest).data;
        double _t1 = 1.0 - t;
        var _col0 = DoubleVector.fromArray(COL_SPECIES, p2Data, 0).fma(DoubleVector.broadcast(COL_SPECIES, t * t), DoubleVector.fromArray(COL_SPECIES, p1Data, 0).fma(DoubleVector.broadcast(COL_SPECIES, 2.0 * t * _t1), DoubleVector.fromArray(COL_SPECIES, sd, 0).mul(DoubleVector.broadcast(COL_SPECIES, _t1 * _t1))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 bezier2_mulAdd(Double4R p1, Double4R p2, double t, @Mutated Double4 dest) {
        ...
        double[] dd = ((Double4Impl) dest).data;
        double _t1 = 1.0 - t;
        var _col0 = DoubleVector.fromArray(COL_SPECIES, p2Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, t * t)).add(DoubleVector.fromArray(COL_SPECIES, p1Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, 2.0 * t * _t1)).add(DoubleVector.fromArray(COL_SPECIES, sd, 0).mul(DoubleVector.broadcast(COL_SPECIES, _t1 * _t1))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 bezier2Tangent_fma(Double4R p1, Double4R p2, double t, @Mutated Double4 dest) {
        ...
        var _col0 = _sv0.sub(DoubleVector.fromArray(COL_SPECIES, sd, 0)).fma(DoubleVector.broadcast(COL_SPECIES, 2.0 * (1.0 - t)), DoubleVector.fromArray(COL_SPECIES, p2Data, 0).sub(_sv0).mul(DoubleVector.broadcast(COL_SPECIES, 2.0 * t)));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 bezier2Tangent_mulAdd(Double4R p1, Double4R p2, double t, @Mutated Double4 dest) {
        ...
        double[] dd = ((Double4Impl) dest).data;
        var _sv0 = DoubleVector.fromArray(COL_SPECIES, p1Data, 0);
        var _col0 = _sv0.sub(DoubleVector.fromArray(COL_SPECIES, sd, 0)).mul(DoubleVector.broadcast(COL_SPECIES, 2.0 * (1.0 - t))).add(DoubleVector.fromArray(COL_SPECIES, p2Data, 0).sub(_sv0).mul(DoubleVector.broadcast(COL_SPECIES, 2.0 * t)));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 hermite_fma(Double4R t0, Double4R v1, Double4R t1, double t, @Mutated Double4 dest) {
        ...
        double _t0 = t * t;
        double _t2 = t * _t0;
        var _col0 = DoubleVector.fromArray(COL_SPECIES, sd, 0).fma(DoubleVector.broadcast(COL_SPECIES, Math.fma(2.0, _t2, Math.fma(-3.0, _t0, 1.0))), DoubleVector.fromArray(COL_SPECIES, t0Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, Math.fma(t - 2.0, _t0, t)))).add(DoubleVector.fromArray(COL_SPECIES, t1Data, 0).fma(DoubleVector.broadcast(COL_SPECIES, t * Math.fma(t, t, -t)), DoubleVector.fromArray(COL_SPECIES, v1Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, Math.fma(3.0, _t0, -(2.0 * _t2))))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 hermite_mulAdd(Double4R t0, Double4R v1, Double4R t1, double t, @Mutated Double4 dest) {
        ...
        double _t0 = t * t;
        double _t2 = t * _t0;
        var _col0 = DoubleVector.fromArray(COL_SPECIES, sd, 0).mul(DoubleVector.broadcast(COL_SPECIES, Math.fma(2.0, _t2, Math.fma(-3.0, _t0, 1.0)))).add(DoubleVector.fromArray(COL_SPECIES, t0Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, Math.fma(t - 2.0, _t0, t)))).add(DoubleVector.fromArray(COL_SPECIES, t1Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, t * Math.fma(t, t, -t))).add(DoubleVector.fromArray(COL_SPECIES, v1Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, Math.fma(3.0, _t0, -(2.0 * _t2))))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 hermiteTangent_fma(Double4R t0, Double4R v1, Double4R t1, double t, @Mutated Double4 dest) {
        ...
        double[] dd = ((Double4Impl) dest).data;
        double _t0 = t * t;
        var _col0 = DoubleVector.fromArray(COL_SPECIES, sd, 0).fma(DoubleVector.broadcast(COL_SPECIES, 6.0 * Math.fma(t, t, -t)), DoubleVector.fromArray(COL_SPECIES, t0Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, Math.fma(3.0, _t0, Math.fma(-4.0, t, 1.0))))).add(DoubleVector.fromArray(COL_SPECIES, t1Data, 0).fma(DoubleVector.broadcast(COL_SPECIES, Math.fma(3.0, _t0, -(2.0 * t))), DoubleVector.fromArray(COL_SPECIES, v1Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, 6.0 * Math.fma(-t, t, t)))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 hermiteTangent_mulAdd(Double4R t0, Double4R v1, Double4R t1, double t, @Mutated Double4 dest) {
        ...
        double[] dd = ((Double4Impl) dest).data;
        double _t0 = t * t;
        var _col0 = DoubleVector.fromArray(COL_SPECIES, sd, 0).mul(DoubleVector.broadcast(COL_SPECIES, 6.0 * Math.fma(t, t, -t))).add(DoubleVector.fromArray(COL_SPECIES, t0Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, Math.fma(3.0, _t0, Math.fma(-4.0, t, 1.0))))).add(DoubleVector.fromArray(COL_SPECIES, t1Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, Math.fma(3.0, _t0, -(2.0 * t)))).add(DoubleVector.fromArray(COL_SPECIES, v1Data, 0).mul(DoubleVector.broadcast(COL_SPECIES, 6.0 * Math.fma(-t, t, t)))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public double angleBetween(double otherX, double otherY, double otherZ, double otherW) {
        ...
        return Math.atan2(Math.sqrt(Math.fma(_t12, _t12, Math.fma(_t13, _t13, Math.fma(_t14, _t14, Math.fma(_t15, _t15, Math.fma(_t16, _t16, _t17 * _t17)))))), Math.fma(otherW, sd[3], Math.fma(otherZ, sd[2], Math.fma(otherX, sd[0], otherY * sd[1]))));
    }
    ...
    private Double4 mod_fma(double y, @Mutated Double4 dest) {
        double[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        var _sv0 = DoubleVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = DoubleVector.broadcast(COL_SPECIES, -y).fma(DoubleVector.zero(COL_SPECIES).withLane(0, Math.floor(sd[0] * 1.0 / y)).withLane(1, Math.floor(sd[1] * 1.0 / y)).withLane(2, Math.floor(sd[2] * 1.0 / y)).withLane(3, Math.floor(sd[3] * 1.0 / y)), _sv0);
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Double4 mod_mulAdd(double y, @Mutated Double4 dest) {
        double[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        var _sv0 = DoubleVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = DoubleVector.broadcast(COL_SPECIES, -y).mul(DoubleVector.zero(COL_SPECIES).withLane(0, Math.floor(sd[0] * 1.0 / y)).withLane(1, Math.floor(sd[1] * 1.0 / y)).withLane(2, Math.floor(sd[2] * 1.0 / y)).withLane(3, Math.floor(sd[3] * 1.0 / y))).add(_sv0);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 mod_fma(Double4R y, @Mutated Double4 dest) {
        double[] sd = this.data;
        double[] yData = ((Double4Impl) y).data;
        double[] dd = ((Double4Impl) dest).data;
        var _sv0 = DoubleVector.fromArray(COL_SPECIES, yData, 0);
        var _sv1 = DoubleVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.neg().fma(DoubleVector.zero(COL_SPECIES).withLane(0, Math.floor(sd[0] / yData[0])).withLane(1, Math.floor(sd[1] / yData[1])).withLane(2, Math.floor(sd[2] / yData[2])).withLane(3, Math.floor(sd[3] / yData[3])), _sv1);
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Double4 mod_mulAdd(Double4R y, @Mutated Double4 dest) {
        double[] sd = this.data;
        double[] yData = ((Double4Impl) y).data;
        double[] dd = ((Double4Impl) dest).data;
        var _sv0 = DoubleVector.fromArray(COL_SPECIES, yData, 0);
        var _sv1 = DoubleVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.neg().mul(DoubleVector.zero(COL_SPECIES).withLane(0, Math.floor(sd[0] / yData[0])).withLane(1, Math.floor(sd[1] / yData[1])).withLane(2, Math.floor(sd[2] / yData[2])).withLane(3, Math.floor(sd[3] / yData[3]))).add(_sv1);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Double4 mod_fma(double yX, double yY, double yZ, double yW, @Mutated Double4 dest) {
        double[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        var _sv0 = DoubleVector.zero(COL_SPECIES).withLane(0, yX).withLane(1, yY).withLane(2, yZ).withLane(3, yW);
        var _sv1 = DoubleVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.neg().fma(DoubleVector.zero(COL_SPECIES).withLane(0, Math.floor(sd[0] / yX)).withLane(1, Math.floor(sd[1] / yY)).withLane(2, Math.floor(sd[2] / yZ)).withLane(3, Math.floor(sd[3] / yW)), _sv1);
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Double4 mod_mulAdd(double yX, double yY, double yZ, double yW, @Mutated Double4 dest) {
        double[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        var _sv0 = DoubleVector.zero(COL_SPECIES).withLane(0, yX).withLane(1, yY).withLane(2, yZ).withLane(3, yW);
        var _sv1 = DoubleVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.neg().mul(DoubleVector.zero(COL_SPECIES).withLane(0, Math.floor(sd[0] / yX)).withLane(1, Math.floor(sd[1] / yY)).withLane(2, Math.floor(sd[2] / yZ)).withLane(3, Math.floor(sd[3] / yW))).add(_sv1);
        _col0.intoArray(dd, 0);
        return dest;
    }
