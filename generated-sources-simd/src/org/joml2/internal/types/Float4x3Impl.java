...
public class Float4x3Impl implements Float4x3 {
    ...
    private Float4x3 lerp_fma(float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22, float m30, float m31, float m32, float t, @Mutated Float4x3 dest) {
        ...
        var _sv3 = FloatVector.fromArray(COL_SPECIES, sd, 8);
        var _col2 = _sv0.fma(FloatVector.zero(COL_SPECIES).withLane(0, m02).withLane(1, m12).withLane(2, m22).withLane(3, m32).sub(_sv3), _sv3);
        _col0.intoArray(dd, 0);
        _col1.intoArray(dd, 4);
        _col2.intoArray(dd, 8);
        return dest;
    ...
    private Float4x3 lerp_mulAdd(float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22, float m30, float m31, float m32, float t, @Mutated Float4x3 dest) {
        ...
        var _sv3 = FloatVector.fromArray(COL_SPECIES, sd, 8);
        var _col2 = _sv0.mul(FloatVector.zero(COL_SPECIES).withLane(0, m02).withLane(1, m12).withLane(2, m22).withLane(3, m32).sub(_sv3)).add(_sv3);
        _col0.intoArray(dd, 0);
        _col1.intoArray(dd, 4);
        _col2.intoArray(dd, 8);
        return dest;
    ...
    private Float4 mul_fma(float vX, float vY, float vZ, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 8).fma(FloatVector.broadcast(COL_SPECIES, vZ), FloatVector.fromArray(COL_SPECIES, sd, 0).fma(FloatVector.broadcast(COL_SPECIES, vX), FloatVector.fromArray(COL_SPECIES, sd, 4).mul(FloatVector.broadcast(COL_SPECIES, vY))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 mul_mulAdd(float vX, float vY, float vZ, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 8).mul(FloatVector.broadcast(COL_SPECIES, vZ)).add(FloatVector.fromArray(COL_SPECIES, sd, 0).mul(FloatVector.broadcast(COL_SPECIES, vX)).add(FloatVector.fromArray(COL_SPECIES, sd, 4).mul(FloatVector.broadcast(COL_SPECIES, vY))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public FloatBuffer storeCMAbsolute(int index, @Mutated FloatBuffer buf) {
        ...
        if (buf.hasArray()) {
            ...
            FloatVector.fromArray(COL_SPECIES, d, 8).intoMemorySegment(seg, baseOff + 32L, ByteOrder.nativeOrder());
        }
        return buf;
    }
    @Mutated public Float4x3 loadCMAbsolute(int index, FloatBuffer buf) {
        ...
        if (buf.hasArray()) {
            ...
            FloatVector.fromMemorySegment(COL_SPECIES, seg, baseOff + 32L, ByteOrder.nativeOrder()).intoArray(d, 8);
        }
        return this;
    }
    public ByteBuffer storeCMAbsolute(int index, ByteBuffer buf) {
        ...
        FloatVector.fromArray(COL_SPECIES, d, 8).intoMemorySegment(seg, index + 32L, ByteOrder.nativeOrder());
        return buf;
    }
    public Float4x3 loadCMAbsolute(int index, ByteBuffer buf) {
        ...
        FloatVector.fromMemorySegment(COL_SPECIES, seg, index + 32L, ByteOrder.nativeOrder()).intoArray(d, 8);
        return this;
    }
    ...
    public MemorySegment storeCM(long offset, MemorySegment dest) {
        ...
        FloatVector.fromArray(COL_SPECIES, d, 8).intoMemorySegment(seg, offset + 32L, ByteOrder.nativeOrder());
        return dest;
    }
    public Float4x3 loadCM(long offset, MemorySegment src) {
        ...
        FloatVector.fromMemorySegment(COL_SPECIES, seg, offset + 32L, ByteOrder.nativeOrder()).intoArray(d, 8);
        return this;
    }
