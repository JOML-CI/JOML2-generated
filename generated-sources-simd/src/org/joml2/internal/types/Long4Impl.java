...
/**
 * Generated implementation of {@link Long4} backed by a {@code long[]} array, with Vector API SIMD
...
public final class Long4Impl implements Long4 {
    ...
    public Long4 add(Long4R other, @Mutated Long4 dest) {
        ...
        var _col0 = LongVector.fromArray(COL_SPECIES, otherData, 0).add(LongVector.fromArray(COL_SPECIES, sd, 0));
    ...
    public Long4 ceilDiv(long scalar, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, java.lang.Math.ceilDiv(sd[0], scalar)).withLane(1, java.lang.Math.ceilDiv(sd[1], scalar)).withLane(2, java.lang.Math.ceilDiv(sd[2], scalar)).withLane(3, java.lang.Math.ceilDiv(sd[3], scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 ceilDiv(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, java.lang.Math.ceilDiv(sd[0], otherData[0])).withLane(1, java.lang.Math.ceilDiv(sd[1], otherData[1])).withLane(2, java.lang.Math.ceilDiv(sd[2], otherData[2])).withLane(3, java.lang.Math.ceilDiv(sd[3], otherData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 ceilMod(long scalar, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, java.lang.Math.ceilMod(sd[0], scalar)).withLane(1, java.lang.Math.ceilMod(sd[1], scalar)).withLane(2, java.lang.Math.ceilMod(sd[2], scalar)).withLane(3, java.lang.Math.ceilMod(sd[3], scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 ceilMod(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, java.lang.Math.ceilMod(sd[0], otherData[0])).withLane(1, java.lang.Math.ceilMod(sd[1], otherData[1])).withLane(2, java.lang.Math.ceilMod(sd[2], otherData[2])).withLane(3, java.lang.Math.ceilMod(sd[3], otherData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 div(long scalar, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).div(LongVector.broadcast(COL_SPECIES, scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 div(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).div(LongVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 floorDiv(long scalar, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.floorDiv(sd[0], scalar)).withLane(1, Math.floorDiv(sd[1], scalar)).withLane(2, Math.floorDiv(sd[2], scalar)).withLane(3, Math.floorDiv(sd[3], scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 floorDiv(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.floorDiv(sd[0], otherData[0])).withLane(1, Math.floorDiv(sd[1], otherData[1])).withLane(2, Math.floorDiv(sd[2], otherData[2])).withLane(3, Math.floorDiv(sd[3], otherData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 floorMod(long scalar, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.floorMod(sd[0], scalar)).withLane(1, Math.floorMod(sd[1], scalar)).withLane(2, Math.floorMod(sd[2], scalar)).withLane(3, Math.floorMod(sd[3], scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 floorMod(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.floorMod(sd[0], otherData[0])).withLane(1, Math.floorMod(sd[1], otherData[1])).withLane(2, Math.floorMod(sd[2], otherData[2])).withLane(3, Math.floorMod(sd[3], otherData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 mul(long scalar, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.broadcast(COL_SPECIES, scalar).mul(LongVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 mul(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, otherData, 0).mul(LongVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 negate(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).neg();
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 sub(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).sub(LongVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 and(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).lanewise(VectorOperators.AND, LongVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 bitCount(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.bitCount(sd[0])).withLane(1, Math.bitCount(sd[1])).withLane(2, Math.bitCount(sd[2])).withLane(3, Math.bitCount(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 numberOfLeadingZeros(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.numberOfLeadingZeros(sd[0])).withLane(1, Math.numberOfLeadingZeros(sd[1])).withLane(2, Math.numberOfLeadingZeros(sd[2])).withLane(3, Math.numberOfLeadingZeros(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 numberOfTrailingZeros(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.numberOfTrailingZeros(sd[0])).withLane(1, Math.numberOfTrailingZeros(sd[1])).withLane(2, Math.numberOfTrailingZeros(sd[2])).withLane(3, Math.numberOfTrailingZeros(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 or(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).lanewise(VectorOperators.OR, LongVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 reverseBits(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.reverseBits(sd[0])).withLane(1, Math.reverseBits(sd[1])).withLane(2, Math.reverseBits(sd[2])).withLane(3, Math.reverseBits(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 reverseBytes(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.reverseBytes(sd[0])).withLane(1, Math.reverseBytes(sd[1])).withLane(2, Math.reverseBytes(sd[2])).withLane(3, Math.reverseBytes(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 rotateLeft(long distance, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.rotateLeft(sd[0], distance)).withLane(1, Math.rotateLeft(sd[1], distance)).withLane(2, Math.rotateLeft(sd[2], distance)).withLane(3, Math.rotateLeft(sd[3], distance));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 rotateRight(long distance, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.rotateRight(sd[0], distance)).withLane(1, Math.rotateRight(sd[1], distance)).withLane(2, Math.rotateRight(sd[2], distance)).withLane(3, Math.rotateRight(sd[3], distance));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 shl(long shift, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).lanewise(VectorOperators.LSHL, LongVector.broadcast(COL_SPECIES, shift));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 shr(long shift, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).lanewise(VectorOperators.ASHR, LongVector.broadcast(COL_SPECIES, shift));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 ushr(long shift, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).lanewise(VectorOperators.LSHR, LongVector.broadcast(COL_SPECIES, shift));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 xor(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).lanewise(VectorOperators.XOR, LongVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
     ...
     * @return this
     */
    @Mutated public Long4 set(Long4R v) {
        long[] dd = this.data;
        long[] vData = ((Long4Impl) v).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, vData, 0);
        _col0.intoArray(dd, 0);
        return this;
    }
    ...
    public Long4 set(long s, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.broadcast(COL_SPECIES, s);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    @Mutated public Long4 makeZero() {
        long[] dd = this.data;
        var _col0 = LongVector.broadcast(COL_SPECIES, 0L);
        _col0.intoArray(dd, 0);
        return this;
    }
    ...
    public Long4 absolute(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).abs();
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 clamp(long min, long max, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).max(LongVector.broadcast(COL_SPECIES, min)).min(LongVector.broadcast(COL_SPECIES, max));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 clamp(Long4R min, Long4R max, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] minData = ((Long4Impl) min).data;
        long[] maxData = ((Long4Impl) max).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).max(LongVector.fromArray(COL_SPECIES, minData, 0)).min(LongVector.fromArray(COL_SPECIES, maxData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
     ...
     * @return dest
     */
    public Long4 cross(Long4R v, Long4R w, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] vData = ((Long4Impl) v).data;
        long[] wData = ((Long4Impl) w).data;
        long[] dd = ((Long4Impl) dest).data;
        long _t12 = vData[2] * wData[3] - vData[3] * wData[2];
        long _t13 = vData[1] * wData[3] - vData[3] * wData[1];
        long _t14 = vData[1] * wData[2] - vData[2] * wData[1];
        long _t15 = vData[0] * wData[3] - vData[3] * wData[0];
        long _t16 = vData[0] * wData[2] - vData[2] * wData[0];
        long _t17 = vData[0] * wData[1] - vData[1] * wData[0];
        long _buf0 = sd[1] * _t12 - sd[2] * _t13 + sd[3] * _t14;
        long _buf1 = sd[2] * _t15 - sd[0] * _t12 - sd[3] * _t16;
        long _buf2 = sd[0] * _t13 - sd[1] * _t15 + sd[3] * _t17;
     ...
     * @return dest
     */
    public Long4 cross(long vX, long vY, long vZ, long vW, long wX, long wY, long wZ, long wW, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        long _t12 = vZ * wW - vW * wZ;
        long _t13 = vY * wW - vW * wY;
        long _t14 = vY * wZ - vZ * wY;
        long _t15 = vX * wW - vW * wX;
        long _t16 = vX * wZ - vZ * wX;
        long _t17 = vX * wY - vY * wX;
        long _buf0 = sd[1] * _t12 - sd[2] * _t13 + sd[3] * _t14;
        long _buf1 = sd[2] * _t15 - sd[0] * _t12 - sd[3] * _t16;
        long _buf2 = sd[0] * _t13 - sd[1] * _t15 + sd[3] * _t17;
        dd[3] = sd[1] * _t16 - sd[0] * _t14 - sd[2] * _t17;
    ...
    public Long4 max(long scalar, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).max(LongVector.broadcast(COL_SPECIES, scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 max(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).max(LongVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 min(long scalar, @Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).min(LongVector.broadcast(COL_SPECIES, scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 min(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.fromArray(COL_SPECIES, sd, 0).min(LongVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 sign(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, Math.signum(sd[0])).withLane(1, Math.signum(sd[1])).withLane(2, Math.signum(sd[2])).withLane(3, Math.signum(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 satAdd(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, org.joml2.SaturatingMath.satAddL(sd[0], otherData[0])).withLane(1, org.joml2.SaturatingMath.satAddL(sd[1], otherData[1])).withLane(2, org.joml2.SaturatingMath.satAddL(sd[2], otherData[2])).withLane(3, org.joml2.SaturatingMath.satAddL(sd[3], otherData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 satMul(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, org.joml2.SaturatingMath.satMulL(sd[0], otherData[0])).withLane(1, org.joml2.SaturatingMath.satMulL(sd[1], otherData[1])).withLane(2, org.joml2.SaturatingMath.satMulL(sd[2], otherData[2])).withLane(3, org.joml2.SaturatingMath.satMulL(sd[3], otherData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 satNegate(@Mutated Long4 dest) {
        long[] sd = this.data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, org.joml2.SaturatingMath.satNegL(sd[0])).withLane(1, org.joml2.SaturatingMath.satNegL(sd[1])).withLane(2, org.joml2.SaturatingMath.satNegL(sd[2])).withLane(3, org.joml2.SaturatingMath.satNegL(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Long4 satSub(Long4R other, @Mutated Long4 dest) {
        ...
        long[] otherData = ((Long4Impl) other).data;
        long[] dd = ((Long4Impl) dest).data;
        var _col0 = LongVector.zero(COL_SPECIES).withLane(0, org.joml2.SaturatingMath.satSubL(sd[0], otherData[0])).withLane(1, org.joml2.SaturatingMath.satSubL(sd[1], otherData[1])).withLane(2, org.joml2.SaturatingMath.satSubL(sd[2], otherData[2])).withLane(3, org.joml2.SaturatingMath.satSubL(sd[3], otherData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public long[] store(@Mutated long[] dest, int offset) {
        long[] d = this.data;
        LongVector.fromArray(COL_SPECIES, d, 0).intoArray(dest, offset);
        return dest;
    }
    public @Mutated Long4 load(long[] src, int offset) {
        long[] d = this.data;
        LongVector.fromArray(COL_SPECIES, src, offset).intoArray(d, 0);
        return this;
    }
    public LongBuffer storeAbsolute(int index, @Mutated LongBuffer buf) {
        ...
        if (buf.hasArray()) {
            ...
            LongVector.fromArray(COL_SPECIES, d, 0).intoArray(arr, off);
            ...
            LongVector.fromArray(COL_SPECIES, d, 0).intoMemorySegment(seg, baseOff, ByteOrder.nativeOrder());
        }
        return buf;
    }
    @Mutated public Long4 loadAbsolute(int index, LongBuffer buf) {
        ...
        if (buf.hasArray()) {
            long[] arr = buf.array();
            int off = buf.arrayOffset() + index;
            LongVector.fromArray(COL_SPECIES, arr, off).intoArray(d, 0);
        } else if (buf.order() != ByteOrder.nativeOrder()) {
            return BB_OPS.loadAbsolute(this, index, buf);
        } else {
            MemorySegment seg = MemorySegment.ofBuffer(buf.duplicate().position(0));
            long baseOff = (long) index * 8;
            LongVector.fromMemorySegment(COL_SPECIES, seg, baseOff, ByteOrder.nativeOrder()).intoArray(d, 0);
        }
        return this;
    }
    public ByteBuffer storeAbsolute(int index, ByteBuffer buf) {
        ...
        long[] d = this.data;
        MemorySegment seg = MemorySegment.ofBuffer(buf.duplicate().position(0));
        LongVector.fromArray(COL_SPECIES, d, 0).intoMemorySegment(seg, index, ByteOrder.nativeOrder());
        return buf;
    }
    public Long4 loadAbsolute(int index, ByteBuffer buf) {
        ...
        long[] d = this.data;
        MemorySegment seg = MemorySegment.ofBuffer(buf.duplicate().position(0));
        LongVector.fromMemorySegment(COL_SPECIES, seg, index, ByteOrder.nativeOrder()).intoArray(d, 0);
        return this;
    }
    ...
    public MemorySegment store(long offset, MemorySegment dest) {
        ...
        LongVector.fromArray(COL_SPECIES, d, 0).intoMemorySegment(seg, offset, ByteOrder.nativeOrder());
        return dest;
    }
    public Long4 load(long offset, MemorySegment src) {
        long[] d = this.data;
        MemorySegment seg = src;
        LongVector.fromMemorySegment(COL_SPECIES, seg, offset, ByteOrder.nativeOrder()).intoArray(d, 0);
        return this;
    }
    ...
    private static final VectorSpecies<Long> COL_SPECIES = LongVector.SPECIES_256;
