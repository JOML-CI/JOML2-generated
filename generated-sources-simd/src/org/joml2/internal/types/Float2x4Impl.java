...
/**
 * Generated implementation of {@link Float2x4} backed by a {@code float[]} array, with Vector API
...
public class Float2x4Impl implements Float2x4 {
    ...
    public float frobeniusNorm() {
        float[] sd = this.data;
        return (float) Math.sqrt(Math.fma(sd[0], sd[0], sd[1] * sd[1]) + Math.fma(sd[2], sd[2], sd[3] * sd[3]) + (Math.fma(sd[4], sd[4], sd[5] * sd[5]) + Math.fma(sd[6], sd[6], sd[7] * sd[7])));
    }
    ...
    public Float2x4 add(Float2x4R other, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float2x4Impl) other).data;
    ...
    @Mutated public Float2x4 set(Float2x4R v) {
        float[] dd = this.data;
        float[] vData = ((Float2x4Impl) v).data;
    ...
    private Float2x4 lerp_fma(Float2x4R other, float t, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float2x4Impl) other).data;
        float[] dd = ((Float2x4Impl) dest).data;
    ...
    private Float2x4 lerp_mulAdd(Float2x4R other, float t, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float2x4Impl) other).data;
        float[] dd = ((Float2x4Impl) dest).data;
        var _sv0 = FloatVector.broadcast(COL_SPECIES, t);
    ...
    private Float2x4 lerp_fma(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float t, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float2x4Impl) dest).data;
        var _sv0 = FloatVector.broadcast(COL_SPECIES, t);
        var _sv1 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.fma(FloatVector.zero(COL_SPECIES).withLane(0, m00).withLane(1, m01).withLane(2, m02).withLane(3, m03).sub(_sv1), _sv1);
        var _sv2 = FloatVector.fromArray(COL_SPECIES, sd, 4);
        var _col1 = _sv0.fma(FloatVector.zero(COL_SPECIES).withLane(0, m10).withLane(1, m11).withLane(2, m12).withLane(3, m13).sub(_sv2), _sv2);
        _col0.intoArray(dd, 0);
        _col1.intoArray(dd, 4);
        return dest;
    }

    private Float2x4 lerp_mulAdd(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float t, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float2x4Impl) dest).data;
        var _sv0 = FloatVector.broadcast(COL_SPECIES, t);
        var _sv1 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.mul(FloatVector.zero(COL_SPECIES).withLane(0, m00).withLane(1, m01).withLane(2, m02).withLane(3, m03).sub(_sv1)).add(_sv1);
        var _sv2 = FloatVector.fromArray(COL_SPECIES, sd, 4);
        var _col1 = _sv0.mul(FloatVector.zero(COL_SPECIES).withLane(0, m10).withLane(1, m11).withLane(2, m12).withLane(3, m13).sub(_sv2)).add(_sv2);
        _col0.intoArray(dd, 0);
        _col1.intoArray(dd, 4);
        return dest;
    }
    ...
    public Float2x4 mul(Float2x4R right, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] rightData = ((Float2x4Impl) right).data;
        float[] dd = ((Float2x4Impl) dest).data;
        float _buf0 = Math.fma(rightData[0], sd[0], rightData[4] * sd[1]);
        float _buf1 = Math.fma(rightData[1], sd[0], rightData[5] * sd[1]);
        float _buf2 = Math.fma(rightData[2], sd[0], Math.fma(rightData[6], sd[1], sd[2]));
        float _buf3 = Math.fma(rightData[3], sd[0], Math.fma(rightData[7], sd[1], sd[3]));
        float _buf4 = Math.fma(rightData[0], sd[4], rightData[4] * sd[5]);
        float _buf5 = Math.fma(rightData[1], sd[4], rightData[5] * sd[5]);
    ...
    public Float2x4 mul(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float2x4Impl) dest).data;
        float _buf0 = Math.fma(m00, sd[0], m10 * sd[1]);
        float _buf1 = Math.fma(m01, sd[0], m11 * sd[1]);
        dd[2] = Math.fma(m02, sd[0], Math.fma(m12, sd[1], sd[2]));
        dd[3] = Math.fma(m03, sd[0], Math.fma(m13, sd[1], sd[3]));
        float _buf2 = Math.fma(m00, sd[4], m10 * sd[5]);
        float _buf3 = Math.fma(m01, sd[4], m11 * sd[5]);
    ...
    public Float2x4 preMul(Float2x4R other, @Mutated Float2x4 dest) {
        ...
        float[] otherData = ((Float2x4Impl) other).data;
        float[] dd = ((Float2x4Impl) dest).data;
        float _buf0 = Math.fma(otherData[0], sd[0], otherData[1] * sd[4]);
        float _buf1 = Math.fma(otherData[0], sd[1], otherData[1] * sd[5]);
        float _buf2 = Math.fma(otherData[0], sd[2], Math.fma(otherData[1], sd[6], otherData[2]));
        float _buf3 = Math.fma(otherData[0], sd[3], Math.fma(otherData[1], sd[7], otherData[3]));
        float _buf4 = Math.fma(otherData[4], sd[0], otherData[5] * sd[4]);
        float _buf5 = Math.fma(otherData[4], sd[1], otherData[5] * sd[5]);
    ...
    public Float2x4 preMul(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float2x4Impl) dest).data;
        float _buf0 = Math.fma(m00, sd[0], m01 * sd[4]);
        float _buf1 = Math.fma(m00, sd[1], m01 * sd[5]);
        float _buf2 = Math.fma(m00, sd[2], Math.fma(m01, sd[6], m02));
        float _buf3 = Math.fma(m00, sd[3], Math.fma(m01, sd[7], m03));
    ...
    private Float2x4 addScaled_fma(Float2x4R other, float weight, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float2x4Impl) other).data;
        float[] dd = ((Float2x4Impl) dest).data;
    ...
    private Float2x4 addScaled_mulAdd(Float2x4R other, float weight, @Mutated Float2x4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float2x4Impl) other).data;
        float[] dd = ((Float2x4Impl) dest).data;
        var _sv0 = FloatVector.broadcast(COL_SPECIES, weight);
    ...
    public float m01() { return data[1]; }
    public float m02() { return data[2]; }
    public float m03() { return data[3]; }
    public float m10() { return data[4]; }
    public float m11() { return data[5]; }
    public float m12() { return data[6]; }
    public float m13() { return data[7]; }
