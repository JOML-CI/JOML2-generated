...
public final class Float4Impl implements Float4 {
    ...
    public float angleBetween(float otherX, float otherY, float otherZ, float otherW) {
        ...
        return (float) Math.atan2((float) Math.sqrt(Math.fma(_t12, _t12, Math.fma(_t13, _t13, Math.fma(_t14, _t14, Math.fma(_t15, _t15, Math.fma(_t16, _t16, _t17 * _t17)))))), Math.fma(otherW, sd[3], Math.fma(otherZ, sd[2], Math.fma(otherX, sd[0], otherY * sd[1]))));
    }
    ...
    public Float4 mod(float y, @Mutated Float4 dest) {
        if (SimdMath.USE_FMA) return mod_fma(y, dest);
        return mod_mulAdd(y, dest);
    }

    private Float4 mod_fma(float y, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = FloatVector.broadcast(COL_SPECIES, -y).fma(FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.floor(sd[0] * 1.0f / y)).withLane(1, (float) Math.floor(sd[1] * 1.0f / y)).withLane(2, (float) Math.floor(sd[2] * 1.0f / y)).withLane(3, (float) Math.floor(sd[3] * 1.0f / y)), _sv0);
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 mod_mulAdd(float y, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = FloatVector.broadcast(COL_SPECIES, -y).mul(FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.floor(sd[0] * 1.0f / y)).withLane(1, (float) Math.floor(sd[1] * 1.0f / y)).withLane(2, (float) Math.floor(sd[2] * 1.0f / y)).withLane(3, (float) Math.floor(sd[3] * 1.0f / y))).add(_sv0);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Double4 mod(float y, @Mutated Double4 dest) {
        ...
        double[] dd = ((Double4Impl) dest).data;
        float _rcp0 = 1.0f / y;
        dd[0] = Math.fma(-y, (float) Math.floor(sd[0] * _rcp0), sd[0]);
        dd[1] = Math.fma(-y, (float) Math.floor(sd[1] * _rcp0), sd[1]);
        dd[2] = Math.fma(-y, (float) Math.floor(sd[2] * _rcp0), sd[2]);
        dd[3] = Math.fma(-y, (float) Math.floor(sd[3] * _rcp0), sd[3]);
        return dest;
    }
    ...
    private Float4 mod_fma(Float4R y, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] yData = ((Float4Impl) y).data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, yData, 0);
        var _sv1 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.neg().fma(FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.floor(sd[0] / yData[0])).withLane(1, (float) Math.floor(sd[1] / yData[1])).withLane(2, (float) Math.floor(sd[2] / yData[2])).withLane(3, (float) Math.floor(sd[3] / yData[3])), _sv1);
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 mod_mulAdd(Float4R y, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] yData = ((Float4Impl) y).data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, yData, 0);
        var _sv1 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.neg().mul(FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.floor(sd[0] / yData[0])).withLane(1, (float) Math.floor(sd[1] / yData[1])).withLane(2, (float) Math.floor(sd[2] / yData[2])).withLane(3, (float) Math.floor(sd[3] / yData[3]))).add(_sv1);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 mod(float yX, float yY, float yZ, float yW, @Mutated Float4 dest) {
        if (SimdMath.USE_FMA) return mod_fma(yX, yY, yZ, yW, dest);
        return mod_mulAdd(yX, yY, yZ, yW, dest);
    }

    private Float4 mod_fma(float yX, float yY, float yZ, float yW, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.zero(COL_SPECIES).withLane(0, yX).withLane(1, yY).withLane(2, yZ).withLane(3, yW);
        var _sv1 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.neg().fma(FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.floor(sd[0] / yX)).withLane(1, (float) Math.floor(sd[1] / yY)).withLane(2, (float) Math.floor(sd[2] / yZ)).withLane(3, (float) Math.floor(sd[3] / yW)), _sv1);
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 mod_mulAdd(float yX, float yY, float yZ, float yW, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.zero(COL_SPECIES).withLane(0, yX).withLane(1, yY).withLane(2, yZ).withLane(3, yW);
        var _sv1 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.neg().mul(FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.floor(sd[0] / yX)).withLane(1, (float) Math.floor(sd[1] / yY)).withLane(2, (float) Math.floor(sd[2] / yZ)).withLane(3, (float) Math.floor(sd[3] / yW))).add(_sv1);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 rotateAxis(float angle, Float3R axis, @Mutated Float4 dest) {
        ...
        float _buf0 = Math.fma(_t2, axisData[0] * _t5, Math.fma(sd[0], _t0, Math.fma(axisData[1], sd[2], -(axisData[2] * sd[1])) * _t1));
        float _buf1 = Math.fma(_t2, axisData[1] * _t5, Math.fma(sd[1], _t0, Math.fma(axisData[2], sd[0], -(axisData[0] * sd[2])) * _t1));
