...
/**
 * Generated implementation of {@link Float4} backed by a {@code float[]} array, with Vector API
...
public final class Float4Impl implements Float4 {
    ...
    public Float4 add(Float4R other, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float4Impl) other).data;
    ...
    public Float4 div(float scalar, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).mul(FloatVector.broadcast(COL_SPECIES, 1.0f / scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 div(Float4R other, @Mutated Float4 dest) {
        ...
        float[] otherData = ((Float4Impl) other).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).div(FloatVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 fma_fma(float b, Float4R c, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] cData = ((Float4Impl) c).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).fma(FloatVector.broadcast(COL_SPECIES, b), FloatVector.fromArray(COL_SPECIES, cData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 fma_mulAdd(float b, Float4R c, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] cData = ((Float4Impl) c).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).mul(FloatVector.broadcast(COL_SPECIES, b)).add(FloatVector.fromArray(COL_SPECIES, cData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 fma_fma(Float4R b, Float4R c, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] bData = ((Float4Impl) b).data;
        float[] cData = ((Float4Impl) c).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).fma(FloatVector.fromArray(COL_SPECIES, bData, 0), FloatVector.fromArray(COL_SPECIES, cData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 fma_mulAdd(Float4R b, Float4R c, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] bData = ((Float4Impl) b).data;
        float[] cData = ((Float4Impl) c).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).mul(FloatVector.fromArray(COL_SPECIES, bData, 0)).add(FloatVector.fromArray(COL_SPECIES, cData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 mul(Float4R other, @Mutated Float4 dest) {
        ...
        float[] otherData = ((Float4Impl) other).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, otherData, 0).mul(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    @Mutated public Float4 makeUniformDirection(float u, float v, float w) {
        ...
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.cosFromSin(_t4, _t1)).withLane(1, _t4).withLane(2, (float) Math.cosFromSin(_t6, _t3)).withLane(3, _t6).mul(FloatVector.broadcast(COL_SPECIES, (float) Math.sqrt(1.0f - u)).blend(FloatVector.broadcast(COL_SPECIES, (float) Math.sqrt(u)), MASK_0));
        _col0.intoArray(dd, 0);
        return this;
    }
     ...
     * @return this
     */
    @Mutated public Float4 set(Float4R v) {
        float[] dd = this.data;
        float[] vData = ((Float4Impl) v).data;
    ...
    public Float4 set(float s, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.broadcast(COL_SPECIES, s);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 bezier_fma(Float4R p1, Float4R p2, Float4R p3, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        ...
        float _t1 = t * t;
        float _t3 = _t0 * _t0;
        var _col0 = FloatVector.fromArray(COL_SPECIES, p1Data, 0).fma(FloatVector.broadcast(COL_SPECIES, 3.0f * t * _t3), FloatVector.fromArray(COL_SPECIES, sd, 0).mul(FloatVector.broadcast(COL_SPECIES, _t0 * _t3))).add(FloatVector.fromArray(COL_SPECIES, p2Data, 0).fma(FloatVector.broadcast(COL_SPECIES, 3.0f * _t0 * _t1), FloatVector.fromArray(COL_SPECIES, p3Data, 0).mul(FloatVector.broadcast(COL_SPECIES, t * _t1))));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 bezier_mulAdd(Float4R p1, Float4R p2, Float4R p3, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] p3Data = ((Float4Impl) p3).data;
        ...
        float _t1 = t * t;
        float _t3 = _t0 * _t0;
        var _col0 = FloatVector.fromArray(COL_SPECIES, p1Data, 0).mul(FloatVector.broadcast(COL_SPECIES, 3.0f * t * _t3)).add(FloatVector.fromArray(COL_SPECIES, sd, 0).mul(FloatVector.broadcast(COL_SPECIES, _t0 * _t3))).add(FloatVector.fromArray(COL_SPECIES, p2Data, 0).mul(FloatVector.broadcast(COL_SPECIES, 3.0f * _t0 * _t1)).add(FloatVector.fromArray(COL_SPECIES, p3Data, 0).mul(FloatVector.broadcast(COL_SPECIES, t * _t1))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 bezier2_fma(Float4R p1, Float4R p2, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] dd = ((Float4Impl) dest).data;
    ...
    private Float4 bezier2_mulAdd(Float4R p1, Float4R p2, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] dd = ((Float4Impl) dest).data;
    ...
    private Float4 bezier2Tangent_fma(Float4R p1, Float4R p2, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] dd = ((Float4Impl) dest).data;
    ...
    private Float4 bezier2Tangent_mulAdd(Float4R p1, Float4R p2, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] dd = ((Float4Impl) dest).data;
    ...
    private Float4 bezierTangent_fma(Float4R p1, Float4R p2, Float4R p3, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] p3Data = ((Float4Impl) p3).data;
        float[] dd = ((Float4Impl) dest).data;
        float _t1 = 1.0f - t;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, p2Data, 0);
        var _sv1 = FloatVector.fromArray(COL_SPECIES, p1Data, 0);
        var _col0 = FloatVector.fromArray(COL_SPECIES, p3Data, 0).sub(_sv0).fma(FloatVector.broadcast(COL_SPECIES, 3.0f * t * t), _sv1.sub(FloatVector.fromArray(COL_SPECIES, sd, 0)).fma(FloatVector.broadcast(COL_SPECIES, 3.0f * _t1 * _t1), _sv0.sub(_sv1).mul(FloatVector.broadcast(COL_SPECIES, 6.0f * t * _t1))));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 bezierTangent_mulAdd(Float4R p1, Float4R p2, Float4R p3, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] p3Data = ((Float4Impl) p3).data;
        ...
        var _sv0 = FloatVector.fromArray(COL_SPECIES, p2Data, 0);
        var _sv1 = FloatVector.fromArray(COL_SPECIES, p1Data, 0);
        var _col0 = FloatVector.fromArray(COL_SPECIES, p3Data, 0).sub(_sv0).mul(FloatVector.broadcast(COL_SPECIES, 3.0f * t * t)).add(_sv1.sub(FloatVector.fromArray(COL_SPECIES, sd, 0)).mul(FloatVector.broadcast(COL_SPECIES, 3.0f * _t1 * _t1)).add(_sv0.sub(_sv1).mul(FloatVector.broadcast(COL_SPECIES, 6.0f * t * _t1))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 catmullRom_fma(Float4R p1, Float4R p2, Float4R p3, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] p3Data = ((Float4Impl) p3).data;
        ...
        var _col0 = FloatVector.broadcast(COL_SPECIES, 0.5f).mul(_sv0.fma(_sv1, FloatVector.broadcast(COL_SPECIES, t).mul(_sv2.sub(_sv3))).add(FloatVector.broadcast(COL_SPECIES, -5.0f).fma(_sv1, _sv0.fma(_sv3, FloatVector.broadcast(COL_SPECIES, 4.0f).fma(_sv2, _sv4.neg()))).fma(FloatVector.broadcast(COL_SPECIES, _t0), FloatVector.broadcast(COL_SPECIES, -3.0f).fma(_sv2, FloatVector.broadcast(COL_SPECIES, 3.0f).fma(_sv1, _sv4.sub(_sv3))).mul(FloatVector.broadcast(COL_SPECIES, t * _t0)))));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 catmullRom_mulAdd(Float4R p1, Float4R p2, Float4R p3, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] p3Data = ((Float4Impl) p3).data;
    ...
    private Float4 catmullRomTangent_fma(Float4R p1, Float4R p2, Float4R p3, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] p3Data = ((Float4Impl) p3).data;
        ...
        var _sv1 = FloatVector.fromArray(COL_SPECIES, p1Data, 0);
        var _sv2 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _sv3 = FloatVector.fromArray(COL_SPECIES, p2Data, 0);
        var _sv4 = FloatVector.fromArray(COL_SPECIES, p3Data, 0);
        var _sv5 = FloatVector.broadcast(COL_SPECIES, 3.0f);
        var _col0 = FloatVector.broadcast(COL_SPECIES, 0.5f).mul(FloatVector.broadcast(COL_SPECIES, t).fma(_sv0.mul(FloatVector.broadcast(COL_SPECIES, -5.0f).fma(_sv1, _sv0.fma(_sv2, FloatVector.broadcast(COL_SPECIES, 4.0f).fma(_sv3, _sv4.neg())))), _sv5.mul(FloatVector.broadcast(COL_SPECIES, -3.0f).fma(_sv3, _sv5.fma(_sv1, _sv4.sub(_sv2)))).fma(FloatVector.broadcast(COL_SPECIES, t * t), _sv3.sub(_sv2))));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 catmullRomTangent_mulAdd(Float4R p1, Float4R p2, Float4R p3, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] p1Data = ((Float4Impl) p1).data;
        float[] p2Data = ((Float4Impl) p2).data;
        float[] p3Data = ((Float4Impl) p3).data;
        ...
        var _sv4 = FloatVector.fromArray(COL_SPECIES, p3Data, 0);
        var _sv5 = FloatVector.broadcast(COL_SPECIES, 3.0f);
        var _col0 = FloatVector.broadcast(COL_SPECIES, 0.5f).mul(FloatVector.broadcast(COL_SPECIES, t).mul(_sv0.mul(FloatVector.broadcast(COL_SPECIES, -5.0f).mul(_sv1).add(_sv0.mul(_sv2).add(FloatVector.broadcast(COL_SPECIES, 4.0f).mul(_sv3).add(_sv4.neg()))))).add(_sv5.mul(FloatVector.broadcast(COL_SPECIES, -3.0f).mul(_sv3).add(_sv5.mul(_sv1).add(_sv4.sub(_sv2)))).mul(FloatVector.broadcast(COL_SPECIES, t * t)).add(_sv3.sub(_sv2))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 hermite_fma(Float4R t0, Float4R v1, Float4R t1, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] t0Data = ((Float4Impl) t0).data;
        float[] v1Data = ((Float4Impl) v1).data;
    ...
    private Float4 hermite_mulAdd(Float4R t0, Float4R v1, Float4R t1, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] t0Data = ((Float4Impl) t0).data;
        float[] v1Data = ((Float4Impl) v1).data;
        float[] t1Data = ((Float4Impl) t1).data;
    ...
    private Float4 hermiteTangent_fma(Float4R t0, Float4R v1, Float4R t1, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] t0Data = ((Float4Impl) t0).data;
        float[] v1Data = ((Float4Impl) v1).data;
        float[] t1Data = ((Float4Impl) t1).data;
    ...
    private Float4 hermiteTangent_mulAdd(Float4R t0, Float4R v1, Float4R t1, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] t0Data = ((Float4Impl) t0).data;
        float[] v1Data = ((Float4Impl) v1).data;
        float[] t1Data = ((Float4Impl) t1).data;
    ...
    private Float4 lerp_fma(Float4R other, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float4Impl) other).data;
        float[] dd = ((Float4Impl) dest).data;
    ...
    private Float4 lerp_mulAdd(Float4R other, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float4Impl) other).data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
    ...
    private Float4 lerp_fma(float otherX, float otherY, float otherZ, float otherW, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
    ...
    private Float4 lerp_mulAdd(float otherX, float otherY, float otherZ, float otherW, float t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
    ...
    private Float4 lerp_fma(Float4R other, Float4R t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float4Impl) other).data;
        float[] tData = ((Float4Impl) t).data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = FloatVector.fromArray(COL_SPECIES, tData, 0).fma(FloatVector.fromArray(COL_SPECIES, otherData, 0).sub(_sv0), _sv0);
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 lerp_mulAdd(Float4R other, Float4R t, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] otherData = ((Float4Impl) other).data;
        float[] tData = ((Float4Impl) t).data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = FloatVector.fromArray(COL_SPECIES, tData, 0).mul(FloatVector.fromArray(COL_SPECIES, otherData, 0).sub(_sv0)).add(_sv0);
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 slerp(Float4R other, float t, @Mutated Float4 dest) {
        ...
        float[] otherData = ((Float4Impl) other).data;
        float[] dd = ((Float4Impl) dest).data;
        float _ct0 = Math.fma(sd[3], sd[3], Math.fma(sd[2], sd[2], Math.fma(sd[0], sd[0], sd[1] * sd[1])));
        if (!(_ct0 > 1.1754944E-38f && _ct0 < Float.POSITIVE_INFINITY)) return slerp_degenerate(other, t, dest);
        float _t8 = _ct0;
        float _ct1 = Math.fma(otherData[3], otherData[3], Math.fma(otherData[2], otherData[2], Math.fma(otherData[0], otherData[0], otherData[1] * otherData[1])));
        if (!(_ct1 > 1.1754944E-38f && _ct1 < Float.POSITIVE_INFINITY)) return slerp_degenerate(other, t, dest);
        float _t9 = _ct1;
        float _t12 = (float) Math.sqrt(_t8);
        float _t10 = 1.0f / _t12;
        float _t13 = (1.0f / (float) Math.sqrt(_t9));
        float _t14 = sd[0] * _t10;
        float _t16 = sd[3] * _t10;
        float _t18 = sd[2] * _t10;
        float _t21 = sd[1] * _t10;
        float _t24 = Math.fma(t, (float) Math.sqrt(_t9) - _t12, _t12);
        float _t27 = Math.fma(otherData[3] * _t13, _t16, Math.fma(otherData[2] * _t13, _t18, Math.fma(otherData[0] * _t13, _t14, otherData[1] * _t13 * _t21)));
        float _t36 = Math.fma(otherData[3], _t13, -(_t27 * _t16));
        float _t37 = Math.fma(otherData[2], _t13, -(_t27 * _t18));
        float _t38 = Math.fma(otherData[0], _t13, -(_t27 * _t14));
        float _t39 = Math.fma(otherData[1], _t13, -(_t27 * _t21));
        ...
        if (!(_ct2 > 1.1754944E-38f && _ct2 < Float.POSITIVE_INFINITY)) return slerp_degenerate(other, t, dest);
        float _t53 = _ct2;
    ...
    public Double4 slerp(float otherX, float otherY, float otherZ, float otherW, float t, @Mutated Double4 dest) {
        ...
        if (!(_ct2 > 1.1754944E-38f && _ct2 < Float.POSITIVE_INFINITY)) return slerp_degenerate(otherX, otherY, otherZ, otherW, t, dest);
        float _t53 = _ct2;
        float _t55 = (1.0f / (float) Math.sqrt(_t53));
        float _t57 = t * (float) Math.atan2((float) Math.sqrt(_t53), _t27);
        float _t58 = (float) Math.sin(_t57);
        float _t59 = _t24 * _t58;
        float _t61 = _t24 * (float) Math.cosFromSin(_t58, _t57);
        dd[0] = Math.fma(_t14, _t61, _t59 * _t47 * _t55);
        dd[1] = Math.fma(_t21, _t61, _t59 * _t48 * _t55);
        dd[2] = Math.fma(_t18, _t61, _t59 * _t46 * _t55);
        dd[3] = Math.fma(_t16, _t61, _t59 * _t45 * _t55);
        return dest;
    }
    ...
    private Float4 slerp_degenerate(Float4R other, float t, @Mutated Float4 dest) {
        ...
        float[] otherData = ((Float4Impl) other).data;
        float[] dd = ((Float4Impl) dest).data;
        float _t6 = unitScale(otherData[2], otherData[3], Math.max(Math.abs(otherData[0]), Math.abs(otherData[1])));
        float _t7 = unitScale(sd[2], sd[3], Math.max(Math.abs(sd[0]), Math.abs(sd[1])));
        float _t16 = otherData[3] * _t6;
        float _t17 = otherData[2] * _t6;
        float _t18 = otherData[0] * _t6;
        float _t19 = otherData[1] * _t6;
        float _t20 = sd[3] * _t7;
        float _t21 = sd[2] * _t7;
        float _t22 = sd[0] * _t7;
        float _t23 = sd[1] * _t7;
     ...
     * through them.
     */
    @Mutated private Float4 slerp_degenerate(Float4R other, float t) {
        return slerp_degenerate(other, t, Joml.RETURN_NEW ? Joml.float4() : this);
    }
    ...
    public Float4 absolute(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).abs();
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 acos(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.acos(sd[0])).withLane(1, (float) Math.acos(sd[1])).withLane(2, (float) Math.acos(sd[2])).withLane(3, (float) Math.acos(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 addScaled_fma(Float4R b, float scalar, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] bData = ((Float4Impl) b).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.broadcast(COL_SPECIES, scalar).fma(FloatVector.fromArray(COL_SPECIES, bData, 0), FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 addScaled_mulAdd(Float4R b, float scalar, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] bData = ((Float4Impl) b).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.broadcast(COL_SPECIES, scalar).mul(FloatVector.fromArray(COL_SPECIES, bData, 0)).add(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 addScaled_fma(Float4R b, Float4R c, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] bData = ((Float4Impl) b).data;
        float[] cData = ((Float4Impl) c).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, bData, 0).fma(FloatVector.fromArray(COL_SPECIES, cData, 0), FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 addScaled_mulAdd(Float4R b, Float4R c, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] bData = ((Float4Impl) b).data;
        float[] cData = ((Float4Impl) c).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, bData, 0).mul(FloatVector.fromArray(COL_SPECIES, cData, 0)).add(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public float angleBetween(float otherX, float otherY, float otherZ, float otherW) {
        ...
        return (float) Math.atan2((float) Math.sqrt(_ct0), Math.fma(otherW, sd[3], Math.fma(otherZ, sd[2], Math.fma(otherX, sd[0], otherY * sd[1]))));
    }
    ...
    public Float4 asin(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.asin(sd[0])).withLane(1, (float) Math.asin(sd[1])).withLane(2, (float) Math.asin(sd[2])).withLane(3, (float) Math.asin(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 atan(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.atan(sd[0])).withLane(1, (float) Math.atan(sd[1])).withLane(2, (float) Math.atan(sd[2])).withLane(3, (float) Math.atan(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 atan2(float x, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.atan2(sd[0], x)).withLane(1, (float) Math.atan2(sd[1], x)).withLane(2, (float) Math.atan2(sd[2], x)).withLane(3, (float) Math.atan2(sd[3], x));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Double4 atan2(float x, @Mutated Double4 dest) {
        float[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        dd[0] = (float) Math.atan2(sd[0], x);
        dd[1] = (float) Math.atan2(sd[1], x);
        dd[2] = (float) Math.atan2(sd[2], x);
        dd[3] = (float) Math.atan2(sd[3], x);
        return dest;
    }
    ...
    public Float4 atan2(Float4R x, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] xData = ((Float4Impl) x).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.atan2(sd[0], xData[0])).withLane(1, (float) Math.atan2(sd[1], xData[1])).withLane(2, (float) Math.atan2(sd[2], xData[2])).withLane(3, (float) Math.atan2(sd[3], xData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 cbrt(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.cbrt(sd[0])).withLane(1, (float) Math.cbrt(sd[1])).withLane(2, (float) Math.cbrt(sd[2])).withLane(3, (float) Math.cbrt(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 ceil(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.ceil(sd[0])).withLane(1, (float) Math.ceil(sd[1])).withLane(2, (float) Math.ceil(sd[2])).withLane(3, (float) Math.ceil(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 clamp(float min, float max, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).max(FloatVector.broadcast(COL_SPECIES, min)).min(FloatVector.broadcast(COL_SPECIES, max));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 clamp(Float4R min, Float4R max, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] minData = ((Float4Impl) min).data;
        float[] maxData = ((Float4Impl) max).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).max(FloatVector.fromArray(COL_SPECIES, minData, 0)).min(FloatVector.fromArray(COL_SPECIES, maxData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 copySign(float sign, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, Math.copySign(sd[0], sign)).withLane(1, Math.copySign(sd[1], sign)).withLane(2, Math.copySign(sd[2], sign)).withLane(3, Math.copySign(sd[3], sign));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 copySign(Float4R sign, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] signData = ((Float4Impl) sign).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, Math.copySign(sd[0], signData[0])).withLane(1, Math.copySign(sd[1], signData[1])).withLane(2, Math.copySign(sd[2], signData[2])).withLane(3, Math.copySign(sd[3], signData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 cos(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.cos(sd[0])).withLane(1, (float) Math.cos(sd[1])).withLane(2, (float) Math.cos(sd[2])).withLane(3, (float) Math.cos(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 cosh(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.cosh(sd[0])).withLane(1, (float) Math.cosh(sd[1])).withLane(2, (float) Math.cosh(sd[2])).withLane(3, (float) Math.cosh(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 cross_fma(Float4R v, Float4R w, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] vData = ((Float4Impl) v).data;
        float[] wData = ((Float4Impl) w).data;
        float[] dd = ((Float4Impl) dest).data;
        float _r0 = vData[1];
        float _r1 = wData[2];
        float _r2 = vData[2];
        ...
        float _r10 = sd[1];
        float _r11 = sd[0];
        float _t12 = Math.fma(_r0, _r1, -(_r2 * _r3));
        float _t13 = Math.fma(_r2, _r4, -(_r5 * _r1));
        float _t14 = Math.fma(_r0, _r4, -(_r5 * _r3));
        float _t15 = Math.fma(_r6, _r1, -(_r2 * _r7));
        float _t16 = Math.fma(_r6, _r4, -(_r5 * _r7));
        float _t17 = Math.fma(_r6, _r3, -(_r0 * _r7));
        cross_s54418060_tail(dd, _r8, _r9, _r10, _r11, _t12, _t13, _t14, _t15, _t16, _t17);
        return dest;
    }

    private Float4 cross_mulAdd(Float4R v, Float4R w, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] vData = ((Float4Impl) v).data;
        float[] wData = ((Float4Impl) w).data;
        float[] dd = ((Float4Impl) dest).data;
        ...
        float _t16 = Math.fma(_r6, _r4, -(_r5 * _r7));
        float _t17 = Math.fma(_r6, _r3, -(_r0 * _r7));
        cross_s7ee2cc97_tail(dd, _r8, _r9, _r10, _r11, _t12, _t13, _t14, _t15, _t16, _t17);
        return dest;
    }

    /** Private vector tail of {@code cross_s54418060}: loads, computes and stores every column; reached only through it. */
    private static void cross_s54418060_tail(float[] dd, float _r8, float _r9, float _r10, float _r11, float _t12, float _t13, float _t14, float _t15, float _t16, float _t17) {
        var _sv0 = FloatVector.broadcast(COL_SPECIES, _r8);
        var _col0 = _sv0.blend(_sv0.withLane(3, _r9).neg(), MASK_1).fma(FloatVector.zero(COL_SPECIES).withLane(0, _t12).withLane(1, _t15).withLane(2, _t17).withLane(3, _t17), FloatVector.zero(COL_SPECIES).withLane(0, _r10 * _t13 - _r9 * _t14).withLane(1, _r9 * _t16 + -(_r11 * _t13)).withLane(2, _r11 * _t14 + -(_r10 * _t16)).withLane(3, _r10 * _t15 - _r11 * _t12));
        _col0.intoArray(dd, 0);
    }

    /** Private vector tail of {@code cross_s7ee2cc97}: loads, computes and stores every column; reached only through it. */
    private static void cross_s7ee2cc97_tail(float[] dd, float _r8, float _r9, float _r10, float _r11, float _t12, float _t13, float _t14, float _t15, float _t16, float _t17) {
        var _sv0 = FloatVector.broadcast(COL_SPECIES, _r8);
        var _col0 = _sv0.blend(_sv0.withLane(3, _r9).neg(), MASK_1).mul(FloatVector.zero(COL_SPECIES).withLane(0, _t12).withLane(1, _t15).withLane(2, _t17).withLane(3, _t17)).add(FloatVector.zero(COL_SPECIES).withLane(0, _r10 * _t13 - _r9 * _t14).withLane(1, _r9 * _t16 + -(_r11 * _t13)).withLane(2, _r11 * _t14 + -(_r10 * _t16)).withLane(3, _r10 * _t15 - _r11 * _t12));
        _col0.intoArray(dd, 0);
    }
    ...
    private Float4 cross_fma(float vX, float vY, float vZ, float vW, float wX, float wY, float wZ, float wW, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        float _r0 = sd[3];
        float _r1 = sd[2];
        ...
        cross_s495c72ef_tail(dd, _r0, _r1, _r2, _r3, _t12, _t13, _t14, _t15, _t16, _t17);
        return dest;
    }

    private Float4 cross_mulAdd(float vX, float vY, float vZ, float vW, float wX, float wY, float wZ, float wW, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        float _r0 = sd[3];
        float _r1 = sd[2];
        ...
        float _t16 = Math.fma(vX, wW, -(vW * wX));
        float _t17 = Math.fma(vX, wY, -(vY * wX));
        cross_s29cb9ba8_tail(dd, _r0, _r1, _r2, _r3, _t12, _t13, _t14, _t15, _t16, _t17);
        return dest;
    }

    /** Private vector tail of {@code cross_s495c72ef}: loads, computes and stores every column; reached only through it. */
    private static void cross_s495c72ef_tail(float[] dd, float _r0, float _r1, float _r2, float _r3, float _t12, float _t13, float _t14, float _t15, float _t16, float _t17) {
        var _sv0 = FloatVector.broadcast(COL_SPECIES, _r0);
        var _col0 = _sv0.blend(_sv0.withLane(3, _r1).neg(), MASK_1).fma(FloatVector.zero(COL_SPECIES).withLane(0, _t12).withLane(1, _t15).withLane(2, _t17).withLane(3, _t17), FloatVector.zero(COL_SPECIES).withLane(0, _r2 * _t13 - _r1 * _t14).withLane(1, _r1 * _t16 + -(_r3 * _t13)).withLane(2, _r3 * _t14 + -(_r2 * _t16)).withLane(3, _r2 * _t15 - _r3 * _t12));
        _col0.intoArray(dd, 0);
    }

    /** Private vector tail of {@code cross_s29cb9ba8}: loads, computes and stores every column; reached only through it. */
    private static void cross_s29cb9ba8_tail(float[] dd, float _r0, float _r1, float _r2, float _r3, float _t12, float _t13, float _t14, float _t15, float _t16, float _t17) {
        var _sv0 = FloatVector.broadcast(COL_SPECIES, _r0);
        var _col0 = _sv0.blend(_sv0.withLane(3, _r1).neg(), MASK_1).mul(FloatVector.zero(COL_SPECIES).withLane(0, _t12).withLane(1, _t15).withLane(2, _t17).withLane(3, _t17)).add(FloatVector.zero(COL_SPECIES).withLane(0, _r2 * _t13 - _r1 * _t14).withLane(1, _r1 * _t16 + -(_r3 * _t13)).withLane(2, _r3 * _t14 + -(_r2 * _t16)).withLane(3, _r2 * _t15 - _r3 * _t12));
        _col0.intoArray(dd, 0);
    }
    ...
    public Double4 cross(float vX, float vY, float vZ, float vW, float wX, float wY, float wZ, float wW, @Mutated Double4 dest) {
        ...
        float _t16 = Math.fma(vX, wW, -(vW * wX));
        float _t17 = Math.fma(vX, wY, -(vY * wX));
        float _buf0 = Math.fma(sd[3], _t12, Math.fma(sd[1], _t13, -(sd[2] * _t14)));
        float _buf1 = Math.fma(-sd[3], _t15, Math.fma(sd[2], _t16, -(sd[0] * _t13)));
        float _buf2 = Math.fma(sd[3], _t17, Math.fma(sd[0], _t14, -(sd[1] * _t16)));
    ...
    public Float4 degrees(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.toDegrees(sd[0])).withLane(1, (float) Math.toDegrees(sd[1])).withLane(2, (float) Math.toDegrees(sd[2])).withLane(3, (float) Math.toDegrees(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 exp(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.exp(sd[0])).withLane(1, (float) Math.exp(sd[1])).withLane(2, (float) Math.exp(sd[2])).withLane(3, (float) Math.exp(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 exp2(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.pow(2.0f, sd[0])).withLane(1, (float) Math.pow(2.0f, sd[1])).withLane(2, (float) Math.pow(2.0f, sd[2])).withLane(3, (float) Math.pow(2.0f, sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 expm1(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.expm1(sd[0])).withLane(1, (float) Math.expm1(sd[1])).withLane(2, (float) Math.expm1(sd[2])).withLane(3, (float) Math.expm1(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 faceforward(Float4R I, Float4R Nref, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] IData = ((Float4Impl) I).data;
        float[] NrefData = ((Float4Impl) Nref).data;
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = (Math.fma(IData[3], NrefData[3], Math.fma(IData[2], NrefData[2], Math.fma(IData[0], NrefData[0], IData[1] * NrefData[1]))) < 0.0f ? _sv0 : _sv0.neg());
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 faceforward(float IX, float IY, float IZ, float IW, float NrefX, float NrefY, float NrefZ, float NrefW, @Mutated Float4 dest) {
        ...
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = (Math.fma(IW, NrefW, Math.fma(IZ, NrefZ, Math.fma(IX, NrefX, IY * NrefY))) < 0.0f ? _sv0 : _sv0.neg());
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 floor(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.floor(sd[0])).withLane(1, (float) Math.floor(sd[1])).withLane(2, (float) Math.floor(sd[2])).withLane(3, (float) Math.floor(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 fract(@Mutated Float4 dest) {
        ...
        float[] dd = ((Float4Impl) dest).data;
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = _sv0.sub(FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.floor(sd[0])).withLane(1, (float) Math.floor(sd[1])).withLane(2, (float) Math.floor(sd[2])).withLane(3, (float) Math.floor(sd[3])));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 hypot(float y, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.hypot(sd[0], y)).withLane(1, (float) Math.hypot(sd[1], y)).withLane(2, (float) Math.hypot(sd[2], y)).withLane(3, (float) Math.hypot(sd[3], y));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Double4 hypot(float y, @Mutated Double4 dest) {
        float[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        dd[0] = (float) Math.hypot(sd[0], y);
        dd[1] = (float) Math.hypot(sd[1], y);
        dd[2] = (float) Math.hypot(sd[2], y);
        dd[3] = (float) Math.hypot(sd[3], y);
        return dest;
    }
    ...
    public Float4 hypot(Float4R y, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] yData = ((Float4Impl) y).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.hypot(sd[0], yData[0])).withLane(1, (float) Math.hypot(sd[1], yData[1])).withLane(2, (float) Math.hypot(sd[2], yData[2])).withLane(3, (float) Math.hypot(sd[3], yData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 inverse(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.broadcast(COL_SPECIES, 1.0f).div(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 inverseSqrt(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (1.0f / (float) Math.sqrt(sd[0]))).withLane(1, (1.0f / (float) Math.sqrt(sd[1]))).withLane(2, (1.0f / (float) Math.sqrt(sd[2]))).withLane(3, (1.0f / (float) Math.sqrt(sd[3])));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 log(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.log(sd[0])).withLane(1, (float) Math.log(sd[1])).withLane(2, (float) Math.log(sd[2])).withLane(3, (float) Math.log(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 log10(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.log10(sd[0])).withLane(1, (float) Math.log10(sd[1])).withLane(2, (float) Math.log10(sd[2])).withLane(3, (float) Math.log10(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 log1p(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.log1p(sd[0])).withLane(1, (float) Math.log1p(sd[1])).withLane(2, (float) Math.log1p(sd[2])).withLane(3, (float) Math.log1p(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 log2(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.log(sd[0])).withLane(1, (float) Math.log(sd[1])).withLane(2, (float) Math.log(sd[2])).withLane(3, (float) Math.log(sd[3])).mul(FloatVector.broadcast(COL_SPECIES, 1.0f / (float) Math.log(2.0f)));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 max(float scalar, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).max(FloatVector.broadcast(COL_SPECIES, scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Double4 max(float scalar, @Mutated Double4 dest) {
        float[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        dd[0] = Math.max(sd[0], scalar);
        dd[1] = Math.max(sd[1], scalar);
        dd[2] = Math.max(sd[2], scalar);
        dd[3] = Math.max(sd[3], scalar);
        return dest;
    }
    ...
    public Float4 max(Float4R other, @Mutated Float4 dest) {
        ...
        float[] otherData = ((Float4Impl) other).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).max(FloatVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 min(float scalar, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).min(FloatVector.broadcast(COL_SPECIES, scalar));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Double4 min(float scalar, @Mutated Double4 dest) {
        float[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        dd[0] = Math.min(sd[0], scalar);
        dd[1] = Math.min(sd[1], scalar);
        dd[2] = Math.min(sd[2], scalar);
        dd[3] = Math.min(sd[3], scalar);
        return dest;
    }
    ...
    public Float4 min(Float4R other, @Mutated Float4 dest) {
        ...
        float[] otherData = ((Float4Impl) other).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).min(FloatVector.fromArray(COL_SPECIES, otherData, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 nextDown(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, Math.nextDown(sd[0])).withLane(1, Math.nextDown(sd[1])).withLane(2, Math.nextDown(sd[2])).withLane(3, Math.nextDown(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 nextUp(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, Math.nextUp(sd[0])).withLane(1, Math.nextUp(sd[1])).withLane(2, Math.nextUp(sd[2])).withLane(3, Math.nextUp(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 normalizeMul(float length, @Mutated Float4 dest) {
        ...
        float[] dd = ((Float4Impl) dest).data;
        float _t3 = Math.fma(sd[3], sd[3], Math.fma(sd[2], sd[2], Math.fma(sd[0], sd[0], sd[1] * sd[1])));
        var _col0 = (_t3 != 0.0f ? FloatVector.fromArray(COL_SPECIES, sd, 0).mul(FloatVector.broadcast(COL_SPECIES, length * (1.0f / (float) Math.sqrt(_t3)))) : FloatVector.broadcast(COL_SPECIES, 0.0f));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4x4 outerProduct(float rowX, float rowY, float rowZ, float rowW, @Mutated Float4x4 dest) {
        ...
        var _sv0 = FloatVector.fromArray(COL_SPECIES, sd, 0);
        var _col0 = FloatVector.broadcast(COL_SPECIES, rowX).mul(_sv0);
        var _col1 = FloatVector.broadcast(COL_SPECIES, rowY).mul(_sv0);
        var _col2 = FloatVector.broadcast(COL_SPECIES, rowZ).mul(_sv0);
        var _col3 = FloatVector.broadcast(COL_SPECIES, rowW).mul(_sv0);
        _col0.intoArray(dd, 0);
    ...
    public Float4 pow(float exponent, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.pow(sd[0], exponent)).withLane(1, (float) Math.pow(sd[1], exponent)).withLane(2, (float) Math.pow(sd[2], exponent)).withLane(3, (float) Math.pow(sd[3], exponent));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Double4 pow(float exponent, @Mutated Double4 dest) {
        float[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        dd[0] = (float) Math.pow(sd[0], exponent);
        dd[1] = (float) Math.pow(sd[1], exponent);
        dd[2] = (float) Math.pow(sd[2], exponent);
        dd[3] = (float) Math.pow(sd[3], exponent);
        return dest;
    }
    ...
    public Float4 pow(Float4R exponent, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] exponentData = ((Float4Impl) exponent).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.pow(sd[0], exponentData[0])).withLane(1, (float) Math.pow(sd[1], exponentData[1])).withLane(2, (float) Math.pow(sd[2], exponentData[2])).withLane(3, (float) Math.pow(sd[3], exponentData[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 project(Float4R onto, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] ontoData = ((Float4Impl) onto).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, ontoData, 0).mul(FloatVector.broadcast(COL_SPECIES, Math.fma(ontoData[3], sd[3], Math.fma(ontoData[2], sd[2], Math.fma(ontoData[0], sd[0], ontoData[1] * sd[1]))))).mul(FloatVector.broadcast(COL_SPECIES, 1.0f / Math.fma(ontoData[3], ontoData[3], Math.fma(ontoData[2], ontoData[2], Math.fma(ontoData[0], ontoData[0], ontoData[1] * ontoData[1])))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 project(float ontoX, float ontoY, float ontoZ, float ontoW, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, ontoX).withLane(1, ontoY).withLane(2, ontoZ).withLane(3, ontoW).mul(FloatVector.broadcast(COL_SPECIES, Math.fma(ontoW, sd[3], Math.fma(ontoZ, sd[2], Math.fma(ontoX, sd[0], ontoY * sd[1]))))).mul(FloatVector.broadcast(COL_SPECIES, 1.0f / Math.fma(ontoW, ontoW, Math.fma(ontoZ, ontoZ, Math.fma(ontoX, ontoX, ontoY * ontoY)))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 projectOnPlane_fma(Float4R normal, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] normalData = ((Float4Impl) normal).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, normalData, 0).fma(FloatVector.broadcast(COL_SPECIES, -Math.fma(normalData[3], sd[3], Math.fma(normalData[2], sd[2], Math.fma(normalData[0], sd[0], normalData[1] * sd[1])))), FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 projectOnPlane_mulAdd(Float4R normal, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] normalData = ((Float4Impl) normal).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, normalData, 0).mul(FloatVector.broadcast(COL_SPECIES, -Math.fma(normalData[3], sd[3], Math.fma(normalData[2], sd[2], Math.fma(normalData[0], sd[0], normalData[1] * sd[1]))))).add(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 radians(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.toRadians(sd[0])).withLane(1, (float) Math.toRadians(sd[1])).withLane(2, (float) Math.toRadians(sd[2])).withLane(3, (float) Math.toRadians(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 reflect_fma(Float4R normal, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] normalData = ((Float4Impl) normal).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, normalData, 0).fma(FloatVector.broadcast(COL_SPECIES, -(2.0f * Math.fma(normalData[3], sd[3], Math.fma(normalData[2], sd[2], Math.fma(normalData[0], sd[0], normalData[1] * sd[1]))))), FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 reflect_mulAdd(Float4R normal, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] normalData = ((Float4Impl) normal).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, normalData, 0).mul(FloatVector.broadcast(COL_SPECIES, -(2.0f * Math.fma(normalData[3], sd[3], Math.fma(normalData[2], sd[2], Math.fma(normalData[0], sd[0], normalData[1] * sd[1])))))).add(FloatVector.fromArray(COL_SPECIES, sd, 0));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 refract_fma(Float4R normal, float eta, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] normalData = ((Float4Impl) normal).data;
        float[] dd = ((Float4Impl) dest).data;
        float _t4 = Math.fma(normalData[3], sd[3], Math.fma(normalData[2], sd[2], Math.fma(normalData[0], sd[0], normalData[1] * sd[1])));
        float _t8 = Math.fma(-Math.fma(-_t4, _t4, 1.0f), eta * eta, 1.0f);
        var _col0 = (_t8 >= 0.0f ? FloatVector.broadcast(COL_SPECIES, eta).fma(FloatVector.fromArray(COL_SPECIES, sd, 0), FloatVector.fromArray(COL_SPECIES, normalData, 0).mul(FloatVector.broadcast(COL_SPECIES, -Math.fma(eta, _t4, (float) Math.sqrt(Math.max(0.0f, _t8)))))) : FloatVector.broadcast(COL_SPECIES, 0.0f));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 refract_mulAdd(Float4R normal, float eta, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] normalData = ((Float4Impl) normal).data;
        float[] dd = ((Float4Impl) dest).data;
        float _t4 = Math.fma(normalData[3], sd[3], Math.fma(normalData[2], sd[2], Math.fma(normalData[0], sd[0], normalData[1] * sd[1])));
        float _t8 = Math.fma(-Math.fma(-_t4, _t4, 1.0f), eta * eta, 1.0f);
        var _col0 = (_t8 >= 0.0f ? FloatVector.broadcast(COL_SPECIES, eta).mul(FloatVector.fromArray(COL_SPECIES, sd, 0)).add(FloatVector.fromArray(COL_SPECIES, normalData, 0).mul(FloatVector.broadcast(COL_SPECIES, -Math.fma(eta, _t4, (float) Math.sqrt(Math.max(0.0f, _t8)))))) : FloatVector.broadcast(COL_SPECIES, 0.0f));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 refract_fma(float normalX, float normalY, float normalZ, float normalW, float eta, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        float _t4 = Math.fma(normalW, sd[3], Math.fma(normalZ, sd[2], Math.fma(normalX, sd[0], normalY * sd[1])));
        float _t8 = Math.fma(-Math.fma(-_t4, _t4, 1.0f), eta * eta, 1.0f);
        var _col0 = (_t8 >= 0.0f ? FloatVector.broadcast(COL_SPECIES, eta).fma(FloatVector.fromArray(COL_SPECIES, sd, 0), FloatVector.zero(COL_SPECIES).withLane(0, normalX).withLane(1, normalY).withLane(2, normalZ).withLane(3, normalW).mul(FloatVector.broadcast(COL_SPECIES, -Math.fma(eta, _t4, (float) Math.sqrt(Math.max(0.0f, _t8)))))) : FloatVector.broadcast(COL_SPECIES, 0.0f));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 refract_mulAdd(float normalX, float normalY, float normalZ, float normalW, float eta, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        float _t4 = Math.fma(normalW, sd[3], Math.fma(normalZ, sd[2], Math.fma(normalX, sd[0], normalY * sd[1])));
        float _t8 = Math.fma(-Math.fma(-_t4, _t4, 1.0f), eta * eta, 1.0f);
        var _col0 = (_t8 >= 0.0f ? FloatVector.broadcast(COL_SPECIES, eta).mul(FloatVector.fromArray(COL_SPECIES, sd, 0)).add(FloatVector.zero(COL_SPECIES).withLane(0, normalX).withLane(1, normalY).withLane(2, normalZ).withLane(3, normalW).mul(FloatVector.broadcast(COL_SPECIES, -Math.fma(eta, _t4, (float) Math.sqrt(Math.max(0.0f, _t8)))))) : FloatVector.broadcast(COL_SPECIES, 0.0f));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 round(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.rint(sd[0])).withLane(1, (float) Math.rint(sd[1])).withLane(2, (float) Math.rint(sd[2])).withLane(3, (float) Math.rint(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 sign(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, Math.signum(sd[0])).withLane(1, Math.signum(sd[1])).withLane(2, Math.signum(sd[2])).withLane(3, Math.signum(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 sin(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.sin(sd[0])).withLane(1, (float) Math.sin(sd[1])).withLane(2, (float) Math.sin(sd[2])).withLane(3, (float) Math.sin(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 sinh(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.sinh(sd[0])).withLane(1, (float) Math.sinh(sd[1])).withLane(2, (float) Math.sinh(sd[2])).withLane(3, (float) Math.sinh(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 smoothstep(Float4R edge0, Float4R edge1, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] edge0Data = ((Float4Impl) edge0).data;
        float[] edge1Data = ((Float4Impl) edge1).data;
        float[] dd = ((Float4Impl) dest).data;
        float _t16 = Math.max(0.0f, Math.min(1.0f, (sd[0] - edge0Data[0]) / (edge1Data[0] - edge0Data[0])));
        float _t17 = Math.max(0.0f, Math.min(1.0f, (sd[1] - edge0Data[1]) / (edge1Data[1] - edge0Data[1])));
        float _t18 = Math.max(0.0f, Math.min(1.0f, (sd[2] - edge0Data[2]) / (edge1Data[2] - edge0Data[2])));
        float _t19 = Math.max(0.0f, Math.min(1.0f, (sd[3] - edge0Data[3]) / (edge1Data[3] - edge0Data[3])));
    ...
    public Float4 sqrt(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, sd, 0).sqrt();
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 step(Float4R edge, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] edgeData = ((Float4Impl) edge).data;
        float[] dd = ((Float4Impl) dest).data;
        dd[0] = sd[0] < edgeData[0] ? 0.0f : 1.0f;
        dd[1] = sd[1] < edgeData[1] ? 0.0f : 1.0f;
        dd[2] = sd[2] < edgeData[2] ? 0.0f : 1.0f;
        dd[3] = sd[3] < edgeData[3] ? 0.0f : 1.0f;
        return dest;
    }
    ...
    public Float4 tan(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.tan(sd[0])).withLane(1, (float) Math.tan(sd[1])).withLane(2, (float) Math.tan(sd[2])).withLane(3, (float) Math.tan(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 tanh(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, (float) Math.tanh(sd[0])).withLane(1, (float) Math.tanh(sd[1])).withLane(2, (float) Math.tanh(sd[2])).withLane(3, (float) Math.tanh(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 ulp(@Mutated Float4 dest) {
        float[] sd = this.data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.zero(COL_SPECIES).withLane(0, Math.ulp(sd[0])).withLane(1, Math.ulp(sd[1])).withLane(2, Math.ulp(sd[2])).withLane(3, Math.ulp(sd[3]));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    private Float4 preMul_fma(Float4x4R mat, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] matData = ((Float4x4Impl) mat).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, matData, 12).fma(FloatVector.broadcast(COL_SPECIES, sd[3]), FloatVector.fromArray(COL_SPECIES, matData, 8).fma(FloatVector.broadcast(COL_SPECIES, sd[2]), FloatVector.fromArray(COL_SPECIES, matData, 0).fma(FloatVector.broadcast(COL_SPECIES, sd[0]), FloatVector.fromArray(COL_SPECIES, matData, 4).mul(FloatVector.broadcast(COL_SPECIES, sd[1])))));
        _col0.intoArray(dd, 0);
        return dest;
    }

    private Float4 preMul_mulAdd(Float4x4R mat, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] matData = ((Float4x4Impl) mat).data;
        float[] dd = ((Float4Impl) dest).data;
        var _col0 = FloatVector.fromArray(COL_SPECIES, matData, 12).mul(FloatVector.broadcast(COL_SPECIES, sd[3])).add(FloatVector.fromArray(COL_SPECIES, matData, 8).mul(FloatVector.broadcast(COL_SPECIES, sd[2])).add(FloatVector.fromArray(COL_SPECIES, matData, 0).mul(FloatVector.broadcast(COL_SPECIES, sd[0])).add(FloatVector.fromArray(COL_SPECIES, matData, 4).mul(FloatVector.broadcast(COL_SPECIES, sd[1])))));
        _col0.intoArray(dd, 0);
        return dest;
    }
    ...
    public Float4 rotate(FloatQuatR quat, @Mutated Float4 dest) {
        float[] sd = this.data;
        float[] quatData = ((FloatQuatImpl) quat).data;
        float[] dd = ((Float4Impl) dest).data;
        float _t9 = 2.0f * Math.fma(quatData[0], sd[1], -(quatData[1] * sd[0]));
        float _t10 = 2.0f * Math.fma(quatData[2], sd[0], -(quatData[0] * sd[2]));
        float _t11 = 2.0f * Math.fma(quatData[1], sd[2], -(quatData[2] * sd[1]));
    ...
    public Float4 rotateAxis(float angle, Float3R axis, @Mutated Float4 dest) {
        ...
        float _t3 = 1.0f - _t1;
        float _t5 = Math.fma(axisData[2], sd[2], Math.fma(axisData[0], sd[0], axisData[1] * sd[1]));
        float _buf0 = Math.fma(_t3, axisData[0] * _t5, Math.fma(sd[0], _t1, Math.fma(axisData[1], sd[2], -(axisData[2] * sd[1])) * _t0));
        float _buf1 = Math.fma(_t3, axisData[1] * _t5, Math.fma(sd[1], _t1, Math.fma(axisData[2], sd[0], -(axisData[0] * sd[2])) * _t0));
    ...
    public Float4 rotateInverse(FloatQuatR quat, @Mutated Float4 dest) {
        ...
        float[] quatData = ((FloatQuatImpl) quat).data;
        float[] dd = ((Float4Impl) dest).data;
        float _t9 = 2.0f * Math.fma(quatData[0], sd[2], -(quatData[2] * sd[0]));
        float _t10 = 2.0f * Math.fma(quatData[1], sd[0], -(quatData[0] * sd[1]));
        float _t11 = 2.0f * Math.fma(quatData[2], sd[1], -(quatData[1] * sd[2]));
    ...
    private static final VectorMask<Float> MASK_0 = VectorMask.fromValues(COL_SPECIES, false, false, true, true);
    private static final VectorMask<Float> MASK_1 = VectorMask.fromValues(COL_SPECIES, false, true, false, true);
