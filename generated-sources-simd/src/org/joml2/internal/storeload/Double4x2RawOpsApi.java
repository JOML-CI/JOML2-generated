...
public final class Double4x2RawOpsApi implements Double4x2RawOps {
    ...
    public Double4x2 loadCMUnsafe(Double4x2Impl self, long address, int stride) {
        self.loadCM(0L, VIRTUAL_MEMORY.asSlice(address, (long) 8 * ((1) * stride + 4)), stride);
        return self;
    }
    ...
    public Double4x2 loadCMFloatUnsafe(Double4x2Impl self, long address, int stride) {
        self.loadCMFloat(0L, VIRTUAL_MEMORY.asSlice(address, (long) 4 * ((1) * stride + 4)), stride);
        return self;
    }
    ...
    public Double4x2 loadRMUnsafe(Double4x2Impl self, long address, int stride) {
        self.loadRM(0L, VIRTUAL_MEMORY.asSlice(address, (long) 8 * ((3) * stride + 2)), stride);
        return self;
    }
    ...
    public Double4x2 loadRMFloatUnsafe(Double4x2Impl self, long address, int stride) {
        self.loadRMFloat(0L, VIRTUAL_MEMORY.asSlice(address, (long) 4 * ((3) * stride + 2)), stride);
        return self;
    }
}
