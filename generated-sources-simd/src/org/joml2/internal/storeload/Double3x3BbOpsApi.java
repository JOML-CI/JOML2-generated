...
public final class Double3x3BbOpsApi implements Double3x3BbOps {
    ...
    public Double3x3 loadRMAbsolute(Double3x3Impl self, int index, ByteBuffer buf) {
        ...
        self.data[6] = buf.getDouble(index + 16);
        self.data[1] = buf.getDouble(index + 24);
        self.data[4] = buf.getDouble(index + 32);
        self.data[7] = buf.getDouble(index + 40);
        self.data[2] = buf.getDouble(index + 48);
        self.data[5] = buf.getDouble(index + 56);
        self.data[8] = buf.getDouble(index + 64);
        self.properties = self.determineProperties();
        return self;
    }
    public FloatBuffer storeRMAbsolute(Double3x3Impl self, int index, FloatBuffer buf) {
        ...
        buf.put(index + 2, (float) self.data[6]);
        buf.put(index + 3, (float) self.data[1]);
        buf.put(index + 4, (float) self.data[4]);
        buf.put(index + 5, (float) self.data[7]);
        buf.put(index + 6, (float) self.data[2]);
        buf.put(index + 7, (float) self.data[5]);
        buf.put(index + 8, (float) self.data[8]);
        return buf;
    }
    ...
    public ByteBuffer storeRMFloatAbsolute(Double3x3Impl self, int index, ByteBuffer buf) {
        ...
        buf.putFloat(index + 8, (float) self.data[6]);
        buf.putFloat(index + 12, (float) self.data[1]);
        buf.putFloat(index + 16, (float) self.data[4]);
        buf.putFloat(index + 20, (float) self.data[7]);
        buf.putFloat(index + 24, (float) self.data[2]);
        buf.putFloat(index + 28, (float) self.data[5]);
        buf.putFloat(index + 32, (float) self.data[8]);
        return buf;
    }
    ...
    public Double3x3 loadCMAbsolute(Double3x3Impl self, int index, ByteBuffer buf, int stride) {
        ...
        self.data[6] = buf.getDouble(_p2);
        self.data[7] = buf.getDouble(_p2 + 8);
        self.data[8] = buf.getDouble(_p2 + 16);
        self.properties = self.determineProperties();
        return self;
    }
    public FloatBuffer storeCMAbsolute(Double3x3Impl self, int index, FloatBuffer buf, int stride) {
        ...
        buf.put(_p2, (float) self.data[6]);
        buf.put(_p2 + 1, (float) self.data[7]);
        buf.put(_p2 + 2, (float) self.data[8]);
        return buf;
    }
    ...
    public ByteBuffer storeCMFloatAbsolute(Double3x3Impl self, int index, ByteBuffer buf, int stride) {
        ...
        buf.putFloat(_p2, (float) self.data[6]);
        buf.putFloat(_p2 + 4, (float) self.data[7]);
        buf.putFloat(_p2 + 8, (float) self.data[8]);
        return buf;
    }
    ...
    public Double3x3 loadRMAbsolute(Double3x3Impl self, int index, ByteBuffer buf, int stride) {
        ...
        self.data[4] = buf.getDouble(_p1 + 8);
        self.data[7] = buf.getDouble(_p1 + 16);
    ...
    public FloatBuffer storeRMAbsolute(Double3x3Impl self, int index, FloatBuffer buf, int stride) {
        ...
        buf.put(_p1 + 1, (float) self.data[4]);
        buf.put(_p1 + 2, (float) self.data[7]);
    ...
    public ByteBuffer storeRMFloatAbsolute(Double3x3Impl self, int index, ByteBuffer buf, int stride) {
        ...
        buf.putFloat(_p1 + 4, (float) self.data[4]);
        buf.putFloat(_p1 + 8, (float) self.data[7]);
    ...
    public FloatBuffer storeCM4x4Absolute(Double3x3Impl self, int index, FloatBuffer buf) {
        ...
        buf.put(index + 4, (float) self.data[3]);
        buf.put(index + 5, (float) self.data[4]);
        buf.put(index + 6, (float) self.data[5]);
        buf.put(index + 7, (float) 0.0);
        buf.put(index + 8, (float) self.data[6]);
        buf.put(index + 9, (float) self.data[7]);
        buf.put(index + 10, (float) self.data[8]);
    ...
    public ByteBuffer storeCM4x4FloatAbsolute(Double3x3Impl self, int index, ByteBuffer buf) {
        ...
        buf.putFloat(index + 16, (float) self.data[3]);
        buf.putFloat(index + 20, (float) self.data[4]);
        buf.putFloat(index + 24, (float) self.data[5]);
        buf.putFloat(index + 28, (float) 0.0);
        buf.putFloat(index + 32, (float) self.data[6]);
        buf.putFloat(index + 36, (float) self.data[7]);
        buf.putFloat(index + 40, (float) self.data[8]);
    ...
    public FloatBuffer storeRM4x4Absolute(Double3x3Impl self, int index, FloatBuffer buf) {
        ...
        buf.put(index + 5, (float) self.data[4]);
        buf.put(index + 6, (float) self.data[7]);
        buf.put(index + 7, (float) 0.0);
        buf.put(index + 8, (float) self.data[2]);
        buf.put(index + 9, (float) self.data[5]);
        buf.put(index + 10, (float) self.data[8]);
        buf.put(index + 11, (float) 0.0);
        buf.put(index + 12, (float) 0.0);
        buf.put(index + 13, (float) 0.0);
    ...
    public ByteBuffer storeRM4x4FloatAbsolute(Double3x3Impl self, int index, ByteBuffer buf) {
        ...
        buf.putFloat(index + 20, (float) self.data[4]);
        buf.putFloat(index + 24, (float) self.data[7]);
        buf.putFloat(index + 28, (float) 0.0);
        buf.putFloat(index + 32, (float) self.data[2]);
        buf.putFloat(index + 36, (float) self.data[5]);
        buf.putFloat(index + 40, (float) self.data[8]);
        buf.putFloat(index + 44, (float) 0.0);
        buf.putFloat(index + 48, (float) 0.0);
        buf.putFloat(index + 52, (float) 0.0);
