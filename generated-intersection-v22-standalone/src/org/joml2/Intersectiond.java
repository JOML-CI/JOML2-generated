...
public final class Intersectiond {
    ...
    public static Double3 findClosestPointOnLineSegment(double aX, double aY, double aZ, double bX, double bY, double bZ, double pX, double pY, double pZ) {
        ...
        double _t1 = bZ - aZ;
        double _t4 = bY - aY;
        double _t13 = java.lang.Math.clamp(Math.fma(_t1, pZ - aZ, Math.fma(_t0, pX - aX, _t4 * (pY - aY))) / Math.fma(_t1, _t1, Math.fma(_t0, _t0, _t4 * _t4)), 0.0, 1.0);
        return Joml.double3(Math.fma(_t0, _t13, aX), Math.fma(_t4, _t13, aY), Math.fma(_t1, _t13, aZ));
    }
    ...
    public static DoubleHit3 findClosestPointOnTriangle(double v0X, double v0Y, double v0Z, double v1X, double v1Y, double v1Z, double v2X, double v2Y, double v2Z, double pX, double pY, double pZ) {
        ...
        double _t65 = _t61 + _t62 + _t60;
        double _t65_inv = 1.0 / _t65;
        if ((_t39 <= 0.0) && (_t40 <= 0.0)) return new DoubleHit3(1, v0X, v0Y, v0Z);
        if ((_t41 >= 0.0) && (_t42 <= _t41)) return new DoubleHit3(2, v1X, v1Y, v1Z);
        if ((_t60 <= 0.0) && ((_t39 >= 0.0) && (_t41 <= 0.0))) return new DoubleHit3(4, v0X + _t39 * _t3 * _t53_inv, v0Y + _t39 * _t5 * _t53_inv, v0Z + _t39 * _t1 * _t53_inv);
        if ((_t43 >= 0.0) && (_t44 <= _t43)) return new DoubleHit3(3, v2X, v2Y, v2Z);
        if ((_t61 <= 0.0) && ((_t40 >= 0.0) && (_t43 <= 0.0))) return new DoubleHit3(6, v0X + _t40 * _t7 * _t54_inv, v0Y + _t40 * _t8 * _t54_inv, v0Z + _t40 * _t6 * _t54_inv);
        if ((_t62 <= 0.0) && ((_t52 >= 0.0) && (_t44 - _t43 >= 0.0))) return new DoubleHit3(5, v1X + (v2X - v1X) * _t52 * _t63_inv, v1Y + (v2Y - v1Y) * _t52 * _t63_inv, v1Z + (v2Z - v1Z) * _t52 * _t63_inv);
        return new DoubleHit3(7, v0X + _t3 * _t61 * _t65_inv + _t7 * _t60 * _t65_inv, v0Y + _t5 * _t61 * _t65_inv + _t8 * _t60 * _t65_inv, v0Z + _t1 * _t61 * _t65_inv + _t6 * _t60 * _t65_inv);
    }
    ...
    public static DoubleHit2 findClosestPointOnTriangle(double v0X, double v0Y, double v1X, double v1Y, double v2X, double v2Y, double pX, double pY) {
        ...
        if ((_t22 <= 0.0) && (_t23 <= 0.0)) return new DoubleHit2(1, v0X, v0Y);
        if ((_t24 >= 0.0) && (_t25 <= _t24)) return new DoubleHit2(2, v1X, v1Y);
        if ((_t41 <= 0.0) && ((_t22 >= 0.0) && (_t24 <= 0.0))) return new DoubleHit2(4, v0X + _t22 * _t1 * _t34_inv, v0Y + _t22 * _t3 * _t34_inv);
        if ((_t26 >= 0.0) && (_t27 <= _t26)) return new DoubleHit2(3, v2X, v2Y);
        if ((_t42 <= 0.0) && ((_t23 >= 0.0) && (_t26 <= 0.0))) return new DoubleHit2(6, v0X + _t23 * _t4 * _t35_inv, v0Y + _t23 * _t5 * _t35_inv);
        if ((_t43 <= 0.0) && ((_t33 >= 0.0) && (_t27 - _t26 >= 0.0))) return new DoubleHit2(5, v1X + (v2X - v1X) * _t33 * _t44_inv, v1Y + (v2Y - v1Y) * _t33 * _t44_inv);
        return new DoubleHit2(7, v0X + _t1 * _t42 * _t46_inv + _t4 * _t41 * _t46_inv, v0Y + _t3 * _t42 * _t46_inv + _t5 * _t41 * _t46_inv);
    }
    ...
    public static DoubleHit3 intersectLineSegmentPlane(double p0X, double p0Y, double p0Z, double p1X, double p1Y, double p1Z, double a, double b, double c, double d) {
        ...
        if ((_t10 >= 0.0) && (_t10 <= 1.0)) return new DoubleHit3(1, p0X - _t6 * _t1 * _t8_inv, p0Y - _t6 * _t2 * _t8_inv, p0Z - _t6 * _t0 * _t8_inv);
        return DoubleHit3.MISS;
    }
    ...
    public static DoubleHit4 intersectPlaneSweptSphere(double a, double b, double c, double d, double centerX, double centerY, double centerZ, double radius, double vX, double vY, double vZ) {
        ...
        if ((_t6 <= radius) || (_t5 * _t4 < 0.0)) return new DoubleHit4(1, _t6 <= radius ? centerX : Math.fma(-a, _t7, centerX + vX * _t11 * _t4_inv), _t6 <= radius ? centerY : Math.fma(-b, _t7, centerY + vY * _t11 * _t4_inv), _t6 <= radius ? centerZ : Math.fma(-c, _t7, centerZ + vZ * _t11 * _t4_inv), _t6 <= radius ? 0.0 : _t11 * _t4_inv);
        return DoubleHit4.MISS;
    }
     ...
     * @return <code>true</code> iff both circles intersect
     */
    public static boolean testCircleCircle(Double2 a, double rA, Double2 b, double rB) {
    ...
    public static boolean testLineSegmentSphere(double p0X, double p0Y, double p0Z, double p1X, double p1Y, double p1Z, double centerX, double centerY, double centerZ, double radiusSquared) {
        ...
        double _t3 = p1X - p0X;
        double _t5 = p1Y - p0Y;
        double _t16 = java.lang.Math.clamp(Math.fma(centerZ - p0Z, _t0, Math.fma(centerX - p0X, _t3, (centerY - p0Y) * _t5)) / Math.fma(_t0, _t0, Math.fma(_t3, _t3, _t5 * _t5)), 0.0, 1.0);
