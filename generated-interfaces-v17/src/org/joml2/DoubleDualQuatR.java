 ...
 * <p>
 * Arguments of type {@code DoubleDualQuatR} must be instances created by the library ({@link Joml}
...
public interface DoubleDualQuatR {
     ...
     * @return dest
     */
    DoubleDualQuat setDual(DoubleQuatR dual, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat setDual(double x, double y, double z, double w, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat setReal(DoubleQuatR real, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat setReal(double x, double y, double z, double w, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat preRotate(DoubleQuatR rotation, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat preRotate(double x, double y, double z, double w, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat rotateXZY(double angleX, double angleZ, double angleY, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat rotateYXZ(double angleY, double angleX, double angleZ, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat rotateYZX(double angleY, double angleZ, double angleX, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat rotateZXY(double angleZ, double angleX, double angleY, @Mutated DoubleDualQuat dest);
     ...
     * @return dest
     */
    DoubleDualQuat rotateZYX(double angleZ, double angleY, double angleX, @Mutated DoubleDualQuat dest);
