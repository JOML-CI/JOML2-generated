...
/**
 * Read-only view of a 4x2 matrix of single-precision {@code float} components.
 * <p>
 * Declares the accessors, queries, store methods and dest-form operations that read but never
 * mutate the receiver; the mutable counterpart is {@link Float4x2}. APIs that only read a 4x2
 * matrix should accept {@code Float4x2R}, so callers can pass mutable instances without exposing
 * them to modification.
 * <p>
 * Arguments of type {@code Float4x2R} must be instances created by the library ({@link Joml}
...
public interface Float4x2R {
    ...
    public static Float4x2R IDENTITY() { return Holder.IDENTITY; }
    /** {@return a shared all-zero matrix} Never mutate it - it is returned as the read-only view for that reason. */
    public static Float4x2R ZERO() { return Holder.ZERO; }
     ...
     * @return dest
     */
    Float2x4 transpose(@Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 transpose(@Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float4x2 add(Float4x2R other, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 add(Float4x2R other, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 add(float m00, float m01, float m10, float m11, float m20, float m21, float m30, float m31, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 add(float m00, float m01, float m10, float m11, float m20, float m21, float m30, float m31, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 mul(float scalar, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 mul(float scalar, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 negate(@Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 negate(@Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 sub(Float4x2R other, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 sub(Float4x2R other, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 sub(float m00, float m01, float m10, float m11, float m20, float m21, float m30, float m31, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 sub(float m00, float m01, float m10, float m11, float m20, float m21, float m30, float m31, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Double4x2 toDouble(@Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 lerp(Float4x2R other, float t, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 lerp(Float4x2R other, float t, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 lerp(float m00, float m01, float m10, float m11, float m20, float m21, float m30, float m31, float t, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 lerp(float m00, float m01, float m10, float m11, float m20, float m21, float m30, float m31, float t, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 mul(Float2x2R right, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 mul(Float2x2R right, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 preMul(Float4x4R other, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 preMul(Float4x4R other, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 addScaled(Float4x2R other, float weight, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 addScaled(Float4x2R other, float weight, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4x2 addScaled(float m00, float m01, float m10, float m11, float m20, float m21, float m30, float m31, float weight, @Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 addScaled(float m00, float m01, float m10, float m11, float m20, float m21, float m30, float m31, float weight, @Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float4 mul(Float2R v, @Mutated Float4 dest);
     ...
     * @return dest
     */
    Double4 mul(Float2R v, @Mutated Double4 dest);
     ...
     * @return dest
     */
    Float4 mul(float x, float y, @Mutated Float4 dest);
     ...
     * @return dest
     */
    Double4 mul(float x, float y, @Mutated Double4 dest);
     ...
     *        variants only)
     */
    Float4x2 storeCMUnsafe(long address);
     ...
     *        variants only)
     */
    Float4x2 storeCMDoubleUnsafe(long address);
     ...
     *        variants only)
     */
    Float4x2 storeRMUnsafe(long address);
     ...
     *        variants only)
     */
    Float4x2 storeRMDoubleUnsafe(long address);
     ...
     *        variants only)
     */
    Float4x2 storeCMUnsafe(long address, int stride);
     ...
     *        variants only)
     */
    Float4x2 storeCMDoubleUnsafe(long address, int stride);
     ...
     *        variants only)
     */
    Float4x2 storeRMUnsafe(long address, int stride);
     ...
     *        variants only)
     */
    Float4x2 storeRMDoubleUnsafe(long address, int stride);
     ...
     */
    boolean equalsEpsilon(Float4x2R other, float epsilon);
     ...
     *        variants only)
     */
    default Float4x2 storeUnsafe(long address) { return storeCMUnsafe(address); }
     ...
     *        variants only)
     */
    default Float4x2 storeUnsafe(long address, int stride) { return storeCMUnsafe(address, stride); }
    ...
    final class Holder {
        private Holder() {}
        static final Float4x2R IDENTITY = Joml.float4x2();
        static final Float4x2R ZERO = Joml.float4x2(0, 0, 0, 0, 0, 0, 0, 0);
    }
}
