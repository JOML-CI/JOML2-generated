...
public final class Double2x4BbOpsApi implements Double2x4BbOps {
    public DoubleBuffer storeCMAbsolute(Double2x4 self, int index, DoubleBuffer buf) {
    ...
    public Double2x4 loadCMAbsolute(int index, DoubleBuffer buf) {
        double _c0 = buf.get(index + 0);
        double _c4 = buf.get(index + 1);
        double _c1 = buf.get(index + 2);
        double _c5 = buf.get(index + 3);
        double _c2 = buf.get(index + 4);
        double _c6 = buf.get(index + 5);
        double _c3 = buf.get(index + 6);
        double _c7 = buf.get(index + 7);
        return new Double2x4(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public ByteBuffer storeCMAbsolute(Double2x4 self, int index, ByteBuffer buf) {
    ...
    public Double2x4 loadCMAbsolute(int index, ByteBuffer buf) {
        ...
        double _c5 = buf.getDouble(index + 24);
        double _c2 = buf.getDouble(index + 32);
        double _c6 = buf.getDouble(index + 40);
        double _c3 = buf.getDouble(index + 48);
        double _c7 = buf.getDouble(index + 56);
        return new Double2x4(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public FloatBuffer storeCMAbsolute(Double2x4 self, int index, FloatBuffer buf) {
    ...
    public Double2x4 loadCMAbsolute(int index, FloatBuffer buf) {
        double _c0 = buf.get(index + 0);
        double _c4 = buf.get(index + 1);
        double _c1 = buf.get(index + 2);
        double _c5 = buf.get(index + 3);
    ...
    public ByteBuffer storeCMFloatAbsolute(Double2x4 self, int index, ByteBuffer buf) {
    ...
    public Double2x4 loadCMFloatAbsolute(int index, ByteBuffer buf) {
        ...
        double _c5 = buf.getFloat(index + 12);
        double _c2 = buf.getFloat(index + 16);
        double _c6 = buf.getFloat(index + 20);
        double _c3 = buf.getFloat(index + 24);
        double _c7 = buf.getFloat(index + 28);
        return new Double2x4(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public DoubleBuffer storeRMAbsolute(Double2x4 self, int index, DoubleBuffer buf) {
        buf.put(index + 0, self.m00());
    ...
    public Double2x4 loadRMAbsolute(int index, DoubleBuffer buf) {
        double _c0 = buf.get(index + 0);
    ...
    public ByteBuffer storeRMAbsolute(Double2x4 self, int index, ByteBuffer buf) {
        buf.putDouble(index + 0, self.m00());
    ...
    public FloatBuffer storeRMAbsolute(Double2x4 self, int index, FloatBuffer buf) {
        buf.put(index + 0, (float) self.m00());
    ...
    public Double2x4 loadRMAbsolute(int index, FloatBuffer buf) {
        double _c0 = buf.get(index + 0);
        double _c1 = buf.get(index + 1);
        double _c2 = buf.get(index + 2);
        double _c3 = buf.get(index + 3);
    ...
    public ByteBuffer storeRMFloatAbsolute(Double2x4 self, int index, ByteBuffer buf) {
        buf.putFloat(index + 0, (float) self.m00());
    ...
    public DoubleBuffer storeCMAbsolute(Double2x4 self, int index, DoubleBuffer buf, int stride) {
    ...
    public Double2x4 loadCMAbsolute(int index, DoubleBuffer buf, int stride) {
        int _p1 = index + stride;
        int _p2 = _p1 + stride;
        int _p3 = _p2 + stride;
    ...
    public ByteBuffer storeCMAbsolute(Double2x4 self, int index, ByteBuffer buf, int stride) {
        int _ps = stride * 8;
        int _p1 = index + _ps;
        int _p2 = _p1 + _ps;
        int _p3 = _p2 + _ps;
    ...
    public FloatBuffer storeCMAbsolute(Double2x4 self, int index, FloatBuffer buf, int stride) {
        int _p1 = index + stride;
        int _p2 = _p1 + stride;
        int _p3 = _p2 + stride;
    ...
    public Double2x4 loadCMAbsolute(int index, FloatBuffer buf, int stride) {
        int _p1 = index + stride;
        int _p2 = _p1 + stride;
        int _p3 = _p2 + stride;
        double _c0 = buf.get(index);
    ...
    public ByteBuffer storeCMFloatAbsolute(Double2x4 self, int index, ByteBuffer buf, int stride) {
        int _ps = stride * 4;
        int _p1 = index + _ps;
        int _p2 = _p1 + _ps;
        int _p3 = _p2 + _ps;
    ...
    public DoubleBuffer storeRMAbsolute(Double2x4 self, int index, DoubleBuffer buf, int stride) {
        int _p1 = index + stride;
        buf.put(index, self.m00());
        buf.put(index + 1, self.m01());
        buf.put(index + 2, self.m02());
    ...
    public Double2x4 loadRMAbsolute(int index, DoubleBuffer buf, int stride) {
        int _p1 = index + stride;
        double _c0 = buf.get(index);
        double _c1 = buf.get(index + 1);
        double _c2 = buf.get(index + 2);
    ...
    public ByteBuffer storeRMAbsolute(Double2x4 self, int index, ByteBuffer buf, int stride) {
        int _ps = stride * 8;
        int _p1 = index + _ps;
        buf.putDouble(index, self.m00());
        buf.putDouble(index + 8, self.m01());
    ...
    public FloatBuffer storeRMAbsolute(Double2x4 self, int index, FloatBuffer buf, int stride) {
        int _p1 = index + stride;
        buf.put(index, (float) self.m00());
        buf.put(index + 1, (float) self.m01());
        buf.put(index + 2, (float) self.m02());
    ...
    public Double2x4 loadRMAbsolute(int index, FloatBuffer buf, int stride) {
        int _p1 = index + stride;
        double _c0 = buf.get(index);
        double _c1 = buf.get(index + 1);
        double _c2 = buf.get(index + 2);
    ...
    public ByteBuffer storeRMFloatAbsolute(Double2x4 self, int index, ByteBuffer buf, int stride) {
        int _ps = stride * 4;
        int _p1 = index + _ps;
        buf.putFloat(index, (float) self.m00());
        buf.putFloat(index + 4, (float) self.m01());
