...
public final class Double2x3BbOpsUnsafe implements Double2x3BbOps {

    private static final Double2x3BbOpsApi API = new Double2x3BbOpsApi();
    private static final Double2x3RawOpsUnsafe RAW = new Double2x3RawOpsUnsafe();
    ...
    public DoubleBuffer storeCMAbsolute(Double2x3 self, int index, DoubleBuffer buf) {
    ...
    public Double2x3 loadCMAbsolute(int index, DoubleBuffer buf) {
        if (!buf.isDirect()) return API.loadCMAbsolute(index, buf);
        return RAW.loadCMUnsafe(U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 8);
    }
    public ByteBuffer storeCMAbsolute(Double2x3 self, int index, ByteBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCMAbsolute(self, index, buf);
    ...
    public FloatBuffer storeCMAbsolute(Double2x3 self, int index, FloatBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCMAbsolute(self, index, buf);
        RAW.storeCMFloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4);
        return buf;
    }
    public Double2x3 loadCMAbsolute(int index, FloatBuffer buf) {
        if (!buf.isDirect()) return API.loadCMAbsolute(index, buf);
        return RAW.loadCMFloatUnsafe(U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4);
    }
    public ByteBuffer storeCMFloatAbsolute(Double2x3 self, int index, ByteBuffer buf) {
    ...
    public DoubleBuffer storeRMAbsolute(Double2x3 self, int index, DoubleBuffer buf) {
    ...
    public Double2x3 loadRMAbsolute(int index, DoubleBuffer buf) {
        if (!buf.isDirect()) return API.loadRMAbsolute(index, buf);
        return RAW.loadRMUnsafe(U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 8);
    }
    public ByteBuffer storeRMAbsolute(Double2x3 self, int index, ByteBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRMAbsolute(self, index, buf);
    ...
    public FloatBuffer storeRMAbsolute(Double2x3 self, int index, FloatBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRMAbsolute(self, index, buf);
        RAW.storeRMFloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4);
        return buf;
    }
    public Double2x3 loadRMAbsolute(int index, FloatBuffer buf) {
        if (!buf.isDirect()) return API.loadRMAbsolute(index, buf);
        return RAW.loadRMFloatUnsafe(U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4);
    }
    public ByteBuffer storeRMFloatAbsolute(Double2x3 self, int index, ByteBuffer buf) {
    ...
    public DoubleBuffer storeCMAbsolute(Double2x3 self, int index, DoubleBuffer buf, int stride) {
    ...
    public Double2x3 loadCMAbsolute(int index, DoubleBuffer buf, int stride) {
    ...
    public ByteBuffer storeCMAbsolute(Double2x3 self, int index, ByteBuffer buf, int stride) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCMAbsolute(self, index, buf, stride);
    ...
    public FloatBuffer storeCMAbsolute(Double2x3 self, int index, FloatBuffer buf, int stride) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCMAbsolute(self, index, buf, stride);
        RAW.storeCMFloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4, stride);
        return buf;
    }
    public Double2x3 loadCMAbsolute(int index, FloatBuffer buf, int stride) {
        if (!buf.isDirect()) return API.loadCMAbsolute(index, buf, stride);
        return RAW.loadCMFloatUnsafe(U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4, stride);
    }
    public ByteBuffer storeCMFloatAbsolute(Double2x3 self, int index, ByteBuffer buf, int stride) {
    ...
    public DoubleBuffer storeRMAbsolute(Double2x3 self, int index, DoubleBuffer buf, int stride) {
    ...
    public Double2x3 loadRMAbsolute(int index, DoubleBuffer buf, int stride) {
    ...
    public ByteBuffer storeRMAbsolute(Double2x3 self, int index, ByteBuffer buf, int stride) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRMAbsolute(self, index, buf, stride);
    ...
    public FloatBuffer storeRMAbsolute(Double2x3 self, int index, FloatBuffer buf, int stride) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRMAbsolute(self, index, buf, stride);
        RAW.storeRMFloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4, stride);
        return buf;
    }
    public Double2x3 loadRMAbsolute(int index, FloatBuffer buf, int stride) {
        if (!buf.isDirect()) return API.loadRMAbsolute(index, buf, stride);
        return RAW.loadRMFloatUnsafe(U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4, stride);
    }
    public ByteBuffer storeRMFloatAbsolute(Double2x3 self, int index, ByteBuffer buf, int stride) {
    ...
    public DoubleBuffer storeCM3x3Absolute(Double2x3 self, int index, DoubleBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCM3x3Absolute(self, index, buf);
        RAW.storeCM3x3Unsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 8);
        return buf;
    }
    public ByteBuffer storeCM3x3Absolute(Double2x3 self, int index, ByteBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCM3x3Absolute(self, index, buf);
        RAW.storeCM3x3Unsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + index);
        return buf;
    }
    public FloatBuffer storeCM3x3Absolute(Double2x3 self, int index, FloatBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCM3x3Absolute(self, index, buf);
        RAW.storeCM3x3FloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4);
        return buf;
    }
    public ByteBuffer storeCM3x3FloatAbsolute(Double2x3 self, int index, ByteBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCM3x3FloatAbsolute(self, index, buf);
        RAW.storeCM3x3FloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + index);
        return buf;
    }
    public DoubleBuffer storeRM3x3Absolute(Double2x3 self, int index, DoubleBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRM3x3Absolute(self, index, buf);
        RAW.storeRM3x3Unsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 8);
        return buf;
    }
    public ByteBuffer storeRM3x3Absolute(Double2x3 self, int index, ByteBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRM3x3Absolute(self, index, buf);
        RAW.storeRM3x3Unsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + index);
        return buf;
    }
    public FloatBuffer storeRM3x3Absolute(Double2x3 self, int index, FloatBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRM3x3Absolute(self, index, buf);
        RAW.storeRM3x3FloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4);
        return buf;
    }
    public ByteBuffer storeRM3x3FloatAbsolute(Double2x3 self, int index, ByteBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRM3x3FloatAbsolute(self, index, buf);
        RAW.storeRM3x3FloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + index);
        return buf;
    }
    public DoubleBuffer storeCM4x4Absolute(Double2x3 self, int index, DoubleBuffer buf) {
    ...
    public ByteBuffer storeCM4x4Absolute(Double2x3 self, int index, ByteBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCM4x4Absolute(self, index, buf);
        RAW.storeCM4x4Unsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + index);
        return buf;
    }
    public FloatBuffer storeCM4x4Absolute(Double2x3 self, int index, FloatBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeCM4x4Absolute(self, index, buf);
        RAW.storeCM4x4FloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4);
        return buf;
    }
    public ByteBuffer storeCM4x4FloatAbsolute(Double2x3 self, int index, ByteBuffer buf) {
    ...
    public DoubleBuffer storeRM4x4Absolute(Double2x3 self, int index, DoubleBuffer buf) {
    ...
    public ByteBuffer storeRM4x4Absolute(Double2x3 self, int index, ByteBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRM4x4Absolute(self, index, buf);
        RAW.storeRM4x4Unsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + index);
        return buf;
    }
    public FloatBuffer storeRM4x4Absolute(Double2x3 self, int index, FloatBuffer buf) {
        if (!buf.isDirect() || buf.isReadOnly()) return API.storeRM4x4Absolute(self, index, buf);
        RAW.storeRM4x4FloatUnsafe(self, U.getLong(buf, BB_ADDRESS_OFFSET) + (long) index * 4);
        return buf;
    }
    public ByteBuffer storeRM4x4FloatAbsolute(Double2x3 self, int index, ByteBuffer buf) {
