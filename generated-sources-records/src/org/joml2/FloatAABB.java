...
/**
 * Immutable axis-aligned bounding box of single-precision {@code float} components.
 * <p>
 ...
 */
public record FloatAABB(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
