...
public record Double2(double x, double y) {
    ...
    private Byte2 toByte_half_toward_positive_infinity() {
        return new Byte2((byte) (int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, Math.round(this.x))), (byte) (int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, Math.round(this.y))));
    }
    ...
    private Byte2 toByte_half_away_from_zero() {
        return new Byte2((byte) (Math.abs(this.x - Math.rint(this.x)) == 0.5 ? this.x + Math.copySign(0.5, this.x) : Math.rint(this.x)), (byte) (Math.abs(this.y - Math.rint(this.y)) == 0.5 ? this.y + Math.copySign(0.5, this.y) : Math.rint(this.y)));
    }
    ...
    private Short2 toShort_half_toward_positive_infinity() {
        return new Short2((short) (int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, Math.round(this.x))), (short) (int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, Math.round(this.y))));
    }
    ...
    private Short2 toShort_half_away_from_zero() {
        return new Short2((short) (Math.abs(this.x - Math.rint(this.x)) == 0.5 ? this.x + Math.copySign(0.5, this.x) : Math.rint(this.x)), (short) (Math.abs(this.y - Math.rint(this.y)) == 0.5 ? this.y + Math.copySign(0.5, this.y) : Math.rint(this.y)));
    }
    ...
    private Int2 toInt_half_toward_positive_infinity() {
        return new Int2((int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, Math.round(this.x))), (int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, Math.round(this.y))));
    }
    ...
    private Int2 toInt_half_away_from_zero() {
        return new Int2((int) (Math.abs(this.x - Math.rint(this.x)) == 0.5 ? this.x + Math.copySign(0.5, this.x) : Math.rint(this.x)), (int) (Math.abs(this.y - Math.rint(this.y)) == 0.5 ? this.y + Math.copySign(0.5, this.y) : Math.rint(this.y)));
    }
    ...
    private Long2 toLong_half_toward_positive_infinity() {
        return new Long2(Math.round(this.x), Math.round(this.y));
    }
    ...
    private Long2 toLong_half_away_from_zero() {
        return new Long2((long) (Math.abs(this.x - Math.rint(this.x)) == 0.5 ? this.x + Math.copySign(0.5, this.x) : Math.rint(this.x)), (long) (Math.abs(this.y - Math.rint(this.y)) == 0.5 ? this.y + Math.copySign(0.5, this.y) : Math.rint(this.y)));
    }
    ...
    public Double2 project(double ontoX, double ontoY) {
        ...
        return new Double2(ontoX * _sp0, ontoY * _sp0);
    }
