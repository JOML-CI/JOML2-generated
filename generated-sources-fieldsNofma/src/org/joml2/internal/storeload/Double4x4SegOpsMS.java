...
public final class Double4x4SegOpsMS implements Double4x4SegOps {
    ...
    public Double4x4 loadCM(Double4x4Impl self, long offset, MemorySegment src) {
        ...
        self.m02 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 64L);
        self.m12 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 72L);
        self.m22 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 80L);
        self.m32 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 88L);
        self.m03 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 96L);
        self.m13 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 104L);
        self.m23 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 112L);
        self.m33 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 120L);
    ...
    public Double4x4 loadRM(Double4x4Impl self, long offset, MemorySegment src) {
        ...
        self.m30 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 96L);
        self.m31 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 104L);
        self.m32 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 112L);
        self.m33 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 120L);
        self.properties = self.determineProperties();
        return self;
    }
    ...
    public Double4x4 loadCM(Double4x4Impl self, long offset, MemorySegment src, int stride) {
        ...
        self.m32 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p2 + 24);
        ...
        self.m33 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 24);
        self.properties = self.determineProperties();
        return self;
    }
    ...
    public Double4x4 loadRM(Double4x4Impl self, long offset, MemorySegment src, int stride) {
        ...
        self.m32 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 16);
        self.m33 = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 24);
        self.properties = self.determineProperties();
        return self;
    }
