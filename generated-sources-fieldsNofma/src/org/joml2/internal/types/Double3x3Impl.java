...
public class Double3x3Impl implements Double3x3 {
    ...
    private Double3 getEulerAnglesXYZ_translation(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t0 = this.m12 * this.m12;
        double _t1 = _t0 + 1.0;
        d.x = _t1 < (_t0 + (this.m02 * this.m02 + 1.0)) * 1.0E-15 ? 0.0 : Math.atan2(-this.m12, 1.0);
    ...
    private Double3 getEulerAnglesXYZ_general(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t3 = this.m12 * this.m12 + this.m22 * this.m22;
        double _t5 = (_t3 + this.m02 * this.m02) * 1.0E-15;
        if (_t3 < _t5) {
        ...
        d.y = Math.atan2(this.m02, Math.sqrt(_t3));
        return d;
    }
     ...
     * only through the public {@code getEulerAnglesXZY} dispatcher.
     */
    private Double3 getEulerAnglesXZY_orthogonal(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t0 = this.m11 * this.m11;
        double _t3 = (this.m01 * this.m01 + _t0) * 1.0E-15;
        if (_t0 < _t3) {
            double _buf0 = Math.atan2(-this.m12, 1.0);
            double _buf1 = 0.0;
            d.x = _buf0;
            d.y = _buf1;
        } else {
            double _buf0 = Math.atan2(0.0, this.m11);
            double _buf1 = Math.atan2(this.m02, this.m00);
            d.x = _buf0;
            d.y = _buf1;
        }
        d.z = Math.atan2(-this.m01, Math.abs(this.m11));
        return d;
    }
    ...
    private Double3 getEulerAnglesXZY_general(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t3 = this.m11 * this.m11 + this.m21 * this.m21;
        double _t5 = (_t3 + this.m01 * this.m01) * 1.0E-15;
        if (_t3 < _t5) {
            double _buf0 = Math.atan2(-this.m12, this.m22);
            double _buf1 = 0.0;
            d.x = _buf0;
        ...
        d.z = Math.atan2(-this.m01, Math.sqrt(_t3));
        return d;
    }
    ...
    private Double3 getEulerAnglesYXZ_translation(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t0 = this.m02 * this.m02;
        double _t1 = _t0 + 1.0;
        d.x = Math.atan2(-this.m12, Math.sqrt(_t1));
        d.y = _t1 < (_t0 + (this.m12 * this.m12 + 1.0)) * 1.0E-15 ? 0.0 : Math.atan2(this.m02, 1.0);
        d.z = 0.0;
        return d;
    }
    ...
    private Double3 getEulerAnglesYXZ_general(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t3 = this.m02 * this.m02 + this.m22 * this.m22;
        double _t5 = (_t3 + this.m12 * this.m12) * 1.0E-15;
        if (_t3 < _t5) {
        ...
        d.x = Math.atan2(-this.m12, Math.sqrt(_t3));
        return d;
    }
    ...
    private Double3 getEulerAnglesYZX_general(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t3 = this.m11 * this.m11 + this.m12 * this.m12;
        double _t5 = (_t3 + this.m10 * this.m10) * 1.0E-15;
        if (_t3 < _t5) {
            double _buf0 = 0.0;
            d.y = Math.atan2(this.m02, this.m22);
            d.x = _buf0;
        ...
        d.z = Math.atan2(this.m10, Math.sqrt(_t3));
        return d;
    }
    ...
    private Double3 getEulerAnglesZXY_orthogonal(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t2 = this.m01 * this.m01 + this.m11 * this.m11;
        double _buf0 = 0.0;
        double _buf1 = 0.0;
        d.z = _t2 < _t2 * 1.0E-15 ? Math.atan2(this.m10, this.m00) : Math.atan2(-this.m01, this.m11);
        d.x = _buf0;
        d.y = _buf1;
        return d;
    }
    ...
    private Double3 getEulerAnglesZXY_general(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t3 = this.m01 * this.m01 + this.m11 * this.m11;
        double _t5 = (_t3 + this.m21 * this.m21) * 1.0E-15;
        if (_t3 < _t5) {
            double _buf0 = 0.0;
        ...
        d.x = Math.atan2(this.m21, Math.sqrt(_t3));
        return d;
    }
    ...
    private Double3 getEulerAnglesZYX_general(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        double _t3 = this.m21 * this.m21 + this.m22 * this.m22;
        double _t5 = (_t3 + this.m20 * this.m20) * 1.0E-15;
        if (_t3 < _t5) {
            double _buf0 = 0.0;
            d.z = Math.atan2(-this.m01, this.m11);
            d.x = _buf0;
        ...
        d.y = Math.atan2(-this.m20, Math.sqrt(_t3));
        return d;
    }
    ...
    private void getNormalizedRotation_translation_s62e3ac38_c0(DoubleQuatImpl _dst, double _t15, double _sp0, double _t23, double _t12, double _t8, double _t20, double _t7, double _sp1, double _t24, double _t22, double _t25, double _t26, double _t21, double _t19) {
        _dst.x = _t15 > 0.0 ? -(_sp0 * _t23) : _t12 > _t8 ? 0.5 * Math.sqrt(_t20) : 1.0 > _t7 ? 0.0 : _sp1 * _t24;
        _dst.y = _t15 > 0.0 ? _sp1 * _t23 : _t12 > _t8 ? 0.0 : 1.0 > _t7 ? 0.5 * Math.sqrt(_t22) : _sp0 * _t24;
        _dst.z = _t15 > 0.0 ? 0.0 : _t12 > _t8 ? _sp1 * _t25 : 1.0 > _t7 ? _sp0 * _t26 : 0.5 * Math.sqrt(_t21);
        _dst.w = _t15 > 0.0 ? 0.5 * Math.sqrt(_t19) : _t12 > _t8 ? -(_sp0 * _t25) : 1.0 > _t7 ? _sp1 * _t26 : 0.0;
    }
    ...
    private DoubleQuat getNormalizedRotation_translation(@Mutated DoubleQuat dest) {
        ...
        double _r0 = this.m02;
        double _r1 = this.m12;
        double _t3 = _r0 * _r0 + (_r1 * _r1 + 1.0);
        double _t4 = (1.0 / Math.sqrt(_t3));
        double _t7 = _t3 != 0.0 ? _t4 : 0.0;
        double _t8 = Math.max(1.0, _t7);
        double _sp0, _sp1;
        if (_t3 != 0.0) {
            _sp0 = 0.5 * _r1 * _t4;
            _sp1 = 0.5 * _r0 * _t4;
        ...
        double _t12 = _t7 < 0.0 ? -1.0 : 1.0;
        double _t13 = 1.0 + _t12;
        double _t15 = _t13 + _t7;
        double _t19 = 1.0 + _t15;
        double _t20 = 1.0 + (_t12 - (1.0 + _t7));
        double _t21 = 1.0 + (_t7 - _t13);
        double _t22 = 1.0 + (1.0 - (_t12 + _t7));
        double _t23 = (1.0 / Math.sqrt(_t19));
        double _t24 = (1.0 / Math.sqrt(_t21));
        double _t25 = (1.0 / Math.sqrt(_t20));
        double _t26 = (1.0 / Math.sqrt(_t22));
        getNormalizedRotation_translation_s62e3ac38_c0(d, _t15, _sp0, _t23, _t12, _t8, _t20, _t7, _sp1, _t24, _t22, _t25, _t26, _t21, _t19);
        return d;
    }
    ...
    private void getNormalizedRotation_general_s62e3ac38_tail2(DoubleQuatImpl _dst, double _t56, double _t31, double _t34, double _t35, double _t27, double _t33, double _t32, double _t28, double _t45, double _t46, double _t48) {
        ...
        double _t60 = _t57 + _t27;
        double _t61 = _t58 + _t33;
        double _t63 = _t59 + _t32;
        double _t64 = _t32 - _t59;
        double _t65 = _t58 - _t33;
        double _t66 = _t60 + _t28;
        double _t70 = 1.0 + _t66;
        double _t71 = 1.0 + (_t57 - (_t27 + _t28));
        double _t72 = 1.0 + (_t27 - (_t57 + _t28));
        double _t73 = 1.0 + (_t28 - _t60);
        double _sp0 = 0.5 * (1.0 / Math.sqrt(_t70));
    ...
    private Double3 getScale_translation(@Mutated Double3 dest) {
        ...
        d.x = 1.0;
        d.y = 1.0;
        d.z = Math.sqrt(this.m02 * this.m02 + (this.m12 * this.m12 + 1.0));
        return d;
    }
    ...
    private Double3 getScale_general(@Mutated Double3 dest) {
        Double3Impl d = (Double3Impl) dest;
        d.x = Math.sqrt(this.m00 * this.m00 + this.m10 * this.m10 + this.m20 * this.m20);
        d.y = Math.sqrt(this.m01 * this.m01 + this.m11 * this.m11 + this.m21 * this.m21);
        d.z = Math.sqrt(this.m02 * this.m02 + this.m12 * this.m12 + this.m22 * this.m22);
        return d;
    }
    ...
    private Double3x3 cofactor_general(@Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _buf0 = this.m11 * this.m22 - this.m12 * this.m21;
        double _buf1 = this.m02 * this.m21 - this.m01 * this.m22;
        double _buf2 = this.m01 * this.m12 - this.m02 * this.m11;
        double _buf3 = this.m12 * this.m20 - this.m10 * this.m22;
        double _buf4 = this.m00 * this.m22 - this.m02 * this.m20;
        double _buf5 = this.m02 * this.m10 - this.m00 * this.m12;
    ...
    public double frobeniusNorm() {
        return Math.sqrt(this.m00 * this.m00 + this.m01 * this.m01 + (this.m02 * this.m02 + this.m10 * this.m10) + (this.m11 * this.m11 + this.m12 * this.m12 + (this.m20 * this.m20 + (this.m21 * this.m21 + this.m22 * this.m22))));
    }
    ...
    private Double3x3 invert_orthogonal(@Mutated Double3x3 dest) {
        ...
        double _buf1 = this.m11;
        d.m21 = 0.0;
        double _buf2 = -(this.m10 * this.m12) - this.m02 * this.m11;
    ...
    private Double3x3 invert_affine(@Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _t2 = this.m00 * this.m11 - this.m01 * this.m10;
        ...
        d.m21 = 0.0;
        double _buf4 = (this.m01 * this.m12 - this.m02 * this.m11) * _t2_inv;
    ...
    private void invert_general_s37258727_c0(Double3x3Impl _dst, double _t6, double _t13_inv, double _t3, double _t2, double _t8) {
    ...
    private void invert_general_s37258727_c1(Double3x3Impl _dst, double _r8, double _r5, double _r7, double _r1, double _t13_inv, double _r6, double _r3) {
    ...
    private void invert_general_s37258727_c2(Double3x3Impl _dst, double _r7, double _r2, double _r8, double _r4, double _t13_inv, double _r0, double _r6) {
    ...
    private Double3x3 invert_general(@Mutated Double3x3 dest) {
        ...
        double _t2 = _r0 * _r1;
        double _t3 = _r2 * _r3;
        double _t6 = _r4 * _r1 - _r2 * _r5;
        double _t8 = _r0 * _r5 - _r4 * _r3;
        double _t13 = _r6 * _t6 - _r7 * (_t2 - _t3) + _r8 * _t8;
        double _t13_inv = 1.0 / _t13;
        invert_general_s37258727_c0(d, _t6, _t13_inv, _t3, _t2, _t8);
        invert_general_s37258727_c1(d, _r8, _r5, _r7, _r1, _t13_inv, _r6, _r3);
        invert_general_s37258727_c2(d, _r7, _r2, _r8, _r4, _t13_inv, _r0, _r6);
        d.properties = 0;
        return d;
    }
    ...
    private void invertProduct_general_s1154904e_c0(Double3x3Impl _dst, double _t51, double _t58_inv, double _t48, double _t47, double _t53) {
    ...
    private void invertProduct_general_s1154904e_c1(Double3x3Impl _dst, double _t38, double _t44, double _t41, double _t37, double _t58_inv, double _t40, double _t43) {
    ...
    private void invertProduct_general_s1154904e_c2(Double3x3Impl _dst, double _t41, double _t39, double _t36, double _t44, double _t58_inv, double _t42, double _t40) {
    ...
    private void invertProduct_general_s1154904e_tail(Double3x3Impl _dst, double _r6, double _r7, double _r8, double _r9, double _r10, double _r11, double _r0, double _r2, double _r4, double _r1, double _r3, double _r5, double _r12, double _r13, double _r14, double _r15, double _r16, double _r17, double _t36) {
        double _t37 = _r6 * _r7 + _r8 * _r9 + _r10 * _r11;
        double _t38 = _r0 * _r7 + _r2 * _r9 + _r4 * _r11;
        double _t39 = _r6 * _r1 + _r8 * _r3 + _r10 * _r5;
        double _t40 = _r12 * _r13 + _r14 * _r15 + _r16 * _r17;
        double _t41 = _r0 * _r13 + _r2 * _r15 + _r4 * _r17;
        double _t42 = _r12 * _r1 + _r14 * _r3 + _r16 * _r5;
        double _t43 = _r12 * _r7 + _r14 * _r9 + _r16 * _r11;
        double _t44 = _r6 * _r13 + _r8 * _r15 + _r10 * _r17;
        double _t47 = _t42 * _t37;
        double _t48 = _t43 * _t39;
        double _t51 = _t36 * _t37 - _t38 * _t39;
        double _t53 = _t42 * _t38 - _t43 * _t36;
        invertProduct_general_s1154904e_tail2(_dst, _t40, _t51, _t41, _t47, _t48, _t44, _t53, _t38, _t37, _t39, _t36, _t43, _t42);
    }

    /** Private tail of {@code invertProduct_general}; reached only through it. */
    private void invertProduct_general_s1154904e_tail2(Double3x3Impl _dst, double _t40, double _t51, double _t41, double _t47, double _t48, double _t44, double _t53, double _t38, double _t37, double _t39, double _t36, double _t43, double _t42) {
        double _t58 = _t40 * _t51 - _t41 * (_t47 - _t48) + _t44 * _t53;
        double _t58_inv = 1.0 / _t58;
        invertProduct_general_s1154904e_c0(_dst, _t51, _t58_inv, _t48, _t47, _t53);
        invertProduct_general_s1154904e_c1(_dst, _t38, _t44, _t41, _t37, _t58_inv, _t40, _t43);
        invertProduct_general_s1154904e_c2(_dst, _t41, _t39, _t36, _t44, _t58_inv, _t42, _t40);
    }
    ...
    private Double3x3 invertProduct_general(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _t36 = _r0 * _r1 + _r2 * _r3 + _r4 * _r5;
        invertProduct_general_s1154904e_tail(d, _r6, _r7, _r8, _r9, _r10, _r11, _r0, _r2, _r4, _r1, _r3, _r5, _r12, _r13, _r14, _r15, _r16, _r17, _t36);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code invertProduct_identity}: computes and stores it; reached only through it. */
    private void invertProduct_identity_s1154904e_c0(Double3x3Impl _dst, double _t6, double _t13_inv, double _t3, double _t2, double _t8) {
        _dst.m00 = _t6 * _t13_inv;
        _dst.m10 = (_t3 - _t2) * _t13_inv;
        _dst.m20 = _t8 * _t13_inv;
    }
    ...
    private void invertProduct_identity_s1154904e_c1(Double3x3Impl _dst, double _r8, double _r5, double _r7, double _r1, double _t13_inv, double _r6, double _r3) {
        _dst.m01 = (_r8 * _r5 - _r7 * _r1) * _t13_inv;
        _dst.m11 = (_r6 * _r1 - _r8 * _r3) * _t13_inv;
        _dst.m21 = (_r7 * _r3 - _r6 * _r5) * _t13_inv;
    }
    ...
    private void invertProduct_identity_s1154904e_c2(Double3x3Impl _dst, double _r7, double _r2, double _r8, double _r4, double _t13_inv, double _r0, double _r6) {
        _dst.m02 = (_r7 * _r2 - _r8 * _r4) * _t13_inv;
        _dst.m12 = (_r8 * _r0 - _r6 * _r2) * _t13_inv;
        _dst.m22 = (_r6 * _r4 - _r7 * _r0) * _t13_inv;
    }
    ...
    private Double3x3 invertProduct_identity(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _t13 = _r6 * _t6 - _r7 * (_t2 - _t3) + _r8 * _t8;
        double _t13_inv = 1.0 / _t13;
        invertProduct_identity_s1154904e_c0(d, _t6, _t13_inv, _t3, _t2, _t8);
        invertProduct_identity_s1154904e_c1(d, _r8, _r5, _r7, _r1, _t13_inv, _r6, _r3);
        invertProduct_identity_s1154904e_c2(d, _r7, _r2, _r8, _r4, _t13_inv, _r0, _r6);
    ...
    private void invertProduct_translation_s1154904e_c0(Double3x3Impl _dst, double _t18, double _t25_inv, double _t15, double _t14, double _t20) {
    ...
    private void invertProduct_translation_s1154904e_c1(Double3x3Impl _dst, double _r0, double _t11, double _r3, double _t9, double _t25_inv, double _t8, double _r5) {
    ...
    private void invertProduct_translation_s1154904e_c2(Double3x3Impl _dst, double _t9, double _t7, double _t11, double _t6, double _t25_inv, double _t10, double _t8) {
    ...
    private void invertProduct_translation_s1154904e_tail(Double3x3Impl _dst, double _t8, double _t18, double _t9, double _t14, double _t15, double _t11, double _t20, double _r0, double _r3, double _t7, double _t6, double _r5, double _t10) {
        double _t25 = _t8 * _t18 - _t9 * (_t14 - _t15) + _t11 * _t20;
        double _t25_inv = 1.0 / _t25;
        invertProduct_translation_s1154904e_c0(_dst, _t18, _t25_inv, _t15, _t14, _t20);
        invertProduct_translation_s1154904e_c1(_dst, _r0, _t11, _r3, _t9, _t25_inv, _t8, _r5);
        invertProduct_translation_s1154904e_c2(_dst, _t9, _t7, _t11, _t6, _t25_inv, _t10, _t8);
    }
    ...
    private Double3x3 invertProduct_translation(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _t6 = _r0 * _r1 + _r2;
        double _t7 = _r3 * _r1 + _r4;
        double _t8 = _r5 * _r6 + _r7;
        double _t9 = _r0 * _r6 + _r8;
        double _t10 = _r5 * _r1 + _r9;
        double _t11 = _r3 * _r6 + _r10;
        double _t14 = _r3 * _t10;
        double _t15 = _r5 * _t7;
        double _t18 = _r3 * _t6 - _r0 * _t7;
        double _t20 = _r0 * _t10 - _r5 * _t6;
        invertProduct_translation_s1154904e_tail(d, _t8, _t18, _t9, _t14, _t15, _t11, _t20, _r0, _r3, _t7, _t6, _r5, _t10);
    ...
    private void invertProduct_orthogonal_s40da5184_c0(Double3x3Impl _dst, double _t36, double _t43_inv, double _t33, double _t32, double _t38) {
    ...
    private void invertProduct_orthogonal_s40da5184_c1(Double3x3Impl _dst, double _r4, double _t29, double _r8, double _t27, double _t43_inv, double _t26, double _r13) {
    ...
    private void invertProduct_orthogonal_s40da5184_c2(Double3x3Impl _dst, double _t27, double _t25, double _t24, double _t29, double _t43_inv, double _t28, double _t26) {
    ...
    private void invertProduct_orthogonal_s40da5184_tail(Double3x3Impl _dst, double _r9, double _r10, double _r11, double _r12, double _r13, double _r14, double _r0, double _r2, double _r4, double _r1, double _r3, double _r5, double _r6, double _r7, double _r8, double _t25, double _t24) {
        double _t26 = _r9 * _r10 + _r11 * _r12 + _r13 * _r14;
        double _t27 = _r0 * _r10 + _r2 * _r12 + _r4 * _r14;
        double _t28 = _r9 * _r1 + _r11 * _r3 + _r13 * _r5;
        double _t29 = _r6 * _r10 + _r7 * _r12 + _r8 * _r14;
        double _t32 = _r8 * _t28;
        double _t33 = _r13 * _t25;
        double _t36 = _r8 * _t24 - _r4 * _t25;
        double _t38 = _r4 * _t28 - _r13 * _t24;
        double _t43 = _t26 * _t36 - _t27 * (_t32 - _t33) + _t29 * _t38;
        double _t43_inv = 1.0 / _t43;
        invertProduct_orthogonal_s40da5184_c0(_dst, _t36, _t43_inv, _t33, _t32, _t38);
        invertProduct_orthogonal_s40da5184_c1(_dst, _r4, _t29, _r8, _t27, _t43_inv, _t26, _r13);
        invertProduct_orthogonal_s40da5184_c2(_dst, _t27, _t25, _t24, _t29, _t43_inv, _t28, _t26);
    }
    ...
    private Double3x3 invertProduct_orthogonal(Double3x3R other, @Mutated Double3x3 dest, int _props) {
        ...
        double _r5 = this.m12;
        double _r6 = other.m02();
        double _r7 = other.m12();
        double _r8 = other.m22();
        double _r9 = other.m00();
        double _r10 = this.m00;
        double _r11 = other.m10();
        double _r12 = this.m01;
        double _r13 = other.m20();
        double _r14 = this.m02;
        double _t24 = _r0 * _r1 + _r2 * _r3 + _r4 * _r5;
        double _t25 = _r6 * _r1 + _r7 * _r3 + _r8 * _r5;
        invertProduct_orthogonal_s40da5184_tail(d, _r9, _r10, _r11, _r12, _r13, _r14, _r0, _r2, _r4, _r1, _r3, _r5, _r6, _r7, _r8, _t25, _t24);
        d.properties = _props;
        return d;
    }
    ...
    private Double3x3 invertProduct_identity_affine(Double3x3R other, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _t2 = other.m00() * other.m11() - other.m01() * other.m10();
        double _t2_inv = 1.0 / _t2;
        ...
        d.m21 = 0.0;
        double _buf4 = (other.m01() * other.m12() - other.m02() * other.m11()) * _t2_inv;
    ...
    private Double3x3 invertProduct_translation_affine(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _t3 = other.m02() + this.m02;
        double _t4 = other.m00() * other.m11() - other.m01() * other.m10();
    ...
    private Double3x3 invertProduct_orthogonal_translation(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _buf1 = this.m11;
        d.m21 = 0.0;
        double _buf2 = -other.m02() - this.m02 * this.m11 - this.m10 * this.m12;
    ...
    private Double3x3 invertProduct_orthogonal_affine(Double3x3R other, @Mutated Double3x3 dest, int _props) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _t14 = other.m01() * this.m10 + other.m11() * this.m11;
        double _t15 = other.m00() * this.m00 + other.m10() * this.m01;
        double _t16 = other.m00() * this.m10 + other.m10() * this.m11;
        double _t17 = other.m01() * this.m00 + other.m11() * this.m01;
        double _t18 = other.m02() * this.m10 + (other.m12() * this.m11 + this.m12);
        double _t19 = other.m02() * this.m00 + (other.m12() * this.m01 + this.m02);
        double _t22 = _t15 * _t14 - _t16 * _t17;
    ...
    private Double3x3 invertProduct_affine_translation(Double3x3R other, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _t8 = this.m00 * this.m11 - this.m01 * this.m10;
        double _t8_inv = 1.0 / _t8;
        double _t9 = other.m02() * this.m10 + (other.m12() * this.m11 + this.m12);
        double _t10 = other.m02() * this.m00 + (other.m12() * this.m01 + this.m02);
        double _buf0 = this.m11 * _t8_inv;
        double _buf1 = -(this.m10 * _t8_inv);
        d.m20 = 0.0;
        double _buf2 = -(this.m01 * _t8_inv);
        double _buf3 = this.m00 * _t8_inv;
        d.m21 = 0.0;
    ...
    private void invertProduct_general_identity_s1154904e_c0(Double3x3Impl _dst, double _t6, double _t13_inv, double _t3, double _t2, double _t8) {
        _dst.m00 = _t6 * _t13_inv;
        _dst.m10 = (_t3 - _t2) * _t13_inv;
        _dst.m20 = _t8 * _t13_inv;
    }
    ...
    private void invertProduct_general_identity_s1154904e_c1(Double3x3Impl _dst, double _r8, double _r5, double _r7, double _r1, double _t13_inv, double _r6, double _r3) {
        _dst.m01 = (_r8 * _r5 - _r7 * _r1) * _t13_inv;
        _dst.m11 = (_r6 * _r1 - _r8 * _r3) * _t13_inv;
        _dst.m21 = (_r7 * _r3 - _r6 * _r5) * _t13_inv;
    }
    ...
    private void invertProduct_general_identity_s1154904e_c2(Double3x3Impl _dst, double _r7, double _r2, double _r8, double _r4, double _t13_inv, double _r0, double _r6) {
        _dst.m02 = (_r7 * _r2 - _r8 * _r4) * _t13_inv;
        _dst.m12 = (_r8 * _r0 - _r6 * _r2) * _t13_inv;
        _dst.m22 = (_r6 * _r4 - _r7 * _r0) * _t13_inv;
    }
    ...
    private Double3x3 invertProduct_general_identity(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _t13 = _r6 * _t6 - _r7 * (_t2 - _t3) + _r8 * _t8;
        double _t13_inv = 1.0 / _t13;
        invertProduct_general_identity_s1154904e_c0(d, _t6, _t13_inv, _t3, _t2, _t8);
        invertProduct_general_identity_s1154904e_c1(d, _r8, _r5, _r7, _r1, _t13_inv, _r6, _r3);
        invertProduct_general_identity_s1154904e_c2(d, _r7, _r2, _r8, _r4, _t13_inv, _r0, _r6);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code invertProduct_general_translation}: computes and stores it; reached only through it. */
    private void invertProduct_general_translation_s1154904e_c0(Double3x3Impl _dst, double _t20, double _t25_inv, double _t18, double _t17, double _t11) {
    ...
    private void invertProduct_general_translation_s1154904e_c1(Double3x3Impl _dst, double _r1, double _t14, double _r9, double _t12, double _t25_inv, double _r8, double _r3) {
    ...
    private void invertProduct_general_translation_s1154904e_c2(Double3x3Impl _dst, double _r9, double _t13, double _r2, double _t14, double _t25_inv, double _r0, double _r8) {
    ...
    private void invertProduct_general_translation_s1154904e_tail(Double3x3Impl _dst, double _r8, double _t20, double _r9, double _t17, double _t18, double _t14, double _t11, double _r1, double _t12, double _t13, double _r2, double _r3, double _r0) {
        double _t25 = _r8 * _t20 - _r9 * (_t17 - _t18) + _t14 * _t11;
        double _t25_inv = 1.0 / _t25;
        invertProduct_general_translation_s1154904e_c0(_dst, _t20, _t25_inv, _t18, _t17, _t11);
        invertProduct_general_translation_s1154904e_c1(_dst, _r1, _t14, _r9, _t12, _t25_inv, _r8, _r3);
        invertProduct_general_translation_s1154904e_c2(_dst, _r9, _t13, _r2, _t14, _t25_inv, _r0, _r8);
    }
    ...
    private Double3x3 invertProduct_general_translation(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _t11 = _r0 * _r1 - _r2 * _r3;
        double _t12 = _r4 * _r3 + (_r5 * _r1 + _r6);
        double _t13 = _r4 * _r0 + (_r5 * _r2 + _r7);
        double _t14 = _r4 * _r8 + (_r5 * _r9 + _r10);
        double _t17 = _r0 * _t12;
        double _t18 = _r3 * _t13;
        double _t20 = _r2 * _t12 - _r1 * _t13;
        invertProduct_general_translation_s1154904e_tail(d, _r8, _t20, _r9, _t17, _t18, _t14, _t11, _r1, _t12, _t13, _r2, _r3, _r0);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code invertProduct_general_affine}: computes and stores it; reached only through it. */
    private void invertProduct_general_affine_s1154904e_c0(Double3x3Impl _dst, double _t37, double _t43_inv, double _t35, double _t34, double _t36) {
    ...
    private void invertProduct_general_affine_s1154904e_c1(Double3x3Impl _dst, double _t29, double _t22, double _t27, double _t24, double _t43_inv, double _t23, double _t26) {
    ...
    private void invertProduct_general_affine_s1154904e_c2(Double3x3Impl _dst, double _t28, double _t24, double _t29, double _t21, double _t43_inv, double _t25, double _t23) {
    ...
    private void invertProduct_general_affine_s1154904e_tail(Double3x3Impl _dst, double _r6, double _r1, double _r8, double _r3, double _r4, double _r5, double _r10, double _r11, double _r12, double _r13, double _r7, double _r9, double _r14, double _t22, double _t21, double _t23, double _t24) {
        double _t25 = _r6 * _r1 + _r8 * _r3;
        double _t26 = _r6 * _r4 + _r8 * _r5;
        double _t27 = _r10 * _r4 + (_r11 * _r5 + _r12);
        double _t28 = _r10 * _r1 + (_r11 * _r3 + _r13);
        double _t29 = _r10 * _r7 + (_r11 * _r9 + _r14);
        double _t34 = _t27 * _t25;
        double _t35 = _t28 * _t26;
        double _t36 = _t25 * _t22 - _t26 * _t21;
        double _t37 = _t27 * _t21 - _t28 * _t22;
        double _t43 = _t23 * _t37 - _t24 * (_t34 - _t35) + _t29 * _t36;
        double _t43_inv = 1.0 / _t43;
        invertProduct_general_affine_s1154904e_c0(_dst, _t37, _t43_inv, _t35, _t34, _t36);
        invertProduct_general_affine_s1154904e_c1(_dst, _t29, _t22, _t27, _t24, _t43_inv, _t23, _t26);
        invertProduct_general_affine_s1154904e_c2(_dst, _t28, _t24, _t29, _t21, _t43_inv, _t25, _t23);
    }
    ...
    private Double3x3 invertProduct_general_affine(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _r14 = this.m02;
        double _t21 = _r0 * _r1 + _r2 * _r3;
        double _t22 = _r0 * _r4 + _r2 * _r5;
        double _t23 = _r6 * _r7 + _r8 * _r9;
        double _t24 = _r0 * _r7 + _r2 * _r9;
        invertProduct_general_affine_s1154904e_tail(d, _r6, _r1, _r8, _r3, _r4, _r5, _r10, _r11, _r12, _r13, _r7, _r9, _r14, _t22, _t21, _t23, _t24);
        d.properties = 0;
        return d;
    }
    ...
    private void invertProduct_s34872ae5_c0(Double3x3Impl _dst, double _t51, double _t58_inv, double _t48, double _t47, double _t53) {
        _dst.m00 = _t51 * _t58_inv;
        _dst.m10 = (_t48 - _t47) * _t58_inv;
        _dst.m20 = _t53 * _t58_inv;
    }
    ...
    private void invertProduct_s34872ae5_c1(Double3x3Impl _dst, double _t38, double _t44, double _t41, double _t37, double _t58_inv, double _t40, double _t43) {
        _dst.m01 = (_t38 * _t44 - _t41 * _t37) * _t58_inv;
        _dst.m11 = (_t40 * _t37 - _t43 * _t44) * _t58_inv;
        _dst.m21 = (_t43 * _t41 - _t40 * _t38) * _t58_inv;
    }
    ...
    private void invertProduct_s34872ae5_c2(Double3x3Impl _dst, double _t41, double _t39, double _t36, double _t44, double _t58_inv, double _t42, double _t40) {
        _dst.m02 = (_t41 * _t39 - _t36 * _t44) * _t58_inv;
        _dst.m12 = (_t42 * _t44 - _t40 * _t39) * _t58_inv;
        _dst.m22 = (_t40 * _t36 - _t42 * _t41) * _t58_inv;
    }
    ...
    private void invertProduct_s34872ae5_tail(Double3x3Impl _dst, double m01, double _r6, double m11, double _r7, double m21, double _r8, double m00, double _r0, double m10, double _r1, double m20, double _r2, double _r3, double _r4, double _r5, double m02, double m12, double m22, double _t37, double _t39, double _t36, double _t38, double _t40) {
        double _t41 = m01 * _r6 + m11 * _r7 + m21 * _r8;
        double _t42 = m00 * _r0 + m10 * _r1 + m20 * _r2;
        double _t43 = m00 * _r3 + m10 * _r4 + m20 * _r5;
        double _t44 = m02 * _r6 + m12 * _r7 + m22 * _r8;
        double _t47 = _t42 * _t37;
        double _t48 = _t43 * _t39;
        double _t51 = _t36 * _t37 - _t38 * _t39;
        double _t53 = _t42 * _t38 - _t43 * _t36;
        double _t58 = _t40 * _t51 - _t41 * (_t47 - _t48) + _t44 * _t53;
        double _t58_inv = 1.0 / _t58;
        invertProduct_s34872ae5_c0(_dst, _t51, _t58_inv, _t48, _t47, _t53);
        invertProduct_s34872ae5_c1(_dst, _t38, _t44, _t41, _t37, _t58_inv, _t40, _t43);
        invertProduct_s34872ae5_c2(_dst, _t41, _t39, _t36, _t44, _t58_inv, _t42, _t40);
    }
    ...
    public Double3x3 invertProduct(double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22, @Mutated Double3x3 dest) {
        ...
        double _r7 = this.m01;
        double _r8 = this.m02;
        double _t36 = m01 * _r0 + m11 * _r1 + m21 * _r2;
        double _t37 = m02 * _r3 + m12 * _r4 + m22 * _r5;
        double _t38 = m01 * _r3 + m11 * _r4 + m21 * _r5;
        double _t39 = m02 * _r0 + m12 * _r1 + m22 * _r2;
        double _t40 = m00 * _r6 + m10 * _r7 + m20 * _r8;
        invertProduct_s34872ae5_tail(d, m01, _r6, m11, _r7, m21, _r8, m00, _r0, m10, _r1, m20, _r2, _r3, _r4, _r5, m02, m12, m22, _t37, _t39, _t36, _t38, _t40);
        d.properties = 0;
        return d;
    }
    ...
    private void normal_general_s37258727_c0(Double3x3Impl _dst, double _t6, double _t13_inv, double _r8, double _r5, double _r7, double _r1, double _r2, double _r4) {
        _dst.m00 = _t6 * _t13_inv;
    ...
    private void normal_general_s37258727_c1(Double3x3Impl _dst, double _t3, double _t2, double _t13_inv, double _r6, double _r1, double _r8, double _r3, double _r0, double _r2) {
    ...
    private void normal_general_s37258727_c2(Double3x3Impl _dst, double _t8, double _t13_inv, double _r7, double _r3, double _r6, double _r5, double _r4, double _r0) {
    ...
    private Double3x3 normal_general(@Mutated Double3x3 dest) {
        ...
        double _t13 = _r6 * _t6 - _r7 * (_t2 - _t3) + _r8 * _t8;
        double _t13_inv = 1.0 / _t13;
        normal_general_s37258727_c0(d, _t6, _t13_inv, _r8, _r5, _r7, _r1, _r2, _r4);
        normal_general_s37258727_c1(d, _t3, _t2, _t13_inv, _r6, _r1, _r8, _r3, _r0, _r2);
        normal_general_s37258727_c2(d, _t8, _t13_inv, _r7, _r3, _r6, _r5, _r4, _r0);
        d.properties = 0;
        return d;
    }
    ...
    @Mutated public Double3x3 makeFromRigid(double rTX, double rTY, double rTZ, double rRX, double rRY, double rRZ, double rRW) {
        ...
        double _t7 = rRY * rRZ;
        double _t8 = rRX * rRW;
        this.m00 = 1.0 - 2.0 * (_t0 + _t1);
        this.m10 = 2.0 * (_t2 + _t3);
        this.m20 = 2.0 * (_t4 - _t5);
        this.m01 = 2.0 * (_t2 - _t3);
        this.m11 = 1.0 - 2.0 * (_t6 + _t1);
        this.m21 = 2.0 * (_t8 + _t7);
        this.m02 = 2.0 * (_t4 + _t5);
        this.m12 = 2.0 * (_t7 - _t8);
        this.m22 = 1.0 - 2.0 * (_t6 + _t0);
        this.properties = 0;
        return this;
    }
    ...
    private void toRigid_translation_s14533caa_c0(DoubleRigidImpl _dst, double _t13, double _sp0, double _t20, double _t9, double _t5, double _t18, double _t4, double _sp1, double _t21) {
        _dst.tX = 0.0;
        _dst.tY = 0.0;
        _dst.tZ = 0.0;
        _dst.rX = _t13 > 0.0 ? -(_sp0 * _t20) : _t9 > _t5 ? 0.5 * Math.sqrt(_t18) : 1.0 > _t4 ? 0.0 : _sp1 * _t21;
    }

    /** Private store group 1 of {@code toRigid_translation}: computes and stores it; reached only through it. */
    private void toRigid_translation_s14533caa_c1(DoubleRigidImpl _dst, double _t13, double _sp1, double _t20, double _t9, double _t5, double _t4, double _t15, double _sp0, double _t21, double _t22, double _t16, double _t19, double _t17) {
        _dst.rY = _t13 > 0.0 ? _sp1 * _t20 : _t9 > _t5 ? 0.0 : 1.0 > _t4 ? 0.5 * Math.sqrt(_t15) : _sp0 * _t21;
        _dst.rZ = _t13 > 0.0 ? 0.0 : _t9 > _t5 ? _sp1 * _t22 : 1.0 > _t4 ? _sp0 * _t16 : 0.5 * Math.sqrt(_t19);
        _dst.rW = _t13 > 0.0 ? 0.5 * Math.sqrt(_t17) : _t9 > _t5 ? -(_sp0 * _t22) : 1.0 > _t4 ? _sp1 * _t16 : 0.0;
    }
    ...
    private DoubleRigid toRigid_translation(@Mutated DoubleRigid dest) {
        ...
        double _r0 = this.m02;
        double _r1 = this.m12;
        double _t4 = (1.0 / Math.sqrt(_r0 * _r0 + (_r1 * _r1 + 1.0)));
        double _t5 = Math.max(1.0, _t4);
        double _sp0 = 0.5 * _r1 * _t4;
        double _sp1 = 0.5 * _r0 * _t4;
        double _t9 = _t4 < 0.0 ? -1.0 : 1.0;
        double _t10 = 1.0 + _t9;
        double _t13 = _t10 + _t4;
        double _t15 = 2.0 - _t9 - _t4;
        double _t16 = (1.0 / Math.sqrt(_t15));
        double _t17 = 1.0 + _t13;
        double _t18 = _t10 - 1.0 - _t4;
        double _t19 = 1.0 + _t4 - _t9 - 1.0;
        double _t20 = (1.0 / Math.sqrt(_t17));
        double _t21 = (1.0 / Math.sqrt(_t19));
        double _t22 = (1.0 / Math.sqrt(_t18));
        toRigid_translation_s14533caa_c0(d, _t13, _sp0, _t20, _t9, _t5, _t18, _t4, _sp1, _t21);
        toRigid_translation_s14533caa_c1(d, _t13, _sp1, _t20, _t9, _t5, _t4, _t15, _sp0, _t21, _t22, _t16, _t19, _t17);
        return d;
    }

    /** Private store group 0 of {@code toRigid_general}: computes and stores it; reached only through it. */
    private void toRigid_general_s14533caa_c0(DoubleRigidImpl _dst, double _t61, double _sp0, double _t36, double _t47, double _t37, double _t63, double _t18, double _t19, double _sp1, double _t53, double _sp2, double _t54) {
        _dst.tX = 0.0;
        _dst.tY = 0.0;
        _dst.tZ = 0.0;
    ...
    private void toRigid_general_s14533caa_tail(DoubleRigidImpl _dst, double _t24, double _t21, double _t20, double _t18, double _t22, double _t23, double _t19, double _t25, double _t26, double _t36, double _t37) {
        ...
        toRigid_general_s14533caa_tail2(_dst, _t64, _t65, _t63, _t61, _sp0, _t36, _t47, _t37, _t18, _t19, _t53, _t54, _t55, _t38, _t56, _t62);
    }

    /** Private tail of {@code toRigid_general}; reached only through it. */
    private void toRigid_general_s14533caa_tail2(DoubleRigidImpl _dst, double _t64, double _t65, double _t63, double _t61, double _sp0, double _t36, double _t47, double _t37, double _t18, double _t19, double _t53, double _t54, double _t55, double _t38, double _t56, double _t62) {
        double _sp1 = 0.5 * (1.0 / Math.sqrt(_t64));
        double _sp2 = 0.5 * (1.0 / Math.sqrt(_t65));
        double _sp3 = 0.5 * (1.0 / Math.sqrt(_t63));
        toRigid_general_s14533caa_c0(_dst, _t61, _sp0, _t36, _t47, _t37, _t63, _t18, _t19, _sp1, _t53, _sp2, _t54);
    ...
    private DoubleRigid toRigid_general(@Mutated DoubleRigid dest) {
        ...
        toRigid_general_s14533caa_tail(d, _t24, _t21, _t20, _t18, _t22, _t23, _t19, _t25, _t26, _t36, _t37);
        return d;
    }
    ...
    private void toTransform_translation_s5d096289_c0(DoubleTransformImpl _dst, double _t13, double _sp0, double _t20, double _t9, double _t5, double _t18, double _t4, double _sp1, double _t21) {
        _dst.tX = 0.0;
        _dst.tY = 0.0;
        _dst.tZ = 0.0;
        _dst.rX = _t13 > 0.0 ? -(_sp0 * _t20) : _t9 > _t5 ? 0.5 * Math.sqrt(_t18) : 1.0 > _t4 ? 0.0 : _sp1 * _t21;
    ...
    private void toTransform_translation_s5d096289_c1(DoubleTransformImpl _dst, double _t13, double _sp1, double _t20, double _t9, double _t5, double _t4, double _t15, double _sp0, double _t21, double _t22, double _t16, double _t19, double _t17) {
        _dst.rY = _t13 > 0.0 ? _sp1 * _t20 : _t9 > _t5 ? 0.0 : 1.0 > _t4 ? 0.5 * Math.sqrt(_t15) : _sp0 * _t21;
        _dst.rZ = _t13 > 0.0 ? 0.0 : _t9 > _t5 ? _sp1 * _t22 : 1.0 > _t4 ? _sp0 * _t16 : 0.5 * Math.sqrt(_t19);
        _dst.rW = _t13 > 0.0 ? 0.5 * Math.sqrt(_t17) : _t9 > _t5 ? -(_sp0 * _t22) : 1.0 > _t4 ? _sp1 * _t16 : 0.0;
    }
    ...
    private void toTransform_translation_s5d096289_c2(DoubleTransformImpl _dst, double _t9, double _t3) {
        _dst.sX = _t9;
        _dst.sY = 1.0;
        _dst.sZ = Math.sqrt(_t3);
    }
    ...
    private DoubleTransform toTransform_translation(@Mutated DoubleTransform dest) {
        ...
        double _t21 = (1.0 / Math.sqrt(_t19));
        double _t22 = (1.0 / Math.sqrt(_t18));
        toTransform_translation_s5d096289_c0(d, _t13, _sp0, _t20, _t9, _t5, _t18, _t4, _sp1, _t21);
        toTransform_translation_s5d096289_c1(d, _t13, _sp1, _t20, _t9, _t5, _t4, _t15, _sp0, _t21, _t22, _t16, _t19, _t17);
        toTransform_translation_s5d096289_c2(d, _t9, _t3);
        return d;
    }

    /** Private store group 0 of {@code toTransform_orthogonal}: computes and stores it; reached only through it. */
    private void toTransform_orthogonal_s5d096289_c0(DoubleTransformImpl _dst, double _t40, double _sp0, double _t45, double _t29, double _t25, double _t42, double _t14, double _t13, double _sp2, double _t46, double _sp1, double _t47) {
        _dst.tX = 0.0;
        _dst.tY = 0.0;
        _dst.tZ = 0.0;
        _dst.rX = _t40 > 0.0 ? -(_sp0 * _t45) : _t29 > _t25 ? 0.5 * Math.sqrt(_t42) : _t14 > _t13 ? _sp2 * _t46 : _sp1 * _t47;
    }

    /** Private store group 1 of {@code toTransform_orthogonal}: computes and stores it; reached only through it. */
    private void toTransform_orthogonal_s5d096289_c1(DoubleTransformImpl _dst, double _t40, double _sp1, double _t45, double _t29, double _t25, double _sp2, double _t48, double _t14, double _t13, double _t43, double _sp0, double _t47, double _sp3, double _t46, double _t44, double _t41) {
        _dst.rY = _t40 > 0.0 ? _sp1 * _t45 : _t29 > _t25 ? _sp2 * _t48 : _t14 > _t13 ? 0.5 * Math.sqrt(_t43) : _sp0 * _t47;
        _dst.rZ = _t40 > 0.0 ? _sp3 * _t45 : _t29 > _t25 ? _sp1 * _t48 : _t14 > _t13 ? _sp0 * _t46 : 0.5 * Math.sqrt(_t44);
        _dst.rW = _t40 > 0.0 ? 0.5 * Math.sqrt(_t41) : _t29 > _t25 ? -(_sp0 * _t48) : _t14 > _t13 ? _sp1 * _t46 : _sp3 * _t47;
    }

    /** Private store group 2 of {@code toTransform_orthogonal}: computes and stores it; reached only through it. */
    private void toTransform_orthogonal_s5d096289_c2(DoubleTransformImpl _dst, double _t28, double _t11, double _t12) {
        _dst.sX = _t28 < 0.0 ? -_t11 : _t11;
        _dst.sY = 1.0;
        _dst.sZ = Math.sqrt(_t12);
    }

    /** Private tail of {@code toTransform_orthogonal}; reached only through it. */
    private void toTransform_orthogonal_s5d096289_tail(DoubleTransformImpl _dst, double _t29, double _t16, double _t30, double _t14, double _t13, double _sp0, double _t25, double _sp1, double _t28, double _t11, double _t12) {
        double _t31 = 1.0 + _t29;
        double _sp2 = 0.5 * (_t16 + _t30);
        double _sp3 = 0.5 * (_t30 - _t16);
        double _t40 = _t14 + (_t29 + _t13);
        double _t41 = _t14 + (_t31 + _t13);
        double _t42 = _t31 - _t13 - _t14;
        double _t43 = _t14 + (1.0 - _t29 - _t13);
        double _t44 = 1.0 + _t13 - _t29 - _t14;
        double _t45 = (1.0 / Math.sqrt(_t41));
        double _t46 = (1.0 / Math.sqrt(_t43));
        double _t47 = (1.0 / Math.sqrt(_t44));
        double _t48 = (1.0 / Math.sqrt(_t42));
        toTransform_orthogonal_s5d096289_c0(_dst, _t40, _sp0, _t45, _t29, _t25, _t42, _t14, _t13, _sp2, _t46, _sp1, _t47);
        toTransform_orthogonal_s5d096289_c1(_dst, _t40, _sp1, _t45, _t29, _t25, _sp2, _t48, _t14, _t13, _t43, _sp0, _t47, _sp3, _t46, _t44, _t41);
        toTransform_orthogonal_s5d096289_c2(_dst, _t28, _t11, _t12);
    }
    ...
    private DoubleTransform toTransform_orthogonal(@Mutated DoubleTransform dest) {
        ...
        double _r4 = this.m02;
        double _r5 = this.m12;
        double _t8 = _r0 * _r0 + _r1 * _r1;
        double _t9 = (1.0 / Math.sqrt(_r2 * _r2 + _r3 * _r3));
        double _t11 = Math.sqrt(_t8);
        double _t10 = 1.0 / _t11;
        double _t12 = _r4 * _r4 + (_r5 * _r5 + 1.0);
        double _t13 = (1.0 / Math.sqrt(_t12));
        double _t14 = _r3 * _t9;
        double _t15 = _r0 * _t10;
        double _t16 = _r2 * _t9;
        double _t17 = _r1 * _t10;
        double _sp0 = 0.5 * _r5 * _t13;
        double _sp1 = 0.5 * _r4 * _t13;
        double _t25 = Math.max(_t14, _t13);
        double _t28 = _t15 * _t14 * _t13 - _t16 * _t17 * _t13;
        double _t29, _t30;
        if (_t28 < 0.0) {
            _t29 = -_t15;
            _t30 = -_t17;
        ...
        toTransform_orthogonal_s5d096289_tail(d, _t29, _t16, _t30, _t14, _t13, _sp0, _t25, _sp1, _t28, _t11, _t12);
        return d;
    }

    /** Private store group 0 of {@code toTransform_affine}: computes and stores it; reached only through it. */
    private void toTransform_affine_s5d096289_c0(DoubleTransformImpl _dst, double _t40, double _sp0, double _t45, double _t29, double _t25, double _t42, double _t14, double _t13, double _sp2, double _t46, double _sp1, double _t47) {
        _dst.tX = 0.0;
        _dst.tY = 0.0;
        _dst.tZ = 0.0;
        _dst.rX = _t40 > 0.0 ? -(_sp0 * _t45) : _t29 > _t25 ? 0.5 * Math.sqrt(_t42) : _t14 > _t13 ? _sp2 * _t46 : _sp1 * _t47;
    ...
    private void toTransform_affine_s5d096289_c1(DoubleTransformImpl _dst, double _t40, double _sp1, double _t45, double _t29, double _t25, double _sp2, double _t48, double _t14, double _t13, double _t43, double _sp0, double _t47, double _sp3, double _t46, double _t44, double _t41) {
        _dst.rY = _t40 > 0.0 ? _sp1 * _t45 : _t29 > _t25 ? _sp2 * _t48 : _t14 > _t13 ? 0.5 * Math.sqrt(_t43) : _sp0 * _t47;
        _dst.rZ = _t40 > 0.0 ? _sp3 * _t45 : _t29 > _t25 ? _sp1 * _t48 : _t14 > _t13 ? _sp0 * _t46 : 0.5 * Math.sqrt(_t44);
        _dst.rW = _t40 > 0.0 ? 0.5 * Math.sqrt(_t41) : _t29 > _t25 ? -(_sp0 * _t48) : _t14 > _t13 ? _sp1 * _t46 : _sp3 * _t47;
    }
    ...
    private void toTransform_affine_s5d096289_c2(DoubleTransformImpl _dst, double _t28, double _t11, double _t7, double _t12) {
        _dst.sX = _t28 < 0.0 ? -_t11 : _t11;
        _dst.sY = Math.sqrt(_t7);
        _dst.sZ = Math.sqrt(_t12);
    }

    /** Private tail of {@code toTransform_affine}; reached only through it. */
    private void toTransform_affine_s5d096289_tail(DoubleTransformImpl _dst, double _t28, double _t15, double _t17, double _t16, double _t14, double _t13, double _sp0, double _t25, double _sp1, double _t11, double _t7, double _t12) {
        double _t29, _t30;
        if (_t28 < 0.0) {
            _t29 = -_t15;
            _t30 = -_t17;
        ...
        double _t47 = (1.0 / Math.sqrt(_t44));
        double _t48 = (1.0 / Math.sqrt(_t42));
        toTransform_affine_s5d096289_c0(_dst, _t40, _sp0, _t45, _t29, _t25, _t42, _t14, _t13, _sp2, _t46, _sp1, _t47);
        toTransform_affine_s5d096289_c1(_dst, _t40, _sp1, _t45, _t29, _t25, _sp2, _t48, _t14, _t13, _t43, _sp0, _t47, _sp3, _t46, _t44, _t41);
        toTransform_affine_s5d096289_c2(_dst, _t28, _t11, _t7, _t12);
    }
    ...
    private DoubleTransform toTransform_affine(@Mutated DoubleTransform dest) {
        ...
        double _r4 = this.m02;
        double _r5 = this.m12;
        double _t7 = _r0 * _r0 + _r1 * _r1;
        double _t8 = _r2 * _r2 + _r3 * _r3;
        ...
        double _t16 = _r0 * _t9;
        double _t17 = _r3 * _t10;
        double _sp0 = 0.5 * _r5 * _t13;
        double _sp1 = 0.5 * _r4 * _t13;
        double _t25 = Math.max(_t14, _t13);
        double _t28 = _t15 * _t14 * _t13 - _t16 * _t17 * _t13;
        toTransform_affine_s5d096289_tail(d, _t28, _t15, _t17, _t16, _t14, _t13, _sp0, _t25, _sp1, _t11, _t7, _t12);
        return d;
    }

    /** Private store group 0 of {@code toTransform_general}: computes and stores it; reached only through it. */
    private void toTransform_general_s5d096289_c0(DoubleTransformImpl _dst, double _t62, double _sp0, double _t37, double _t48, double _t38, double _t64, double _t19, double _t20, double _sp1, double _t54, double _sp2, double _t55) {
        _dst.tX = 0.0;
        _dst.tY = 0.0;
        _dst.tZ = 0.0;
    ...
    private void toTransform_general_s5d096289_tail(DoubleTransformImpl _dst, double _t22, double _t25, double _t19, double _t20, double _t21, double _t23, double _t24, double _t26, double _t27, double _t18, double _t12, double _t13) {
        ...
        toTransform_general_s5d096289_tail2(_dst, _t20, _t52, _t19, _t63, _t65, _t64, _t62, _t37, _t48, _t38, _t54, _t55, _t56, _t39, _t57, _t47, _t18, _t12, _t13);
    }

    /** Private tail of {@code toTransform_general}; reached only through it. */
    private void toTransform_general_s5d096289_tail2(DoubleTransformImpl _dst, double _t20, double _t52, double _t19, double _t63, double _t65, double _t64, double _t62, double _t37, double _t48, double _t38, double _t54, double _t55, double _t56, double _t39, double _t57, double _t47, double _t18, double _t12, double _t13) {
        ...
        toTransform_general_s5d096289_c0(_dst, _t62, _sp0, _t37, _t48, _t38, _t64, _t19, _t20, _sp1, _t54, _sp2, _t55);
    ...
    private DoubleTransform toTransform_general(@Mutated DoubleTransform dest) {
        ...
        toTransform_general_s5d096289_tail(d, _t22, _t25, _t19, _t20, _t21, _t23, _t24, _t26, _t27, _t18, _t12, _t13);
        return d;
    }
    ...
    private void decomposeRotation_general_s62e3ac38_tail2(DoubleQuatImpl _dst, double _t67, double _t62, double _t61, double _t60, double _t48, double _t46, double _t9, double _t47, double _t10, double _t11) {
        ...
        double _t81 = _t48 - _t73;
        double _t82 = Math.max(_t46, _t72);
        double _t84 = _t48 + _t73;
        double _t92 = (_t46 * _t72 - _t48 * _t73) * _t9 + (_t48 * _t74 - _t47 * _t72) * _t10 + (_t47 * _t73 - _t46 * _t74) * _t11;
        double _t93, _t94, _t95;
        if (_t92 < 0.0) {
            _t93 = -_t9;
            _t94 = -_t10;
            _t95 = -_t11;
        ...
        double _t96 = _t93 + _t46;
        double _t97 = _t94 + _t47;
    ...
    private void decomposeRotation_general_s62e3ac38_tail3(DoubleQuatImpl _dst, double _t96, double _t72, double _t93, double _t46, double _t81, double _t82, double _t97, double _t100, double _t101, double _t84, double _t98) {
        ...
        double _t108 = 1.0 + (_t46 - (_t93 + _t72));
        double _t109 = 1.0 + (_t72 - _t96);
        double _sp0 = 0.5 * (1.0 / Math.sqrt(_t106));
    ...
    private Double3x3 lerp_identity(Double3x3R other, double t, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        d.m00 = t * (other.m00() - 1.0) + 1.0;
        d.m10 = t * other.m10();
        d.m20 = t * other.m20();
        d.m01 = t * other.m01();
        d.m11 = t * (other.m11() - 1.0) + 1.0;
        d.m21 = t * other.m21();
        d.m02 = t * other.m02();
        d.m12 = t * other.m12();
        d.m22 = t * (other.m22() - 1.0) + 1.0;
        d.properties = Joml.BIT_AFFINE & ((Double3x3Impl) other).properties;
        return d;
    }
    ...
    private Double3x3 lerp_orthogonal_identity(Double3x3R other, double t, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _t2 = t * this.m10;
        double _t3 = t + this.m11 - t * this.m11;
        d.m00 = _t3;
        double _buf0 = this.m10 - _t2;
        d.m20 = 0.0;
        d.m01 = _t2 - this.m10;
        d.m11 = _t3;
        d.m21 = 0.0;
    ...
    private Double3x3 lerp_orthogonal_translation(Double3x3R other, double t, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        d.m00 = t * (1.0 - this.m00) + this.m00;
        d.m10 = this.m10 - t * this.m10;
        d.m20 = 0.0;
        d.m01 = this.m01 - t * this.m01;
        d.m11 = t * (1.0 - this.m11) + this.m11;
        d.m21 = 0.0;
        d.m02 = t * (other.m02() - this.m02) + this.m02;
        d.m12 = t * (other.m12() - this.m12) + this.m12;
        d.m22 = 1.0;
     ...
     * the public {@code lerp} dispatcher.
     */
    private Double3x3 lerp_general_identity(Double3x3R other, double t, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        d.m00 = t * (1.0 - this.m00) + this.m00;
        d.m10 = this.m10 - t * this.m10;
    ...
    private Double3x3 mul_general(Double3x3R right, @Mutated Double3x3 dest) {
        ...
        double _r13 = this.m11;
        double _r14 = this.m12;
        double _r15 = this.m20;
        double _r16 = this.m21;
    ...
    private Double3x3 mul_orthogonal(Double3x3R right, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _buf0 = right.m00() * this.m11 - right.m10() * this.m10 + right.m20() * this.m02;
        double _buf1 = right.m00() * this.m10 + right.m10() * this.m11 + right.m20() * this.m12;
        d.m20 = right.m20();
        double _buf2 = right.m01() * this.m11 - right.m11() * this.m10 + right.m21() * this.m02;
        double _buf3 = right.m01() * this.m10 + right.m11() * this.m11 + right.m21() * this.m12;
        d.m21 = right.m21();
        double _buf4 = right.m02() * this.m11 - right.m12() * this.m10 + right.m22() * this.m02;
    ...
    private Double3x3 mul_affine(Double3x3R right, @Mutated Double3x3 dest) {
        ...
        double _buf1 = right.m00() * this.m10 + right.m10() * this.m11 + right.m20() * this.m12;
        d.m20 = right.m20();
        double _buf2 = right.m01() * this.m00 + right.m11() * this.m01 + right.m21() * this.m02;
        double _buf3 = right.m01() * this.m10 + right.m11() * this.m11 + right.m21() * this.m12;
        d.m21 = right.m21();
        double _buf4 = right.m02() * this.m00 + right.m12() * this.m01 + right.m22() * this.m02;
        d.m12 = right.m02() * this.m10 + right.m12() * this.m11 + right.m22() * this.m12;
        d.m22 = right.m22();
        d.m00 = _buf0;
        d.m10 = _buf1;
    ...
    private Double3x3 mul_orthogonal_translation(Double3x3R right, @Mutated Double3x3 dest, int _props) {
        ...
        d.m21 = 0.0;
        double _buf4 = right.m02() * this.m00 + (right.m12() * this.m01 + this.m02);
    ...
    private Double3x3 mul_orthogonal_affine(Double3x3R right, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _buf0 = right.m00() * this.m11 - right.m10() * this.m10;
        double _buf1 = right.m00() * this.m10 + right.m10() * this.m11;
        d.m20 = 0.0;
        double _buf2 = right.m01() * this.m11 - right.m11() * this.m10;
        double _buf3 = right.m01() * this.m10 + right.m11() * this.m11;
        d.m21 = 0.0;
        double _buf4 = right.m02() * this.m11 + this.m02 - right.m12() * this.m10;
        d.m12 = right.m02() * this.m10 + (right.m12() * this.m11 + this.m12);
        d.m22 = 1.0;
        d.m00 = _buf0;
        d.m10 = _buf1;
    ...
    private Double3x3 mul_affine_affine(Double3x3R right, @Mutated Double3x3 dest) {
        ...
        double _buf1 = right.m00() * this.m10 + right.m10() * this.m11;
        d.m20 = 0.0;
        double _buf2 = right.m01() * this.m00 + right.m11() * this.m01;
        double _buf3 = right.m01() * this.m10 + right.m11() * this.m11;
        d.m21 = 0.0;
        double _buf4 = right.m02() * this.m00 + (right.m12() * this.m01 + this.m02);
        d.m12 = right.m02() * this.m10 + (right.m12() * this.m11 + this.m12);
    ...
    private Double3x3 mul_general_translation(Double3x3R right, @Mutated Double3x3 dest) {
        ...
        double _buf6 = right.m02() * this.m00 + (right.m12() * this.m01 + this.m02);
        double _buf7 = right.m02() * this.m10 + (right.m12() * this.m11 + this.m12);
    ...
    private Double3x3 mul_general_affine(Double3x3R right, @Mutated Double3x3 dest) {
        ...
        double _buf3 = right.m01() * this.m00 + right.m11() * this.m01;
        double _buf4 = right.m01() * this.m10 + right.m11() * this.m11;
        double _buf5 = right.m01() * this.m20 + right.m11() * this.m21;
        double _buf6 = right.m02() * this.m00 + (right.m12() * this.m01 + this.m02);
        double _buf7 = right.m02() * this.m10 + (right.m12() * this.m11 + this.m12);
        d.m22 = right.m02() * this.m20 + (right.m12() * this.m21 + this.m22);
        d.m00 = _buf0;
    ...
    public Double3x3 mul(double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22, @Mutated Double3x3 dest) {
        ...
        double _buf1 = m00 * this.m10 + m10 * this.m11 + m20 * this.m12;
        double _buf2 = m00 * this.m20 + m10 * this.m21 + m20 * this.m22;
        double _buf3 = m01 * this.m00 + m11 * this.m01 + m21 * this.m02;
        double _buf4 = m01 * this.m10 + m11 * this.m11 + m21 * this.m12;
        double _buf5 = m01 * this.m20 + m11 * this.m21 + m21 * this.m22;
    ...
    private Double3x3 mul_orthogonal(Double2x2R right, @Mutated Double3x3 dest) {
        ...
        double _buf0 = right.m00() * this.m10 + right.m10() * this.m11;
        d.m20 = 0.0;
    ...
    private Double3x3 mul_orthogonal(Double2x3R right, @Mutated Double3x3 dest) {
        ...
        d.m20 = 0.0;
        d.m01 = right.m01() * this.m11 - right.m11() * this.m10;
        double _buf1 = right.m01() * this.m10 + right.m11() * this.m11;
        d.m21 = 0.0;
    ...
    private Double3x3 preMul_general(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _r11 = this.m22;
        double _r12 = other.m10();
        double _r13 = other.m11();
        double _r14 = other.m12();
        double _r15 = other.m20();
        double _r16 = other.m21();
    ...
    private Double3x3 preMul_translation(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        double _buf6 = other.m00() * this.m02 + (other.m01() * this.m12 + other.m02());
        double _buf7 = other.m10() * this.m02 + (other.m11() * this.m12 + other.m12());
    ...
    private void preMul_orthogonal_s1154904e_c0(Double3x3Impl _dst, double _r0, double _r1, double _r2, double _r3, double _r7, double _r8, double _r10, double _r11) {
        ...
        _dst.m10 = _r7 * _r1 + _r8 * _r3;
        _dst.m20 = _r10 * _r1 + _r11 * _r3;
    }
    ...
    private void preMul_orthogonal_s1154904e_c1(Double3x3Impl _dst, double _r2, double _r1, double _r0, double _r3, double _r8, double _r7, double _r11, double _r10) {
        _dst.m01 = _r2 * _r1 - _r0 * _r3;
        _dst.m11 = _r8 * _r1 - _r7 * _r3;
        _dst.m21 = _r11 * _r1 - _r10 * _r3;
    }
    ...
    private void preMul_orthogonal_s1154904e_c2(Double3x3Impl _dst, double _r0, double _r4, double _r2, double _r5, double _r6, double _r7, double _r8, double _r9, double _r10, double _r11, double _r12) {
        _dst.m02 = _r0 * _r4 + (_r2 * _r5 + _r6);
        _dst.m12 = _r7 * _r4 + (_r8 * _r5 + _r9);
        _dst.m22 = _r10 * _r4 + (_r11 * _r5 + _r12);
    }
    ...
    private void preMul_affine_s1154904e_c0(Double3x3Impl _dst, double _r0, double _r1, double _r2, double _r3, double _r9, double _r10, double _r12, double _r13) {
        _dst.m00 = _r0 * _r1 + _r2 * _r3;
        _dst.m10 = _r9 * _r1 + _r10 * _r3;
        _dst.m20 = _r12 * _r1 + _r13 * _r3;
    }
    ...
    private void preMul_affine_s1154904e_c1(Double3x3Impl _dst, double _r0, double _r4, double _r2, double _r5, double _r9, double _r10, double _r12, double _r13) {
        ...
        _dst.m11 = _r9 * _r4 + _r10 * _r5;
        _dst.m21 = _r12 * _r4 + _r13 * _r5;
    }
    ...
    private void preMul_affine_s1154904e_c2(Double3x3Impl _dst, double _r0, double _r6, double _r2, double _r7, double _r8, double _r9, double _r10, double _r11, double _r12, double _r13, double _r14) {
        _dst.m02 = _r0 * _r6 + (_r2 * _r7 + _r8);
        _dst.m12 = _r9 * _r6 + (_r10 * _r7 + _r11);
        _dst.m22 = _r12 * _r6 + (_r13 * _r7 + _r14);
    }
    ...
    private Double3x3 preMul_translation_affine(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        d.m21 = 0.0;
        double _buf4 = other.m00() * this.m02 + (other.m01() * this.m12 + other.m02());
    ...
    private Double3x3 preMul_orthogonal_affine(Double3x3R other, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _buf0 = other.m00() * this.m11 + other.m01() * this.m10;
        double _buf1 = other.m10() * this.m11 + other.m11() * this.m10;
        d.m20 = 0.0;
        double _buf2 = other.m01() * this.m11 - other.m00() * this.m10;
        double _buf3 = other.m11() * this.m11 - other.m10() * this.m10;
        d.m21 = 0.0;
        double _buf4 = other.m00() * this.m02 + (other.m01() * this.m12 + other.m02());
        d.m12 = other.m10() * this.m02 + (other.m11() * this.m12 + other.m12());
        d.m22 = 1.0;
    ...
    private Double3x3 preMul_affine_affine(Double3x3R other, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _buf0 = other.m00() * this.m00 + other.m01() * this.m10;
        double _buf1 = other.m10() * this.m00 + other.m11() * this.m10;
        d.m20 = 0.0;
        double _buf2 = other.m00() * this.m01 + other.m01() * this.m11;
        double _buf3 = other.m10() * this.m01 + other.m11() * this.m11;
        d.m21 = 0.0;
        double _buf4 = other.m00() * this.m02 + (other.m01() * this.m12 + other.m02());
        d.m12 = other.m10() * this.m02 + (other.m11() * this.m12 + other.m12());
        d.m22 = 1.0;
    ...
    private Double3x3 preMul_general_affine(Double3x3R other, @Mutated Double3x3 dest) {
        ...
        d.m20 = this.m20;
        double _buf2 = other.m00() * this.m01 + other.m01() * this.m11 + other.m02() * this.m21;
        double _buf3 = other.m10() * this.m01 + other.m11() * this.m11 + other.m12() * this.m21;
        d.m21 = this.m21;
        double _buf4 = other.m00() * this.m02 + other.m01() * this.m12 + other.m02() * this.m22;
    ...
    public Double3x3 preMul(double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22, @Mutated Double3x3 dest) {
        ...
        double _buf1 = m10 * this.m00 + m11 * this.m10 + m12 * this.m20;
        d.m20 = m20 * this.m00 + m21 * this.m10 + m22 * this.m20;
        double _buf2 = m00 * this.m01 + m01 * this.m11 + m02 * this.m21;
        double _buf3 = m10 * this.m01 + m11 * this.m11 + m12 * this.m21;
        d.m21 = m20 * this.m01 + m21 * this.m11 + m22 * this.m21;
        double _buf4 = m00 * this.m02 + m01 * this.m12 + m02 * this.m22;
        double _buf5 = m10 * this.m02 + m11 * this.m12 + m12 * this.m22;
    ...
    private Double3x3 preMul_translation(Double2x2R other, @Mutated Double3x3 dest) {
        ...
        d.m11 = other.m11();
        d.m21 = 0.0;
        double _buf0 = other.m00() * this.m02 + other.m01() * this.m12;
    ...
    private Double3x3 preMul_orthogonal(Double2x2R other, @Mutated Double3x3 dest) {
        ...
        double _buf0 = other.m10() * this.m11 + other.m11() * this.m10;
        d.m20 = 0.0;
        d.m01 = other.m01() * this.m11 - other.m00() * this.m10;
        d.m11 = other.m11() * this.m11 - other.m10() * this.m10;
        d.m21 = 0.0;
        double _buf1 = other.m00() * this.m02 + other.m01() * this.m12;
        d.m12 = other.m10() * this.m02 + other.m11() * this.m12;
        d.m22 = 1.0;
        d.m10 = _buf0;
        d.m02 = _buf1;
    ...
    private Double3x3 preMul_affine(Double2x2R other, @Mutated Double3x3 dest) {
        ...
        d.m20 = 0.0;
        double _buf1 = other.m00() * this.m01 + other.m01() * this.m11;
        d.m11 = other.m10() * this.m01 + other.m11() * this.m11;
        d.m21 = 0.0;
        double _buf2 = other.m00() * this.m02 + other.m01() * this.m12;
        d.m12 = other.m10() * this.m02 + other.m11() * this.m12;
        d.m22 = 1.0;
        d.m00 = _buf0;
        d.m01 = _buf1;
    ...
    private Double3x3 preMul_translation(Double2x3R other, @Mutated Double3x3 dest) {
        ...
        d.m11 = other.m11();
        d.m21 = 0.0;
        double _buf0 = other.m00() * this.m02 + (other.m01() * this.m12 + other.m02());
        d.m12 = other.m10() * this.m02 + (other.m11() * this.m12 + other.m12());
        d.m22 = 1.0;
        d.m02 = _buf0;
    ...
    private Double3x3 preMul_orthogonal(Double2x3R other, @Mutated Double3x3 dest) {
        ...
        d.m11 = other.m11() * this.m11 - other.m10() * this.m10;
        d.m21 = 0.0;
        double _buf1 = other.m00() * this.m02 + (other.m01() * this.m12 + other.m02());
        d.m12 = other.m10() * this.m02 + (other.m11() * this.m12 + other.m12());
        d.m22 = 1.0;
        d.m10 = _buf0;
        d.m02 = _buf1;
    ...
    private Double3x3 preMul_affine(Double2x3R other, @Mutated Double3x3 dest) {
        ...
        d.m11 = other.m10() * this.m01 + other.m11() * this.m11;
        d.m21 = 0.0;
        double _buf2 = other.m00() * this.m02 + (other.m01() * this.m12 + other.m02());
        d.m12 = other.m10() * this.m02 + (other.m11() * this.m12 + other.m12());
        d.m22 = 1.0;
        d.m00 = _buf0;
        d.m01 = _buf1;
    ...
    private Double3x3 addScaled_general(Double3x3R other, double weight, @Mutated Double3x3 dest) {
        ...
        d.m22 = weight * other.m22() + this.m22;
        d.properties = 0;
        return d;
    }
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double3x3 addScaled_translation(Double3x3R other, double weight, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        d.m00 = weight * other.m00() + 1.0;
        d.m10 = weight * other.m10();
        d.m20 = weight * other.m20();
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double3x3 addScaled_general_affine(Double3x3R other, double weight, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        d.m00 = weight * other.m00() + this.m00;
        d.m10 = weight * other.m10() + this.m10;
        d.m20 = this.m20;
    ...
    public Double3x3 addScaled(Double3x3R other, double weight, @Mutated Double3x3 dest) {
        ...
        if ((q & Joml.BIT_AFFINE) == Joml.BIT_AFFINE) return addScaled_general_affine(other, weight, dest);
        return addScaled_general(other, weight, dest);
    }
    ...
    @Mutated public Double3x3 addScaled(Double3x3R other, double weight) {
        ...
        if ((q & Joml.BIT_AFFINE) == Joml.BIT_AFFINE) return addScaled_general_affine(other, weight, this);
        return addScaled_general(other, weight, this);
    }
    ...
    private Double3x3 lookAlong_identity(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated Double3x3 dest) {
        ...
        double _t7 = dirY * _t5;
        double _t8 = dirX * _t5;
        double _t15 = upY * _t6 - upZ * _t7;
        double _t16 = upZ * _t8 - upX * _t6;
        double _t17 = upX * _t7 - upY * _t8;
        double _ct0 = _t15 * _t15 + _t16 * _t16 + _t17 * _t17;
        if (!(_ct0 > 0.0)) return lookAlong_degenerate(dirX, dirY, dirZ, upX, upY, upZ, dest);
        double _t24 = (1.0 / Math.sqrt(_ct0));
        double _t25 = _t15 * _t24;
        double _t26 = _t17 * _t24;
        double _t27 = _t16 * _t24;
        d.m00 = _t25;
        d.m10 = _t27;
        d.m20 = _t26;
    ...
    private Double3x3 lookAlong_translation(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated Double3x3 dest) {
        ...
        double _t7 = dirX * _t5;
        double _t8 = dirZ * _t5;
        double _t15 = upX * _t6 - upY * _t7;
        double _t16 = upY * _t8 - upZ * _t6;
        double _t17 = upZ * _t7 - upX * _t8;
        double _ct0 = _t16 * _t16 + _t17 * _t17 + _t15 * _t15;
        if (!(_ct0 > 0.0)) return lookAlong_degenerate(dirX, dirY, dirZ, upX, upY, upZ, dest);
        double _t24 = (1.0 / Math.sqrt(_ct0));
        double _t25 = _t15 * _t24;
        double _t26 = _t16 * _t24;
        double _t27 = _t17 * _t24;
        double _t30 = _t7 * _t27 - _t6 * _t26;
        d.m00 = this.m02 * _t25 + _t26;
        d.m10 = this.m12 * _t25 + _t27;
        d.m20 = _t25;
        d.m01 = _t6 * _t25 - _t8 * _t27 + this.m02 * _t30;
        d.m11 = _t8 * _t26 - _t7 * _t25 + this.m12 * _t30;
        d.m21 = _t30;
        d.m02 = _t7 + this.m02 * _t8;
        d.m12 = _t6 + this.m12 * _t8;
        d.m22 = _t8;
        d.properties = 0;
        return d;
    }
    ...
    private Double3x3 lookAlong_orthogonal(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated Double3x3 dest) {
        Double3x3Impl d = (Double3x3Impl) dest;
        double _t0 = dirZ * this.m10;
        double _t1 = dirX * this.m10;
        double _t2 = dirY * this.m11;
        double _t3 = dirZ * this.m11;
        double _t4 = dirX * dirX;
        double _t5 = dirY * dirY;
        double _t7 = dirY * this.m10;
        double _t8 = dirX * this.m11;
        double _t9 = dirX * dirZ;
        double _t10 = dirY * dirZ;
        double _t11 = dirY * _t1;
        double _t12 = dirY * _t8;
        double _t13 = dirZ * _t0;
        double _t14 = dirZ * _t3;
        double _t17 = (1.0 / Math.sqrt(_t4 + _t5 + dirZ * dirZ));
        double _t18 = dirZ * _t17;
        double _t19 = dirY * _t17;
        double _sp9 = _t19 * upX;
        double _t20 = dirX * _t17;
        double _sp10 = upY * _t20;
        double _t27 = upY * _t18 - upZ * _t19;
        double _t28 = upZ * _t20 - upX * _t18;
        double _t29 = _sp9 - _sp10;
        double _ct0 = _t27 * _t27 + _t28 * _t28 + _t29 * _t29;
        if (!(_ct0 > 0.0)) return lookAlong_degenerate(dirX, dirY, dirZ, upX, upY, upZ, dest);
        double _sp0 = _t17 * (1.0 / Math.sqrt(_ct0));
        double _sp14 = _t18 * _sp0;
        double _sp1 = _t17 * _sp0;
        double _sp16 = upX * _sp1;
        double _sp15 = upY * _sp1;
        double _sp4 = this.m12 * _sp1;
        d.m00 = (upX * _t0 - upZ * _t1 - upZ * _t2 + upY * _t3 - upY * dirX * this.m02 + upX * dirY * this.m02) * _sp0;
        d.m10 = (upY * _t0 - upZ * _t7 + upZ * _t8 - upX * _t3 - upY * dirX * this.m12 + upX * dirY * this.m12) * _sp0;
        d.m20 = (dirY * upX - dirX * upY) * _sp0;
        d.m01 = (upX * _t11 + (upZ * dirZ * _t7 - upY * dirX * _t1) + (-(upY * _t12) - upZ * dirZ * _t8 - upY * _t13) + (upX * dirY * _t2 + (upX * _t14 - upX * this.m02 * _t9) + (upZ * this.m02 * _t4 + (upZ * this.m02 * _t5 - upY * this.m02 * _t10)))) * _sp1;
        d.m11 = _sp9 * _t7 * _sp0 - _t1 * upZ * _sp14 - _sp15 * _t11 + (_sp16 * _t13 + (_sp10 * _t8 * _sp0 - _sp16 * _t12)) + (_sp15 * _t14 - upX * _t9 * _sp4 - upZ * _t2 * _sp14 + (upZ * _t4 * _sp4 + (upZ * _t5 * _sp4 - upY * _t10 * _sp4)));
        d.m21 = (upZ * _t4 - upX * _t9 - upY * _t10 + upZ * _t5) * _sp1;
        d.m02 = (_t8 - _t7 + dirZ * this.m02) * _t17;
        d.m12 = (_t1 + _t2 + dirZ * this.m12) * _t17;
        d.m22 = _t18;
        d.properties = 0;
        return d;
    }
    ...
    private void lookAlong_affine_s2d83ce2f_c0(Double3x3Impl _dst, double _r0, double _t25, double _r1, double _t26, double _r2, double _t27, double _r3, double _r4, double _r5) {
        _dst.m00 = _r0 * _t25 + _r1 * _t26 + _r2 * _t27;
        _dst.m10 = _r3 * _t25 + _r4 * _t26 + _r5 * _t27;
        _dst.m20 = _t27;
    }

    /** Private column 1 of {@code lookAlong_affine}: computes and stores it; reached only through it. */
    private void lookAlong_affine_s2d83ce2f_c1(Double3x3Impl _dst, double _r0, double _t34, double _r1, double _t35, double _r2, double _t36, double _r3, double _r4, double _r5) {
        _dst.m01 = _r0 * _t34 + _r1 * _t35 + _r2 * _t36;
        _dst.m11 = _r3 * _t34 + _r4 * _t35 + _r5 * _t36;
        _dst.m21 = _t36;
    }

    /** Private column 2 of {@code lookAlong_affine}: computes and stores it; reached only through it. */
    private void lookAlong_affine_s2d83ce2f_c2(Double3x3Impl _dst, double _r0, double _t8, double _r1, double _t7, double _r2, double _t6, double _r3, double _r4, double _r5) {
        _dst.m02 = _r0 * _t8 + _r1 * _t7 + _r2 * _t6;
        _dst.m12 = _r3 * _t8 + _r4 * _t7 + _r5 * _t6;
        _dst.m22 = _t6;
    }

    /** Private tail of {@code lookAlong_affine}; reached only through it. */
    private void lookAlong_affine_s2d83ce2f_tail(Double3x3Impl _dst, double _t8, double _t26, double _t7, double _t25, double _r0, double _r1, double _r2, double _t27, double _t34, double _t35, double _t6, double _r3, double _r4, double _r5) {
        double _t36 = _t8 * _t26 - _t7 * _t25;
        lookAlong_affine_s2d83ce2f_c0(_dst, _r0, _t25, _r1, _t26, _r2, _t27, _r3, _r4, _r5);
        lookAlong_affine_s2d83ce2f_c1(_dst, _r0, _t34, _r1, _t35, _r2, _t36, _r3, _r4, _r5);
        lookAlong_affine_s2d83ce2f_c2(_dst, _r0, _t8, _r1, _t7, _r2, _t6, _r3, _r4, _r5);
    }
    ...
    private Double3x3 lookAlong_affine(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated Double3x3 dest) {
        ...
        double _t26 = _t16 * _t24;
        double _t27 = _t17 * _t24;
        double _t34 = _t7 * _t27 - _t6 * _t26;
        double _t35 = _t6 * _t25 - _t8 * _t27;
        lookAlong_affine_s2d83ce2f_tail(d, _t8, _t26, _t7, _t25, _r0, _r1, _r2, _t27, _t34, _t35, _t6, _r3, _r4, _r5);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code lookAlong_general}: computes and stores it; reached only through it. */
    private void lookAlong_general_s2d83ce2f_c0(Double3x3Impl _dst, double _r0, double _t25, double _r1, double _t26, double _r2, double _t27, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t25 + _r1 * _t26 + _r2 * _t27;
        _dst.m10 = _r3 * _t25 + _r4 * _t26 + _r5 * _t27;
        _dst.m20 = _r6 * _t25 + _r7 * _t26 + _r8 * _t27;
    }

    /** Private column 1 of {@code lookAlong_general}: computes and stores it; reached only through it. */
    private void lookAlong_general_s2d83ce2f_c1(Double3x3Impl _dst, double _r0, double _t34, double _r1, double _t35, double _r2, double _t36, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m01 = _r0 * _t34 + _r1 * _t35 + _r2 * _t36;
        _dst.m11 = _r3 * _t34 + _r4 * _t35 + _r5 * _t36;
        _dst.m21 = _r6 * _t34 + _r7 * _t35 + _r8 * _t36;
    }

    /** Private column 2 of {@code lookAlong_general}: computes and stores it; reached only through it. */
    private void lookAlong_general_s2d83ce2f_c2(Double3x3Impl _dst, double _r0, double _t8, double _r1, double _t7, double _r2, double _t6, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t8 + _r1 * _t7 + _r2 * _t6;
        _dst.m12 = _r3 * _t8 + _r4 * _t7 + _r5 * _t6;
        _dst.m22 = _r6 * _t8 + _r7 * _t7 + _r8 * _t6;
    }

    /** Private tail of {@code lookAlong_general}; reached only through it. */
    private void lookAlong_general_s2d83ce2f_tail(Double3x3Impl _dst, double _t7, double _t27, double _t6, double _t26, double _t25, double _t8, double _r0, double _r1, double _r2, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        double _t34 = _t7 * _t27 - _t6 * _t26;
        double _t35 = _t6 * _t25 - _t8 * _t27;
        double _t36 = _t8 * _t26 - _t7 * _t25;
        lookAlong_general_s2d83ce2f_c0(_dst, _r0, _t25, _r1, _t26, _r2, _t27, _r3, _r4, _r5, _r6, _r7, _r8);
        lookAlong_general_s2d83ce2f_c1(_dst, _r0, _t34, _r1, _t35, _r2, _t36, _r3, _r4, _r5, _r6, _r7, _r8);
        lookAlong_general_s2d83ce2f_c2(_dst, _r0, _t8, _r1, _t7, _r2, _t6, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 lookAlong_general(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated Double3x3 dest) {
        ...
        double _t26 = _t16 * _t24;
        double _t27 = _t17 * _t24;
        lookAlong_general_s2d83ce2f_tail(d, _t7, _t27, _t6, _t26, _t25, _t8, _r0, _r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    private void lookAlong_degenerate_s2d83ce2f_c0(Double3x3Impl _dst, double _r0, double _t47, double _r1, double _t48, double _r2, double _t46, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t47 + _r1 * _t48 + _r2 * _t46;
        _dst.m10 = _r3 * _t47 + _r4 * _t48 + _r5 * _t46;
        _dst.m20 = _r6 * _t47 + _r7 * _t48 + _r8 * _t46;
    }

    /** Private column 1 of {@code lookAlong_degenerate}: computes and stores it; reached only through it. */
    private void lookAlong_degenerate_s2d83ce2f_c1(Double3x3Impl _dst, double _r0, double _t56, double _r1, double _t55, double _r2, double _t57, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m01 = _r0 * _t56 + _r1 * _t55 + _r2 * _t57;
        _dst.m11 = _r3 * _t56 + _r4 * _t55 + _r5 * _t57;
        _dst.m21 = _r6 * _t56 + _r7 * _t55 + _r8 * _t57;
    }

    /** Private column 2 of {@code lookAlong_degenerate}: computes and stores it; reached only through it. */
    private void lookAlong_degenerate_s2d83ce2f_c2(Double3x3Impl _dst, double _r0, double _t12, double _r1, double _t14, double _r2, double _t13, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t12 + _r1 * _t14 + _r2 * _t13;
        _dst.m12 = _r3 * _t12 + _r4 * _t14 + _r5 * _t13;
        _dst.m22 = _r6 * _t12 + _r7 * _t14 + _r8 * _t13;
    }

    /** Private tail of {@code lookAlong_degenerate}; reached only through it. */
    private void lookAlong_degenerate_s2d83ce2f_tail(Double3x3Impl _dst, double _t4, double upZ, double upX, double upY, double dirX, double _t5, double dirZ, double dirY, double _r0, double _r1, double _r2, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        ...
        lookAlong_degenerate_s2d83ce2f_tail2(_dst, _t27, _t28, _t29, _t26, _t30, _t25, _t13, _t12, _t14, _r0, _r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8);
    }

    /** Private tail of {@code lookAlong_degenerate}; reached only through it. */
    private void lookAlong_degenerate_s2d83ce2f_tail2(Double3x3Impl _dst, double _t27, double _t28, double _t29, double _t26, double _t30, double _t25, double _t13, double _t12, double _t14, double _r0, double _r1, double _r2, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        ...
        double _t55 = _t47 * _t13 - _t46 * _t12;
        double _t56 = _t46 * _t14 - _t48 * _t13;
        double _t57 = _t48 * _t12 - _t47 * _t14;
        lookAlong_degenerate_s2d83ce2f_c0(_dst, _r0, _t47, _r1, _t48, _r2, _t46, _r3, _r4, _r5, _r6, _r7, _r8);
        lookAlong_degenerate_s2d83ce2f_c1(_dst, _r0, _t56, _r1, _t55, _r2, _t57, _r3, _r4, _r5, _r6, _r7, _r8);
        lookAlong_degenerate_s2d83ce2f_c2(_dst, _r0, _t12, _r1, _t14, _r2, _t13, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 lookAlong_degenerate(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated Double3x3 dest) {
        ...
        double _t5 = (1.0 / Math.sqrt(_t4));
        lookAlong_degenerate_s2d83ce2f_tail(d, _t4, upZ, upX, upY, dirX, _t5, dirZ, dirY, _r0, _r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    @Mutated public Double3x3 makeRotationAxis(double angle, double axisX, double axisY, double axisZ) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _t3 = axisZ * _t0;
        double _t4 = axisY * _t0;
        double _t7 = axisX * _t0;
        double _t8 = 1.0 - _t1;
        double _sp1 = axisY * _t8;
        double _sp0 = axisX * _t8;
        double _t9 = _sp0 * axisY;
        double _t10 = _sp0 * axisZ;
        double _t11 = _sp1 * axisZ;
    ...
    private Double3x3 preRotateAround_general(double angle, double pivotX, double pivotY, @Mutated Double3x3 dest) {
        ...
        double _buf0 = this.m00 * _t2 - this.m10 * _t0 + this.m20 * _t10;
        d.m10 = this.m00 * _t0 + this.m10 * _t2 + this.m20 * _t11;
        d.m20 = this.m20;
        double _buf1 = this.m01 * _t2 - this.m11 * _t0 + this.m21 * _t10;
        d.m11 = this.m01 * _t0 + this.m11 * _t2 + this.m21 * _t11;
        d.m21 = this.m21;
        double _buf2 = this.m02 * _t2 - this.m12 * _t0 + this.m22 * _t10;
    ...
    private Double3x3 preRotateAxis_translation(double angle, double axisX, double axisY, double axisZ, @Mutated Double3x3 dest) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _t4 = axisZ * _t0;
        double _t5 = axisY * _t0;
        double _t9 = axisX * _t0;
        double _t10 = 1.0 - _t1;
        double _sp1 = axisY * _t10;
        double _sp0 = axisX * _t10;
        double _t12 = _sp0 * axisY;
        double _t13 = _sp0 * axisZ;
        double _t15 = _sp1 * axisZ;
        double _t16 = _sp0 * axisX + _t1;
        double _t17 = _sp1 * axisY + _t1;
        double _t18 = _t12 - _t4;
        double _t19 = _t4 + _t12;
        double _t20 = _t13 - _t5;
        double _t21 = _t9 + _t15;
        d.m00 = _t16;
        d.m10 = _t19;
        d.m20 = _t20;
        d.m01 = _t18;
        d.m11 = _t17;
        d.m21 = _t21;
        double _buf0 = _t5 + _t13 + (this.m02 * _t16 + this.m12 * _t18);
        double _buf1 = this.m02 * _t19 + this.m12 * _t17 + (_t15 - _t9);
    ...
    private void preRotateAxis_orthogonal_s140fcbd8_c0(Double3x3Impl _dst, double _r0, double _t16, double _r1, double _t18, double _t19, double _t17, double _t20, double _t21) {
    ...
    private void preRotateAxis_orthogonal_s140fcbd8_c1(Double3x3Impl _dst, double _r2, double _t16, double _r3, double _t18, double _t19, double _t17, double _t20, double _t21) {
    ...
    private void preRotateAxis_orthogonal_s140fcbd8_c2(Double3x3Impl _dst, double _t5, double _t13, double _r4, double _t16, double _r5, double _t18, double _t19, double _t17, double _t15, double _t9, double _t20, double _t21, double _t10, double axisZ, double _t1) {
    ...
    private void preRotateAxis_orthogonal_s140fcbd8_tail(Double3x3Impl _dst, double _t9, double _t15, double _r0, double _t16, double _r1, double _t18, double _r2, double _r3, double _t5, double _t13, double _r4, double _r5, double _t19, double _t17, double _t20, double _t10, double axisZ, double _t1) {
        double _t21 = _t9 + _t15;
        preRotateAxis_orthogonal_s140fcbd8_c0(_dst, _r0, _t16, _r1, _t18, _t19, _t17, _t20, _t21);
        preRotateAxis_orthogonal_s140fcbd8_c1(_dst, _r2, _t16, _r3, _t18, _t19, _t17, _t20, _t21);
        preRotateAxis_orthogonal_s140fcbd8_c2(_dst, _t5, _t13, _r4, _t16, _r5, _t18, _t19, _t17, _t15, _t9, _t20, _t21, _t10, axisZ, _t1);
    }
    ...
    private Double3x3 preRotateAxis_orthogonal(double angle, double axisX, double axisY, double axisZ, @Mutated Double3x3 dest) {
        ...
        double _t19 = _t4 + _t12;
        double _t20 = _t13 - _t5;
        preRotateAxis_orthogonal_s140fcbd8_tail(d, _t9, _t15, _r0, _t16, _r1, _t18, _r2, _r3, _t5, _t13, _r4, _r5, _t19, _t17, _t20, _t10, axisZ, _t1);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code preRotateAxis_general}: computes and stores it; reached only through it. */
    private void preRotateAxis_general_s140fcbd8_c0(Double3x3Impl _dst, double _r0, double _t18, double _r1, double _t21, double _r2, double _t22, double _t23, double _t19, double _t24, double _t25, double _t26, double _t20) {
    ...
    private void preRotateAxis_general_s140fcbd8_c1(Double3x3Impl _dst, double _r3, double _t18, double _r4, double _t21, double _r5, double _t22, double _t23, double _t19, double _t24, double _t25, double _t26, double _t20) {
    ...
    private void preRotateAxis_general_s140fcbd8_c2(Double3x3Impl _dst, double _r6, double _t18, double _r7, double _t21, double _r8, double _t22, double _t23, double _t19, double _t24, double _t25, double _t26, double _t20) {
    ...
    private void preRotateAxis_general_s140fcbd8_tail(Double3x3Impl _dst, double _t16, double _t9, double _t14, double _t5, double _r0, double _t18, double _r1, double _t21, double _r2, double _t22, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8, double _t23, double _t19, double _t20) {
        double _t24 = _t16 - _t9;
        double _t25 = _t14 - _t5;
        double _t26 = _t9 + _t16;
        preRotateAxis_general_s140fcbd8_c0(_dst, _r0, _t18, _r1, _t21, _r2, _t22, _t23, _t19, _t24, _t25, _t26, _t20);
        preRotateAxis_general_s140fcbd8_c1(_dst, _r3, _t18, _r4, _t21, _r5, _t22, _t23, _t19, _t24, _t25, _t26, _t20);
        preRotateAxis_general_s140fcbd8_c2(_dst, _r6, _t18, _r7, _t21, _r8, _t22, _t23, _t19, _t24, _t25, _t26, _t20);
    }
    ...
    private Double3x3 preRotateAxis_general(double angle, double axisX, double axisY, double axisZ, @Mutated Double3x3 dest) {
        ...
        double _t9 = axisX * _t0;
        double _t11 = 1.0 - _t1;
        double _sp1 = axisY * _t11;
        double _sp0 = axisX * _t11;
        double _t13 = _sp0 * axisY;
        double _t14 = _sp0 * axisZ;
        double _t16 = _sp1 * axisZ;
        double _t18 = _sp0 * axisX + _t1;
        double _t19 = _sp1 * axisY + _t1;
        double _t20 = _t11 * axisZ * axisZ + _t1;
        double _t21 = _t13 - _t4;
        double _t22 = _t5 + _t14;
        double _t23 = _t4 + _t13;
        preRotateAxis_general_s140fcbd8_tail(d, _t16, _t9, _t14, _t5, _r0, _t18, _r1, _t21, _r2, _t22, _r3, _r4, _r5, _r6, _r7, _r8, _t23, _t19, _t20);
        d.properties = 0;
        return d;
    }
    ...
    public Double3x3 preRotateX(double angle, @Mutated Double3x3 dest) {
        ...
        double _t1 = Math.cosFromSin(_t0, angle);
        d.m00 = this.m00;
        double _buf0 = this.m10 * _t1 - this.m20 * _t0;
        d.m20 = this.m10 * _t0 + this.m20 * _t1;
        d.m01 = this.m01;
        double _buf1 = this.m11 * _t1 - this.m21 * _t0;
        d.m21 = this.m11 * _t0 + this.m21 * _t1;
        d.m02 = this.m02;
        double _buf2 = this.m12 * _t1 - this.m22 * _t0;
    ...
    public Double3x3 preRotateY(double angle, @Mutated Double3x3 dest) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _buf0 = this.m00 * _t1 + this.m20 * _t0;
        d.m10 = this.m10;
        d.m20 = this.m20 * _t1 - this.m00 * _t0;
        double _buf1 = this.m01 * _t1 + this.m21 * _t0;
        d.m11 = this.m11;
        d.m21 = this.m21 * _t1 - this.m01 * _t0;
        double _buf2 = this.m02 * _t1 + this.m22 * _t0;
        d.m12 = this.m12;
    ...
    private Double3x3 preScaleAround_general(double s, double pivotX, double pivotY, @Mutated Double3x3 dest) {
        ...
        d.m00 = s * this.m00 + this.m20 * _t1;
        d.m10 = s * this.m10 + this.m20 * _t2;
        d.m20 = this.m20;
        d.m01 = s * this.m01 + this.m21 * _t1;
        d.m11 = s * this.m11 + this.m21 * _t2;
        d.m21 = this.m21;
        d.m02 = s * this.m02 + this.m22 * _t1;
        d.m12 = s * this.m12 + this.m22 * _t2;
        d.m22 = this.m22;
        d.properties = 0;
        return d;
    }
    ...
    private Double3x3 preScaleAround_translation(double sX, double sY, double pivotX, double pivotY, @Mutated Double3x3 dest) {
        ...
        d.m11 = sY;
        d.m21 = 0.0;
        d.m02 = pivotX * (1.0 - sX) + sX * this.m02;
        d.m12 = pivotY * (1.0 - sY) + sY * this.m12;
        d.m22 = 1.0;
        d.properties = Joml.BIT_AFFINE;
        return d;
    }
    ...
    private Double3x3 rotate_general(double angle, @Mutated Double3x3 dest) {
        ...
        double _buf0 = this.m00 * _t1 + this.m01 * _t0;
        double _buf1 = this.m10 * _t1 + this.m11 * _t0;
        double _buf2 = this.m20 * _t1 + this.m21 * _t0;
        d.m01 = this.m01 * _t1 - this.m00 * _t0;
        d.m11 = this.m11 * _t1 - this.m10 * _t0;
    ...
    private Double3x3 rotateAround_general(double angle, double pivotX, double pivotY, @Mutated Double3x3 dest) {
        ...
        double _buf0 = this.m00 * _t2 + this.m01 * _t0;
        double _buf1 = this.m10 * _t2 + this.m11 * _t0;
        double _buf2 = this.m20 * _t2 + this.m21 * _t0;
        double _buf3 = this.m01 * _t2 - this.m00 * _t0;
        double _buf4 = this.m11 * _t2 - this.m10 * _t0;
        double _buf5 = this.m21 * _t2 - this.m20 * _t0;
        d.m02 = this.m00 * _t10 + (this.m01 * _t11 + this.m02);
        d.m12 = this.m10 * _t10 + (this.m11 * _t11 + this.m12);
    ...
    private Double3x3 rotateAxis_translation(double angle, double axisX, double axisY, double axisZ, @Mutated Double3x3 dest) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _t3 = axisY * _t0;
        double _t5 = axisZ * _t0;
        double _t6 = axisX * _t0;
        double _t9 = 1.0 - _t1;
        double _sp1 = axisY * _t9;
        double _sp0 = axisX * _t9;
        double _t10 = _sp0 * axisZ;
        double _t11 = _sp0 * axisY;
        double _t12 = _sp1 * axisZ;
        double _t14 = _t9 * axisZ * axisZ + _t1;
        double _t15 = _t10 - _t3;
        double _t16 = _t6 + _t12;
        d.m00 = _sp0 * axisX + (this.m02 * _t15 + _t1);
        d.m10 = _t5 + _t11 + this.m12 * _t15;
        d.m20 = _t15;
        d.m01 = _t11 - _t5 + this.m02 * _t16;
        d.m11 = _sp1 * axisY + (this.m12 * _t16 + _t1);
        d.m21 = _t16;
    ...
    private void rotateAxis_orthogonal_s140fcbd8_c0(Double3x3Impl _dst, double _r0, double _t18, double _r1, double _t21, double _r2, double _t22, double _r3, double _r4, double _r5) {
        _dst.m00 = _r0 * _t18 + _r1 * _t21 + _r2 * _t22;
    ...
    private void rotateAxis_orthogonal_s140fcbd8_c1(Double3x3Impl _dst, double _r0, double _t23, double _r1, double _t19, double _r2, double _t24, double _r3, double _r4, double _r5) {
    ...
    private void rotateAxis_orthogonal_s140fcbd8_c2(Double3x3Impl _dst, double _r0, double _t25, double _r1, double _t26, double _r2, double _t20, double _r3, double _r4, double _r5) {
    ...
    private void rotateAxis_orthogonal_s140fcbd8_tail(Double3x3Impl _dst, double _t16, double _t8, double _r0, double _t18, double _r1, double _t21, double _r2, double _t22, double _t23, double _t19, double _t24, double _t25, double _t20, double _r3, double _r4, double _r5) {
        double _t26 = _t16 - _t8;
        rotateAxis_orthogonal_s140fcbd8_c0(_dst, _r0, _t18, _r1, _t21, _r2, _t22, _r3, _r4, _r5);
        rotateAxis_orthogonal_s140fcbd8_c1(_dst, _r0, _t23, _r1, _t19, _r2, _t24, _r3, _r4, _r5);
        rotateAxis_orthogonal_s140fcbd8_c2(_dst, _r0, _t25, _r1, _t26, _r2, _t20, _r3, _r4, _r5);
    }
    ...
    private Double3x3 rotateAxis_orthogonal(double angle, double axisX, double axisY, double axisZ, @Mutated Double3x3 dest) {
        ...
        double _t1 = Math.cosFromSin(_t0, angle);
        double _t3 = axisZ * _t0;
        double _t6 = axisY * _t0;
        double _t8 = axisX * _t0;
        double _t11 = 1.0 - _t1;
        double _sp1 = axisY * _t11;
        double _sp0 = axisX * _t11;
        double _t13 = _sp0 * axisY;
        ...
        double _t19 = _sp1 * axisY + _t1;
        double _t20 = _t11 * axisZ * axisZ + _t1;
        double _t21 = _t3 + _t13;
        double _t22 = _t14 - _t6;
        double _t23 = _t13 - _t3;
        double _t24 = _t8 + _t16;
        double _t25 = _t6 + _t14;
        rotateAxis_orthogonal_s140fcbd8_tail(d, _t16, _t8, _r0, _t18, _r1, _t21, _r2, _t22, _t23, _t19, _t24, _t25, _t20, _r3, _r4, _r5);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code rotateAxis_general}: computes and stores it; reached only through it. */
    private void rotateAxis_general_s140fcbd8_c0(Double3x3Impl _dst, double _r0, double _t18, double _r1, double _t21, double _r2, double _t22, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t18 + _r1 * _t21 + _r2 * _t22;
        _dst.m10 = _r3 * _t18 + _r4 * _t21 + _r5 * _t22;
    ...
    private void rotateAxis_general_s140fcbd8_c1(Double3x3Impl _dst, double _r0, double _t23, double _r1, double _t19, double _r2, double _t24, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m01 = _r0 * _t23 + _r1 * _t19 + _r2 * _t24;
        _dst.m11 = _r3 * _t23 + _r4 * _t19 + _r5 * _t24;
    ...
    private void rotateAxis_general_s140fcbd8_c2(Double3x3Impl _dst, double _r0, double _t25, double _r1, double _t26, double _r2, double _t20, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t25 + _r1 * _t26 + _r2 * _t20;
        _dst.m12 = _r3 * _t25 + _r4 * _t26 + _r5 * _t20;
        _dst.m22 = _r6 * _t25 + _r7 * _t26 + _r8 * _t20;
    }
    ...
    private void rotateAxis_general_s140fcbd8_tail(Double3x3Impl _dst, double _t8, double _t16, double _t6, double _t14, double _r0, double _t18, double _r1, double _t21, double _r2, double _t22, double _t23, double _t19, double _t20, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        double _t24 = _t8 + _t16;
        double _t25 = _t6 + _t14;
        double _t26 = _t16 - _t8;
        rotateAxis_general_s140fcbd8_c0(_dst, _r0, _t18, _r1, _t21, _r2, _t22, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateAxis_general_s140fcbd8_c1(_dst, _r0, _t23, _r1, _t19, _r2, _t24, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateAxis_general_s140fcbd8_c2(_dst, _r0, _t25, _r1, _t26, _r2, _t20, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 rotateAxis_general(double angle, double axisX, double axisY, double axisZ, @Mutated Double3x3 dest) {
        ...
        double _t22 = _t14 - _t6;
        double _t23 = _t13 - _t3;
        rotateAxis_general_s140fcbd8_tail(d, _t8, _t16, _t6, _t14, _r0, _t18, _r1, _t21, _r2, _t22, _t23, _t19, _t20, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    public Double3x3 rotateX(double angle, @Mutated Double3x3 dest) {
        ...
        d.m10 = this.m10;
        d.m20 = this.m20;
        double _buf0 = this.m01 * _t1 + this.m02 * _t0;
        double _buf1 = this.m11 * _t1 + this.m12 * _t0;
        double _buf2 = this.m21 * _t1 + this.m22 * _t0;
    ...
    private Double3x3 rotateXYZ_translation(double angleX, double angleY, double angleZ, @Mutated Double3x3 dest) {
        ...
        double _t8 = _t2 * _t3;
        double _t10 = _t3 * _t5;
        double _t13 = _t0 * _t1 - _t8 * _t4;
        double _t14 = _t8 * _t1 + _t0 * _t4;
    ...
    private void rotateXYZ_orthogonal_s406dbcde_c0(Double3x3Impl _dst, double _r0, double _t14, double _r1, double _t20, double _r2, double _t21, double _r3, double _r4, double _r5) {
    ...
    private void rotateXYZ_orthogonal_s406dbcde_c1(Double3x3Impl _dst, double _r1, double _t22, double _r0, double _t10, double _r2, double _t23, double _r4, double _r3, double _r5) {
    ...
    private void rotateXYZ_orthogonal_s406dbcde_c2(Double3x3Impl _dst, double _r0, double _t0, double _r1, double _t12, double _r2, double _t16, double _r3, double _r4, double _r5) {
    ...
    private void rotateXYZ_orthogonal_s406dbcde_tail(Double3x3Impl _dst, double _t9, double _t1, double _t2, double _t4, double _r0, double _t14, double _r1, double _t20, double _r2, double _t21, double _t22, double _t10, double _t0, double _t12, double _t16, double _r3, double _r4, double _r5) {
        double _t23 = _t9 * _t1 + _t2 * _t4;
        rotateXYZ_orthogonal_s406dbcde_c0(_dst, _r0, _t14, _r1, _t20, _r2, _t21, _r3, _r4, _r5);
        rotateXYZ_orthogonal_s406dbcde_c1(_dst, _r1, _t22, _r0, _t10, _r2, _t23, _r4, _r3, _r5);
        rotateXYZ_orthogonal_s406dbcde_c2(_dst, _r0, _t0, _r1, _t12, _r2, _t16, _r3, _r4, _r5);
    }
    ...
    private Double3x3 rotateXYZ_orthogonal(double angleX, double angleY, double angleZ, @Mutated Double3x3 dest) {
        ...
        double _t14 = _t3 * _t4;
        double _t16 = _t5 * _t3;
        double _t20 = _t6 * _t4 + _t1 * _t5;
        double _t21 = _t2 * _t1 - _t9 * _t4;
        double _t22 = _t5 * _t4 - _t6 * _t1;
        rotateXYZ_orthogonal_s406dbcde_tail(d, _t9, _t1, _t2, _t4, _r0, _t14, _r1, _t20, _r2, _t21, _t22, _t10, _t0, _t12, _t16, _r3, _r4, _r5);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code rotateXYZ_general}: computes and stores it; reached only through it. */
    private void rotateXYZ_general_s406dbcde_c0(Double3x3Impl _dst, double _r0, double _t14, double _r1, double _t20, double _r2, double _t21, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t14 + _r1 * _t20 + _r2 * _t21;
        _dst.m10 = _r3 * _t14 + _r4 * _t20 + _r5 * _t21;
    ...
    private void rotateXYZ_general_s406dbcde_c1(Double3x3Impl _dst, double _r1, double _t22, double _r0, double _t10, double _r2, double _t23, double _r4, double _r3, double _r5, double _r7, double _r6, double _r8) {
        _dst.m01 = _r1 * _t22 - _r0 * _t10 + _r2 * _t23;
        _dst.m11 = _r4 * _t22 - _r3 * _t10 + _r5 * _t23;
    ...
    private void rotateXYZ_general_s406dbcde_c2(Double3x3Impl _dst, double _r0, double _t0, double _r1, double _t12, double _r2, double _t16, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t0 - _r1 * _t12 + _r2 * _t16;
        _dst.m12 = _r3 * _t0 - _r4 * _t12 + _r5 * _t16;
    ...
    private void rotateXYZ_general_s406dbcde_tail(Double3x3Impl _dst, double _t9, double _t1, double _t2, double _t4, double _r0, double _t14, double _r1, double _t20, double _r2, double _t21, double _t22, double _t10, double _t0, double _t12, double _t16, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        double _t23 = _t9 * _t1 + _t2 * _t4;
        rotateXYZ_general_s406dbcde_c0(_dst, _r0, _t14, _r1, _t20, _r2, _t21, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateXYZ_general_s406dbcde_c1(_dst, _r1, _t22, _r0, _t10, _r2, _t23, _r4, _r3, _r5, _r7, _r6, _r8);
        rotateXYZ_general_s406dbcde_c2(_dst, _r0, _t0, _r1, _t12, _r2, _t16, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 rotateXYZ_general(double angleX, double angleY, double angleZ, @Mutated Double3x3 dest) {
        ...
        double _t21 = _t2 * _t1 - _t9 * _t4;
        double _t22 = _t5 * _t4 - _t6 * _t1;
        rotateXYZ_general_s406dbcde_tail(d, _t9, _t1, _t2, _t4, _r0, _t14, _r1, _t20, _r2, _t21, _t22, _t10, _t0, _t12, _t16, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    private Double3x3 rotateXZY_translation(double angleX, double angleZ, double angleY, @Mutated Double3x3 dest) {
        ...
        double _t8 = _t0 * _t5;
        double _t9 = _t1 * _t4;
        double _t13 = _t6 * _t3 - _t2 * _t4;
        double _t14 = _t6 * _t2 + _t4 * _t3;
    ...
    private void rotateXZY_orthogonal_s4b3494c0_c0(Double3x3Impl _dst, double _r0, double _t14, double _r1, double _t20, double _r2, double _t21, double _r3, double _r4, double _r5) {
        _dst.m00 = _r0 * _t14 + _r1 * _t20 + _r2 * _t21;
        _dst.m10 = _r3 * _t14 + _r4 * _t20 + _r5 * _t21;
        _dst.m20 = _t21;
    }
    ...
    private void rotateXZY_orthogonal_s4b3494c0_c1(Double3x3Impl _dst, double _r1, double _t15, double _r0, double _t1, double _r2, double _t10, double _r4, double _r3, double _r5) {
    ...
    private void rotateXZY_orthogonal_s4b3494c0_c2(Double3x3Impl _dst, double _r0, double _t11, double _r1, double _t22, double _r2, double _t23, double _r3, double _r4, double _r5) {
    ...
    private void rotateXZY_orthogonal_s4b3494c0_tail(Double3x3Impl _dst, double _t7, double _t0, double _t5, double _t3, double _r0, double _t14, double _r1, double _t20, double _r2, double _t21, double _t15, double _t1, double _t10, double _t11, double _t22, double _r3, double _r4, double _r5) {
        double _t23 = _t7 * _t0 + _t5 * _t3;
        rotateXZY_orthogonal_s4b3494c0_c0(_dst, _r0, _t14, _r1, _t20, _r2, _t21, _r3, _r4, _r5);
        rotateXZY_orthogonal_s4b3494c0_c1(_dst, _r1, _t15, _r0, _t1, _r2, _t10, _r4, _r3, _r5);
        rotateXZY_orthogonal_s4b3494c0_c2(_dst, _r0, _t11, _r1, _t22, _r2, _t23, _r3, _r4, _r5);
    }
    ...
    private Double3x3 rotateXZY_orthogonal(double angleX, double angleZ, double angleY, @Mutated Double3x3 dest) {
        ...
        double _t14 = _t3 * _t4;
        double _t15 = _t5 * _t4;
        double _t20 = _t8 * _t3 + _t2 * _t0;
        double _t21 = _t7 * _t3 - _t0 * _t5;
        double _t22 = _t8 * _t0 - _t2 * _t3;
        rotateXZY_orthogonal_s4b3494c0_tail(d, _t7, _t0, _t5, _t3, _r0, _t14, _r1, _t20, _r2, _t21, _t15, _t1, _t10, _t11, _t22, _r3, _r4, _r5);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code rotateXZY_general}: computes and stores it; reached only through it. */
    private void rotateXZY_general_s4b3494c0_c0(Double3x3Impl _dst, double _r0, double _t14, double _r1, double _t20, double _r2, double _t21, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t14 + _r1 * _t20 + _r2 * _t21;
        _dst.m10 = _r3 * _t14 + _r4 * _t20 + _r5 * _t21;
        _dst.m20 = _r6 * _t14 + _r7 * _t20 + _r8 * _t21;
    }
    ...
    private void rotateXZY_general_s4b3494c0_c1(Double3x3Impl _dst, double _r1, double _t15, double _r0, double _t1, double _r2, double _t10, double _r4, double _r3, double _r5, double _r7, double _r6, double _r8) {
        _dst.m01 = _r1 * _t15 - _r0 * _t1 + _r2 * _t10;
        _dst.m11 = _r4 * _t15 - _r3 * _t1 + _r5 * _t10;
    ...
    private void rotateXZY_general_s4b3494c0_c2(Double3x3Impl _dst, double _r0, double _t11, double _r1, double _t22, double _r2, double _t23, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t11 + _r1 * _t22 + _r2 * _t23;
        _dst.m12 = _r3 * _t11 + _r4 * _t22 + _r5 * _t23;
    ...
    private void rotateXZY_general_s4b3494c0_tail(Double3x3Impl _dst, double _t7, double _t0, double _t5, double _t3, double _r0, double _t14, double _r1, double _t20, double _r2, double _t21, double _t15, double _t1, double _t10, double _t11, double _t22, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        double _t23 = _t7 * _t0 + _t5 * _t3;
        rotateXZY_general_s4b3494c0_c0(_dst, _r0, _t14, _r1, _t20, _r2, _t21, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateXZY_general_s4b3494c0_c1(_dst, _r1, _t15, _r0, _t1, _r2, _t10, _r4, _r3, _r5, _r7, _r6, _r8);
        rotateXZY_general_s4b3494c0_c2(_dst, _r0, _t11, _r1, _t22, _r2, _t23, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 rotateXZY_general(double angleX, double angleZ, double angleY, @Mutated Double3x3 dest) {
        ...
        double _t21 = _t7 * _t3 - _t0 * _t5;
        double _t22 = _t8 * _t0 - _t2 * _t3;
        rotateXZY_general_s4b3494c0_tail(d, _t7, _t0, _t5, _t3, _r0, _t14, _r1, _t20, _r2, _t21, _t15, _t1, _t10, _t11, _t22, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    public Double3x3 rotateY(double angle, @Mutated Double3x3 dest) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _buf0 = this.m00 * _t1 - this.m02 * _t0;
        double _buf1 = this.m10 * _t1 - this.m12 * _t0;
        double _buf2 = this.m20 * _t1 - this.m22 * _t0;
        d.m01 = this.m01;
        d.m11 = this.m11;
        d.m21 = this.m21;
    ...
    private Double3x3 rotateYXZ_translation(double angleY, double angleX, double angleZ, @Mutated Double3x3 dest) {
        ...
        double _t8 = _t0 * _t3;
        double _t10 = _t5 * _t3;
        double _t13 = _t8 * _t2 - _t1 * _t4;
        double _t14 = _t8 * _t4 + _t1 * _t2;
    ...
    private void rotateYXZ_orthogonal_s3503e4bc_c0(Double3x3Impl _dst, double _r0, double _t20, double _r1, double _t8, double _r2, double _t21, double _r3, double _r4, double _r5) {
    ...
    private void rotateYXZ_orthogonal_s3503e4bc_c1(Double3x3Impl _dst, double _r0, double _t22, double _r1, double _t15, double _r2, double _t23, double _r3, double _r4, double _r5) {
    ...
    private void rotateYXZ_orthogonal_s3503e4bc_c2(Double3x3Impl _dst, double _r0, double _t12, double _r1, double _t0, double _r2, double _t16, double _r3, double _r4, double _r5) {
    ...
    private void rotateYXZ_orthogonal_s3503e4bc_tail(Double3x3Impl _dst, double _t9, double _t4, double _t1, double _t2, double _r0, double _t20, double _r1, double _t8, double _r2, double _t21, double _t22, double _t15, double _t12, double _t0, double _t16, double _r3, double _r4, double _r5) {
        double _t23 = _t9 * _t4 + _t1 * _t2;
        rotateYXZ_orthogonal_s3503e4bc_c0(_dst, _r0, _t20, _r1, _t8, _r2, _t21, _r3, _r4, _r5);
        rotateYXZ_orthogonal_s3503e4bc_c1(_dst, _r0, _t22, _r1, _t15, _r2, _t23, _r3, _r4, _r5);
        rotateYXZ_orthogonal_s3503e4bc_c2(_dst, _r0, _t12, _r1, _t0, _r2, _t16, _r3, _r4, _r5);
    }
    ...
    private Double3x3 rotateYXZ_orthogonal(double angleY, double angleX, double angleZ, @Mutated Double3x3 dest) {
        ...
        rotateYXZ_orthogonal_s3503e4bc_tail(d, _t9, _t4, _t1, _t2, _r0, _t20, _r1, _t8, _r2, _t21, _t22, _t15, _t12, _t0, _t16, _r3, _r4, _r5);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code rotateYXZ_general}: computes and stores it; reached only through it. */
    private void rotateYXZ_general_s3503e4bc_c0(Double3x3Impl _dst, double _r0, double _t20, double _r1, double _t8, double _r2, double _t21, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t20 + _r1 * _t8 + _r2 * _t21;
        _dst.m10 = _r3 * _t20 + _r4 * _t8 + _r5 * _t21;
    ...
    private void rotateYXZ_general_s3503e4bc_c1(Double3x3Impl _dst, double _r0, double _t22, double _r1, double _t15, double _r2, double _t23, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m01 = _r0 * _t22 + _r1 * _t15 + _r2 * _t23;
        _dst.m11 = _r3 * _t22 + _r4 * _t15 + _r5 * _t23;
    ...
    private void rotateYXZ_general_s3503e4bc_c2(Double3x3Impl _dst, double _r0, double _t12, double _r1, double _t0, double _r2, double _t16, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t12 - _r1 * _t0 + _r2 * _t16;
        _dst.m12 = _r3 * _t12 - _r4 * _t0 + _r5 * _t16;
    ...
    private void rotateYXZ_general_s3503e4bc_tail(Double3x3Impl _dst, double _t9, double _t4, double _t1, double _t2, double _r0, double _t20, double _r1, double _t8, double _r2, double _t21, double _t22, double _t15, double _t12, double _t0, double _t16, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        double _t23 = _t9 * _t4 + _t1 * _t2;
        rotateYXZ_general_s3503e4bc_c0(_dst, _r0, _t20, _r1, _t8, _r2, _t21, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateYXZ_general_s3503e4bc_c1(_dst, _r0, _t22, _r1, _t15, _r2, _t23, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateYXZ_general_s3503e4bc_c2(_dst, _r0, _t12, _r1, _t0, _r2, _t16, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 rotateYXZ_general(double angleY, double angleX, double angleZ, @Mutated Double3x3 dest) {
        ...
        double _t21 = _t9 * _t2 - _t1 * _t4;
        double _t22 = _t6 * _t4 - _t2 * _t3;
        rotateYXZ_general_s3503e4bc_tail(d, _t9, _t4, _t1, _t2, _r0, _t20, _r1, _t8, _r2, _t21, _t22, _t15, _t12, _t0, _t16, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    private Double3x3 rotateYZX_translation(double angleY, double angleZ, double angleX, @Mutated Double3x3 dest) {
        ...
        double _t7 = _t0 * _t4;
        double _t8 = _t1 * _t3;
        double _t13 = _t6 * _t5 + _t2 * _t3;
        double _t14 = _t5 * _t3 - _t6 * _t2;
    ...
    private void rotateYZX_orthogonal_s4a919480_c0(Double3x3Impl _dst, double _r0, double _t14, double _r1, double _t1, double _r2, double _t8, double _r3, double _r4, double _r5) {
    ...
    private void rotateYZX_orthogonal_s4a919480_c1(Double3x3Impl _dst, double _r0, double _t20, double _r1, double _t15, double _r2, double _t21, double _r3, double _r4, double _r5) {
    ...
    private void rotateYZX_orthogonal_s4a919480_c2(Double3x3Impl _dst, double _r0, double _t22, double _r1, double _t12, double _r2, double _t23, double _r3, double _r4, double _r5) {
    ...
    private void rotateYZX_orthogonal_s4a919480_tail(Double3x3Impl _dst, double _t5, double _t3, double _t7, double _t2, double _r0, double _t14, double _r1, double _t1, double _r2, double _t8, double _t20, double _t15, double _t21, double _t22, double _t12, double _r3, double _r4, double _r5) {
        double _t23 = _t5 * _t3 - _t7 * _t2;
        rotateYZX_orthogonal_s4a919480_c0(_dst, _r0, _t14, _r1, _t1, _r2, _t8, _r3, _r4, _r5);
        rotateYZX_orthogonal_s4a919480_c1(_dst, _r0, _t20, _r1, _t15, _r2, _t21, _r3, _r4, _r5);
        rotateYZX_orthogonal_s4a919480_c2(_dst, _r0, _t22, _r1, _t12, _r2, _t23, _r3, _r4, _r5);
    }
    ...
    private Double3x3 rotateYZX_orthogonal(double angleY, double angleZ, double angleX, @Mutated Double3x3 dest) {
        ...
        double _t14 = _t3 * _t4;
        double _t15 = _t5 * _t4;
        double _t20 = _t2 * _t0 - _t9 * _t5;
        double _t21 = _t7 * _t5 + _t2 * _t3;
        double _t22 = _t9 * _t2 + _t0 * _t5;
        rotateYZX_orthogonal_s4a919480_tail(d, _t5, _t3, _t7, _t2, _r0, _t14, _r1, _t1, _r2, _t8, _t20, _t15, _t21, _t22, _t12, _r3, _r4, _r5);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code rotateYZX_general}: computes and stores it; reached only through it. */
    private void rotateYZX_general_s4a919480_c0(Double3x3Impl _dst, double _r0, double _t14, double _r1, double _t1, double _r2, double _t8, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t14 + _r1 * _t1 - _r2 * _t8;
        _dst.m10 = _r3 * _t14 + _r4 * _t1 - _r5 * _t8;
    ...
    private void rotateYZX_general_s4a919480_c1(Double3x3Impl _dst, double _r0, double _t20, double _r1, double _t15, double _r2, double _t21, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m01 = _r0 * _t20 + _r1 * _t15 + _r2 * _t21;
        _dst.m11 = _r3 * _t20 + _r4 * _t15 + _r5 * _t21;
    ...
    private void rotateYZX_general_s4a919480_c2(Double3x3Impl _dst, double _r0, double _t22, double _r1, double _t12, double _r2, double _t23, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t22 - _r1 * _t12 + _r2 * _t23;
        _dst.m12 = _r3 * _t22 - _r4 * _t12 + _r5 * _t23;
    ...
    private void rotateYZX_general_s4a919480_tail(Double3x3Impl _dst, double _t5, double _t3, double _t7, double _t2, double _r0, double _t14, double _r1, double _t1, double _r2, double _t8, double _t20, double _t15, double _t21, double _t22, double _t12, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        double _t23 = _t5 * _t3 - _t7 * _t2;
        rotateYZX_general_s4a919480_c0(_dst, _r0, _t14, _r1, _t1, _r2, _t8, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateYZX_general_s4a919480_c1(_dst, _r0, _t20, _r1, _t15, _r2, _t21, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateYZX_general_s4a919480_c2(_dst, _r0, _t22, _r1, _t12, _r2, _t23, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 rotateYZX_general(double angleY, double angleZ, double angleX, @Mutated Double3x3 dest) {
        ...
        double _t21 = _t7 * _t5 + _t2 * _t3;
        double _t22 = _t9 * _t2 + _t0 * _t5;
        rotateYZX_general_s4a919480_tail(d, _t5, _t3, _t7, _t2, _r0, _t14, _r1, _t1, _r2, _t8, _t20, _t15, _t21, _t22, _t12, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    private void rotateZXY_orthogonal_s3460e47c_c0(Double3x3Impl _dst, double _r0, double _t20, double _r1, double _t21, double _r2, double _t10, double _r3, double _r4, double _r5) {
    ...
    private void rotateZXY_orthogonal_s3460e47c_c1(Double3x3Impl _dst, double _r1, double _t15, double _r0, double _t11, double _r2, double _t2, double _r4, double _r3, double _r5) {
    ...
    private void rotateZXY_orthogonal_s3460e47c_c2(Double3x3Impl _dst, double _r0, double _t22, double _r1, double _t23, double _r2, double _t16, double _r3, double _r4, double _r5) {
    ...
    private void rotateZXY_orthogonal_s3460e47c_tail(Double3x3Impl _dst, double _t0, double _t1, double _t8, double _t3, double _r0, double _t20, double _r1, double _t21, double _r2, double _t10, double _t15, double _t11, double _t2, double _t22, double _t16, double _r3, double _r4, double _r5) {
        double _t23 = _t0 * _t1 - _t8 * _t3;
        rotateZXY_orthogonal_s3460e47c_c0(_dst, _r0, _t20, _r1, _t21, _r2, _t10, _r3, _r4, _r5);
        rotateZXY_orthogonal_s3460e47c_c1(_dst, _r1, _t15, _r0, _t11, _r2, _t2, _r4, _r3, _r5);
        rotateZXY_orthogonal_s3460e47c_c2(_dst, _r0, _t22, _r1, _t23, _r2, _t16, _r3, _r4, _r5);
    }
    ...
    private Double3x3 rotateZXY_orthogonal(double angleZ, double angleX, double angleY, @Mutated Double3x3 dest) {
        ...
        double _t15 = _t5 * _t4;
        double _t16 = _t5 * _t3;
        double _t20 = _t3 * _t4 - _t6 * _t0;
        double _t21 = _t8 * _t0 + _t1 * _t3;
        double _t22 = _t6 * _t3 + _t0 * _t4;
        rotateZXY_orthogonal_s3460e47c_tail(d, _t0, _t1, _t8, _t3, _r0, _t20, _r1, _t21, _r2, _t10, _t15, _t11, _t2, _t22, _t16, _r3, _r4, _r5);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code rotateZXY_general}: computes and stores it; reached only through it. */
    private void rotateZXY_general_s3460e47c_c0(Double3x3Impl _dst, double _r0, double _t20, double _r1, double _t21, double _r2, double _t10, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t20 + _r1 * _t21 - _r2 * _t10;
        _dst.m10 = _r3 * _t20 + _r4 * _t21 - _r5 * _t10;
    ...
    private void rotateZXY_general_s3460e47c_c1(Double3x3Impl _dst, double _r1, double _t15, double _r0, double _t11, double _r2, double _t2, double _r4, double _r3, double _r5, double _r7, double _r6, double _r8) {
        _dst.m01 = _r1 * _t15 - _r0 * _t11 + _r2 * _t2;
        _dst.m11 = _r4 * _t15 - _r3 * _t11 + _r5 * _t2;
    ...
    private void rotateZXY_general_s3460e47c_c2(Double3x3Impl _dst, double _r0, double _t22, double _r1, double _t23, double _r2, double _t16, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t22 + _r1 * _t23 + _r2 * _t16;
        _dst.m12 = _r3 * _t22 + _r4 * _t23 + _r5 * _t16;
    ...
    private void rotateZXY_general_s3460e47c_tail(Double3x3Impl _dst, double _t0, double _t1, double _t8, double _t3, double _r0, double _t20, double _r1, double _t21, double _r2, double _t10, double _t15, double _t11, double _t2, double _t22, double _t16, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        double _t23 = _t0 * _t1 - _t8 * _t3;
        rotateZXY_general_s3460e47c_c0(_dst, _r0, _t20, _r1, _t21, _r2, _t10, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateZXY_general_s3460e47c_c1(_dst, _r1, _t15, _r0, _t11, _r2, _t2, _r4, _r3, _r5, _r7, _r6, _r8);
        rotateZXY_general_s3460e47c_c2(_dst, _r0, _t22, _r1, _t23, _r2, _t16, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 rotateZXY_general(double angleZ, double angleX, double angleY, @Mutated Double3x3 dest) {
        ...
        double _t21 = _t8 * _t0 + _t1 * _t3;
        double _t22 = _t6 * _t3 + _t0 * _t4;
        rotateZXY_general_s3460e47c_tail(d, _t0, _t1, _t8, _t3, _r0, _t20, _r1, _t21, _r2, _t10, _t15, _t11, _t2, _t22, _t16, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    private void rotateZYX_orthogonal_s3f27bc5e_c0(Double3x3Impl _dst, double _r0, double _t14, double _r1, double _t8, double _r2, double _t0, double _r3, double _r4, double _r5) {
    ...
    private void rotateZYX_orthogonal_s3f27bc5e_c1(Double3x3Impl _dst, double _r0, double _t20, double _r1, double _t21, double _r2, double _t11, double _r3, double _r4, double _r5) {
    ...
    private void rotateZYX_orthogonal_s3f27bc5e_c2(Double3x3Impl _dst, double _r0, double _t22, double _r1, double _t23, double _r2, double _t16, double _r3, double _r4, double _r5) {
        _dst.m02 = _r0 * _t22 + _r1 * _t23 + _r2 * _t16;
        _dst.m12 = _r3 * _t22 + _r4 * _t23 + _r5 * _t16;
        _dst.m22 = _t16;
    }
    ...
    private void rotateZYX_orthogonal_s3f27bc5e_tail(Double3x3Impl _dst, double _t6, double _t5, double _t2, double _t4, double _r0, double _t14, double _r1, double _t8, double _r2, double _t0, double _t20, double _t21, double _t11, double _t22, double _t16, double _r3, double _r4, double _r5) {
        double _t23 = _t6 * _t5 - _t2 * _t4;
        rotateZYX_orthogonal_s3f27bc5e_c0(_dst, _r0, _t14, _r1, _t8, _r2, _t0, _r3, _r4, _r5);
        rotateZYX_orthogonal_s3f27bc5e_c1(_dst, _r0, _t20, _r1, _t21, _r2, _t11, _r3, _r4, _r5);
        rotateZYX_orthogonal_s3f27bc5e_c2(_dst, _r0, _t22, _r1, _t23, _r2, _t16, _r3, _r4, _r5);
    }
    ...
    private Double3x3 rotateZYX_orthogonal(double angleZ, double angleY, double angleX, @Mutated Double3x3 dest) {
        ...
        double _t14 = _t3 * _t4;
        double _t16 = _t5 * _t3;
        double _t20 = _t9 * _t2 - _t1 * _t5;
        double _t21 = _t6 * _t2 + _t5 * _t4;
        double _t22 = _t9 * _t5 + _t2 * _t1;
        rotateZYX_orthogonal_s3f27bc5e_tail(d, _t6, _t5, _t2, _t4, _r0, _t14, _r1, _t8, _r2, _t0, _t20, _t21, _t11, _t22, _t16, _r3, _r4, _r5);
        d.properties = 0;
        return d;
    }

    /** Private column 0 of {@code rotateZYX_general}: computes and stores it; reached only through it. */
    private void rotateZYX_general_s3f27bc5e_c0(Double3x3Impl _dst, double _r0, double _t14, double _r1, double _t8, double _r2, double _t0, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m00 = _r0 * _t14 + _r1 * _t8 - _r2 * _t0;
        _dst.m10 = _r3 * _t14 + _r4 * _t8 - _r5 * _t0;
    ...
    private void rotateZYX_general_s3f27bc5e_c1(Double3x3Impl _dst, double _r0, double _t20, double _r1, double _t21, double _r2, double _t11, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m01 = _r0 * _t20 + _r1 * _t21 + _r2 * _t11;
        _dst.m11 = _r3 * _t20 + _r4 * _t21 + _r5 * _t11;
    ...
    private void rotateZYX_general_s3f27bc5e_c2(Double3x3Impl _dst, double _r0, double _t22, double _r1, double _t23, double _r2, double _t16, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        _dst.m02 = _r0 * _t22 + _r1 * _t23 + _r2 * _t16;
        _dst.m12 = _r3 * _t22 + _r4 * _t23 + _r5 * _t16;
        _dst.m22 = _r6 * _t22 + _r7 * _t23 + _r8 * _t16;
    }
    ...
    private void rotateZYX_general_s3f27bc5e_tail(Double3x3Impl _dst, double _t6, double _t5, double _t2, double _t4, double _r0, double _t14, double _r1, double _t8, double _r2, double _t0, double _t20, double _t21, double _t11, double _t22, double _t16, double _r3, double _r4, double _r5, double _r6, double _r7, double _r8) {
        double _t23 = _t6 * _t5 - _t2 * _t4;
        rotateZYX_general_s3f27bc5e_c0(_dst, _r0, _t14, _r1, _t8, _r2, _t0, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateZYX_general_s3f27bc5e_c1(_dst, _r0, _t20, _r1, _t21, _r2, _t11, _r3, _r4, _r5, _r6, _r7, _r8);
        rotateZYX_general_s3f27bc5e_c2(_dst, _r0, _t22, _r1, _t23, _r2, _t16, _r3, _r4, _r5, _r6, _r7, _r8);
    }
    ...
    private Double3x3 rotateZYX_general(double angleZ, double angleY, double angleX, @Mutated Double3x3 dest) {
        ...
        double _t21 = _t6 * _t2 + _t5 * _t4;
        double _t22 = _t9 * _t5 + _t2 * _t1;
        rotateZYX_general_s3f27bc5e_tail(d, _t6, _t5, _t2, _t4, _r0, _t14, _r1, _t8, _r2, _t0, _t20, _t21, _t11, _t22, _t16, _r3, _r4, _r5, _r6, _r7, _r8);
        d.properties = 0;
        return d;
    }
    ...
    private Double3x3 scaleAround_general(double s, double pivotX, double pivotY, @Mutated Double3x3 dest) {
        ...
        d.m02 = this.m00 * _t1 + (this.m01 * _t2 + this.m02);
        d.m12 = this.m10 * _t1 + (this.m11 * _t2 + this.m12);
        d.m22 = this.m20 * _t1 + (this.m21 * _t2 + this.m22);
        d.m00 = _buf0;
        d.m10 = _buf1;
        d.m20 = _buf2;
        d.m01 = _buf3;
    ...
    private Double3x3 scaleAround_translation(double sX, double sY, double pivotX, double pivotY, @Mutated Double3x3 dest) {
        ...
        d.m11 = sY;
        d.m21 = 0.0;
        d.m02 = pivotX * (1.0 - sX) + this.m02;
        d.m12 = pivotY * (1.0 - sY) + this.m12;
        d.m22 = 1.0;
        d.properties = Joml.BIT_AFFINE;
        return d;
    }
