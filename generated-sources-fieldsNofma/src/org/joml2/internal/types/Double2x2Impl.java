...
public class Double2x2Impl implements Double2x2 {
    ...
    private Double2x2 invertProduct_general(Double2x2R other, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        double _t8 = other.m01() * this.m10 + other.m11() * this.m11;
        double _t9 = other.m00() * this.m00 + other.m10() * this.m01;
        double _t10 = other.m00() * this.m10 + other.m10() * this.m11;
        double _t11 = other.m01() * this.m00 + other.m11() * this.m01;
        double _t14 = _t9 * _t8 - _t10 * _t11;
    ...
    private Double2x2 invertProduct_translation(Double2x2R other, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        double _t2 = other.m10() * this.m01 + other.m00();
        double _t3 = other.m11() * this.m01 + other.m01();
        double _t6 = other.m11() * _t2 - other.m10() * _t3;
    ...
    private Double2x2 invertProduct_orthogonal(Double2x2R other, @Mutated Double2x2 dest, int _props) {
        ...
        double _t8 = other.m11() * _t4 - other.m10() * _t5;
        double _t8_inv = 1.0 / _t8;
        d.m00 = other.m11() * _t8_inv;
        d.m10 = -(other.m10() * _t8_inv);
        d.m01 = -(_t5 * _t8_inv);
        d.m11 = _t4 * _t8_inv;
        d.properties = _props;
        return d;
    ...
    private Double2x2 invertProduct_general_translation(Double2x2R other, @Mutated Double2x2 dest) {
        ...
        double _t6 = this.m00 * _t2 - this.m10 * _t3;
        double _t6_inv = 1.0 / _t6;
        double _buf0 = _t2 * _t6_inv;
        d.m10 = -(this.m10 * _t6_inv);
        d.m01 = -(_t3 * _t6_inv);
        d.m11 = this.m00 * _t6_inv;
        d.m00 = _buf0;
        d.properties = 0;
        return d;
    }
    ...
    private Double2x2 invertProduct_general_affine(Double2x2R other, @Mutated Double2x2 dest) {
        ...
        double _t3 = other.m00() * this.m10;
        double _t4 = other.m01() * this.m10 + this.m11;
        double _t5 = other.m01() * this.m00 + this.m01;
        double _t8 = _t4 * _t1 - _t5 * _t3;
        double _t8_inv = 1.0 / _t8;
        d.m00 = _t4 * _t8_inv;
        d.m10 = -(_t3 * _t8_inv);
        d.m01 = -(_t5 * _t8_inv);
    ...
    public Double2x2 invertProduct(double m00, double m01, double m10, double m11, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        double _t8 = m01 * this.m10 + m11 * this.m11;
        double _t9 = m00 * this.m00 + m10 * this.m01;
        double _t10 = m00 * this.m10 + m10 * this.m11;
        double _t11 = m01 * this.m00 + m11 * this.m01;
        double _t14 = _t9 * _t8 - _t10 * _t11;
        double _t14_inv = 1.0 / _t14;
        d.m00 = _t8 * _t14_inv;
        d.m10 = -(_t10 * _t14_inv);
     ...
     */
    private Double2x2 mul_identity_self(double scalar, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = scalar;
        d.m11 = scalar;
        d.properties = 0;
    ...
    private Double2x2 lerp_orthogonal(Double2x2R other, double t, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        double _t0 = 1.0 - t;
        d.m00 = t * other.m00() + _t0;
        d.m10 = t * other.m10();
        d.m01 = t * other.m01() + (this.m01 - t * this.m01);
        d.m11 = t * other.m11() + _t0;
     ...
     * the public {@code lerp} dispatcher.
     */
    private Double2x2 lerp_general_identity(Double2x2R other, double t, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = t * (1.0 - this.m00) + this.m00;
    ...
    private Double2x2 mul_affine_translation(Double2x2R right, @Mutated Double2x2 dest) {
        ...
        d.m10 = 0.0;
        d.m01 = right.m01() * this.m00 + this.m01;
        d.m11 = 1.0;
        d.m00 = _buf0;
        d.properties = Joml.BIT_AFFINE & ((Double2x2Impl) right).properties;
        return d;
    ...
    private Double2x2 mul_general_translation(Double2x2R right, @Mutated Double2x2 dest) {
        ...
        double _buf2 = right.m01() * this.m00 + this.m01;
        d.m11 = right.m01() * this.m10 + this.m11;
        d.m00 = _buf0;
        d.m10 = _buf1;
        d.m01 = _buf2;
        d.properties = 0;
    ...
    private Double2x2 preMul_translation(Double2x2R other, @Mutated Double2x2 dest, int _props) {
        ...
        double _buf2 = other.m00() * this.m01 + other.m01();
        d.m11 = other.m10() * this.m01 + other.m11();
        d.m00 = _buf0;
        d.m10 = _buf1;
        d.m01 = _buf2;
        d.properties = _props;
    ...
    private Double2x2 preMul_translation_affine(Double2x2R other, @Mutated Double2x2 dest, int _props) {
        ...
        double _buf0 = other.m00();
        d.m10 = 0.0;
        d.m01 = other.m00() * this.m01 + other.m01();
        d.m11 = 1.0;
        d.m00 = _buf0;
        d.properties = _props;
        return d;
    ...
    private Double2x2 preMul_general_affine(Double2x2R other, @Mutated Double2x2 dest) {
        ...
        double _buf0 = other.m00() * this.m00 + other.m01() * this.m10;
        d.m10 = this.m10;
        d.m01 = other.m00() * this.m01 + other.m01() * this.m11;
        d.m11 = this.m11;
        d.m00 = _buf0;
        d.properties = 0;
        return d;
     ...
     */
    private Double2x2 addScaled_general(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_identity(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_translation(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = weight * other.m00() + 1.0;
        d.m10 = weight * other.m10();
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_identity_identity(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_identity_translation(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        double _t0 = 1.0 + weight;
        d.m00 = _t0;
        d.m10 = 0.0;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_identity_affine(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = weight * other.m00() + 1.0;
        d.m10 = 0.0;
        d.m01 = weight * other.m01();
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_translation_identity(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        double _t0 = 1.0 + weight;
        d.m00 = _t0;
        d.m10 = 0.0;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_translation_translation(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        double _t0 = 1.0 + weight;
        d.m00 = _t0;
        d.m10 = 0.0;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_translation_affine(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = weight * other.m00() + 1.0;
        d.m10 = 0.0;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_affine_identity(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_affine_translation(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = weight + this.m00;
        d.m10 = 0.0;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_affine_affine(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = weight * other.m00() + this.m00;
        d.m10 = 0.0;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_general_identity(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = weight + this.m00;
        d.m10 = this.m10;
        d.m01 = this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_general_translation(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = weight + this.m00;
        d.m10 = this.m10;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x2 addScaled_general_affine(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        Double2x2Impl d = (Double2x2Impl) dest;
        d.m00 = weight * other.m00() + this.m00;
        d.m10 = this.m10;
        d.m01 = weight * other.m01() + this.m01;
    ...
    public Double2x2 addScaled(Double2x2R other, double weight, @Mutated Double2x2 dest) {
        ...
        if ((p & Joml.BIT_AFFINE) == Joml.BIT_AFFINE) {
            if ((q & Joml.BIT_IDENTITY) == Joml.BIT_IDENTITY) return addScaled_affine_identity(other, weight, dest);
            if ((q & Joml.BIT_TRANSLATION) == Joml.BIT_TRANSLATION) return addScaled_affine_translation(other, weight, dest);
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated public Double2x2 addScaled(Double2x2R other, double weight) {
        if (Joml.RETURN_NEW) return addScaled(other, weight, Joml.double2x2());
        int p = this.properties;
        int q = ((Double2x2Impl) other).properties;
        if ((p & Joml.BIT_IDENTITY) == Joml.BIT_IDENTITY) {
        ...
        if ((p & Joml.BIT_AFFINE) == Joml.BIT_AFFINE) {
            if ((q & Joml.BIT_IDENTITY) == Joml.BIT_IDENTITY) return addScaled_affine_identity(other, weight, this);
            if ((q & Joml.BIT_TRANSLATION) == Joml.BIT_TRANSLATION) return addScaled_affine_translation(other, weight, this);
