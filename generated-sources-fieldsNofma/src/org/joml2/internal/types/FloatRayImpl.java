...
public final class FloatRayImpl implements FloatRay {
    ...
    public FloatRay transform(Float3x4R m, @Mutated FloatRay dest) {
        FloatRayImpl d = (FloatRayImpl) dest;
        float _buf0 = m.m02() * this.oZ + (m.m00() * this.oX + (m.m01() * this.oY + m.m03()));
        float _buf1 = m.m12() * this.oZ + (m.m10() * this.oX + (m.m11() * this.oY + m.m13()));
        d.oZ = m.m22() * this.oZ + (m.m20() * this.oX + (m.m21() * this.oY + m.m23()));
        float _buf2 = m.m00() * this.dX + m.m01() * this.dY + m.m02() * this.dZ;
        float _buf3 = m.m10() * this.dX + m.m11() * this.dY + m.m12() * this.dZ;
    ...
    public Float3 closestPointToPoint(float pX, float pY, float pZ, @Mutated Float3 dest) {
        Float3Impl d = (Float3Impl) dest;
        float _t14 = Math.max(0.0f, (this.dX * (pX - this.oX) + this.dY * (pY - this.oY) + this.dZ * (pZ - this.oZ)) / (this.dX * this.dX + this.dY * this.dY + this.dZ * this.dZ));
    ...
    public float distanceSquaredToPoint(float pX, float pY, float pZ) {
        float _t0 = pX - this.oX;
        float _t1 = pY - this.oY;
        float _t2 = pZ - this.oZ;
        float _t14 = Math.max(0.0f, (this.dX * _t0 + this.dY * _t1 + this.dZ * _t2) / (this.dX * this.dX + this.dY * this.dY + this.dZ * this.dZ));
        float _t18 = _t0 - this.dX * _t14;
        float _t19 = _t1 - this.dY * _t14;
        float _t20 = _t2 - this.dZ * _t14;
    ...
    public float distanceToPoint(float pX, float pY, float pZ) {
        ...
        float _t19 = _t1 - this.dY * _t14;
        float _t20 = _t2 - this.dZ * _t14;
        return (float) Math.sqrt(_t18 * _t18 + _t19 * _t19 + _t20 * _t20);
    }
