...
public final class DoubleQuatImpl implements DoubleQuat {
    ...
    @Mutated public DoubleQuat makeRotationLookAlong(double dirX, double dirY, double dirZ, double upX, double upY, double upZ) {
        ...
        if (_t56 > 0.0) {
            ...
            this.y = _sp0 * _t38;
            this.z = _sp0 * _t54;
            this.w = 0.5 * Math.sqrt(_t57);
        } else {
            if (_t27 > _t49) {
                this.x = 0.5 * Math.sqrt(_t58);
                this.y = _sp3 * _t53;
                this.z = _sp3 * _t37;
                this.w = _sp3 * _t48;
            } else {
                if (_t43 > _t6) {
                    this.x = _sp1 * _t53;
                    this.y = 0.5 * Math.sqrt(_t59);
                    this.z = _sp1 * _t50;
                    this.w = _sp1 * _t38;
                } else {
                    this.x = _sp2 * _t37;
                    this.y = _sp2 * _t50;
                    this.z = 0.5 * Math.sqrt(_t60);
                    this.w = _sp2 * _t54;
                }
            }
        }
    ...
    @Mutated private DoubleQuat makeRotationLookAlong_degenerate(double dirX, double dirY, double dirZ, double upX, double upY, double upZ) {
        ...
        if (_t76 > 0.0) {
            ...
            this.y = _sp0 * _t54;
            this.z = _sp0 * _t86;
            this.w = 0.5 * Math.sqrt(_t77);
        } else {
            if (_t49 > _t72) {
                this.x = 0.5 * Math.sqrt(_t78);
                this.y = _sp3 * _t85;
                this.z = _sp3 * _t53;
                this.w = _sp3 * _t75;
            } else {
                if (_t67 > _t13) {
                    this.x = _sp1 * _t85;
                    this.y = 0.5 * Math.sqrt(_t79);
                    this.z = _sp1 * _t74;
                    this.w = _sp1 * _t54;
                } else {
                    this.x = _sp2 * _t53;
                    this.y = _sp2 * _t74;
                    this.z = 0.5 * Math.sqrt(_t80);
                    this.w = _sp2 * _t86;
                }
            }
        }
