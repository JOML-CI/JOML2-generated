...
public class Float2x3Impl implements Float2x3 {
    ...
    public float frobeniusNorm() {
        return (float) Math.sqrt(this.m00 * this.m00 + this.m01 * this.m01 + this.m02 * this.m02 + this.m10 * this.m10 + this.m11 * this.m11 + this.m12 * this.m12);
    }
    ...
    private Float2x3 invert_general(@Mutated Float2x3 dest) {
        ...
        float _buf4 = -((this.m02 * this.m11 - this.m01 * this.m12) * _t2_inv);
    ...
    private Float2x3 invertProduct_general(Float2x3R other, @Mutated Float2x3 dest, int _props) {
        ...
        float _t18 = other.m02() * this.m00 + (other.m12() * this.m01 + this.m02);
        float _t19 = other.m02() * this.m10 + (other.m12() * this.m11 + this.m12);
    ...
    private Float2x3 invertProduct_identity(Float2x3R other, @Mutated Float2x3 dest) {
        ...
        float _buf4 = -((other.m02() * other.m11() - other.m01() * other.m12()) * _t2_inv);
    ...
    private Float2x3 invertProduct_general_translation(Float2x3R other, @Mutated Float2x3 dest) {
        ...
        float _t9 = other.m02() * this.m00 + (other.m12() * this.m01 + this.m02);
        float _t10 = other.m02() * this.m10 + (other.m12() * this.m11 + this.m12);
    ...
    public Float2x3 invertProduct(float m00, float m01, float m02, float m10, float m11, float m12, @Mutated Float2x3 dest) {
        Float2x3Impl d = (Float2x3Impl) dest;
        float _t14 = m01 * this.m10 + m11 * this.m11;
        float _t15 = m00 * this.m00 + m10 * this.m01;
        float _t16 = m00 * this.m10 + m10 * this.m11;
        float _t17 = m01 * this.m00 + m11 * this.m01;
        float _t18 = m02 * this.m00 + (m12 * this.m01 + this.m02);
        float _t19 = m02 * this.m10 + (m12 * this.m11 + this.m12);
        float _t22 = _t15 * _t14 - _t16 * _t17;
        float _t22_inv = 1.0f / _t22;
        d.m00 = _t14 * _t22_inv;
        d.m10 = -(_t16 * _t22_inv);
     ...
     * the public {@code lerp} dispatcher.
     */
    private Float2x3 lerp_orthogonal_identity(Float2x3R other, float t, @Mutated Float2x3 dest) {
        Float2x3Impl d = (Float2x3Impl) dest;
     ...
     * the public {@code lerp} dispatcher.
     */
    private Float2x3 lerp_general_identity(Float2x3R other, float t, @Mutated Float2x3 dest) {
        Float2x3Impl d = (Float2x3Impl) dest;
    ...
    public Float2x3 mul(float m00, float m01, float m02, float m10, float m11, float m12, @Mutated Float2x3 dest) {
        ...
        float _buf2 = m01 * this.m00 + m11 * this.m01;
        float _buf3 = m01 * this.m10 + m11 * this.m11;
    ...
    public Float2x3 preMul(float m00, float m01, float m02, float m10, float m11, float m12, @Mutated Float2x3 dest) {
        ...
        float _buf2 = m00 * this.m02 + (m01 * this.m12 + m02);
