...
public final class FloatTransformImpl implements FloatTransform {
    ...
    @Mutated public FloatTransform makeFromMatrix(Float3x3R m) {
        ...
        this.tY = 0.0f;
        this.tZ = 0.0f;
        this.rX = _t62 > 0.0f ? 0.5f * _t37 * _t67 : _t48 > _t38 ? 0.5f * (float) Math.sqrt(_t64) : _t19 > _t20 ? 0.5f * _t54 * _t68 : 0.5f * _t55 * _t69;
        this.rY = _t62 > 0.0f ? 0.5f * _t56 * _t67 : _t48 > _t38 ? 0.5f * _t54 * _t70 : _t19 > _t20 ? 0.5f * (float) Math.sqrt(_t65) : 0.5f * _t39 * _t69;
        this.rZ = _t62 > 0.0f ? 0.5f * _t57 * _t67 : _t48 > _t38 ? 0.5f * _t55 * _t70 : _t19 > _t20 ? 0.5f * _t39 * _t68 : 0.5f * (float) Math.sqrt(_t66);
        this.rW = _t62 > 0.0f ? 0.5f * (float) Math.sqrt(_t63) : _t48 > _t38 ? 0.5f * _t37 * _t70 : _t19 > _t20 ? 0.5f * _t56 * _t68 : 0.5f * _t57 * _t69;
    ...
    public Float4x4 toMatrix(@Mutated Float4x4 dest) {
        ...
        float _t7 = this.rY * this.rZ;
        float _t8 = this.rX * this.rW;
        float _buf0 = this.sX * (1.0f - 2.0f * (_t0 + _t1));
        d.m10 = this.sX * 2.0f * (_t2 + _t3);
        float _buf1 = this.sX * 2.0f * (_t4 - _t5);
        d.m30 = 0.0f;
        float _buf2 = this.sY * 2.0f * (_t2 - _t3);
        d.m11 = this.sY * (1.0f - 2.0f * (_t6 + _t1));
        float _buf3 = this.sY * 2.0f * (_t8 + _t7);
        d.m31 = 0.0f;
        float _buf4 = this.sZ * 2.0f * (_t4 + _t5);
        d.m12 = this.sZ * 2.0f * (_t7 - _t8);
        d.m22 = this.sZ * (1.0f - 2.0f * (_t6 + _t0));
        d.m32 = 0.0f;
        d.m03 = this.tX;
        d.m13 = this.tY;
        d.m23 = this.tZ;
    ...
    public Float3x3 toMatrix3x3(@Mutated Float3x3 dest) {
        ...
        float _t7 = this.rY * this.rZ;
        float _t8 = this.rX * this.rW;
        d.m00 = this.sX * (1.0f - 2.0f * (_t0 + _t1));
        d.m10 = this.sX * 2.0f * (_t2 + _t3);
        d.m20 = this.sX * 2.0f * (_t4 - _t5);
        d.m01 = this.sY * 2.0f * (_t2 - _t3);
        d.m11 = this.sY * (1.0f - 2.0f * (_t6 + _t1));
        d.m21 = this.sY * 2.0f * (_t8 + _t7);
        d.m02 = this.sZ * 2.0f * (_t4 + _t5);
        d.m12 = this.sZ * 2.0f * (_t7 - _t8);
        d.m22 = this.sZ * (1.0f - 2.0f * (_t6 + _t0));
        d.properties = 0;
        return d;
    ...
    public Float3x4 toMatrix3x4(@Mutated Float3x4 dest) {
        ...
        float _t8 = this.rX * this.rW;
        float _buf0 = this.sX * (1.0f - 2.0f * (_t0 + _t1));
        float _buf1 = this.sY * 2.0f * (_t2 - _t3);
        float _buf2 = this.sZ * 2.0f * (_t4 + _t5);
        d.m03 = this.tX;
        d.m10 = this.sX * 2.0f * (_t2 + _t3);
        d.m11 = this.sY * (1.0f - 2.0f * (_t6 + _t1));
        d.m12 = this.sZ * 2.0f * (_t7 - _t8);
        float _buf3 = this.tY;
        float _buf4 = this.sX * 2.0f * (_t4 - _t5);
        float _buf5 = this.sY * 2.0f * (_t8 + _t7);
        d.m22 = this.sZ * (1.0f - 2.0f * (_t6 + _t0));
        d.m23 = this.tZ;
        d.m00 = _buf0;
        d.m01 = _buf1;
    ...
    public FloatTransform invert(@Mutated FloatTransform dest) {
        ...
        float _rcp2 = 1.0f / this.sY;
        float _t15 = 2.0f * (this.tX * this.rZ * _rcp0 - this.tZ * this.rX * _rcp1);
        float _t16 = 2.0f * (this.tZ * this.rY * _rcp1 - this.tY * this.rZ * _rcp2);
        float _t17 = 2.0f * (this.tY * this.rX * _rcp2 - this.tX * this.rY * _rcp0);
