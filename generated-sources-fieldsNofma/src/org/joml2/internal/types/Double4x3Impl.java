...
public class Double4x3Impl implements Double4x3 {
    ...
    public double frobeniusNorm() {
        return Math.sqrt(this.m00 * this.m00 + (this.m01 * this.m01 + this.m02 * this.m02) + (this.m10 * this.m10 + (this.m11 * this.m11 + this.m12 * this.m12)) + (this.m20 * this.m20 + (this.m21 * this.m21 + this.m22 * this.m22) + (this.m30 * this.m30 + (this.m31 * this.m31 + this.m32 * this.m32))));
    }
    ...
    public Double4x3 lerp(Double4x3R other, double t, @Mutated Double4x3 dest) {
        ...
        d.m32 = t * (other.m32() - this.m32) + this.m32;
        return d;
    }
    ...
    public Double4x3 mul(Double3x3R right, @Mutated Double4x3 dest) {
        ...
        double _r18 = this.m30;
        double _r19 = this.m31;
    ...
    public Double4 mul(double vX, double vY, double vZ, @Mutated Double4 dest) {
        ...
        d.w = this.m30 * vX + this.m31 * vY + this.m32 * vZ;
        return d;
    }
