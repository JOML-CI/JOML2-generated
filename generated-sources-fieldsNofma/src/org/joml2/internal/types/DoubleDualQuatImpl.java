...
public final class DoubleDualQuatImpl implements DoubleDualQuat {
    ...
    public DoubleDualQuat sclerp(double otherRX, double otherRY, double otherRZ, double otherRW, double otherDX, double otherDY, double otherDZ, double otherDW, double t, @Mutated DoubleDualQuat dest) {
        ...
        double _t144 = Math.cos(_t143);
        double _t145 = Math.sin(_t143);
        double _t146 = _t138 * _t124;
        double _t147 = t * _t146;
        double _t148 = _t146 * _t119;
        double _t149, _t161, _t162, _t163, _t167;
        if (_t136 < 1.0E-28) {
            _t149 = 1.0;
            _t161 = t * _t117;
            _t162 = t * _t118;
        ...
        if (_t136 < 1.0E-28) {
            ...
            _t177 = (_t148 * _t139 + _t125) * _t138 * _t145 - _t154 * _t139;
            _t178 = (_t148 * _t140 + _t126) * _t138 * _t145 - _t154 * _t140;
            _t179 = (_t148 * _t142 + _t130) * _t138 * _t145 - _t154 * _t142;
        }
        double _buf0 = this.rX * _t149 + this.rW * _t161 + (this.rY * _t162 - this.rZ * _t163);
        double _buf1 = this.rY * _t149 + this.rZ * _t161 + (this.rW * _t163 - this.rX * _t162);
        double _buf2 = this.rX * _t163 + this.rW * _t162 + (this.rZ * _t149 - this.rY * _t161);
        double _buf3 = this.rW * _t149 - this.rX * _t161 - (this.rY * _t163 + this.rZ * _t162);
        double _buf4 = this.rX * _t167 + this.rW * _t177 + (this.rY * _t178 - this.rZ * _t179) + (this.dX * _t149 + this.dW * _t161 + (this.dY * _t162 - this.dZ * _t163));
        double _buf5 = this.rY * _t167 + this.rZ * _t177 + (this.rW * _t179 - this.rX * _t178) + (this.dY * _t149 + this.dZ * _t161 + (this.dW * _t163 - this.dX * _t162));
        double _buf6 = this.rX * _t179 + this.rW * _t178 + (this.rZ * _t167 - this.rY * _t177) + (this.dX * _t163 + this.dW * _t162 + (this.dZ * _t149 - this.dY * _t161));
        d.dW = this.rW * _t167 - this.rX * _t177 + (-(this.rY * _t179) - this.rZ * _t178) + (this.dW * _t149 - this.dX * _t161 + (-(this.dY * _t163) - this.dZ * _t162));
        d.rX = _buf0;
        d.rY = _buf1;
        d.rZ = _buf2;
        d.rW = _buf3;
