...
public final class DoubleDualQuatImpl implements DoubleDualQuat {
    ...
    @Mutated public DoubleDualQuat makeRotationLookAlong(double dirX, double dirY, double dirZ, double upX, double upY, double upZ) {
        ...
        if (_t56 > 0.0) {
            ...
            this.rY = _sp0 * _t38;
            this.rZ = _sp0 * _t54;
            this.rW = 0.5 * Math.sqrt(_t57);
        } else {
            if (_t27 > _t49) {
                this.rX = 0.5 * Math.sqrt(_t58);
                this.rY = _sp3 * _t53;
                this.rZ = _sp3 * _t37;
                this.rW = _sp3 * _t48;
            } else {
                if (_t43 > _t6) {
                    this.rX = _sp1 * _t53;
                    this.rY = 0.5 * Math.sqrt(_t59);
                    this.rZ = _sp1 * _t50;
                    this.rW = _sp1 * _t38;
                } else {
                    this.rX = _sp2 * _t37;
                    this.rY = _sp2 * _t50;
                    this.rZ = 0.5 * Math.sqrt(_t60);
                    this.rW = _sp2 * _t54;
                }
            }
        }
    ...
    @Mutated private DoubleDualQuat makeRotationLookAlong_degenerate(double dirX, double dirY, double dirZ, double upX, double upY, double upZ) {
        ...
        if (_t76 > 0.0) {
            ...
            this.rY = _sp0 * _t54;
            this.rZ = _sp0 * _t86;
            this.rW = 0.5 * Math.sqrt(_t77);
        } else {
            if (_t49 > _t72) {
                this.rX = 0.5 * Math.sqrt(_t78);
                this.rY = _sp3 * _t85;
                this.rZ = _sp3 * _t53;
                this.rW = _sp3 * _t75;
            } else {
                if (_t67 > _t13) {
                    this.rX = _sp1 * _t85;
                    this.rY = 0.5 * Math.sqrt(_t79);
                    this.rZ = _sp1 * _t74;
                    this.rW = _sp1 * _t54;
                } else {
                    this.rX = _sp2 * _t53;
                    this.rY = _sp2 * _t74;
                    this.rZ = 0.5 * Math.sqrt(_t80);
                    this.rW = _sp2 * _t86;
                }
            }
        }
