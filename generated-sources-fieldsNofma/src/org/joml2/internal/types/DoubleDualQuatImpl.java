...
public final class DoubleDualQuatImpl implements DoubleDualQuat {
    ...
    @Mutated public DoubleDualQuat makeFromAxisAngle(double axisX, double axisY, double axisZ, double angle, double translationX, double translationY, double translationZ) {
        ...
        this.rZ = _t4;
        this.rW = _t5;
        this.dX = 0.5 * (translationX * _t5 + translationY * _t4 - translationZ * _t3);
        this.dY = 0.5 * (translationY * _t5 - translationX * _t4 + translationZ * _t2);
        this.dZ = 0.5 * (translationX * _t3 - translationY * _t2 + translationZ * _t5);
        this.dW = 0.5 * (-(translationX * _t2) - translationY * _t3 - translationZ * _t4);
        return this;
    }
    ...
    public DoubleDualQuat invert(@Mutated DoubleDualQuat dest) {
        ...
        double _sp0 = 2.0 * (this.rX * this.dX + this.rY * this.dY + (this.rZ * this.dZ + this.rW * this.dW)) / (_t12 * _t12);
    ...
    private void toMatrix_s20bb8ca5_c0(Double4x4Impl _dst, double _t12, double _t10, double _t3, double _t2, double _t5, double _t4) {
        _dst.m00 = _t12 - _t10;
    ...
    private void toMatrix_s20bb8ca5_c1(Double4x4Impl _dst, double _t2, double _t3, double _t12, double _t11, double _t7, double _t8) {
    ...
    private void toMatrix_s20bb8ca5_c2(Double4x4Impl _dst, double _t4, double _t5, double _t7, double _t8, double _t10, double _t11) {
    ...
    private void toMatrix_s20bb8ca5_c3(Double4x4Impl _dst, double _r3, double _r4, double _r0, double _r5, double _r1, double _r6, double _r2, double _r7) {
        _dst.m03 = 2.0 * (_r3 * _r4 - _r0 * _r5 + (_r1 * _r6 - _r2 * _r7));
        _dst.m13 = 2.0 * (_r0 * _r6 - _r2 * _r4 + (_r1 * _r5 - _r3 * _r7));
        _dst.m23 = 2.0 * (_r2 * _r5 - _r3 * _r6 + (_r1 * _r4 - _r0 * _r7));
        _dst.m33 = 1.0;
    }
    ...
    public Double4x4 toMatrix(@Mutated Double4x4 dest) {
        ...
        double _t7 = _r2 * _r1;
        double _t8 = _r3 * _r0;
        double _t10 = (_r3 + _r3) * _r3;
        double _t11 = (_r2 + _r2) * _r2;
        double _t12 = 1.0 - (_r0 + _r0) * _r0;
    ...
    public Double3x3 toMatrix3x3(@Mutated Double3x3 dest) {
        ...
        double _t10 = (this.rY + this.rY) * this.rY;
        double _t11 = (this.rX + this.rX) * this.rX;
        double _t12 = 1.0 - (this.rZ + this.rZ) * this.rZ;
        d.m00 = _t12 - _t10;
        d.m10 = 2.0 * (_t3 + _t2);
        d.m20 = -2.0 * _t5 + (_t4 + _t4);
        d.m01 = -2.0 * _t2 + (_t3 + _t3);
        d.m11 = _t12 - _t11;
        d.m21 = 2.0 * (_t7 + _t8);
        d.m02 = 2.0 * (_t4 + _t5);
        d.m12 = -2.0 * _t7 + (_t8 + _t8);
        d.m22 = 1.0 - _t10 - _t11;
        d.properties = 0;
        return d;
    }
    ...
    private void toMatrix3x4_s38da5fc6_c0(Double3x4Impl _dst, double _t12, double _t10, double _t3, double _t2, double _t5, double _t4) {
        _dst.m00 = _t12 - _t10;
        _dst.m10 = 2.0 * (_t3 + _t2);
        _dst.m20 = -2.0 * _t5 + (_t4 + _t4);
    }
    ...
    private void toMatrix3x4_s38da5fc6_c1(Double3x4Impl _dst, double _t2, double _t3, double _t12, double _t11, double _t7, double _t8) {
        _dst.m01 = -2.0 * _t2 + (_t3 + _t3);
        _dst.m11 = _t12 - _t11;
        _dst.m21 = 2.0 * (_t7 + _t8);
    }
    ...
    private void toMatrix3x4_s38da5fc6_c2(Double3x4Impl _dst, double _t4, double _t5, double _t7, double _t8, double _t10, double _t11) {
        _dst.m02 = 2.0 * (_t4 + _t5);
        _dst.m12 = -2.0 * _t7 + (_t8 + _t8);
        _dst.m22 = 1.0 - _t10 - _t11;
    }
    ...
    private void toMatrix3x4_s38da5fc6_c3(Double3x4Impl _dst, double _r3, double _r4, double _r0, double _r5, double _r1, double _r6, double _r2, double _r7) {
        _dst.m03 = 2.0 * (_r3 * _r4 - _r0 * _r5 + (_r1 * _r6 - _r2 * _r7));
        _dst.m13 = 2.0 * (_r0 * _r6 - _r2 * _r4 + (_r1 * _r5 - _r3 * _r7));
        _dst.m23 = 2.0 * (_r2 * _r5 - _r3 * _r6 + (_r1 * _r4 - _r0 * _r7));
    }
    ...
    public DoubleDualQuat lookAlong(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated DoubleDualQuat dest) {
        ...
        double _buf0 = this.rX * _t105 + this.rW * _t106 + (this.rY * _t107 - this.rZ * _t108);
        double _buf1 = this.rY * _t105 + this.rZ * _t106 + (this.rW * _t108 - this.rX * _t107);
        double _buf2 = this.rX * _t108 + this.rW * _t107 + (this.rZ * _t105 - this.rY * _t106);
        d.rW = this.rW * _t105 - this.rX * _t106 - (this.rY * _t108 + this.rZ * _t107);
        double _buf3 = this.dX * _t105 + this.dW * _t106 + (this.dY * _t107 - this.dZ * _t108);
        double _buf4 = this.dY * _t105 + this.dZ * _t106 + (this.dW * _t108 - this.dX * _t107);
        double _buf5 = this.dX * _t108 + this.dW * _t107 + (this.dZ * _t105 - this.dY * _t106);
    ...
    private DoubleDualQuat lookAlong_degenerate(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated DoubleDualQuat dest) {
        ...
        double _buf0 = this.rX * _t129 + this.rW * _t130 + (this.rY * _t127 - this.rZ * _t128);
        double _buf1 = this.rY * _t129 + this.rZ * _t130 + (this.rW * _t128 - this.rX * _t127);
        double _buf2 = this.rX * _t128 + this.rW * _t127 + (this.rZ * _t129 - this.rY * _t130);
        d.rW = this.rW * _t129 - this.rX * _t130 - (this.rY * _t128 + this.rZ * _t127);
        double _buf3 = this.dX * _t129 + this.dW * _t130 + (this.dY * _t127 - this.dZ * _t128);
        double _buf4 = this.dY * _t129 + this.dZ * _t130 + (this.dW * _t128 - this.dX * _t127);
        double _buf5 = this.dX * _t128 + this.dW * _t127 + (this.dZ * _t129 - this.dY * _t130);
    ...
    private void makeRotationLookAlong_s6a304d84_c0(DoubleDualQuatImpl _dst, double _t56, double _sp0, double _t48, double _t27, double _t49, double _t58, double _t43, double _t6, double _sp1, double _t53, double _sp2, double _t37, double _t38, double _sp3, double _t59, double _t50, double _t54, double _t60, double _t57) {
        _dst.rX = _t56 > 0.0 ? _sp0 * _t48 : _t27 > _t49 ? 0.5 * Math.sqrt(_t58) : _t43 > _t6 ? _sp1 * _t53 : _sp2 * _t37;
        _dst.rY = _t56 > 0.0 ? _sp0 * _t38 : _t27 > _t49 ? _sp3 * _t53 : _t43 > _t6 ? 0.5 * Math.sqrt(_t59) : _sp2 * _t50;
        _dst.rZ = _t56 > 0.0 ? _sp0 * _t54 : _t27 > _t49 ? _sp3 * _t37 : _t43 > _t6 ? _sp1 * _t50 : 0.5 * Math.sqrt(_t60);
        _dst.rW = _t56 > 0.0 ? 0.5 * Math.sqrt(_t57) : _t27 > _t49 ? _sp3 * _t48 : _t43 > _t6 ? _sp1 * _t38 : _sp2 * _t54;
    }
    ...
    private void makeRotationLookAlong_s6a304d84_tail(DoubleDualQuatImpl _dst, double _t43, double _t27, double _t6, double _t31, double _t32, double _t30, double _t48, double _t49, double _t53, double _t37, double _t38, double _t50, double _t54) {
        double _t56 = _t43 + _t27 + _t6;
        double _t57 = _t31 + (_t27 + (_t6 + 1.0) - _t32);
        double _t58 = _t27 + (_t32 + (1.0 - _t6) - _t31);
        double _t59 = _t31 + (_t30 - _t6 - _t32);
    ...
    private void makeRotationLookAlong_degenerate_s6a304d84_c0(DoubleDualQuatImpl _dst, double _t76, double _sp0, double _t75, double _t49, double _t72, double _t78, double _t67, double _t13, double _sp1, double _t85, double _sp2, double _t53, double _t54, double _sp3, double _t79, double _t74, double _t86, double _t80, double _t77) {
        _dst.rX = _t76 > 0.0 ? _sp0 * _t75 : _t49 > _t72 ? 0.5 * Math.sqrt(_t78) : _t67 > _t13 ? _sp1 * _t85 : _sp2 * _t53;
        _dst.rY = _t76 > 0.0 ? _sp0 * _t54 : _t49 > _t72 ? _sp3 * _t85 : _t67 > _t13 ? 0.5 * Math.sqrt(_t79) : _sp2 * _t74;
        _dst.rZ = _t76 > 0.0 ? _sp0 * _t86 : _t49 > _t72 ? _sp3 * _t53 : _t67 > _t13 ? _sp1 * _t74 : 0.5 * Math.sqrt(_t80);
        _dst.rW = _t76 > 0.0 ? 0.5 * Math.sqrt(_t77) : _t49 > _t72 ? _sp3 * _t75 : _t67 > _t13 ? _sp1 * _t54 : _sp2 * _t86;
    }
    ...
    private void makeRotationLookAlong_degenerate_s6a304d84_tail(DoubleDualQuatImpl _dst, double _t10, double _t14, double _t12, double _t11, double _t15, double _t16, double _t13, double _t29, double _t30, double _t28, double _t27, double _t17, double _t19, double _t20) {
        double _t31 = _t10 * _t14 - _t12 * _t11;
    ...
    /** Private tail of {@code makeRotationLookAlong_degenerate}; reached only through it. */
    private void makeRotationLookAlong_degenerate_s6a304d84_tail2(DoubleDualQuatImpl _dst, double _t61, double _t14, double _t57, double _t17, double _t55, double _t49, double _t13, double _t51, double _t19, double _t20, double _t71, double _t50, double _t72, double _t67, double _t53, double _t54) {
        double _t74 = _t61 + (_t14 - _t57);
        double _t75 = _t61 + (_t17 - _t57);
        double _t76 = _t55 + (_t49 + _t13 - _t51);
        double _t77 = _t55 + (_t49 + _t19 - _t51);
    ...
    public DoubleDualQuat preRotate(double rotationX, double rotationY, double rotationZ, double rotationW, @Mutated DoubleDualQuat dest) {
        DoubleDualQuatImpl d = (DoubleDualQuatImpl) dest;
        double _buf0 = rotationX * this.rW + rotationW * this.rX + (rotationY * this.rZ - rotationZ * this.rY);
        double _buf1 = rotationY * this.rW + rotationZ * this.rX + (rotationW * this.rY - rotationX * this.rZ);
        double _buf2 = rotationX * this.rY + rotationW * this.rZ + (rotationZ * this.rW - rotationY * this.rX);
        d.rW = rotationW * this.rW - rotationX * this.rX - (rotationY * this.rY + rotationZ * this.rZ);
        double _buf3 = rotationX * this.dW + rotationW * this.dX + (rotationY * this.dZ - rotationZ * this.dY);
        double _buf4 = rotationY * this.dW + rotationZ * this.dX + (rotationW * this.dY - rotationX * this.dZ);
        double _buf5 = rotationX * this.dY + rotationW * this.dZ + (rotationZ * this.dW - rotationY * this.dX);
    ...
    public DoubleDualQuat rotateX(double angle, @Mutated DoubleDualQuat dest) {
        ...
        double _buf2 = this.dX * _t2 + this.dW * _t1;
        double _buf3 = this.dY * _t2 + this.dZ * _t1;
    ...
    public DoubleDualQuat rotateY(double angle, @Mutated DoubleDualQuat dest) {
        ...
        double _buf2 = this.dX * _t2 - this.dZ * _t1;
        double _buf3 = this.dY * _t2 + this.dW * _t1;
    ...
    public DoubleDualQuat rotateZ(double angle, @Mutated DoubleDualQuat dest) {
        ...
        double _buf2 = this.dX * _t2 + this.dY * _t1;
        d.dY = this.dY * _t2 - this.dX * _t1;
        double _buf3 = this.dZ * _t2 + this.dW * _t1;
