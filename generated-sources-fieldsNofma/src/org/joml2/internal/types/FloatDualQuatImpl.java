...
public final class FloatDualQuatImpl implements FloatDualQuat {
    ...
    private void makeRotationLookAlong_s524747ee_c0(FloatDualQuatImpl _dst, float _t56, float _sp0, float _t48, float _t27, float _t49, float _t58, float _t43, float _t6, float _sp1, float _t53, float _sp2, float _t37, float _t38, float _sp3, float _t59, float _t50, float _t54, float _t60, float _t57) {
        _dst.rX = _t56 > 0.0f ? _sp0 * _t48 : _t27 > _t49 ? 0.5f * (float) Math.sqrt(_t58) : _t43 > _t6 ? _sp1 * _t53 : _sp2 * _t37;
        _dst.rY = _t56 > 0.0f ? _sp0 * _t38 : _t27 > _t49 ? _sp3 * _t53 : _t43 > _t6 ? 0.5f * (float) Math.sqrt(_t59) : _sp2 * _t50;
        _dst.rZ = _t56 > 0.0f ? _sp0 * _t54 : _t27 > _t49 ? _sp3 * _t37 : _t43 > _t6 ? _sp1 * _t50 : 0.5f * (float) Math.sqrt(_t60);
        _dst.rW = _t56 > 0.0f ? 0.5f * (float) Math.sqrt(_t57) : _t27 > _t49 ? _sp3 * _t48 : _t43 > _t6 ? _sp1 * _t38 : _sp2 * _t54;
    }
    ...
    private void makeRotationLookAlong_s524747ee_tail(FloatDualQuatImpl _dst, float _t43, float _t27, float _t6, float _t31, float _t32, float _t30, float _t48, float _t49, float _t53, float _t37, float _t38, float _t50, float _t54) {
        float _t56 = _t43 + _t27 + _t6;
        float _t57 = _t31 + (_t27 + (_t6 + 1.0f) - _t32);
        float _t58 = _t27 + (_t32 + (1.0f - _t6) - _t31);
        float _t59 = _t31 + (_t30 - _t6 - _t32);
    ...
    private void makeRotationLookAlong_degenerate_s524747ee_c0(FloatDualQuatImpl _dst, float _t76, float _sp0, float _t75, float _t49, float _t72, float _t78, float _t67, float _t13, float _sp1, float _t85, float _sp2, float _t53, float _t54, float _sp3, float _t79, float _t74, float _t86, float _t80, float _t77) {
        _dst.rX = _t76 > 0.0f ? _sp0 * _t75 : _t49 > _t72 ? 0.5f * (float) Math.sqrt(_t78) : _t67 > _t13 ? _sp1 * _t85 : _sp2 * _t53;
        _dst.rY = _t76 > 0.0f ? _sp0 * _t54 : _t49 > _t72 ? _sp3 * _t85 : _t67 > _t13 ? 0.5f * (float) Math.sqrt(_t79) : _sp2 * _t74;
        _dst.rZ = _t76 > 0.0f ? _sp0 * _t86 : _t49 > _t72 ? _sp3 * _t53 : _t67 > _t13 ? _sp1 * _t74 : 0.5f * (float) Math.sqrt(_t80);
        _dst.rW = _t76 > 0.0f ? 0.5f * (float) Math.sqrt(_t77) : _t49 > _t72 ? _sp3 * _t75 : _t67 > _t13 ? _sp1 * _t54 : _sp2 * _t86;
    }
    ...
    private void makeRotationLookAlong_degenerate_s524747ee_tail(FloatDualQuatImpl _dst, float _t10, float _t14, float _t12, float _t11, float _t15, float _t16, float _t13, float _t29, float _t30, float _t28, float _t27, float _t17, float _t19, float _t20) {
        float _t31 = _t10 * _t14 - _t12 * _t11;
    ...
    /** Private tail of {@code makeRotationLookAlong_degenerate}; reached only through it. */
    private void makeRotationLookAlong_degenerate_s524747ee_tail2(FloatDualQuatImpl _dst, float _t61, float _t14, float _t57, float _t17, float _t55, float _t49, float _t13, float _t51, float _t19, float _t20, float _t71, float _t50, float _t72, float _t67, float _t53, float _t54) {
        float _t74 = _t61 + (_t14 - _t57);
        float _t75 = _t61 + (_t17 - _t57);
        float _t76 = _t55 + (_t49 + _t13 - _t51);
        float _t77 = _t55 + (_t49 + _t19 - _t51);
    ...
    public FloatDualQuat preRotate(float rotationX, float rotationY, float rotationZ, float rotationW, @Mutated FloatDualQuat dest) {
        FloatDualQuatImpl d = (FloatDualQuatImpl) dest;
        float _buf0 = rotationX * this.rW + rotationW * this.rX + (rotationY * this.rZ - rotationZ * this.rY);
        float _buf1 = rotationY * this.rW + rotationZ * this.rX + (rotationW * this.rY - rotationX * this.rZ);
        float _buf2 = rotationX * this.rY + rotationW * this.rZ + (rotationZ * this.rW - rotationY * this.rX);
        d.rW = rotationW * this.rW - rotationX * this.rX - (rotationY * this.rY + rotationZ * this.rZ);
        float _buf3 = rotationX * this.dW + rotationW * this.dX + (rotationY * this.dZ - rotationZ * this.dY);
        float _buf4 = rotationY * this.dW + rotationZ * this.dX + (rotationW * this.dY - rotationX * this.dZ);
        float _buf5 = rotationX * this.dY + rotationW * this.dZ + (rotationZ * this.dW - rotationY * this.dX);
