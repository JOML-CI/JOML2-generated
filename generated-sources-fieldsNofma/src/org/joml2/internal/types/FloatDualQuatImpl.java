...
public final class FloatDualQuatImpl implements FloatDualQuat {
    ...
    public FloatDualQuat sclerp(float otherRX, float otherRY, float otherRZ, float otherRW, float otherDX, float otherDY, float otherDZ, float otherDW, float t, @Mutated FloatDualQuat dest) {
        ...
        float _t144 = (float) Math.cos(_t143);
        float _t145 = (float) Math.sin(_t143);
        float _t146 = _t138 * _t124;
        float _t147 = t * _t146;
        float _t148 = _t146 * _t119;
        float _t149, _t161, _t162, _t163, _t167;
        if (_t136 < 1.0E-12f) {
            _t149 = 1.0f;
            _t161 = t * _t117;
            _t162 = t * _t118;
        ...
        float _buf0 = this.rX * _t149 + this.rW * _t161 + (this.rY * _t162 - this.rZ * _t163);
        float _buf1 = this.rY * _t149 + this.rZ * _t161 + (this.rW * _t163 - this.rX * _t162);
        float _buf2 = this.rX * _t163 + this.rW * _t162 + (this.rZ * _t149 - this.rY * _t161);
        float _buf3 = this.rW * _t149 - this.rX * _t161 - (this.rY * _t163 + this.rZ * _t162);
        float _buf4 = this.rX * _t167 + this.rW * _t177 + (this.rY * _t178 - this.rZ * _t179) + (this.dX * _t149 + this.dW * _t161 + (this.dY * _t162 - this.dZ * _t163));
        float _buf5 = this.rY * _t167 + this.rZ * _t177 + (this.rW * _t179 - this.rX * _t178) + (this.dY * _t149 + this.dZ * _t161 + (this.dW * _t163 - this.dX * _t162));
        float _buf6 = this.rX * _t179 + this.rW * _t178 + (this.rZ * _t167 - this.rY * _t177) + (this.dX * _t163 + this.dW * _t162 + (this.dZ * _t149 - this.dY * _t161));
    ...
    public FloatDualQuat pow(float t, @Mutated FloatDualQuat dest) {
        ...
        float _t31 = (float) Math.cos(_t28);
        float _t32 = _t27 * _t11;
        float _t33 = _t29 * _t31;
        if (_t20 < 1.0E-12f) {
            d.rX = t * _t8;
            d.rY = t * _t9;
            d.rZ = t * _t10;
    ...
    public Float4x4 toMatrix(@Mutated Float4x4 dest) {
        ...
        d.m30 = 0.0f;
        float _buf2 = -2.0f * _t2 + (_t3 + _t3);
        float _buf3 = _t12 - _t11;
        d.m21 = 2.0f * (_t7 + _t8);
        d.m31 = 0.0f;
        float _buf4 = 2.0f * (_t4 + _t5);
        float _buf5 = -2.0f * _t7 + (_t8 + _t8);
