...
public final class FloatDualQuatImpl implements FloatDualQuat {
    ...
    public FloatDualQuat sclerp(float otherRX, float otherRY, float otherRZ, float otherRW, float otherDX, float otherDY, float otherDZ, float otherDW, float t, @Mutated FloatDualQuat dest) {
        ...
        float _t92 = this.rX * _t9 + this.rW * _t10 + this.rY * _t11 + this.rZ * _t12;
        ...
        float _t101 = this.rX * _t12 + this.rW * _t11 + (-(this.rY * _t10) - this.rZ * _t9);
        float _t108 = this.rX * _t13 + this.rW * _t14 + (this.rY * _t15 + this.rZ * _t16) + (this.dX * _t9 + this.dW * _t10 + (this.dY * _t11 + this.dZ * _t12));
        float _t109 = this.rZ * _t15 - this.rY * _t16 + (this.rW * _t13 - this.rX * _t14) + (this.dZ * _t11 - this.dY * _t12 + (this.dW * _t9 - this.dX * _t10));
        float _t110 = this.rY * _t13 - this.rZ * _t14 + (this.rW * _t16 - this.rX * _t15) + (this.dY * _t9 - this.dZ * _t10 + (this.dW * _t12 - this.dX * _t11));
        float _t114 = this.rX * _t16 + this.rW * _t15 + (-(this.rY * _t14) - this.rZ * _t13) + (this.dX * _t12 + this.dW * _t11 + (-(this.dY * _t10) - this.dZ * _t9));
        float _t116, _t117, _t118, _t119, _t123, _t124, _t125, _t129;
        if (_t92 < 0.0f) {
            _t116 = -_t93;
            _t117 = -_t94;
            _t118 = -_t92;
        ...
        float _t135 = _t119 * _t119 + _t116 * _t116 + _t117 * _t117;
        float _t137 = (1.0f / (float) Math.sqrt(_t135));
        float _t139 = _t137 * _t116;
        float _t140 = _t137 * _t117;
        float _t141 = t * (float) Math.atan2((float) Math.sqrt(_t135), _t118);
        float _t142 = _t137 * _t119;
        float _t143 = (float) Math.cos(_t141);
        float _t144 = (float) Math.sin(_t141);
        float _t145 = _t137 * _t123;
        float _t146 = t * _t145;
        float _t147 = _t145 * _t118;
        float _t148, _t160, _t161, _t162, _t166;
        if (_t135 < 1.0E-12f) {
            _t148 = 1.0f;
            _t160 = t * _t116;
            _t161 = t * _t117;
        ...
        float _t153 = _t146 * _t143;
        float _t176, _t177, _t178;
        if (_t135 < 1.0E-12f) {
            _t176 = t * _t124;
            _t177 = t * _t125;
            _t178 = t * _t129;
        ...
        float _buf0 = this.rX * _t148 + this.rW * _t160 + (this.rY * _t161 - this.rZ * _t162);
        float _buf1 = this.rY * _t148 + this.rZ * _t160 + (this.rW * _t162 - this.rX * _t161);
        float _buf2 = this.rX * _t162 + this.rW * _t161 + (this.rZ * _t148 - this.rY * _t160);
        float _buf3 = this.rW * _t148 - this.rX * _t160 - this.rY * _t162 - this.rZ * _t161;
        float _buf4 = this.rX * _t166 + this.rW * _t176 + (this.rY * _t177 - this.rZ * _t178) + (this.dX * _t148 + this.dW * _t160 + (this.dY * _t161 - this.dZ * _t162));
        float _buf5 = this.rY * _t166 + this.rZ * _t176 + (this.rW * _t178 - this.rX * _t177) + (this.dY * _t148 + this.dZ * _t160 + (this.dW * _t162 - this.dX * _t161));
        float _buf6 = this.rX * _t178 + this.rW * _t177 + (this.rZ * _t166 - this.rY * _t176) + (this.dX * _t162 + this.dW * _t161 + (this.dZ * _t148 - this.dY * _t160));
