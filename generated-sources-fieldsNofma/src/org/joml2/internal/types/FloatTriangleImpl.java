...
public final class FloatTriangleImpl implements FloatTriangle {
    ...
    public FloatTriangle transform(Float3x4R m, @Mutated FloatTriangle dest) {
        ...
        float _buf0 = m.m02() * this.v0Z + (m.m00() * this.v0X + (m.m01() * this.v0Y + m.m03()));
        float _buf1 = m.m12() * this.v0Z + (m.m10() * this.v0X + (m.m11() * this.v0Y + m.m13()));
        d.v0Z = m.m22() * this.v0Z + (m.m20() * this.v0X + (m.m21() * this.v0Y + m.m23()));
        float _buf2 = m.m02() * this.v1Z + (m.m00() * this.v1X + (m.m01() * this.v1Y + m.m03()));
        float _buf3 = m.m12() * this.v1Z + (m.m10() * this.v1X + (m.m11() * this.v1Y + m.m13()));
        d.v1Z = m.m22() * this.v1Z + (m.m20() * this.v1X + (m.m21() * this.v1Y + m.m23()));
        float _buf4 = m.m02() * this.v2Z + (m.m00() * this.v2X + (m.m01() * this.v2Y + m.m03()));
        float _buf5 = m.m12() * this.v2Z + (m.m10() * this.v2X + (m.m11() * this.v2Y + m.m13()));
    ...
    public float area() {
        ...
        return 0.5f * (float) Math.sqrt(_t12 * _t12 + _t13 * _t13 + _t14 * _t14);
    }
