...
public class Double2x3Impl implements Double2x3 {
    ...
    public double frobeniusNorm() {
        return Math.sqrt(this.m00 * this.m00 + this.m01 * this.m01 + this.m02 * this.m02 + this.m10 * this.m10 + this.m11 * this.m11 + this.m12 * this.m12);
    }
    ...
    private Double2x3 invert_general(@Mutated Double2x3 dest) {
        ...
        double _buf4 = -((this.m02 * this.m11 - this.m01 * this.m12) * _t2_inv);
        d.m12 = -((this.m00 * this.m12 - this.m02 * this.m10) * _t2_inv);
        d.m00 = _buf0;
        d.m10 = _buf1;
        d.m01 = _buf2;
        d.m11 = _buf3;
    ...
    private Double2x3 invertProduct_general(Double2x3R other, @Mutated Double2x3 dest, int _props) {
        ...
        double _t18 = other.m02() * this.m00 + (other.m12() * this.m01 + this.m02);
        double _t19 = other.m02() * this.m10 + (other.m12() * this.m11 + this.m12);
        ...
        d.m01 = -(_t17 * _t22_inv);
        d.m11 = _t15 * _t22_inv;
        d.m02 = -((_t18 * _t14 - _t19 * _t17) * _t22_inv);
        d.m12 = -((_t19 * _t15 - _t18 * _t16) * _t22_inv);
        d.properties = _props;
        return d;
    }
    ...
    private Double2x3 invertProduct_identity(Double2x3R other, @Mutated Double2x3 dest) {
        ...
        double _buf4 = -((other.m02() * other.m11() - other.m01() * other.m12()) * _t2_inv);
        d.m12 = -((other.m00() * other.m12() - other.m02() * other.m10()) * _t2_inv);
        d.m00 = _buf0;
        d.m10 = _buf1;
        d.m01 = _buf2;
        d.m11 = _buf3;
    ...
    private Double2x3 invertProduct_translation(Double2x3R other, @Mutated Double2x3 dest) {
        ...
        d.m02 = -((other.m11() * _t2 - other.m01() * _t3) * _t4_inv);
        d.m12 = -((other.m00() * _t3 - other.m10() * _t2) * _t4_inv);
        d.m00 = _buf0;
        d.m10 = _buf1;
        d.m01 = _buf2;
        d.m11 = _buf3;
    ...
    private Double2x3 invertProduct_general_translation(Double2x3R other, @Mutated Double2x3 dest) {
        ...
        double _t9 = other.m02() * this.m00 + (other.m12() * this.m01 + this.m02);
        double _t10 = other.m02() * this.m10 + (other.m12() * this.m11 + this.m12);
        double _buf0 = this.m11 * _t8_inv;
        double _buf1 = -(this.m10 * _t8_inv);
        double _buf2 = -(this.m01 * _t8_inv);
        double _buf3 = this.m00 * _t8_inv;
        d.m02 = -((this.m11 * _t9 - this.m01 * _t10) * _t8_inv);
        d.m12 = -((this.m00 * _t10 - this.m10 * _t9) * _t8_inv);
        d.m00 = _buf0;
        d.m10 = _buf1;
        d.m01 = _buf2;
        d.m11 = _buf3;
    ...
    public Double2x3 invertProduct(double m00, double m01, double m02, double m10, double m11, double m12, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        double _t14 = m01 * this.m10 + m11 * this.m11;
        double _t15 = m00 * this.m00 + m10 * this.m01;
        double _t16 = m00 * this.m10 + m10 * this.m11;
        double _t17 = m01 * this.m00 + m11 * this.m01;
        double _t18 = m02 * this.m00 + (m12 * this.m01 + this.m02);
        double _t19 = m02 * this.m10 + (m12 * this.m11 + this.m12);
        double _t22 = _t15 * _t14 - _t16 * _t17;
        double _t22_inv = 1.0 / _t22;
        d.m00 = _t14 * _t22_inv;
        d.m10 = -(_t16 * _t22_inv);
     ...
     */
    private Double2x3 mul_identity_self(double scalar, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        d.m00 = scalar;
        d.m11 = scalar;
        d.properties = Joml.BIT_AFFINE;
     ...
     * the public {@code mul} dispatcher.
     */
    private Double2x3 mul_translation(double scalar, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        d.m00 = scalar;
        d.m10 = 0.0;
        d.m01 = 0.0;
     ...
     * the public {@code mul} dispatcher.
     */
    private Double2x3 mul_general(double scalar, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
     ...
     * the public {@code lerp} dispatcher.
     */
    private Double2x3 lerp_orthogonal_identity(Double2x3R other, double t, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
     ...
     * the public {@code lerp} dispatcher.
     */
    private Double2x3 lerp_general_identity(Double2x3R other, double t, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
    ...
    public Double2x3 mul(double m00, double m01, double m02, double m10, double m11, double m12, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        double _buf0 = m00 * this.m00 + m10 * this.m01;
        double _buf1 = m00 * this.m10 + m10 * this.m11;
        double _buf2 = m01 * this.m00 + m11 * this.m01;
        double _buf3 = m01 * this.m10 + m11 * this.m11;
    ...
    public Double2x3 preMul(double m00, double m01, double m02, double m10, double m11, double m12, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        double _buf0 = m00 * this.m00 + m01 * this.m10;
        d.m10 = m10 * this.m00 + m11 * this.m10;
        double _buf1 = m00 * this.m01 + m01 * this.m11;
        d.m11 = m10 * this.m01 + m11 * this.m11;
        double _buf2 = m00 * this.m02 + (m01 * this.m12 + m02);
     ...
     */
    private Double2x3 addScaled_general(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x3 addScaled_identity(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x3 addScaled_translation(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        d.m00 = weight * other.m00() + 1.0;
        d.m10 = weight * other.m10();
        d.m01 = weight * other.m01();
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x3 addScaled_identity_identity(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x3 addScaled_identity_translation(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        double _t0 = 1.0 + weight;
        d.m00 = _t0;
        d.m10 = 0.0;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x3 addScaled_translation_identity(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        double _t0 = 1.0 + weight;
        d.m00 = _t0;
        d.m10 = 0.0;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x3 addScaled_translation_translation(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        double _t0 = 1.0 + weight;
        d.m00 = _t0;
        d.m10 = 0.0;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x3 addScaled_orthogonal_identity(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Double2x3 addScaled_orthogonal_translation(Double2x3R other, double weight, @Mutated Double2x3 dest) {
        Double2x3Impl d = (Double2x3Impl) dest;
        d.m00 = weight + this.m00;
        d.m10 = this.m10;
        d.m01 = this.m01;
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated public Double2x3 addScaled(Double2x3R other, double weight) {
        if (Joml.RETURN_NEW) return addScaled(other, weight, Joml.double2x3());
        int p = this.properties;
        int q = ((Double2x3Impl) other).properties;
        if ((p & Joml.BIT_IDENTITY) == Joml.BIT_IDENTITY) {
