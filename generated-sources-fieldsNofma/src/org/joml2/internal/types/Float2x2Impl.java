...
public class Float2x2Impl implements Float2x2 {
    ...
    public float frobeniusNorm() {
        return (float) Math.sqrt(this.m00 * this.m00 + this.m01 * this.m01 + this.m10 * this.m10 + this.m11 * this.m11);
    }
    ...
    private Float2x2 invertProduct_general(Float2x2R other, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _t8 = other.m01() * this.m10 + other.m11() * this.m11;
        float _t9 = other.m00() * this.m00 + other.m10() * this.m01;
        float _t10 = other.m00() * this.m10 + other.m10() * this.m11;
        float _t11 = other.m01() * this.m00 + other.m11() * this.m01;
        float _t14 = _t9 * _t8 - _t10 * _t11;
    ...
    private Float2x2 invertProduct_translation(Float2x2R other, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _t2 = other.m10() * this.m01 + other.m00();
        float _t3 = other.m11() * this.m01 + other.m01();
        float _t6 = other.m11() * _t2 - other.m10() * _t3;
    ...
    private Float2x2 invertProduct_orthogonal(Float2x2R other, @Mutated Float2x2 dest, int _props) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _t4 = other.m00() * this.m00 + other.m10() * this.m01;
        float _t5 = other.m01() * this.m00 + other.m11() * this.m01;
        float _t8 = other.m11() * _t4 - other.m10() * _t5;
    ...
    private Float2x2 invertProduct_general_translation(Float2x2R other, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _t2 = other.m01() * this.m10 + this.m11;
        float _t3 = other.m01() * this.m00 + this.m01;
        float _t6 = this.m00 * _t2 - this.m10 * _t3;
        float _t6_inv = 1.0f / _t6;
        float _buf0 = _t2 * _t6_inv;
    ...
    private Float2x2 invertProduct_general_affine(Float2x2R other, @Mutated Float2x2 dest) {
        ...
        float _t3 = other.m00() * this.m10;
        float _t4 = other.m01() * this.m10 + this.m11;
        float _t5 = other.m01() * this.m00 + this.m01;
        float _t8 = _t4 * _t1 - _t5 * _t3;
        float _t8_inv = 1.0f / _t8;
        d.m00 = _t4 * _t8_inv;
        d.m10 = -(_t3 * _t8_inv);
        d.m01 = -(_t5 * _t8_inv);
    ...
    public Float2x2 invertProduct(float m00, float m01, float m10, float m11, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _t8 = m01 * this.m10 + m11 * this.m11;
        float _t9 = m00 * this.m00 + m10 * this.m01;
        float _t10 = m00 * this.m10 + m10 * this.m11;
        float _t11 = m01 * this.m00 + m11 * this.m01;
        float _t14 = _t9 * _t8 - _t10 * _t11;
        float _t14_inv = 1.0f / _t14;
        d.m00 = _t8 * _t14_inv;
        d.m10 = -(_t10 * _t14_inv);
     ...
     */
    private Float2x2 mul_identity(float scalar, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = scalar;
        d.m10 = 0.0f;
        d.m01 = 0.0f;
     ...
     */
    private Float2x2 mul_identity_self(float scalar, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = scalar;
        d.m11 = scalar;
        d.properties = 0;
     ...
     * the public {@code lerp} dispatcher.
     */
    private Float2x2 lerp_general_identity(Float2x2R other, float t, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = t * (1.0f - this.m00) + this.m00;
    ...
    private Float2x2 mul_general_translation(Float2x2R right, @Mutated Float2x2 dest) {
        ...
        float _buf2 = right.m01() * this.m00 + this.m01;
    ...
    public Float2x2 mul(float m00, float m01, float m10, float m11, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _buf0 = m00 * this.m00 + m10 * this.m01;
        float _buf1 = m00 * this.m10 + m10 * this.m11;
    ...
    private Float2x2 preMul_translation(Float2x2R other, @Mutated Float2x2 dest, int _props) {
        ...
        float _buf2 = other.m00() * this.m01 + other.m01();
    ...
    public Float2x2 preMul(float m00, float m01, float m10, float m11, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _buf0 = m00 * this.m00 + m01 * this.m10;
        d.m10 = m10 * this.m00 + m11 * this.m10;
        float _buf1 = m00 * this.m01 + m01 * this.m11;
     ...
     */
    private Float2x2 addScaled_general(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_identity(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_translation(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = weight * other.m00() + 1.0f;
        d.m10 = weight * other.m10();
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_identity_identity(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_identity_translation(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _t0 = 1.0f + weight;
        d.m00 = _t0;
        d.m10 = 0.0f;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_identity_affine(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = weight * other.m00() + 1.0f;
        d.m10 = 0.0f;
        d.m01 = weight * other.m01();
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_translation_identity(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _t0 = 1.0f + weight;
        d.m00 = _t0;
        d.m10 = 0.0f;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_translation_translation(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        float _t0 = 1.0f + weight;
        d.m00 = _t0;
        d.m10 = 0.0f;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_translation_affine(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = weight * other.m00() + 1.0f;
        d.m10 = 0.0f;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_affine_identity(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_affine_translation(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = weight + this.m00;
        d.m10 = 0.0f;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_affine_affine(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = weight * other.m00() + this.m00;
        d.m10 = 0.0f;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_general_identity(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = weight + this.m00;
        d.m10 = this.m10;
        d.m01 = this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_general_translation(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = weight + this.m00;
        d.m10 = this.m10;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * through the public {@code addScaled} dispatcher.
     */
    private Float2x2 addScaled_general_affine(Float2x2R other, float weight, @Mutated Float2x2 dest) {
        Float2x2Impl d = (Float2x2Impl) dest;
        d.m00 = weight * other.m00() + this.m00;
        d.m10 = this.m10;
        d.m01 = weight * other.m01() + this.m01;
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated public Float2x2 addScaled(Float2x2R other, float weight) {
        if (Joml.RETURN_NEW) return addScaled(other, weight, Joml.float2x2());
        int p = this.properties;
        int q = ((Float2x2Impl) other).properties;
        if ((p & Joml.BIT_IDENTITY) == Joml.BIT_IDENTITY) {
