...
public final class FloatRigidImpl implements FloatRigid {
    ...
    @Mutated public FloatRigid makeFromMatrix(Float3x3R m) {
        ...
        if (_t61 > 0.0f) {
            this.rX = 0.5f * _t36 * _t66;
            this.rY = 0.5f * _t55 * _t66;
            this.rZ = 0.5f * _t56 * _t66;
            this.rW = 0.5f * (float) Math.sqrt(_t62);
        } else {
            if (_t47 > _t37) {
                this.rX = 0.5f * (float) Math.sqrt(_t63);
                this.rY = 0.5f * _t53 * _t69;
                this.rZ = 0.5f * _t54 * _t69;
                this.rW = 0.5f * _t36 * _t69;
            } else {
                if (_t18 > _t19) {
                    this.rX = 0.5f * _t53 * _t67;
                    this.rY = 0.5f * (float) Math.sqrt(_t64);
                    this.rZ = 0.5f * _t38 * _t67;
                    this.rW = 0.5f * _t55 * _t67;
                } else {
                    this.rX = 0.5f * _t54 * _t68;
                    this.rY = 0.5f * _t38 * _t68;
                    this.rZ = 0.5f * (float) Math.sqrt(_t65);
                    this.rW = 0.5f * _t56 * _t68;
                }
            }
        }
        this.tX = 0.0f;
    ...
    public Float4x4 toMatrix(@Mutated Float4x4 dest) {
        ...
        float _buf0 = 1.0f - 2.0f * (_t0 + _t1);
        d.m10 = 2.0f * (_t2 + _t3);
        d.m20 = 2.0f * (_t4 - _t5);
        d.m30 = 0.0f;
        float _buf1 = 2.0f * (_t2 - _t3);
    ...
    public FloatRigid preMul(float otherTX, float otherTY, float otherTZ, float otherRX, float otherRY, float otherRZ, float otherRW, @Mutated FloatRigid dest) {
        FloatRigidImpl d = (FloatRigidImpl) dest;
        float _t9 = 2.0f * (otherRX * this.tY - otherRY * this.tX);
        float _t10 = 2.0f * (otherRY * this.tZ - otherRZ * this.tY);
        float _t11 = 2.0f * (otherRZ * this.tX - otherRX * this.tZ);
    ...
    public FloatRigid invert(@Mutated FloatRigid dest) {
        FloatRigidImpl d = (FloatRigidImpl) dest;
        float _t9 = 2.0f * (this.tX * this.rZ - this.tZ * this.rX);
        float _t10 = 2.0f * (this.tZ * this.rY - this.tY * this.rZ);
        float _t11 = 2.0f * (this.tY * this.rX - this.tX * this.rY);
    ...
    public FloatRigid translate(float translationX, float translationY, float translationZ, @Mutated FloatRigid dest) {
        FloatRigidImpl d = (FloatRigidImpl) dest;
        float _t9 = 2.0f * (this.rX * translationY - this.rY * translationX);
        float _t10 = 2.0f * (this.rY * translationZ - this.rZ * translationY);
        float _t11 = 2.0f * (this.rZ * translationX - this.rX * translationZ);
