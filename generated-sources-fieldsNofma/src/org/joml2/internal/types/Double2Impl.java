...
public final class Double2Impl implements Double2 {
    ...
    private void slerp_s3e62c569_c0(Double2Impl _dst, double _t12, double _t44, double _sp0, double _t31, double _t15, double _t32) {
        _dst.x = _t12 * _t44 + _sp0 * _t31;
        _dst.y = _t15 * _t44 + _sp0 * _t32;
    }

    /** Private tail of {@code slerp}; reached only through it. */
    private void slerp_s3e62c569_tail(Double2Impl _dst, double _t20, double _t41, double _t40, double _t12, double _sp0, double _t31, double _t15, double _t32) {
        double _t44 = _t20 * Math.cosFromSin(_t41, _t40);
        slerp_s3e62c569_c0(_dst, _t12, _t44, _sp0, _t31, _t15, _t32);
    }
    ...
    public Double2 slerp(double otherX, double otherY, double t, @Mutated Double2 dest) {
        ...
        double _r0 = this.x;
        double _r1 = this.y;
        double _ct0 = _r0 * _r0 + _r1 * _r1;
        if (!(_ct0 > 2.2250738585072014E-308 && _ct0 < Double.POSITIVE_INFINITY)) return slerp_degenerate(otherX, otherY, t, dest);
        double _t6 = _ct0;
        double _ct1 = otherX * otherX + otherY * otherY;
        if (!(_ct1 > 2.2250738585072014E-308 && _ct1 < Double.POSITIVE_INFINITY)) return slerp_degenerate(otherX, otherY, t, dest);
        double _t7 = _ct1;
        double _t10 = Math.sqrt(_t6);
        double _t8 = 1.0 / _t10;
        double _t11 = (1.0 / Math.sqrt(_t7));
        double _t12 = _r0 * _t8;
        double _t13 = otherX * _t11;
        double _t14 = otherY * _t11;
        double _t15 = _r1 * _t8;
        double _t20 = t * (Math.sqrt(_t7) - _t10) + _t10;
        double _t21 = _t13 * _t12 + _t14 * _t15;
        double _t24 = _t13 - _t21 * _t12;
        double _t25 = _t14 - _t21 * _t15;
        double _t28 = _t24 * _t12 + _t25 * _t15;
        double _t31 = _t24 - _t28 * _t12;
        double _t32 = _t25 - _t28 * _t15;
        double _ct2 = _t31 * _t31 + _t32 * _t32;
        if (!(_ct2 > 2.2250738585072014E-308 && _ct2 < Double.POSITIVE_INFINITY)) return slerp_degenerate(otherX, otherY, t, dest);
        double _t36 = _ct2;
        double _t40 = t * Math.atan2(Math.sqrt(_t36), _t21);
        double _t41 = Math.sin(_t40);
        double _sp0 = _t20 * _t41 * (1.0 / Math.sqrt(_t36));
        slerp_s3e62c569_tail(d, _t20, _t41, _t40, _t12, _sp0, _t31, _t15, _t32);
        return d;
    }
     ...
     * through them.
     */
    private Double2 slerp_degenerate(Double2R other, double t, @Mutated Double2 dest) {
    ...
    private void slerp_degenerate_s3e62c569_c0(Double2Impl _dst, double _t26, double _t59, double _t53, double _t55, double _t49, double _t25, double _t61, double _t23, double t, double otherX, double _r0, double _t50, double otherY, double _r1) {
        _dst.x = _t26 > 0.0 ? _t59 * (_t53 > 0.0 ? _t55 * _t49 : -_t25) + _t61 * _t23 : t * (otherX - _r0) + _r0;
        _dst.y = _t26 > 0.0 ? _t59 * (_t53 > 0.0 ? _t55 * _t50 : _t23) + _t61 * _t25 : t * (otherY - _r1) + _r1;
    }

    /** Private tail of {@code slerp_degenerate}; reached only through it. */
    private void slerp_degenerate_s3e62c569_tail(Double2Impl _dst, double _t36, double _t39, double _t25, double _t42, double t, double _t32, double _t31, double _t26, double _t23, double otherX, double _r0, double otherY, double _r1) {
        double _t43 = _t36 - _t39 * _t25;
        double _t44 = unitScale(_t42, _t43, _t42);
        double _t49 = _t42 * _t44;
        double _t50 = _t43 * _t44;
        double _t53 = _t49 * _t49 + _t50 * _t50;
        double _t55 = (1.0 / Math.sqrt(_t53));
        double _t57 = t * Math.atan2(Math.sqrt(_t53), _t32 * _t44);
        double _t58 = Math.sin(_t57);
        double _t59 = _t31 * _t58;
        double _t61 = _t31 * Math.cosFromSin(_t58, _t57);
        slerp_degenerate_s3e62c569_c0(_dst, _t26, _t59, _t53, _t55, _t49, _t25, _t61, _t23, t, otherX, _r0, _t50, otherY, _r1);
    }
     ...
     * through them.
     */
    private Double2 slerp_degenerate(double otherX, double otherY, double t, @Mutated Double2 dest) {
        Double2Impl d = (Double2Impl) dest;
        double _r0 = this.x;
        double _r1 = this.y;
        double _t0 = unitScale(otherX, otherY, otherX);
        double _t1 = unitScale(_r0, _r1, _r0);
        double _t6 = otherX * _t0;
        double _t7 = otherY * _t0;
        double _t8 = _r0 * _t1;
        double _t9 = _r1 * _t1;
        double _t14 = _t6 * _t6 + _t7 * _t7;
        double _t15 = _t8 * _t8 + _t9 * _t9;
        double _t18 = (1.0 / Math.sqrt(_t14));
        double _t19 = (1.0 / Math.sqrt(_t15));
        double _t21 = Math.sqrt(_t15) / _t1;
        double _t22 = _t18 * _t6;
        double _t23 = _t19 * _t8;
        double _t24 = _t18 * _t7;
        double _t25 = _t19 * _t9;
        double _t26 = _t14 * _t15;
        double _t31 = t * (Math.sqrt(_t14) / _t0 - _t21) + _t21;
        double _t32 = _t22 * _t23 + _t24 * _t25;
        double _t35 = _t22 - _t32 * _t23;
        double _t36 = _t24 - _t32 * _t25;
        double _t39 = _t35 * _t23 + _t36 * _t25;
        double _t42 = _t35 - _t39 * _t23;
        slerp_degenerate_s3e62c569_tail(d, _t36, _t39, _t25, _t42, t, _t32, _t31, _t26, _t23, otherX, _r0, otherY, _r1);
        return d;
    }
     ...
     * through them.
     */
    @Mutated private Double2 slerp_degenerate(double otherX, double otherY, double t) {
        return slerp_degenerate(otherX, otherY, t, Joml.RETURN_NEW ? Joml.double2() : this);
    }
    ...
    public double angleBetween(double otherX, double otherY) {
        return Math.atan2(Math.abs(otherY * this.x - otherX * this.y), otherX * this.x + otherY * this.y);
    }
    ...
    public Double2 smoothstep(double edge0, double edge1, @Mutated Double2 dest) {
        ...
        d.x = (3.0 - (_t7 + _t7)) * _t7 * _t7;
        d.y = (3.0 - (_t8 + _t8)) * _t8 * _t8;
        return d;
    }
    ...
    public Double2 smoothstep(double edge0X, double edge0Y, double edge1X, double edge1Y, @Mutated Double2 dest) {
        ...
        d.x = (3.0 - (_t8 + _t8)) * _t8 * _t8;
        d.y = (3.0 - (_t9 + _t9)) * _t9 * _t9;
        return d;
    }
    ...
    public Double2 preMulPosition(Double4x4R mat, @Mutated Double2 dest) {
        Double2Impl d = (Double2Impl) dest;
        double _buf0 = mat.m00() * this.x + (mat.m01() * this.y + mat.m03());
