...
public class Float4x3Impl implements Float4x3 {
    ...
    public float frobeniusNorm() {
        return (float) Math.sqrt(this.m00 * this.m00 + (this.m01 * this.m01 + this.m02 * this.m02) + (this.m10 * this.m10 + (this.m11 * this.m11 + this.m12 * this.m12)) + (this.m20 * this.m20 + (this.m21 * this.m21 + this.m22 * this.m22) + (this.m30 * this.m30 + (this.m31 * this.m31 + this.m32 * this.m32))));
    }
