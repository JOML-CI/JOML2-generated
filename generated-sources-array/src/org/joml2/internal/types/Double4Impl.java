...
public final class Double4Impl implements Double4 {
    ...
    public Double4 project(double ontoX, double ontoY, double ontoZ, double ontoW, @Mutated Double4 dest) {
        double[] sd = this.data;
        double[] dd = ((Double4Impl) dest).data;
        double _sp0 = Math.fma(ontoW, sd[3], Math.fma(ontoZ, sd[2], Math.fma(ontoX, sd[0], ontoY * sd[1]))) / Math.fma(ontoW, ontoW, Math.fma(ontoZ, ontoZ, Math.fma(ontoX, ontoX, ontoY * ontoY)));
        dd[0] = ontoX * _sp0;
        dd[1] = ontoY * _sp0;
        dd[2] = ontoZ * _sp0;
        dd[3] = ontoW * _sp0;
