...
public final class FloatDualQuatImpl implements FloatDualQuat {
    ...
    public FloatDualQuat sclerp(float otherRX, float otherRY, float otherRZ, float otherRW, float otherDX, float otherDY, float otherDZ, float otherDW, float t, @Mutated FloatDualQuat dest) {
        ...
        float _t97 = Math.fma(sd[0], _t13, sd[3] * _t14) + Math.fma(sd[1], _t15, sd[2] * _t16) + (Math.fma(sd[4], _t9, sd[7] * _t10) + Math.fma(sd[5], _t12, sd[6] * _t11));
        float _t99 = Math.fma(sd[2], _t15, -(sd[1] * _t16)) + Math.fma(sd[3], _t13, -(sd[0] * _t14)) + (Math.fma(sd[6], _t12, -(sd[5] * _t11)) + Math.fma(sd[7], _t9, -(sd[4] * _t10)));
        float _t100 = Math.fma(sd[1], _t13, -(sd[2] * _t14)) + Math.fma(sd[3], _t16, -(sd[0] * _t15)) + (Math.fma(sd[5], _t9, -(sd[6] * _t10)) + Math.fma(sd[7], _t11, -(sd[4] * _t12)));
        float _t101 = Math.fma(sd[0], _t16, sd[3] * _t15) + Math.fma(_t0, _t13, -(sd[1] * _t14)) + (Math.fma(sd[4], _t11, sd[7] * _t12) + Math.fma(_t2, _t9, -(sd[5] * _t10)));
        ...
        float _buf0 = Math.fma(sd[0], _t142, sd[3] * _t143) + Math.fma(sd[1], _t144, -(sd[2] * _t145));
        float _buf1 = Math.fma(sd[1], _t142, sd[2] * _t143) + Math.fma(sd[3], _t145, -(sd[0] * _t144));
        float _buf2 = Math.fma(sd[0], _t145, sd[3] * _t144) + Math.fma(sd[2], _t142, -(sd[1] * _t143));
        float _buf3 = Math.fma(sd[3], _t142, -(sd[0] * _t143)) - Math.fma(sd[1], _t145, sd[2] * _t144);
        float _buf4 = Math.fma(sd[0], _t147, sd[3] * _t160) + Math.fma(sd[1], _t161, -(sd[2] * _t162)) + (Math.fma(sd[4], _t142, sd[7] * _t143) + Math.fma(sd[5], _t144, -(sd[6] * _t145)));
        float _buf5 = Math.fma(sd[1], _t147, sd[2] * _t160) + Math.fma(sd[3], _t162, -(sd[0] * _t161)) + (Math.fma(sd[5], _t142, sd[6] * _t143) + Math.fma(sd[7], _t145, -(sd[4] * _t144)));
    ...
    public FloatDualQuat mul(float otherRX, float otherRY, float otherRZ, float otherRW, float otherDX, float otherDY, float otherDZ, float otherDW, @Mutated FloatDualQuat dest) {
        ...
        float _buf3 = Math.fma(otherRW, sd[3], -(otherRX * sd[0])) - Math.fma(otherRY, sd[1], otherRZ * sd[2]);
    ...
    public FloatDualQuat difference(float otherRX, float otherRY, float otherRZ, float otherRW, float otherDX, float otherDY, float otherDZ, float otherDW, @Mutated FloatDualQuat dest) {
        ...
        float _buf2 = Math.fma(otherRX, sd[1], -(otherRW * sd[2])) + Math.fma(otherRZ, sd[3], -(otherRY * sd[0]));
        float _buf3 = Math.fma(otherRX, sd[0], otherRW * sd[3]) - Math.fma(-otherRZ, sd[2], -(otherRY * sd[1]));
        float _buf4 = Math.fma(otherRX, sd[7], -(otherRW * sd[4])) + Math.fma(otherRY, sd[6], -(otherRZ * sd[5])) + (Math.fma(otherDX, sd[3], -(otherDW * sd[0])) + Math.fma(otherDY, sd[2], -(otherDZ * sd[1])));
    ...
    public FloatDualQuat invert(@Mutated FloatDualQuat dest) {
        ...
        dd[4] = sd[0] * _sp0 - sd[4] * _t8_inv;
        dd[5] = sd[1] * _sp0 - sd[5] * _t8_inv;
        dd[6] = sd[2] * _sp0 - sd[6] * _t8_inv;
        dd[7] = sd[7] * _t8_inv - sd[3] * _sp0;
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[3] = _buf3;
    ...
    public Float3x4 toMatrix3x4(@Mutated Float3x4 dest) {
        ...
        float _t6 = Math.fma(-2.0f, sd[2] * sd[2], 1.0f);
        float _buf0 = Math.fma(-2.0f, _t0, _t6);
        float _buf1 = Math.fma(-2.0f, _t2, _sp0 * sd[1]);
        ...
        float _buf6 = Math.fma(-2.0f, sd[0] * sd[3], _t5 + _t5);
        float _buf7 = 2.0f * (Math.fma(sd[2], sd[4], -(sd[0] * sd[6])) + Math.fma(sd[3], sd[5], -(sd[1] * sd[7])));
        dd[8] = Math.fma(-2.0f, _t3, _sp0 * sd[2]);
    ...
    public FloatDualQuat lookAlong(float dirX, float dirY, float dirZ, float upX, float upY, float upZ, @Mutated FloatDualQuat dest) {
        ...
        float _buf3 = Math.fma(sd[4], _t111, sd[7] * _t108) + Math.fma(sd[5], _t109, -(sd[6] * _t110));
        float _buf4 = Math.fma(sd[5], _t111, sd[6] * _t108) + Math.fma(sd[7], _t110, -(sd[4] * _t109));
        float _buf5 = Math.fma(sd[4], _t110, sd[7] * _t109) + Math.fma(sd[6], _t111, -(sd[5] * _t108));
        dd[7] = Math.fma(sd[7], _t111, -(sd[4] * _t108)) - Math.fma(sd[5], _t110, sd[6] * _t109);
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[4] = _buf3;
    ...
    private FloatDualQuat lookAlong_degenerate(float dirX, float dirY, float dirZ, float upX, float upY, float upZ, @Mutated FloatDualQuat dest) {
        ...
        float _buf3 = Math.fma(sd[4], _t126, sd[7] * _t123) + Math.fma(sd[5], _t124, -(sd[6] * _t125));
        float _buf4 = Math.fma(sd[5], _t126, sd[6] * _t123) + Math.fma(sd[7], _t125, -(sd[4] * _t124));
        float _buf5 = Math.fma(sd[4], _t125, sd[7] * _t124) + Math.fma(sd[6], _t126, -(sd[5] * _t123));
        dd[7] = Math.fma(sd[7], _t126, -(sd[4] * _t123)) - Math.fma(sd[5], _t125, sd[6] * _t124);
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[4] = _buf3;
    ...
    @Mutated public FloatDualQuat makeRotationLookAlong(float dirX, float dirY, float dirZ, float upX, float upY, float upZ) {
        ...
        if (_t59 > 0.0f) {
            ...
            if (_t28 > _t53) {
                dd[0] = 0.5f * (float) Math.sqrt(_t62);
                dd[1] = _sp3 * _t56;
                dd[2] = _sp3 * _t33;
                dd[3] = _sp3 * _t52;
            } else {
    ...
    @Mutated private FloatDualQuat makeRotationLookAlong_degenerate(float dirX, float dirY, float dirZ, float upX, float upY, float upZ) {
        ...
        if (_t72 > 0.0f) {
            ...
            dd[1] = _sp0 * _t51;
            dd[2] = _sp0 * _t82;
            dd[3] = 0.5f * (float) Math.sqrt(_t73);
        } else {
            if (_t44 > _t68) {
                dd[0] = 0.5f * (float) Math.sqrt(_t74);
                dd[1] = _sp3 * _t81;
                dd[2] = _sp3 * _t48;
                dd[3] = _sp3 * _t71;
            } else {
                if (_t62 > _t12) {
                    dd[0] = _sp1 * _t81;
                    dd[1] = 0.5f * (float) Math.sqrt(_t76);
                    dd[2] = _sp1 * _t70;
                    dd[3] = _sp1 * _t51;
                } else {
                    dd[0] = _sp2 * _t48;
                    dd[1] = _sp2 * _t70;
                    dd[2] = 0.5f * (float) Math.sqrt(_t77);
                    dd[3] = _sp2 * _t82;
                }
            }
        }
    ...
    public FloatDualQuat preRotate(float rotationX, float rotationY, float rotationZ, float rotationW, @Mutated FloatDualQuat dest) {
        ...
        float _buf3 = Math.fma(rotationX, sd[7], rotationW * sd[4]) + Math.fma(rotationY, sd[6], -(rotationZ * sd[5]));
        float _buf4 = Math.fma(rotationY, sd[7], rotationZ * sd[4]) + Math.fma(rotationW, sd[5], -(rotationX * sd[6]));
        float _buf5 = Math.fma(rotationX, sd[5], rotationW * sd[6]) + Math.fma(rotationZ, sd[7], -(rotationY * sd[4]));
    ...
    public FloatDualQuat rotateAxis(float angle, float axisX, float axisY, float axisZ, @Mutated FloatDualQuat dest) {
        ...
        float _buf3 = Math.fma(sd[4], _t5, sd[7] * _t2) + Math.fma(sd[5], _t3, -(sd[6] * _t4));
        float _buf4 = Math.fma(sd[5], _t5, sd[6] * _t2) + Math.fma(sd[7], _t4, -(sd[4] * _t3));
        float _buf5 = Math.fma(sd[4], _t4, sd[7] * _t3) + Math.fma(sd[6], _t5, -(sd[5] * _t2));
        dd[7] = Math.fma(sd[7], _t5, -(sd[4] * _t2)) - Math.fma(sd[5], _t4, sd[6] * _t3);
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[4] = _buf3;
