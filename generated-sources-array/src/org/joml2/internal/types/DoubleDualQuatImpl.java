...
public final class DoubleDualQuatImpl implements DoubleDualQuat {
    ...
    public DoubleDualQuat sclerp(double otherRX, double otherRY, double otherRZ, double otherRW, double otherDX, double otherDY, double otherDZ, double otherDW, double t, @Mutated DoubleDualQuat dest) {
        ...
        double _buf0 = Math.fma(sd[0], _t135, sd[3] * _t144) + Math.fma(sd[1], _t145, -(sd[2] * _t146));
        double _buf1 = Math.fma(sd[1], _t135, sd[2] * _t144) + Math.fma(sd[3], _t146, -(sd[0] * _t145));
        double _buf2 = Math.fma(sd[0], _t146, sd[3] * _t145) + Math.fma(sd[2], _t135, -(sd[1] * _t144));
        double _buf3 = Math.fma(sd[3], _t135, -(sd[0] * _t144)) - Math.fma(sd[1], _t146, sd[2] * _t145);
        double _buf4 = Math.fma(sd[0], _t153, sd[3] * _t160) + Math.fma(sd[1], _t161, -(sd[2] * _t162)) + (Math.fma(sd[4], _t135, sd[7] * _t144) + Math.fma(sd[5], _t145, -(sd[6] * _t146)));
        double _buf5 = Math.fma(sd[1], _t153, sd[2] * _t160) + Math.fma(sd[3], _t162, -(sd[0] * _t161)) + (Math.fma(sd[5], _t135, sd[6] * _t144) + Math.fma(sd[7], _t146, -(sd[4] * _t145)));
