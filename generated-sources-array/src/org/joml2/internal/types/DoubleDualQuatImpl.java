...
public final class DoubleDualQuatImpl implements DoubleDualQuat {
    ...
    public DoubleDualQuat sclerp(double otherRX, double otherRY, double otherRZ, double otherRW, double otherDX, double otherDY, double otherDZ, double otherDW, double t, @Mutated DoubleDualQuat dest) {
        ...
        double _t97 = Math.fma(sd[0], _t13, sd[3] * _t14) + Math.fma(sd[1], _t15, sd[2] * _t16) + (Math.fma(sd[4], _t9, sd[7] * _t10) + Math.fma(sd[5], _t12, sd[6] * _t11));
        double _t99 = Math.fma(sd[2], _t15, -(sd[1] * _t16)) + Math.fma(sd[3], _t13, -(sd[0] * _t14)) + (Math.fma(sd[6], _t12, -(sd[5] * _t11)) + Math.fma(sd[7], _t9, -(sd[4] * _t10)));
        double _t100 = Math.fma(sd[1], _t13, -(sd[2] * _t14)) + Math.fma(sd[3], _t16, -(sd[0] * _t15)) + (Math.fma(sd[5], _t9, -(sd[6] * _t10)) + Math.fma(sd[7], _t11, -(sd[4] * _t12)));
        double _t101 = Math.fma(sd[0], _t16, sd[3] * _t15) + Math.fma(_t0, _t13, -(sd[1] * _t14)) + (Math.fma(sd[4], _t11, sd[7] * _t12) + Math.fma(_t2, _t9, -(sd[5] * _t10)));
        ...
        double _buf0 = Math.fma(sd[0], _t142, sd[3] * _t143) + Math.fma(sd[1], _t144, -(sd[2] * _t145));
        double _buf1 = Math.fma(sd[1], _t142, sd[2] * _t143) + Math.fma(sd[3], _t145, -(sd[0] * _t144));
        double _buf2 = Math.fma(sd[0], _t145, sd[3] * _t144) + Math.fma(sd[2], _t142, -(sd[1] * _t143));
        double _buf3 = Math.fma(sd[3], _t142, -(sd[0] * _t143)) - Math.fma(sd[1], _t145, sd[2] * _t144);
        double _buf4 = Math.fma(sd[0], _t147, sd[3] * _t160) + Math.fma(sd[1], _t161, -(sd[2] * _t162)) + (Math.fma(sd[4], _t142, sd[7] * _t143) + Math.fma(sd[5], _t144, -(sd[6] * _t145)));
        double _buf5 = Math.fma(sd[1], _t147, sd[2] * _t160) + Math.fma(sd[3], _t162, -(sd[0] * _t161)) + (Math.fma(sd[5], _t142, sd[6] * _t143) + Math.fma(sd[7], _t145, -(sd[4] * _t144)));
    ...
    public DoubleDualQuat mul(double otherRX, double otherRY, double otherRZ, double otherRW, double otherDX, double otherDY, double otherDZ, double otherDW, @Mutated DoubleDualQuat dest) {
        ...
        double _buf3 = Math.fma(otherRW, sd[3], -(otherRX * sd[0])) - Math.fma(otherRY, sd[1], otherRZ * sd[2]);
    ...
    public DoubleDualQuat difference(double otherRX, double otherRY, double otherRZ, double otherRW, double otherDX, double otherDY, double otherDZ, double otherDW, @Mutated DoubleDualQuat dest) {
        ...
        double _buf2 = Math.fma(otherRX, sd[1], -(otherRW * sd[2])) + Math.fma(otherRZ, sd[3], -(otherRY * sd[0]));
        double _buf3 = Math.fma(otherRX, sd[0], otherRW * sd[3]) - Math.fma(-otherRZ, sd[2], -(otherRY * sd[1]));
        double _buf4 = Math.fma(otherRX, sd[7], -(otherRW * sd[4])) + Math.fma(otherRY, sd[6], -(otherRZ * sd[5])) + (Math.fma(otherDX, sd[3], -(otherDW * sd[0])) + Math.fma(otherDY, sd[2], -(otherDZ * sd[1])));
    ...
    public Double3x4 toMatrix3x4(@Mutated Double3x4 dest) {
        ...
        double _t6 = Math.fma(-2.0, sd[2] * sd[2], 1.0);
        double _buf0 = Math.fma(-2.0, _t0, _t6);
        double _buf1 = Math.fma(-2.0, _t2, _sp0 * sd[1]);
        ...
        double _buf6 = Math.fma(-2.0, sd[0] * sd[3], _t5 + _t5);
        double _buf7 = 2.0 * (Math.fma(sd[2], sd[4], -(sd[0] * sd[6])) + Math.fma(sd[3], sd[5], -(sd[1] * sd[7])));
        dd[8] = Math.fma(-2.0, _t3, _sp0 * sd[2]);
    ...
    public DoubleDualQuat lookAlong(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated DoubleDualQuat dest) {
        ...
        double _buf3 = Math.fma(sd[4], _t111, sd[7] * _t108) + Math.fma(sd[5], _t109, -(sd[6] * _t110));
        double _buf4 = Math.fma(sd[5], _t111, sd[6] * _t108) + Math.fma(sd[7], _t110, -(sd[4] * _t109));
        double _buf5 = Math.fma(sd[4], _t110, sd[7] * _t109) + Math.fma(sd[6], _t111, -(sd[5] * _t108));
    ...
    private DoubleDualQuat lookAlong_degenerate(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated DoubleDualQuat dest) {
        ...
        double _buf3 = Math.fma(sd[4], _t126, sd[7] * _t123) + Math.fma(sd[5], _t124, -(sd[6] * _t125));
        double _buf4 = Math.fma(sd[5], _t126, sd[6] * _t123) + Math.fma(sd[7], _t125, -(sd[4] * _t124));
        double _buf5 = Math.fma(sd[4], _t125, sd[7] * _t124) + Math.fma(sd[6], _t126, -(sd[5] * _t123));
    ...
    public DoubleDualQuat preRotate(double rotationX, double rotationY, double rotationZ, double rotationW, @Mutated DoubleDualQuat dest) {
        ...
        double _buf3 = Math.fma(rotationX, sd[7], rotationW * sd[4]) + Math.fma(rotationY, sd[6], -(rotationZ * sd[5]));
        double _buf4 = Math.fma(rotationY, sd[7], rotationZ * sd[4]) + Math.fma(rotationW, sd[5], -(rotationX * sd[6]));
        double _buf5 = Math.fma(rotationX, sd[5], rotationW * sd[6]) + Math.fma(rotationZ, sd[7], -(rotationY * sd[4]));
    ...
    public DoubleDualQuat rotateAxis(double angle, double axisX, double axisY, double axisZ, @Mutated DoubleDualQuat dest) {
        ...
        double _buf3 = Math.fma(sd[4], _t5, sd[7] * _t2) + Math.fma(sd[5], _t3, -(sd[6] * _t4));
        double _buf4 = Math.fma(sd[5], _t5, sd[6] * _t2) + Math.fma(sd[7], _t4, -(sd[4] * _t3));
        double _buf5 = Math.fma(sd[4], _t4, sd[7] * _t3) + Math.fma(sd[6], _t5, -(sd[5] * _t2));
