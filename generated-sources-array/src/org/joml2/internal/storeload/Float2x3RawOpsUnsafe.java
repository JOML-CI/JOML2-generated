...
public final class Float2x3RawOpsUnsafe implements Float2x3RawOps {
    ...
    public Float2x3 storeRMUnsafe(Float2x3Impl self, long address) {
        ...
        U.putFloat(address + 8L, self.data[4]);
    ...
    public Float2x3 loadRMDoubleUnsafe(Float2x3Impl self, long address) {
        ...
        self.data[4] = (float) U.getDouble(address + 16L);
        self.data[1] = (float) U.getDouble(address + 24L);
        self.data[3] = (float) U.getDouble(address + 32L);
        self.data[5] = (float) U.getDouble(address + 40L);
        self.properties = self.determineProperties();
        return self;
    }
    ...
    public Float2x3 loadCMDoubleUnsafe(Float2x3Impl self, long address, int stride) {
        ...
        self.data[4] = (float) U.getDouble(_p2);
    ...
    public Float2x3 storeRMUnsafe(Float2x3Impl self, long address, int stride) {
        ...
        U.putFloat(address + 8, self.data[4]);
    ...
    public Float2x3 loadRMDoubleUnsafe(Float2x3Impl self, long address, int stride) {
        ...
        self.data[4] = (float) U.getDouble(address + 16);
    ...
    public Float2x3 storeCM3x3Unsafe(Float2x3Impl self, long address) {
        ...
        U.putFloat(address + 24L, self.data[4]);
    ...
    public Float2x3 storeCM4x4Unsafe(Float2x3Impl self, long address) {
        ...
        U.putFloat(address + 48L, self.data[4]);
        U.putFloat(address + 52L, self.data[5]);
