...
public final class Float4x4SegOpsMS implements Float4x4SegOps {
    public MemorySegment storeCM(Float4x4Impl self, long offset, MemorySegment dest) {
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 48L, self.data[12]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 52L, self.data[13]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 56L, self.data[14]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 60L, self.data[15]);
        return dest;
    }
    public Float4x4 loadCM(Float4x4Impl self, long offset, MemorySegment src) {
        ...
        self.data[15] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 60L);
    ...
    public MemorySegment storeCMDouble(Float4x4Impl self, long offset, MemorySegment dest) {
        ...
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 120L, self.data[15]);
        return dest;
    }
    public Float4x4 loadCMDouble(Float4x4Impl self, long offset, MemorySegment src) {
        ...
        self.data[12] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 96L);
        self.data[13] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 104L);
        self.data[14] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 112L);
        self.data[15] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 120L);
        self.properties = self.determineProperties();
        return self;
    }
    public MemorySegment storeRM(Float4x4Impl self, long offset, MemorySegment dest) {
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 12L, self.data[12]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 16L, self.data[1]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 20L, self.data[5]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 24L, self.data[9]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 28L, self.data[13]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 32L, self.data[2]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 36L, self.data[6]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 40L, self.data[10]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 44L, self.data[14]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 48L, self.data[3]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 52L, self.data[7]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 56L, self.data[11]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 60L, self.data[15]);
        return dest;
    }
    public Float4x4 loadRM(Float4x4Impl self, long offset, MemorySegment src) {
        ...
        self.data[12] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 12L);
        self.data[1] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 16L);
        self.data[5] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 20L);
        self.data[9] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 24L);
        self.data[13] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 28L);
        self.data[2] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 32L);
        self.data[6] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 36L);
        self.data[10] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 40L);
        self.data[14] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 44L);
        self.data[3] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 48L);
        self.data[7] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 52L);
        self.data[11] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 56L);
        self.data[15] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 60L);
        self.properties = self.determineProperties();
        return self;
    }
    public MemorySegment storeRMDouble(Float4x4Impl self, long offset, MemorySegment dest) {
        ...
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 24L, self.data[12]);
        ...
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 56L, self.data[13]);
        ...
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 80L, self.data[10]);
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 88L, self.data[14]);
    ...
    public Float4x4 loadRMDouble(Float4x4Impl self, long offset, MemorySegment src) {
        ...
        self.data[12] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 24L);
        self.data[1] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 32L);
        self.data[5] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 40L);
        self.data[9] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 48L);
        self.data[13] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 56L);
        self.data[2] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 64L);
        self.data[6] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 72L);
        self.data[10] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 80L);
        self.data[14] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 88L);
        self.data[3] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 96L);
        self.data[7] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 104L);
        self.data[11] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 112L);
        self.data[15] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 120L);
        self.properties = self.determineProperties();
        return self;
    }
    public MemorySegment storeCM(Float4x4Impl self, long offset, MemorySegment dest, int stride) {
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3, self.data[12]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 4, self.data[13]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 8, self.data[14]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 12, self.data[15]);
        return dest;
    }
    public Float4x4 loadCM(Float4x4Impl self, long offset, MemorySegment src, int stride) {
        ...
        self.data[12] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3);
        self.data[13] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 4);
        self.data[14] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 8);
        self.data[15] = src.get(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 12);
        self.properties = self.determineProperties();
        return self;
    }
    public MemorySegment storeCMDouble(Float4x4Impl self, long offset, MemorySegment dest, int stride) {
        ...
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3, self.data[12]);
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 8, self.data[13]);
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 16, self.data[14]);
        dest.set(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 24, self.data[15]);
        return dest;
    }
    public Float4x4 loadCMDouble(Float4x4Impl self, long offset, MemorySegment src, int stride) {
        ...
        self.data[12] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3);
        self.data[13] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 8);
        self.data[14] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 16);
        self.data[15] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 24);
        self.properties = self.determineProperties();
        return self;
    }
    ...
    public Float4x4 loadRMDouble(Float4x4Impl self, long offset, MemorySegment src, int stride) {
        ...
        self.data[12] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 24);
        ...
        self.data[13] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p1 + 24);
        ...
        self.data[10] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p2 + 16);
        self.data[14] = (float) src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p2 + 24);
