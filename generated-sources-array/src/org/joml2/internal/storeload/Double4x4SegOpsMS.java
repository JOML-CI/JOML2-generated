...
public final class Double4x4SegOpsMS implements Double4x4SegOps {
    ...
    public Double4x4 loadCM(Double4x4Impl self, long offset, MemorySegment src) {
        ...
        self.data[15] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 120L);
    ...
    public MemorySegment storeCMFloat(Double4x4Impl self, long offset, MemorySegment dest) {
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 60L, (float) self.data[15]);
        return dest;
    }
    ...
    public Double4x4 loadRM(Double4x4Impl self, long offset, MemorySegment src) {
        ...
        self.data[12] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 24L);
        self.data[1] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 32L);
        self.data[5] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 40L);
        self.data[9] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 48L);
        self.data[13] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 56L);
        self.data[2] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 64L);
        self.data[6] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 72L);
        self.data[10] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 80L);
        self.data[14] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 88L);
        self.data[3] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 96L);
        self.data[7] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 104L);
        self.data[11] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 112L);
        self.data[15] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, offset + 120L);
        self.properties = self.determineProperties();
        return self;
    }
    public MemorySegment storeRMFloat(Double4x4Impl self, long offset, MemorySegment dest) {
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 12L, (float) self.data[12]);
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 28L, (float) self.data[13]);
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 40L, (float) self.data[10]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 44L, (float) self.data[14]);
    ...
    public Double4x4 loadCM(Double4x4Impl self, long offset, MemorySegment src, int stride) {
        ...
        self.data[12] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3);
        self.data[13] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 8);
        self.data[14] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 16);
        self.data[15] = src.get(ValueLayout.JAVA_DOUBLE_UNALIGNED, _p3 + 24);
        self.properties = self.determineProperties();
        return self;
    }
    public MemorySegment storeCMFloat(Double4x4Impl self, long offset, MemorySegment dest, int stride) {
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3, (float) self.data[12]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 4, (float) self.data[13]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 8, (float) self.data[14]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p3 + 12, (float) self.data[15]);
        return dest;
    }
    ...
    public MemorySegment storeRMFloat(Double4x4Impl self, long offset, MemorySegment dest, int stride) {
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, offset + 12, (float) self.data[12]);
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p1 + 12, (float) self.data[13]);
        ...
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p2 + 8, (float) self.data[10]);
        dest.set(ValueLayout.JAVA_FLOAT_UNALIGNED, _p2 + 12, (float) self.data[14]);
