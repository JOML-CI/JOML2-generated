...
public final class Double4x3RawOpsUnsafe implements Double4x3RawOps {
    ...
    public Double4x3 loadCMUnsafe(long address) {
        ...
        double _c9 = U.getDouble(address + 24L);
        double _c1 = U.getDouble(address + 32L);
        double _c4 = U.getDouble(address + 40L);
        double _c7 = U.getDouble(address + 48L);
        double _c10 = U.getDouble(address + 56L);
        double _c2 = U.getDouble(address + 64L);
        double _c5 = U.getDouble(address + 72L);
        double _c8 = U.getDouble(address + 80L);
    ...
    public Double4x3 loadCMFloatUnsafe(long address) {
        ...
        double _c9 = U.getFloat(address + 12L);
        double _c1 = U.getFloat(address + 16L);
        double _c4 = U.getFloat(address + 20L);
        double _c7 = U.getFloat(address + 24L);
        double _c10 = U.getFloat(address + 28L);
        double _c2 = U.getFloat(address + 32L);
        double _c5 = U.getFloat(address + 36L);
        double _c8 = U.getFloat(address + 40L);
    ...
    public Double4x3 loadRMUnsafe(long address, int stride) {
        ...
        double _c8 = U.getDouble(_p2 + 16);
        double _c9 = U.getDouble(_p3);
        double _c10 = U.getDouble(_p3 + 8);
    ...
    public Double4x3 loadRMFloatUnsafe(long address, int stride) {
        ...
        double _c8 = U.getFloat(_p2 + 8);
        double _c9 = U.getFloat(_p3);
        double _c10 = U.getFloat(_p3 + 4);
