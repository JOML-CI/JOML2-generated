...
public final class Double2x3BbOpsApi implements Double2x3BbOps {
    ...
    public Double2x3 loadCMAbsolute(int index, DoubleBuffer buf) {
        ...
        double _c4 = buf.get(index + 3);
        double _c2 = buf.get(index + 4);
    ...
    public Double2x3 loadCMAbsolute(int index, ByteBuffer buf) {
        ...
        double _c4 = buf.getDouble(index + 24);
        double _c2 = buf.getDouble(index + 32);
    ...
    public Double2x3 loadCMFloatAbsolute(int index, ByteBuffer buf) {
        ...
        double _c4 = buf.getFloat(index + 12);
        double _c2 = buf.getFloat(index + 16);
    ...
    public FloatBuffer storeCM4x4Absolute(Double2x3 self, int index, FloatBuffer buf) {
        ...
        buf.put(index + 12, (float) self.m02());
        buf.put(index + 13, (float) self.m12());
    ...
    public ByteBuffer storeCM4x4FloatAbsolute(Double2x3 self, int index, ByteBuffer buf) {
        ...
        buf.putFloat(index + 48, (float) self.m02());
        buf.putFloat(index + 52, (float) self.m12());
    ...
    public FloatBuffer storeRM4x4Absolute(Double2x3 self, int index, FloatBuffer buf) {
        ...
        buf.put(index + 1, (float) self.m01());
        buf.put(index + 2, (float) 0.0);
        buf.put(index + 3, (float) self.m02());
    ...
    public ByteBuffer storeRM4x4FloatAbsolute(Double2x3 self, int index, ByteBuffer buf) {
        ...
        buf.putFloat(index + 4, (float) self.m01());
        buf.putFloat(index + 8, (float) 0.0);
        buf.putFloat(index + 12, (float) self.m02());
