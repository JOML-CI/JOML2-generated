...
/**
 * Immutable axis-aligned bounding box of double-precision {@code double} components, declared as a
 * value record.
 * <p>
...
public value record DoubleAABB(double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
     ...
     * @return a new {@code DoubleAABB} holding the loaded elements
     */
    public static DoubleAABB load(MemorySegment src) { return load(0L, src); }
     ...
     * @return a new {@code DoubleAABB} holding the loaded elements
     */
    public static DoubleAABB load(long offset, MemorySegment src) {
     ...
     * @return a new {@code DoubleAABB} holding the loaded elements
     */
    public static DoubleAABB loadFloat(MemorySegment src) { return loadFloat(0L, src); }
     ...
     * @return a new {@code DoubleAABB} holding the loaded elements
     */
    public static DoubleAABB loadFloat(long offset, MemorySegment src) {
