...
/**
 * Immutable 4D vector of {@code int} components, declared as a value record.
 * <p>
...
public value record Int4(int x, int y, int z, int w) {
    ...
    public Int4 ceilDiv(int otherX, int otherY, int otherZ, int otherW) {
        return new Int4(java.lang.Math.ceilDiv(this.x, otherX), java.lang.Math.ceilDiv(this.y, otherY), java.lang.Math.ceilDiv(this.z, otherZ), java.lang.Math.ceilDiv(this.w, otherW));
    }
    ...
    public Int4 ceilMod(int otherX, int otherY, int otherZ, int otherW) {
        return new Int4(java.lang.Math.ceilMod(this.x, otherX), java.lang.Math.ceilMod(this.y, otherY), java.lang.Math.ceilMod(this.z, otherZ), java.lang.Math.ceilMod(this.w, otherW));
    }
     ...
     * @return the resulting vector
     */
    public Int4 cross(Int4 v, Int4 w) {
     ...
     * @return the resulting vector
     */
    public Int4 cross(int vX, int vY, int vZ, int vW, int wX, int wY, int wZ, int wW) {
        ...
        return new Int4(this.y * _t12 - this.z * _t13 + this.w * _t14, this.z * _t15 - this.x * _t12 - this.w * _t16, this.x * _t13 - this.y * _t15 + this.w * _t17, this.y * _t16 - this.x * _t14 - this.z * _t17);
    }
     ...
     */
    public long distanceSquared(Int4 other) {
     ...
     */
    public long manhattanDistance(Int4 other) {
     ...
     * @return a new {@code Int4} holding the loaded elements
     */
    public static Int4 load(MemorySegment src) { return load(0L, src); }
     ...
     * @return a new {@code Int4} holding the loaded elements
     */
    public static Int4 load(long offset, MemorySegment src) {
     ...
     * @return dest
     */
    public MemorySegment storeLong(MemorySegment dest) { return storeLong(0L, dest); }
     ...
     * @return a new {@code Int4} holding the loaded elements
     */
    public static Int4 loadLong(MemorySegment src) { return loadLong(0L, src); }
     ...
     * @return a new {@code Int4} holding the loaded elements
     */
    public static Int4 loadLong(long offset, MemorySegment src) {
        return SEG_OPS.loadLong(offset, src);
    }
