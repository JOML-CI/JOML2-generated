...
/**
 * Immutable triangle of double-precision {@code double} components, declared as a value record.
 * <p>
...
public value record DoubleTriangle(double v0X, double v0Y, double v0Z, double v1X, double v1Y, double v1Z, double v2X, double v2Y, double v2Z) {
     ...
     * @return a new {@code DoubleTriangle} holding the loaded elements
     */
    public static DoubleTriangle load(MemorySegment src) { return load(0L, src); }
     ...
     * @return a new {@code DoubleTriangle} holding the loaded elements
     */
    public static DoubleTriangle loadFloat(MemorySegment src) { return loadFloat(0L, src); }
