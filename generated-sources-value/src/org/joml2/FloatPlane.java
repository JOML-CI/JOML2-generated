...
/**
 * Immutable plane of single-precision {@code float} components, declared as a value record.
 * <p>
...
public value record FloatPlane(float a, float b, float c, float d) {
     ...
     * @return a new {@code FloatPlane} holding the loaded elements
     */
    public static FloatPlane load(MemorySegment src) { return load(0L, src); }
     ...
     * @return a new {@code FloatPlane} holding the loaded elements
     */
    public static FloatPlane loadDouble(MemorySegment src) { return loadDouble(0L, src); }
