...
/**
 * Immutable 2D vector of {@code long} components, declared as a value record.
 * <p>
...
public value record Long2(long x, long y) {
    ...
    public Long2 ceilDiv(long otherX, long otherY) {
        return new Long2(java.lang.Math.ceilDiv(this.x, otherX), java.lang.Math.ceilDiv(this.y, otherY));
    }
    ...
    public Long2 ceilMod(long otherX, long otherY) {
        return new Long2(java.lang.Math.ceilMod(this.x, otherX), java.lang.Math.ceilMod(this.y, otherY));
    }
     ...
     * @return a new {@code Long2} holding the loaded elements
     */
    public static Long2 load(MemorySegment src) { return load(0L, src); }
     ...
     * @return a new {@code Long2} holding the loaded elements
     */
    public static Long2 load(long offset, MemorySegment src) {
     ...
     * @return a new {@code Long2} holding the loaded elements
     */
    public static Long2 loadInt(MemorySegment src) { return loadInt(0L, src); }
     ...
     * @return a new {@code Long2} holding the loaded elements
     */
    public static Long2 loadInt(long offset, MemorySegment src) {
