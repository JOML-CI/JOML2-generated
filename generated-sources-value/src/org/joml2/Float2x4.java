...
/**
 * Immutable 2x4 matrix of single-precision {@code float} components, declared as a value record.
 * <p>
...
public value record Float2x4(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13) {
     ...
     * @return the resulting matrix
     */
    public Float2x4 mul(float scalar) {
        return new Float2x4(scalar * this.m00, scalar * this.m01, scalar * this.m02, scalar * this.m03, scalar * this.m10, scalar * this.m11, scalar * this.m12, scalar * this.m13);
    }
     ...
     * @return the resulting matrix
     */
    public Float2x4 addScaled(Float2x4 other, float weight) {
        return new Float2x4(Math.fma(weight, other.m00(), this.m00), Math.fma(weight, other.m01(), this.m01), Math.fma(weight, other.m02(), this.m02), Math.fma(weight, other.m03(), this.m03), Math.fma(weight, other.m10(), this.m10), Math.fma(weight, other.m11(), this.m11), Math.fma(weight, other.m12(), this.m12), Math.fma(weight, other.m13(), this.m13));
    }
     ...
     * @return the resulting matrix
     */
    public Float2x4 addScaled(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float weight) {
        return new Float2x4(Math.fma(weight, m00, this.m00), Math.fma(weight, m01, this.m01), Math.fma(weight, m02, this.m02), Math.fma(weight, m03, this.m03), Math.fma(weight, m10, this.m10), Math.fma(weight, m11, this.m11), Math.fma(weight, m12, this.m12), Math.fma(weight, m13, this.m13));
    }
