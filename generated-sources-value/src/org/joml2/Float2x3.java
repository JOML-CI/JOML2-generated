...
public value record Float2x3(float m00, float m01, float m02, float m10, float m11, float m12, int properties) {
    ...
    private Float2 getColumn_identity(int col) {
        return new Float2(switch (col) { case 0 -> 1.0f; case 1 -> 0.0f; case 2 -> 0.0f; default -> throw new IndexOutOfBoundsException("Index out of range: " + col); }, switch (col) { case 0 -> 0.0f; case 1 -> 1.0f; case 2 -> 0.0f; default -> throw new IndexOutOfBoundsException("Index out of range: " + col); });
    }
    ...
    private Float2 getColumn_translation(int col) {
        return new Float2(switch (col) { case 0 -> 1.0f; case 1 -> 0.0f; case 2 -> this.m02; default -> throw new IndexOutOfBoundsException("Index out of range: " + col); }, switch (col) { case 0 -> 0.0f; case 1 -> 1.0f; case 2 -> this.m12; default -> throw new IndexOutOfBoundsException("Index out of range: " + col); });
    }
    ...
    private Float2 getColumn_general(int col) {
        return new Float2(switch (col) { case 0 -> this.m00; case 1 -> this.m01; case 2 -> this.m02; default -> throw new IndexOutOfBoundsException("Index out of range: " + col); }, switch (col) { case 0 -> this.m10; case 1 -> this.m11; case 2 -> this.m12; default -> throw new IndexOutOfBoundsException("Index out of range: " + col); });
    }
    ...
    private Float3 getRow_identity(int row) {
        return new Float3(switch (row) { case 0 -> 1.0f; case 1 -> 0.0f; default -> throw new IndexOutOfBoundsException("Index out of range: " + row); }, switch (row) { case 0 -> 0.0f; case 1 -> 1.0f; default -> throw new IndexOutOfBoundsException("Index out of range: " + row); }, 0.0f);
    }
    ...
    private Float3 getRow_translation(int row) {
        return new Float3(switch (row) { case 0 -> 1.0f; case 1 -> 0.0f; default -> throw new IndexOutOfBoundsException("Index out of range: " + row); }, switch (row) { case 0 -> 0.0f; case 1 -> 1.0f; default -> throw new IndexOutOfBoundsException("Index out of range: " + row); }, switch (row) { case 0 -> this.m02; case 1 -> this.m12; default -> throw new IndexOutOfBoundsException("Index out of range: " + row); });
    }
    ...
    private Float3 getRow_general(int row) {
        return new Float3(switch (row) { case 0 -> this.m00; case 1 -> this.m10; default -> throw new IndexOutOfBoundsException("Index out of range: " + row); }, switch (row) { case 0 -> this.m01; case 1 -> this.m11; default -> throw new IndexOutOfBoundsException("Index out of range: " + row); }, switch (row) { case 0 -> this.m02; case 1 -> this.m12; default -> throw new IndexOutOfBoundsException("Index out of range: " + row); });
    }
    ...
    public static Float2x3 makeView(float left, float right, float bottom, float top) {
        ...
        return new Float2x3(2.0f * _t0_inv, 0.0f, -((left + right) * _t0_inv), 0.0f, 2.0f * _t1_inv, -((bottom + top) * _t1_inv), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 preRotateAround_identity(float angle, float pivotX, float pivotY) {
        ...
        float _t1 = (float) Math.sin(angle);
        float _t2 = -pivotX;
        return new Float2x3(_t0, -_t1, Math.fma(pivotY, _t1, Math.fma(_t2, _t0, pivotX)), _t1, _t0, Math.fma(_t2, _t1, Math.fma(-pivotY, _t0, pivotY)), Joml.BIT_ORTHOGONAL);
    }
    ...
    private Float2x3 preRotateAround_translation(float angle, float pivotX, float pivotY) {
        ...
        float _t1 = (float) Math.sin(angle);
        float _t2 = -pivotX;
        return new Float2x3(_t0, -_t1, Math.fma(pivotY, _t1, Math.fma(_t2, _t0, Math.fma(this.m02, _t0, Math.fma(-this.m12, _t1, pivotX)))), _t1, _t0, Math.fma(_t2, _t1, Math.fma(-pivotY, _t0, Math.fma(this.m02, _t1, Math.fma(this.m12, _t0, pivotY)))), Joml.BIT_ORTHOGONAL);
    }
    ...
    private Float2x3 preScaleAround_identity(float s, float pivotX, float pivotY) {
        return new Float2x3(s, 0.0f, Math.fma(-s, pivotX, pivotX), 0.0f, s, Math.fma(-s, pivotY, pivotY), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 preScaleAround_translation(float s, float pivotX, float pivotY) {
        return new Float2x3(s, 0.0f, Math.fma(-s, pivotX, Math.fma(s, this.m02, pivotX)), 0.0f, s, Math.fma(-s, pivotY, Math.fma(s, this.m12, pivotY)), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 preScaleAround_general(float s, float pivotX, float pivotY) {
        return new Float2x3(s * this.m00, s * this.m01, Math.fma(-s, pivotX, Math.fma(s, this.m02, pivotX)), s * this.m10, s * this.m11, Math.fma(-s, pivotY, Math.fma(s, this.m12, pivotY)), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 preScaleAround_identity(float sX, float sY, float pivotX, float pivotY) {
        return new Float2x3(sX, 0.0f, Math.fma(-pivotX, sX, pivotX), 0.0f, sY, Math.fma(-pivotY, sY, pivotY), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 preScaleAround_general(float sX, float sY, float pivotX, float pivotY) {
        return new Float2x3(sX * this.m00, sX * this.m01, Math.fma(-pivotX, sX, Math.fma(sX, this.m02, pivotX)), sY * this.m10, sY * this.m11, Math.fma(-pivotY, sY, Math.fma(sY, this.m12, pivotY)), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 rotateAround_translation(float angle, float pivotX, float pivotY) {
        ...
        float _t1 = (float) Math.sin(angle);
        float _t2 = -pivotX;
        return new Float2x3(_t0, -_t1, Math.fma(pivotY, _t1, Math.fma(_t2, _t0, this.m02 + pivotX)), _t1, _t0, Math.fma(_t2, _t1, Math.fma(-pivotY, _t0, this.m12 + pivotY)), Joml.BIT_ORTHOGONAL);
    }
    ...
    private Float2x3 rotateAround_orthogonal(float angle, float pivotX, float pivotY) {
        ...
        return new Float2x3(Math.fma(this.m00, _t0, this.m01 * _t1), Math.fma(this.m01, _t0, -(this.m00 * _t1)), Math.fma(this.m00, _t6, Math.fma(this.m01, _t7, this.m02)), Math.fma(this.m10, _t0, this.m11 * _t1), Math.fma(this.m11, _t0, -(this.m10 * _t1)), Math.fma(this.m10, _t6, Math.fma(this.m11, _t7, this.m12)), Joml.BIT_ORTHOGONAL);
    }
    ...
    private Float2x3 rotateAround_general(float angle, float pivotX, float pivotY) {
        ...
        float _t6 = Math.fma(pivotY, _t1, Math.fma(_t2, _t0, pivotX));
        float _t7 = Math.fma(_t2, _t1, Math.fma(-pivotY, _t0, pivotY));
        return new Float2x3(Math.fma(this.m00, _t0, this.m01 * _t1), Math.fma(this.m01, _t0, -(this.m00 * _t1)), Math.fma(this.m00, _t6, Math.fma(this.m01, _t7, this.m02)), Math.fma(this.m10, _t0, this.m11 * _t1), Math.fma(this.m11, _t0, -(this.m10 * _t1)), Math.fma(this.m10, _t6, Math.fma(this.m11, _t7, this.m12)), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 scaleAround_translation(float s, float pivotX, float pivotY) {
        return new Float2x3(s, 0.0f, Math.fma(-s, pivotX, this.m02 + pivotX), 0.0f, s, Math.fma(-s, pivotY, this.m12 + pivotY), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 scaleAround_orthogonal(float s, float pivotX, float pivotY) {
        ...
        return new Float2x3(s * this.m00, s * this.m01, Math.fma(this.m00, _t0, Math.fma(this.m01, _t1, this.m02)), s * this.m10, s * this.m11, Math.fma(this.m10, _t0, Math.fma(this.m11, _t1, this.m12)), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 scaleAround_translation(float sX, float sY, float pivotX, float pivotY) {
        return new Float2x3(sX, 0.0f, Math.fma(-pivotX, sX, this.m02 + pivotX), 0.0f, sY, Math.fma(-pivotY, sY, this.m12 + pivotY), Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 view_translation(float left, float right, float bottom, float top) {
        ...
        float _t1 = top - bottom;
        float _t1_inv = 1.0f / _t1;
        return new Float2x3(2.0f * _t0_inv, 0.0f, this.m02 - (left + right) * _t0_inv, 0.0f, 2.0f * _t1_inv, this.m12 - (bottom + top) * _t1_inv, Joml.BIT_AFFINE);
    }
    ...
    private Float2x3 view_orthogonal(float left, float right, float bottom, float top) {
        ...
        return new Float2x3(2.0f * this.m00 * _t0_inv, 2.0f * this.m01 * _t1_inv, this.m02 - this.m00 * _t2 * _t0_inv - this.m01 * _t3 * _t1_inv, 2.0f * this.m10 * _t0_inv, 2.0f * this.m11 * _t1_inv, this.m12 - this.m10 * _t2 * _t0_inv - this.m11 * _t3 * _t1_inv, Joml.BIT_AFFINE);
    }
