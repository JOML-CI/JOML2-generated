...
/**
 * Immutable rectangle of double-precision {@code double} components, declared as a value record.
 * <p>
...
public value record DoubleRect(double minX, double minY, double maxX, double maxY) {
