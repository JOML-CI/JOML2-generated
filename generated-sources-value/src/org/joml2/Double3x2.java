...
/**
 * Immutable 3x2 matrix of double-precision {@code double} components, declared as a value record.
 * <p>
...
public value record Double3x2(double m00, double m01, double m10, double m11, double m20, double m21) {
    ...
    public Double2x3 transpose() {
        return new Double2x3(this.m00, this.m10, this.m20, this.m01, this.m11, this.m21, Joml.BIT_AFFINE);
    }
     ...
     * @return the resulting matrix
     */
    public Double3x2 mul(double scalar) {
        return new Double3x2(scalar * this.m00, scalar * this.m01, scalar * this.m10, scalar * this.m11, scalar * this.m20, scalar * this.m21);
    }
     ...
     * @return the resulting matrix
     */
    public Double3x2 addScaled(Double3x2 other, double weight) {
        return new Double3x2(Math.fma(weight, other.m00(), this.m00), Math.fma(weight, other.m01(), this.m01), Math.fma(weight, other.m10(), this.m10), Math.fma(weight, other.m11(), this.m11), Math.fma(weight, other.m20(), this.m20), Math.fma(weight, other.m21(), this.m21));
    }
     ...
     * @return the resulting matrix
     */
    public Double3x2 addScaled(double m00, double m01, double m10, double m11, double m20, double m21, double weight) {
        return new Double3x2(Math.fma(weight, m00, this.m00), Math.fma(weight, m01, this.m01), Math.fma(weight, m10, this.m10), Math.fma(weight, m11, this.m11), Math.fma(weight, m20, this.m20), Math.fma(weight, m21, this.m21));
    }
