...
public final class Float2Ops {
    ...
    /** {@link #add(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #div(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #fma(float[], int, float[], int, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #mul(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #sub(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static float[] makeUniformDirection(float[] dest, int destOffset, float u) {
        ...
        dest[destOffset + 0] = (float) Math.cosFromSin(_t1, _t0);
        dest[destOffset + 1] = _t1;
        return dest;
    }

    /** {@link #makeUniformDirection(float[], int, float)} on {@link java.nio.FloatBuffer} storage. */
    public static java.nio.FloatBuffer makeUniformDirection(java.nio.FloatBuffer dest, int destOffset, float u) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsTypedBuffer.makeUniformDirection_unsafe(dest, destOffset, u);
        return Float2OpsKernelsTypedBuffer.makeUniformDirection_api(dest, destOffset, u);
    }

    /** {@link #makeUniformDirection(float[], int, float)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.nio.ByteBuffer makeUniformDirection(java.nio.ByteBuffer dest, int destOffset, float u) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsByteBuffer.makeUniformDirection_unsafe(dest, destOffset, u);
        return Float2OpsKernelsByteBuffer.makeUniformDirection_api(dest, destOffset, u);
    }

    /** {@link #makeUniformDirection(float[], int, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment makeUniformDirection(java.lang.foreign.MemorySegment dest, long destOffset, float u) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly()) return Float2OpsKernelsSegment.makeUniformDirection_unsafe(dest, destOffset, u);
        return Float2OpsKernelsSegment.makeUniformDirection_api(dest, destOffset, u);
    }

    /** {@link #makeUniformDirection(float[], int, float)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static long makeUniformDirection(long dest, float u) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.makeUniformDirection_unsafe(dest, u);
        makeUniformDirection(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, u);
        return dest;
    }
    ...
    /** {@link #set(float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #bezier(float[], int, float[], int, float, float, float, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #bezier2(float[], int, float[], int, float, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #bezier2Tangent(float[], int, float[], int, float, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #bezierTangent(float[], int, float[], int, float, float, float, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #catmullRom(float[], int, float[], int, float, float, float, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #catmullRomTangent(float[], int, float[], int, float, float, float, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #hermite(float[], int, float[], int, float, float, float, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #hermiteTangent(float[], int, float[], int, float, float, float, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #lerp(float[], int, float[], int, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static float[] slerp(float[] dest, int destOffset, float[] src, int srcOffset, float otherX, float otherY, float t) {
        ...
        if (!(_ct0 > 1.1754944E-38f && _ct0 < Float.POSITIVE_INFINITY)) return Float2OpsKernelsArray.slerp_degenerate(dest, destOffset, src, srcOffset, otherX, otherY, t);
        float _t4 = _ct0;
        float _ct1 = Math.fma(otherX, otherX, otherY * otherY);
        if (!(_ct1 > 1.1754944E-38f && _ct1 < Float.POSITIVE_INFINITY)) return Float2OpsKernelsArray.slerp_degenerate(dest, destOffset, src, srcOffset, otherX, otherY, t);
        float _t5 = _ct1;
        ...
        if (!(_ct2 > 1.1754944E-38f && _ct2 < Float.POSITIVE_INFINITY)) return Float2OpsKernelsArray.slerp_degenerate(dest, destOffset, src, srcOffset, otherX, otherY, t);
        float _t31 = _ct2;
    ...
    /** {@link #slerp(float[], int, float[], int, float, float, float)} on {@link java.nio.FloatBuffer} storage. */
    public static java.nio.FloatBuffer slerp(java.nio.FloatBuffer dest, int destOffset, java.nio.FloatBuffer src, int srcOffset, float otherX, float otherY, float t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsTypedBuffer.slerp_unsafe(dest, destOffset, src, srcOffset, otherX, otherY, t);
        return Float2OpsKernelsTypedBuffer.slerp_api(dest, destOffset, src, srcOffset, otherX, otherY, t);
    }

    /** {@link #slerp(float[], int, float[], int, float, float, float)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.nio.ByteBuffer slerp(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float otherX, float otherY, float t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsByteBuffer.slerp_unsafe(dest, destOffset, src, srcOffset, otherX, otherY, t);
        return Float2OpsKernelsByteBuffer.slerp_api(dest, destOffset, src, srcOffset, otherX, otherY, t);
    }

    /** {@link #slerp(float[], int, float[], int, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment slerp(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, float otherX, float otherY, float t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return Float2OpsKernelsSegment.slerp_unsafe(dest, destOffset, src, srcOffset, otherX, otherY, t);
        return Float2OpsKernelsSegment.slerp_api(dest, destOffset, src, srcOffset, otherX, otherY, t);
    }

    /** {@link #slerp(float[], int, float[], int, float, float, float)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static long slerp(long dest, long src, float otherX, float otherY, float t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.slerp_unsafe(dest, src, otherX, otherY, t);
        slerp(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, otherX, otherY, t);
        return dest;
    }
    ...
    public static float[] slerp(float[] dest, int destOffset, float[] src, int srcOffset, float[] other, int otherOffset, float t) {
        ...
        float _othery = other[otherOffset + 1];
        float _ct0 = Math.fma(_selfx, _selfx, _selfy * _selfy);
        if (!(_ct0 > 1.1754944E-38f && _ct0 < Float.POSITIVE_INFINITY)) return Float2OpsKernelsArray.slerp_degenerate(dest, destOffset, src, srcOffset, other, otherOffset, t);
        float _t4 = _ct0;
        float _ct1 = Math.fma(_otherx, _otherx, _othery * _othery);
        if (!(_ct1 > 1.1754944E-38f && _ct1 < Float.POSITIVE_INFINITY)) return Float2OpsKernelsArray.slerp_degenerate(dest, destOffset, src, srcOffset, other, otherOffset, t);
        float _t5 = _ct1;
        float _t8 = (float) Math.sqrt(_t4);
        float _t6 = 1.0f / _t8;
        float _t9 = (1.0f / (float) Math.sqrt(_t5));
        ...
        float _t28 = Math.fma(_t26, _t13, _t23);
        float _ct2 = Math.fma(_t27, _t27, _t28 * _t28);
        if (!(_ct2 > 1.1754944E-38f && _ct2 < Float.POSITIVE_INFINITY)) return Float2OpsKernelsArray.slerp_degenerate(dest, destOffset, src, srcOffset, other, otherOffset, t);
        float _t31 = _ct2;
        float _t35 = t * (float) Math.atan2((float) Math.sqrt(_t31), _t17);
        float _t36 = (float) Math.sin(_t35);
        float _sp0 = _t16 * _t36 * (1.0f / (float) Math.sqrt(_t31));
    ...
    public static java.lang.foreign.MemorySegment slerp(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment other, long otherOffset, float t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && other.isNative()) return Float2OpsKernelsSegment.slerp_unsafe(dest, destOffset, src, srcOffset, other, otherOffset, t);
    ...
    public static long slerp(long dest, long src, long other, float t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.slerp_unsafe(dest, src, other, t);
        slerp(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(other, 8L), 0L, t);
        return dest;
    }
    ...
    /** {@link #addScaled(float[], int, float[], int, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #angleBetween(float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #atan2(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #clamp(float[], int, float[], int, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #copySign(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #cross(float[], int, float, float)} on {@link java.nio.FloatBuffer} storage. */
    public static float cross(java.nio.FloatBuffer src, int srcOffset, float otherX, float otherY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsTypedBuffer.cross_unsafe(src, srcOffset, otherX, otherY);
        return Float2OpsKernelsTypedBuffer.cross_api(src, srcOffset, otherX, otherY);
    }

    /** {@link #cross(float[], int, float, float)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static float cross(java.nio.ByteBuffer src, int srcOffset, float otherX, float otherY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsByteBuffer.cross_unsafe(src, srcOffset, otherX, otherY);
        return Float2OpsKernelsByteBuffer.cross_api(src, srcOffset, otherX, otherY);
    }

    /** {@link #cross(float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static float cross(java.lang.foreign.MemorySegment src, long srcOffset, float otherX, float otherY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isNative()) return Float2OpsKernelsSegment.cross_unsafe(src, srcOffset, otherX, otherY);
        return Float2OpsKernelsSegment.cross_api(src, srcOffset, otherX, otherY);
    }

    /** {@link #cross(float[], int, float, float)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static float cross(long src, float otherX, float otherY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.cross_unsafe(src, otherX, otherY);
        return cross(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, otherX, otherY);
    }
    ...
    /** {@link #cross(float[], int, float[], int)} on {@link java.nio.FloatBuffer} storage. */
    public static float cross(java.nio.FloatBuffer src, int srcOffset, java.nio.FloatBuffer other, int otherOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder() && other.isDirect() && other.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsTypedBuffer.cross_unsafe(src, srcOffset, other, otherOffset);
        return Float2OpsKernelsTypedBuffer.cross_api(src, srcOffset, other, otherOffset);
    }

    /** {@link #cross(float[], int, float[], int)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static float cross(java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer other, int otherOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder() && other.isDirect() && other.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsByteBuffer.cross_unsafe(src, srcOffset, other, otherOffset);
        return Float2OpsKernelsByteBuffer.cross_api(src, srcOffset, other, otherOffset);
    }

    /** {@link #cross(float[], int, float[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static float cross(java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment other, long otherOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isNative() && other.isNative()) return Float2OpsKernelsSegment.cross_unsafe(src, srcOffset, other, otherOffset);
        return Float2OpsKernelsSegment.cross_api(src, srcOffset, other, otherOffset);
    }

    /** {@link #cross(float[], int, float[], int)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static float cross(long src, long other) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.cross_unsafe(src, other);
        return cross(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(other, 8L), 0L);
    }
    ...
    /** {@link #distance(float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #distanceSquared(float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #dot(float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #faceforward(float[], int, float[], int, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #hypot(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #manhattanDistance(float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #max(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #min(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #mod(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #orientedAngle(float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #orientedAngle(float[], int, float[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #outerProduct(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #pow(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #project(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #projectOnPlane(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #reflect(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #refract(float[], int, float[], int, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #smoothstep(float[], int, float[], int, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #step(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #preMulDirectionMat2x3(float[], int, float[], int, float[], int)} on {@link java.nio.FloatBuffer} storage. */
    ...
    /** {@link #preMulDirectionMat2x3(float[], int, float[], int, float[], int)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #preMulDirectionMat2x3(float[], int, float[], int, float[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment preMulDirectionMat2x3(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment mat, long matOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && mat.isNative()) return Float2OpsKernelsSegment.preMulDirectionMat2x3_unsafe(dest, destOffset, src, srcOffset, mat, matOffset);
        return Float2OpsKernelsSegment.preMulDirectionMat2x3_api(dest, destOffset, src, srcOffset, mat, matOffset);
    }

    /** {@link #preMulDirectionMat2x3(float[], int, float[], int, float[], int)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static long preMulDirectionMat2x3(long dest, long src, long mat) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.preMulDirectionMat2x3_unsafe(dest, src, mat);
        preMulDirectionMat2x3(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(mat, 24L), 0L);
        return dest;
    }
    ...
    /** {@link #preMulDirectionMat3x3(float[], int, float[], int, float[], int)} on {@link java.nio.FloatBuffer} storage. */
    ...
    /** {@link #preMulDirectionMat3x3(float[], int, float[], int, float[], int)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #preMulDirectionMat3x3(float[], int, float[], int, float[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment preMulDirectionMat3x3(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment mat, long matOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && mat.isNative()) return Float2OpsKernelsSegment.preMulDirectionMat3x3_unsafe(dest, destOffset, src, srcOffset, mat, matOffset);
        return Float2OpsKernelsSegment.preMulDirectionMat3x3_api(dest, destOffset, src, srcOffset, mat, matOffset);
    }

    /** {@link #preMulDirectionMat3x3(float[], int, float[], int, float[], int)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static long preMulDirectionMat3x3(long dest, long src, long mat) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.preMulDirectionMat3x3_unsafe(dest, src, mat);
        preMulDirectionMat3x3(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(mat, 36L), 0L);
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment preMulPositionMat4x4(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment mat, long matOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && mat.isNative()) return Float2OpsKernelsSegment.preMulPositionMat4x4_unsafe(dest, destOffset, src, srcOffset, mat, matOffset);
    ...
    public static long preMulPositionMat4x4(long dest, long src, long mat) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.preMulPositionMat4x4_unsafe(dest, src, mat);
        preMulPositionMat4x4(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(mat, 64L), 0L);
        return dest;
    }
    ...
    /** {@link #preMulPositionMat2x3(float[], int, float[], int, float[], int)} on {@link java.nio.FloatBuffer} storage. */
    ...
    /** {@link #preMulPositionMat2x3(float[], int, float[], int, float[], int)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #preMulPositionMat2x3(float[], int, float[], int, float[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment preMulPositionMat2x3(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment mat, long matOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && mat.isNative()) return Float2OpsKernelsSegment.preMulPositionMat2x3_unsafe(dest, destOffset, src, srcOffset, mat, matOffset);
        return Float2OpsKernelsSegment.preMulPositionMat2x3_api(dest, destOffset, src, srcOffset, mat, matOffset);
    }

    /** {@link #preMulPositionMat2x3(float[], int, float[], int, float[], int)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static long preMulPositionMat2x3(long dest, long src, long mat) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.preMulPositionMat2x3_unsafe(dest, src, mat);
        preMulPositionMat2x3(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(mat, 24L), 0L);
        return dest;
    }
    ...
    /** {@link #preMulPositionMat3x3(float[], int, float[], int, float[], int)} on {@link java.nio.FloatBuffer} storage. */
    ...
    /** {@link #preMulPositionMat3x3(float[], int, float[], int, float[], int)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #preMulPositionMat3x3(float[], int, float[], int, float[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment preMulPositionMat3x3(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment mat, long matOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && mat.isNative()) return Float2OpsKernelsSegment.preMulPositionMat3x3_unsafe(dest, destOffset, src, srcOffset, mat, matOffset);
        return Float2OpsKernelsSegment.preMulPositionMat3x3_api(dest, destOffset, src, srcOffset, mat, matOffset);
    }

    /** {@link #preMulPositionMat3x3(float[], int, float[], int, float[], int)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static long preMulPositionMat3x3(long dest, long src, long mat) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.preMulPositionMat3x3_unsafe(dest, src, mat);
        preMulPositionMat3x3(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(mat, 36L), 0L);
        return dest;
    }
    ...
    public static java.nio.FloatBuffer rotateAround(java.nio.FloatBuffer dest, int destOffset, java.nio.FloatBuffer src, int srcOffset, float angle, float pivotX, float pivotY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsTypedBuffer.rotateAround_unsafe(dest, destOffset, src, srcOffset, angle, pivotX, pivotY);
    ...
    public static java.nio.ByteBuffer rotateAround(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float2OpsKernelsByteBuffer.rotateAround_unsafe(dest, destOffset, src, srcOffset, angle, pivotX, pivotY);
    ...
    public static java.lang.foreign.MemorySegment rotateAround(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, float angle, float pivotX, float pivotY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return Float2OpsKernelsSegment.rotateAround_unsafe(dest, destOffset, src, srcOffset, angle, pivotX, pivotY);
    ...
    public static long rotateAround(long dest, long src, float angle, float pivotX, float pivotY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.rotateAround_unsafe(dest, src, angle, pivotX, pivotY);
        rotateAround(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, angle, pivotX, pivotY);
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment rotateAround(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment pivot, long pivotOffset, float angle) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && pivot.isNative()) return Float2OpsKernelsSegment.rotateAround_unsafe(dest, destOffset, src, srcOffset, pivot, pivotOffset, angle);
    ...
    public static long rotateAround(long dest, long src, long pivot, float angle) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2OpsKernelsAddress.rotateAround_unsafe(dest, src, pivot, angle);
        rotateAround(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 8L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(pivot, 8L), 0L, angle);
        return dest;
    }
