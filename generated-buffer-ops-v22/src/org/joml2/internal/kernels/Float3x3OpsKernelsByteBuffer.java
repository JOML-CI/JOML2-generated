...
public final class Float3x3OpsKernelsByteBuffer {
    ...
    public static java.nio.ByteBuffer preRotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(_self20, _t9, Math.fma(_self00, _t1, -(_self10 * _t0))));
        dest.putFloat(destOffset + 4, Math.fma(_self20, _t10, Math.fma(_self00, _t0, _self10 * _t1)));
        dest.putFloat(destOffset + 8, _self20);
        dest.putFloat(destOffset + 12, Math.fma(_self21, _t9, Math.fma(_self01, _t1, -(_self11 * _t0))));
        dest.putFloat(destOffset + 16, Math.fma(_self21, _t10, Math.fma(_self01, _t0, _self11 * _t1)));
        dest.putFloat(destOffset + 20, _self21);
        dest.putFloat(destOffset + 24, Math.fma(_self22, _t9, Math.fma(_self02, _t1, -(_self12 * _t0))));
        dest.putFloat(destOffset + 28, Math.fma(_self22, _t10, Math.fma(_self02, _t0, _self12 * _t1)));
        dest.putFloat(destOffset + 32, _self22);
        return dest;
    }
