...
public final class FloatQuatOpsKernelsByteBuffer {
    ...
    public static java.nio.ByteBuffer pow_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float t) {
        ...
        dest.putFloat(destOffset + 12, (float) Math.cos(_t24) * _t10);
        return dest;
    }
    ...
    public static java.nio.ByteBuffer makeRotationTo_api(java.nio.ByteBuffer dest, int destOffset, float fromDirX, float fromDirY, float fromDirZ, float toDirX, float toDirY, float toDirZ) {
        ...
        if (_t23 > 1.0E-6f) {
            dest.putFloat(destOffset + 0, _t15 * _t33);
            dest.putFloat(destOffset + 4, _t16 * _t33);
            dest.putFloat(destOffset + 8, _t17 * _t33);
            dest.putFloat(destOffset + 12, 0.5f * _t22 * _t33);
        } else {
            if (_t29 > 0.0f) {
                dest.putFloat(destOffset + 0, _t30 * _t18);
                dest.putFloat(destOffset + 4, _t30 * _t20);
                dest.putFloat(destOffset + 8, _t30 * _t19);
                dest.putFloat(destOffset + 12, 0.0f);
            } else {
                dest.putFloat(destOffset + 0, 0.0f);
                dest.putFloat(destOffset + 4, 0.0f);
    ...
    public static java.nio.ByteBuffer rotateTo_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float fromDirX, float fromDirY, float fromDirZ, float toDirX, float toDirY, float toDirZ) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(_selfx, _t42, _selfw * _t46) + Math.fma(_selfy, _t47, -(_selfz * _t48)));
        dest.putFloat(destOffset + 4, Math.fma(_selfy, _t42, _selfz * _t46) + Math.fma(_selfw, _t48, -(_selfx * _t47)));
        dest.putFloat(destOffset + 8, Math.fma(_selfx, _t48, _selfw * _t47) + Math.fma(_selfz, _t42, -(_selfy * _t46)));
        dest.putFloat(destOffset + 12, Math.fma(-_selfz, _t47, Math.fma(-_selfy, _t48, Math.fma(_selfw, _t42, -(_selfx * _t46)))));
        return dest;
    }
