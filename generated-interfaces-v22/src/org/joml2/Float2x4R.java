...
/**
 * Read-only view of a 2x4 matrix of single-precision {@code float} components.
 * <p>
 * Declares the accessors, queries, store methods and dest-form operations that read but never
 * mutate the receiver; the mutable counterpart is {@link Float2x4}. APIs that only read a 2x4
 * matrix should accept {@code Float2x4R}, so callers can pass mutable instances without exposing
 * them to modification.
 * <p>
 * Arguments of type {@code Float2x4R} must be instances created by the library ({@link Joml}
...
public interface Float2x4R {
    ...
    public static Float2x4R IDENTITY() { return Holder.IDENTITY; }
    /** {@return a shared all-zero matrix} Never mutate it - it is returned as the read-only view for that reason. */
    public static Float2x4R ZERO() { return Holder.ZERO; }
     ...
     * @return dest
     */
    Float4x2 transpose(@Mutated Float4x2 dest);
     ...
     * @return dest
     */
    Double4x2 transpose(@Mutated Double4x2 dest);
     ...
     * @return dest
     */
    Float2x4 add(Float2x4R other, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 add(Float2x4R other, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 add(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 add(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 mul(float scalar, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 mul(float scalar, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 negate(@Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 negate(@Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 sub(Float2x4R other, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 sub(Float2x4R other, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 sub(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 sub(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Double2x4 toDouble(@Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 lerp(Float2x4R other, float t, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 lerp(Float2x4R other, float t, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 lerp(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float t, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 lerp(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float t, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 mul(Float2x4R right, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 mul(Float2x4R right, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 mul(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 mul(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 preMul(Float2x4R other, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 preMul(Float2x4R other, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 preMul(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 preMul(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 addScaled(Float2x4R other, float weight, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 addScaled(Float2x4R other, float weight, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2x4 addScaled(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float weight, @Mutated Float2x4 dest);
     ...
     * @return dest
     */
    Double2x4 addScaled(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float weight, @Mutated Double2x4 dest);
     ...
     * @return dest
     */
    Float2 mul(Float4R v, @Mutated Float2 dest);
     ...
     * @return dest
     */
    Double2 mul(Float4R v, @Mutated Double2 dest);
     ...
     * @return dest
     */
    Float2 mul(float x, float y, float z, float w, @Mutated Float2 dest);
     ...
     * @return dest
     */
    Double2 mul(float x, float y, float z, float w, @Mutated Double2 dest);
     ...
     * @return this
     */
    Float2x4 storeCMUnsafe(long address);
     ...
     * @return this
     */
    Float2x4 storeCMDoubleUnsafe(long address);
     ...
     * @return this
     */
    Float2x4 storeRMUnsafe(long address);
     ...
     * @return this
     */
    Float2x4 storeRMDoubleUnsafe(long address);
     ...
     * @return this
     */
    Float2x4 storeCMUnsafe(long address, int stride);
     ...
     * @return this
     */
    Float2x4 storeCMDoubleUnsafe(long address, int stride);
     ...
     * @return this
     */
    Float2x4 storeRMUnsafe(long address, int stride);
     ...
     * @return this
     */
    Float2x4 storeRMDoubleUnsafe(long address, int stride);
     ...
     */
    boolean equalsEpsilon(Float2x4R other, float epsilon);
     ...
     * @return this
     */
    default Float2x4 storeUnsafe(long address) { return storeCMUnsafe(address); }
     ...
     * @return this
     */
    default Float2x4 storeUnsafe(long address, int stride) { return storeCMUnsafe(address, stride); }
    ...
    final class Holder {
        private Holder() {}
        static final Float2x4R IDENTITY = Joml.float2x4();
        static final Float2x4R ZERO = Joml.float2x4(0, 0, 0, 0, 0, 0, 0, 0);
    }
}
