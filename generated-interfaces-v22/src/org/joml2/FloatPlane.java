...
public interface FloatPlane extends FloatPlaneR {
     ...
     * @return this
     */
    @Mutated default FloatPlane setNormal(Float3R n) { return setNormal(n, this); }
     ...
     * @return this
     */
    @Mutated default FloatPlane setNormal(float x, float y, float z) { return setNormal(x, y, z, this); }
     ...
     * @return this
     */
    @Mutated default FloatPlane set(Float3R normal, float d) { return set(normal.x(), normal.y(), normal.z(), d); }
     ...
     * @return this
     */
    @Mutated default FloatPlane load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated FloatPlane load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default FloatPlane loadDouble(MemorySegment src) { return loadDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated FloatPlane loadDouble(long offset, MemorySegment src);
