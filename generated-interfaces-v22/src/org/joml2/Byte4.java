...
public interface Byte4 extends Byte4R {
     ...
     * to {@code int} first and takes the count modulo 32).
     *
     * @param shift the number of bit positions to shift by
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
     ...
     * @return this
     */
    @Mutated default Byte4 set(byte s) { return set(s, this); }
     ...
     * @return this
     */
    @Mutated default Byte4 load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated Byte4 load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Byte4 loadShort(MemorySegment src) { return loadShort(0L, src); }
     ...
     * @return this
     */
    @Mutated Byte4 loadShort(long offset, MemorySegment src);
