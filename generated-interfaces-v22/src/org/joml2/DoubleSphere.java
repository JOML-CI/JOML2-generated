...
public interface DoubleSphere extends DoubleSphereR {
     ...
     * @return this
     */
    @Mutated default DoubleSphere setCenter(Double3R c) { return setCenter(c, this); }
     ...
     * @return this
     */
    @Mutated default DoubleSphere setCenter(double x, double y, double z) { return setCenter(x, y, z, this); }
     ...
     * @return this
     */
    @Mutated default DoubleSphere setRadius(double radius) { return setRadius(radius, this); }
     ...
     * @return this
     */
    @Mutated default DoubleSphere load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated DoubleSphere load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default DoubleSphere loadFloat(MemorySegment src) { return loadFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated DoubleSphere loadFloat(long offset, MemorySegment src);
