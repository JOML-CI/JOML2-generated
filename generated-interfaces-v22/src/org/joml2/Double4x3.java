...
public interface Double4x3 extends Double4x3R {
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double4x3 mul(double scalar) { return mul(scalar, Joml.RETURN_NEW ? Joml.double4x3() : this); }
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double4x3 addScaled(Double4x3R other, double weight) { return addScaled(other, weight, Joml.RETURN_NEW ? Joml.double4x3() : this); }
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double4x3 addScaled(double m00, double m01, double m02, double m10, double m11, double m12, double m20, double m21, double m22, double m30, double m31, double m32, double weight) { return addScaled(m00, m01, m02, m10, m11, m12, m20, m21, m22, m30, m31, m32, weight, Joml.RETURN_NEW ? Joml.double4x3() : this); }
     ...
     * @return this
     */
    @Mutated default Double4x3 loadCM(MemorySegment src) { return loadCM(0L, src); }
     ...
     * @return this
     */
    @Mutated Double4x3 loadCM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double4x3 loadCMFloat(MemorySegment src) { return loadCMFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated Double4x3 loadCMFloat(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double4x3 loadRM(MemorySegment src) { return loadRM(0L, src); }
     ...
     * @return this
     */
    @Mutated Double4x3 loadRM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double4x3 loadRMFloat(MemorySegment src) { return loadRMFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated Double4x3 loadRMFloat(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double4x3 loadCM(MemorySegment src, int stride) { return loadCM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double4x3 loadCM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double4x3 loadCMFloat(MemorySegment src, int stride) { return loadCMFloat(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double4x3 loadCMFloat(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double4x3 loadRM(MemorySegment src, int stride) { return loadRM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double4x3 loadRM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double4x3 loadRMFloat(MemorySegment src, int stride) { return loadRMFloat(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double4x3 loadRMFloat(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double4x3 load(MemorySegment src) { return loadCM(src); }
     ...
     * @return this
     */
    @Mutated default Double4x3 load(long offset, MemorySegment src) { return loadCM(offset, src); }
     ...
     * @return this
     */
    @Mutated default Double4x3 load(long offset, MemorySegment src, int stride) { return loadCM(offset, src, stride); }
