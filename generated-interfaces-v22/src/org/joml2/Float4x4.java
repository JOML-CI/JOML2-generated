...
public interface Float4x4 extends Float4x4R {
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Float4x4 mul(float scalar) { return mul(scalar, Joml.RETURN_NEW ? Joml.float4x4() : this); }
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Float4x4 addScaled(Float4x4R other, float weight) { return addScaled(other, weight, Joml.RETURN_NEW ? Joml.float4x4() : this); }
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Float4x4 addScaled(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33, float weight) { return addScaled(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33, weight, Joml.RETURN_NEW ? Joml.float4x4() : this); }
     ...
     * @return this
     */
    @Mutated Float4x4 composeTRSAround(Float3R translation, FloatQuatR rotation, Float3R scale, Float3R pivot);
     ...
     * @return this
     */
    @Mutated Float4x4 composeTRSAround(float translationX, float translationY, float translationZ, float rotationX, float rotationY, float rotationZ, float rotationW, float scaleX, float scaleY, float scaleZ, float pivotX, float pivotY, float pivotZ);
     ...
     * @return this
     */
    @Mutated Float4x4 makeObliquePlanometric(float angle);
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Float4x4 obliquePlanometric(float angle) { return obliquePlanometric(angle, Joml.RETURN_NEW ? Joml.float4x4() : this); }
     ...
     * @return this
     */
    @Mutated default Float4x4 loadCM(MemorySegment src) { return loadCM(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4x4 loadCM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4x4 loadCMDouble(MemorySegment src) { return loadCMDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4x4 loadCMDouble(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4x4 loadRM(MemorySegment src) { return loadRM(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4x4 loadRM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4x4 loadRMDouble(MemorySegment src) { return loadRMDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4x4 loadRMDouble(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4x4 loadCM(MemorySegment src, int stride) { return loadCM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Float4x4 loadCM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Float4x4 loadCMDouble(MemorySegment src, int stride) { return loadCMDouble(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Float4x4 loadCMDouble(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Float4x4 loadRM(MemorySegment src, int stride) { return loadRM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Float4x4 loadRM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Float4x4 loadRMDouble(MemorySegment src, int stride) { return loadRMDouble(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Float4x4 loadRMDouble(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Float4x4 load(MemorySegment src) { return loadCM(src); }
     ...
     * @return this
     */
    @Mutated default Float4x4 load(long offset, MemorySegment src) { return loadCM(offset, src); }
     ...
     * @return this
     */
    @Mutated default Float4x4 load(long offset, MemorySegment src, int stride) { return loadCM(offset, src, stride); }
