...
public interface Float4x2 extends Float4x2R {
     ...
     * @return this
     */
    @Mutated default Float4x2 loadCM(MemorySegment src) { return loadCM(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4x2 loadCM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4x2 loadCMDouble(MemorySegment src) { return loadCMDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4x2 loadCMDouble(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4x2 loadRM(MemorySegment src) { return loadRM(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4x2 loadRM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4x2 loadRMDouble(MemorySegment src) { return loadRMDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4x2 loadRMDouble(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4x2 loadCM(MemorySegment src, int stride) { return loadCM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Float4x2 loadCM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Float4x2 loadCMDouble(MemorySegment src, int stride) { return loadCMDouble(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Float4x2 loadCMDouble(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Float4x2 loadRM(MemorySegment src, int stride) { return loadRM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Float4x2 loadRM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Float4x2 loadRMDouble(MemorySegment src, int stride) { return loadRMDouble(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Float4x2 loadRMDouble(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Float4x2 load(MemorySegment src) { return loadCM(src); }
     ...
     * @return this
     */
    @Mutated default Float4x2 load(long offset, MemorySegment src) { return loadCM(offset, src); }
     ...
     * @return this
     */
    @Mutated default Float4x2 load(long offset, MemorySegment src, int stride) { return loadCM(offset, src, stride); }
