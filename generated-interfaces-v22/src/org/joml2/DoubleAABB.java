...
public interface DoubleAABB extends DoubleAABBR {
     ...
     * @return this
     */
    @Mutated default DoubleAABB load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated DoubleAABB load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default DoubleAABB loadFloat(MemorySegment src) { return loadFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated DoubleAABB loadFloat(long offset, MemorySegment src);
