...
public interface Double2x4 extends Double2x4R {
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double2x4 mul(double scalar) { return mul(scalar, Joml.RETURN_NEW ? Joml.double2x4() : this); }
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double2x4 addScaled(Double2x4R other, double weight) { return addScaled(other, weight, Joml.RETURN_NEW ? Joml.double2x4() : this); }

    /**
     * Add ({@code m00}, {@code m01}, {@code m02}, {@code m03}, {@code m10}, {@code m11},
     * {@code m12}, {@code m13}) scaled by {@code weight} to this matrix.
     *
     * @param m00 the element in row 0, column 0 of the matrix
     * @param m01 the element in row 0, column 1 of the matrix
     * @param m02 the element in row 0, column 2 of the matrix
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double2x4 addScaled(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double weight) { return addScaled(m00, m01, m02, m03, m10, m11, m12, m13, weight, Joml.RETURN_NEW ? Joml.double2x4() : this); }
     ...
     * @return this
     */
    @Mutated default Double2x4 loadCM(MemorySegment src) { return loadCM(0L, src); }
     ...
     * @return this
     */
    @Mutated Double2x4 loadCM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double2x4 loadCMFloat(MemorySegment src) { return loadCMFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated Double2x4 loadCMFloat(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double2x4 loadRM(MemorySegment src) { return loadRM(0L, src); }
     ...
     * @return this
     */
    @Mutated Double2x4 loadRM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double2x4 loadRMFloat(MemorySegment src) { return loadRMFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated Double2x4 loadRMFloat(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double2x4 loadCM(MemorySegment src, int stride) { return loadCM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double2x4 loadCM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double2x4 loadCMFloat(MemorySegment src, int stride) { return loadCMFloat(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double2x4 loadCMFloat(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double2x4 loadRM(MemorySegment src, int stride) { return loadRM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double2x4 loadRM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double2x4 loadRMFloat(MemorySegment src, int stride) { return loadRMFloat(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double2x4 loadRMFloat(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double2x4 load(MemorySegment src) { return loadCM(src); }
     ...
     * @return this
     */
    @Mutated default Double2x4 load(long offset, MemorySegment src) { return loadCM(offset, src); }
     ...
     * @return this
     */
    @Mutated default Double2x4 load(long offset, MemorySegment src, int stride) { return loadCM(offset, src, stride); }
