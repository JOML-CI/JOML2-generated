...
public interface FloatAABB extends FloatAABBR {
     ...
     * @return this
     */
    @Mutated default FloatAABB load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated FloatAABB load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default FloatAABB loadDouble(MemorySegment src) { return loadDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated FloatAABB loadDouble(long offset, MemorySegment src);
