...
public interface Double3x4 extends Double3x4R {
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double3x4 mul(double scalar) { return mul(scalar, Joml.RETURN_NEW ? Joml.double3x4() : this); }
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double3x4 addScaled(Double3x4R other, double weight) { return addScaled(other, weight, Joml.RETURN_NEW ? Joml.double3x4() : this); }
     ...
     * @return this (a new instance when {@code Joml.RETURN_NEW} is enabled)
     */
    @Mutated default Double3x4 addScaled(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22, double m23, double weight) { return addScaled(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, weight, Joml.RETURN_NEW ? Joml.double3x4() : this); }
     ...
     * @return this
     */
    @Mutated Double3x4 composeTRSAround(Double3R translation, DoubleQuatR rotation, Double3R scale, Double3R pivot);
     ...
     * @return this
     */
    @Mutated Double3x4 composeTRSAround(double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ, double pivotX, double pivotY, double pivotZ);
     ...
     * @return this
     */
    @Mutated default Double3x4 loadCM(MemorySegment src) { return loadCM(0L, src); }
     ...
     * @return this
     */
    @Mutated Double3x4 loadCM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double3x4 loadCMFloat(MemorySegment src) { return loadCMFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated Double3x4 loadCMFloat(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double3x4 loadRM(MemorySegment src) { return loadRM(0L, src); }
     ...
     * @return this
     */
    @Mutated Double3x4 loadRM(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double3x4 loadRMFloat(MemorySegment src) { return loadRMFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated Double3x4 loadRMFloat(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Double3x4 loadCM(MemorySegment src, int stride) { return loadCM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double3x4 loadCM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double3x4 loadCMFloat(MemorySegment src, int stride) { return loadCMFloat(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double3x4 loadCMFloat(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double3x4 loadRM(MemorySegment src, int stride) { return loadRM(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double3x4 loadRM(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double3x4 loadRMFloat(MemorySegment src, int stride) { return loadRMFloat(0L, src, stride); }
     ...
     * @return this
     */
    @Mutated Double3x4 loadRMFloat(long offset, MemorySegment src, int stride);
     ...
     * @return this
     */
    @Mutated default Double3x4 load(MemorySegment src) { return loadCM(src); }
     ...
     * @return this
     */
    @Mutated default Double3x4 load(long offset, MemorySegment src) { return loadCM(offset, src); }
     ...
     * @return this
     */
    @Mutated default Double3x4 load(long offset, MemorySegment src, int stride) { return loadCM(offset, src, stride); }
