...
public interface Int2 extends Int2R {
     ...
     * @return this
     */
    @Mutated default Int2 load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated Int2 load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Int2 loadLong(MemorySegment src) { return loadLong(0L, src); }
     ...
     * @return this
     */
    @Mutated Int2 loadLong(long offset, MemorySegment src);
