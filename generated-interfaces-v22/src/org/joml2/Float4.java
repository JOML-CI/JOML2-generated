...
public interface Float4 extends Float4R {
     ...
     * @return this
     */
    @Mutated default Float4 load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4 load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default Float4 loadDouble(MemorySegment src) { return loadDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated Float4 loadDouble(long offset, MemorySegment src);
