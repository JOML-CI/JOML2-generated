...
public interface FloatRay extends FloatRayR {
     ...
     * @return this
     */
    @Mutated default FloatRay load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated FloatRay load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default FloatRay loadDouble(MemorySegment src) { return loadDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated FloatRay loadDouble(long offset, MemorySegment src);
