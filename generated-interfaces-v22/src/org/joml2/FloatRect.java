...
public interface FloatRect extends FloatRectR {
     ...
     * @return this
     */
    @Mutated default FloatRect setMax(Float2R max) { return setMax(max, this); }
     ...
     * @return this
     */
    @Mutated default FloatRect setMax(float x, float y) { return setMax(x, y, this); }
     ...
     * @return this
     */
    @Mutated default FloatRect setMin(Float2R min) { return setMin(min, this); }
     ...
     * @return this
     */
    @Mutated default FloatRect setMin(float x, float y) { return setMin(x, y, this); }
     ...
     * @return this
     */
    @Mutated default FloatRect load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated FloatRect load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default FloatRect loadDouble(MemorySegment src) { return loadDouble(0L, src); }
     ...
     * @return this
     */
    @Mutated FloatRect loadDouble(long offset, MemorySegment src);
