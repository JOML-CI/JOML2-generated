...
public interface DoublePlane extends DoublePlaneR {
     ...
     * @return this
     */
    @Mutated default DoublePlane load(MemorySegment src) { return load(0L, src); }
     ...
     * @return this
     */
    @Mutated DoublePlane load(long offset, MemorySegment src);
     ...
     * @return this
     */
    @Mutated default DoublePlane loadFloat(MemorySegment src) { return loadFloat(0L, src); }
     ...
     * @return this
     */
    @Mutated DoublePlane loadFloat(long offset, MemorySegment src);
