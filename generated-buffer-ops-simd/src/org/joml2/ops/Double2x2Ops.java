...
public final class Double2x2Ops {
    ...
    public static double[] set(double[] dest, int destOffset, double[] v, int vOffset) {
        if (SimdSupport.VECTOR_API) return Double2x2OpsSimd.set(dest, destOffset, v, vOffset);
        return Double2x2OpsKernelsArray.set_scalar(dest, destOffset, v, vOffset);
    }
    ...
    public static double[] setMat2x3(double[] dest, int destOffset, double[] m, int mOffset) {
        if (SimdSupport.VECTOR_API) return Double2x2OpsSimd.setMat2x3(dest, destOffset, m, mOffset);
        return Double2x2OpsKernelsArray.setMat2x3_scalar(dest, destOffset, m, mOffset);
    }
    ...
    public static double[] to2x3(double[] dest, int destOffset, double[] src, int srcOffset) {
        if (SimdSupport.VECTOR_API) return Double2x2OpsSimd.to2x3(dest, destOffset, src, srcOffset);
        return Double2x2OpsKernelsArray.to2x3_scalar(dest, destOffset, src, srcOffset);
    }
    ...
    /** {@link #decomposeLDU(double[], int, double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment decomposeLDU(java.lang.foreign.MemorySegment lower, long lowerOffset, java.lang.foreign.MemorySegment diagonal, long diagonalOffset, java.lang.foreign.MemorySegment upper, long upperOffset, java.lang.foreign.MemorySegment src, long srcOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && lower.isNative() && !lower.isReadOnly() && diagonal.isNative() && !diagonal.isReadOnly() && upper.isNative() && !upper.isReadOnly() && src.isNative()) return Double2x2OpsKernelsSegment.decomposeLDU_unsafe(lower, lowerOffset, diagonal, diagonalOffset, upper, upperOffset, src, srcOffset);
        return Double2x2OpsKernelsSegment.decomposeLDU_api(lower, lowerOffset, diagonal, diagonalOffset, upper, upperOffset, src, srcOffset);
    }
    ...
    public static long decomposeLDU(long lower, long diagonal, long upper, long src) {
        ...
        decomposeLDU(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(lower, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(diagonal, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(upper, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 32L), 0L);
        return lower;
    }
