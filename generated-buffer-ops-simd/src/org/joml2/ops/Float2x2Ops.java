...
public final class Float2x2Ops {
    ...
    public static java.nio.FloatBuffer mul(java.nio.FloatBuffer dest, int destOffset, java.nio.FloatBuffer src, int srcOffset, float scalar) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float2x2OpsKernelsTypedBuffer.mul_unsafe(dest, destOffset, src, srcOffset, scalar);
    ...
    public static java.nio.ByteBuffer mul(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float scalar) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float2x2OpsKernelsByteBuffer.mul_unsafe(dest, destOffset, src, srcOffset, scalar);
    ...
    public static java.lang.foreign.MemorySegment mul(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, float scalar) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return Float2x2OpsKernelsSegment.mul_unsafe(dest, destOffset, src, srcOffset, scalar);
    ...
    public static long mul(long dest, long src, float scalar) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2x2OpsKernelsAddress.mul_unsafe(dest, src, scalar);
    ...
    /** {@link #decomposeLDU(float[], int, float[], int, float[], int, float[], int)} on {@link java.nio.FloatBuffer} storage. */
    ...
    /** {@link #decomposeLDU(float[], int, float[], int, float[], int, float[], int)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #decomposeLDU(float[], int, float[], int, float[], int, float[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment decomposeLDU(java.lang.foreign.MemorySegment lower, long lowerOffset, java.lang.foreign.MemorySegment diagonal, long diagonalOffset, java.lang.foreign.MemorySegment upper, long upperOffset, java.lang.foreign.MemorySegment src, long srcOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && lower.isNative() && !lower.isReadOnly() && diagonal.isNative() && !diagonal.isReadOnly() && upper.isNative() && !upper.isReadOnly() && src.isNative()) return Float2x2OpsKernelsSegment.decomposeLDU_unsafe(lower, lowerOffset, diagonal, diagonalOffset, upper, upperOffset, src, srcOffset);
    ...
    /** {@link #decomposeLDU(float[], int, float[], int, float[], int, float[], int)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static long decomposeLDU(long lower, long diagonal, long upper, long src) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2x2OpsKernelsAddress.decomposeLDU_unsafe(lower, diagonal, upper, src);
        decomposeLDU(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(lower, 16L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(diagonal, 16L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(upper, 16L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 16L), 0L);
        return lower;
    }
    ...
    public static java.lang.foreign.MemorySegment addScaled(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment other, long otherOffset, float weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && other.isNative()) return Float2x2OpsKernelsSegment.addScaled_unsafe(dest, destOffset, src, srcOffset, other, otherOffset, weight);
    ...
    public static long addScaled(long dest, long src, long other, float weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Float2x2OpsKernelsAddress.addScaled_unsafe(dest, src, other, weight);
    ...
    /** {@link #makeOuterProduct(float[], int, float, float, float, float)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #makeOuterProduct(float[], int, float, float, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #mulVec2(float[], int, float[], int, float, float)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #mulVec2(float[], int, float[], int, float, float)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #mulVec2(float[], int, float[], int, float[], int)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #mulVec2(float[], int, float[], int, float[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
