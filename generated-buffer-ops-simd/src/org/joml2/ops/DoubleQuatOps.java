...
public final class DoubleQuatOps {
    ...
    public static double[] difference(double[] dest, int destOffset, double[] src, int srcOffset, double otherX, double otherY, double otherZ, double otherW) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.difference(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW);
        return DoubleQuatOpsKernelsArray.difference_scalar(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW);
    }
    ...
    public static double[] difference(double[] dest, int destOffset, double[] src, int srcOffset, double[] other, int otherOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.difference(dest, destOffset, src, srcOffset, other, otherOffset);
        return DoubleQuatOpsKernelsArray.difference_scalar(dest, destOffset, src, srcOffset, other, otherOffset);
    }
