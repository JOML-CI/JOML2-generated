...
public final class DoubleQuatOps {
    ...
    public static double[] invertProduct(double[] dest, int destOffset, double[] src, int srcOffset, double otherX, double otherY, double otherZ, double otherW) {
        ...
        dest[destOffset + 0] = -(_t20 * _t27_inv);
        dest[destOffset + 1] = -(_t23 * _t27_inv);
        dest[destOffset + 2] = -(_t22 * _t27_inv);
        dest[destOffset + 3] = _t21 * _t27_inv;
        return dest;
    }
    ...
    /** {@link #invertProduct(double[], int, double[], int, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] add(double[] dest, int destOffset, double[] src, int srcOffset, double[] other, int otherOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.add(dest, destOffset, src, srcOffset, other, otherOffset);
        return DoubleQuatOpsKernelsArray.add_scalar(dest, destOffset, src, srcOffset, other, otherOffset);
    }
    ...
    public static double[] mul(double[] dest, int destOffset, double[] src, int srcOffset, double scalar) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.mul(dest, destOffset, src, srcOffset, scalar);
        return DoubleQuatOpsKernelsArray.mul_scalar(dest, destOffset, src, srcOffset, scalar);
    }
    ...
    public static java.nio.DoubleBuffer mul(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, double scalar) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.mul_unsafe(dest, destOffset, src, srcOffset, scalar);
        return DoubleQuatOpsKernelsTypedBuffer.mul_api(dest, destOffset, src, srcOffset, scalar);
    }
    ...
    public static java.nio.ByteBuffer mul(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double scalar) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.mul_unsafe(dest, destOffset, src, srcOffset, scalar);
        return DoubleQuatOpsKernelsByteBuffer.mul_api(dest, destOffset, src, srcOffset, scalar);
    }
    ...
    public static java.lang.foreign.MemorySegment mul(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double scalar) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.mul(dest, destOffset, src, srcOffset, scalar);
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return DoubleQuatOpsKernelsSegment.mul_unsafe(dest, destOffset, src, srcOffset, scalar);
        return DoubleQuatOpsKernelsSegment.mul_api(dest, destOffset, src, srcOffset, scalar);
    }
    ...
    public static long mul(long dest, long src, double scalar) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.mul_unsafe(dest, src, scalar);
    ...
    public static double[] negate(double[] dest, int destOffset, double[] src, int srcOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.negate(dest, destOffset, src, srcOffset);
        return DoubleQuatOpsKernelsArray.negate_scalar(dest, destOffset, src, srcOffset);
    }
    ...
    public static double[] sub(double[] dest, int destOffset, double[] src, int srcOffset, double[] other, int otherOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.sub(dest, destOffset, src, srcOffset, other, otherOffset);
        return DoubleQuatOpsKernelsArray.sub_scalar(dest, destOffset, src, srcOffset, other, otherOffset);
    }
     ...
     * @return {@code dest}
     */
    public static double[] makeUniformRotation(double[] dest, int destOffset, double u1, double u2, double u3) {
        ...
        dest[destOffset + 1] = Math.cosFromSin(_t4, _t1) * _t5;
        dest[destOffset + 2] = _t6 * _t0;
        dest[destOffset + 3] = Math.cosFromSin(_t6, _t3) * _t0;
        return dest;
    }

    /** {@link #makeUniformRotation(double[], int, double, double, double)} on {@link java.nio.DoubleBuffer} storage. */
    public static java.nio.DoubleBuffer makeUniformRotation(java.nio.DoubleBuffer dest, int destOffset, double u1, double u2, double u3) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.makeUniformRotation_unsafe(dest, destOffset, u1, u2, u3);
        return DoubleQuatOpsKernelsTypedBuffer.makeUniformRotation_api(dest, destOffset, u1, u2, u3);
    }

    /** {@link #makeUniformRotation(double[], int, double, double, double)} on {@link java.nio.ByteBuffer} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.nio.ByteBuffer makeUniformRotation(java.nio.ByteBuffer dest, int destOffset, double u1, double u2, double u3) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.makeUniformRotation_unsafe(dest, destOffset, u1, u2, u3);
        return DoubleQuatOpsKernelsByteBuffer.makeUniformRotation_api(dest, destOffset, u1, u2, u3);
    }

    /** {@link #makeUniformRotation(double[], int, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    public static java.lang.foreign.MemorySegment makeUniformRotation(java.lang.foreign.MemorySegment dest, long destOffset, double u1, double u2, double u3) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly()) return DoubleQuatOpsKernelsSegment.makeUniformRotation_unsafe(dest, destOffset, u1, u2, u3);
        return DoubleQuatOpsKernelsSegment.makeUniformRotation_api(dest, destOffset, u1, u2, u3);
    }

    /** {@link #makeUniformRotation(double[], int, double, double, double)} on storage addressed by a raw native address - each address points at the first element, so there are no offsets. */
    public static long makeUniformRotation(long dest, double u1, double u2, double u3) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.makeUniformRotation_unsafe(dest, u1, u2, u3);
        makeUniformRotation(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, u1, u2, u3);
        return dest;
    }
    ...
    public static double[] set(double[] dest, int destOffset, double[] v, int vOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.set(dest, destOffset, v, vOffset);
        return DoubleQuatOpsKernelsArray.set_scalar(dest, destOffset, v, vOffset);
    }
    ...
    /** {@link #toMatrix(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #toMatrix3x3(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #toMatrix3x4(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] decomposeSwingTwist(double[] swing, int swingOffset, double[] twist, int twistOffset, double[] src, int srcOffset, double axisX, double axisY, double axisZ) {
        ...
        swing[swingOffset + 3] = Math.fma(_selfx, _t12, _selfw * _t11) - Math.fma(-_selfz, _t14, -(_selfy * _t13));
    ...
    /** {@link #decomposeSwingTwist(double[], int, double[], int, double[], int, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #decomposeSwingTwist(double[], int, double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] getSwing(double[] dest, int destOffset, double[] src, int srcOffset, double axisX, double axisY, double axisZ) {
        ...
        dest[destOffset + 3] = Math.fma(_selfx, _t12, _selfw * _t11) - Math.fma(-_selfz, _t14, -(_selfy * _t13));
        return dest;
    }
    ...
    /** {@link #getSwing(double[], int, double[], int, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #getSwing(double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #getTwist(double[], int, double[], int, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #getTwist(double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] makeZero(double[] dest, int destOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.makeZero(dest, destOffset);
        return DoubleQuatOpsKernelsArray.makeZero_scalar(dest, destOffset);
    }
    ...
    public static double[] lerp(double[] dest, int destOffset, double[] src, int srcOffset, double otherX, double otherY, double otherZ, double otherW, double t) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.lerp(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW, t);
        return DoubleQuatOpsKernelsArray.lerp_scalar(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW, t);
    }
    ...
    public static double[] lerp(double[] dest, int destOffset, double[] src, int srcOffset, double[] other, int otherOffset, double t) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.lerp(dest, destOffset, src, srcOffset, other, otherOffset, t);
        return DoubleQuatOpsKernelsArray.lerp_scalar(dest, destOffset, src, srcOffset, other, otherOffset, t);
    }
    ...
    /** {@link #nlerp(double[], int, double[], int, double, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] nlerp(double[] dest, int destOffset, double[] src, int srcOffset, double[] target, int targetOffset, double alpha) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.nlerp(dest, destOffset, src, srcOffset, target, targetOffset, alpha);
        return DoubleQuatOpsKernelsArray.nlerp_scalar(dest, destOffset, src, srcOffset, target, targetOffset, alpha);
    }
    ...
    /** {@link #nlerp(double[], int, double[], int, double[], int, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #nlerpShortest(double[], int, double[], int, double, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] nlerpShortest(double[] dest, int destOffset, double[] src, int srcOffset, double[] target, int targetOffset, double alpha) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.nlerpShortest(dest, destOffset, src, srcOffset, target, targetOffset, alpha);
        return DoubleQuatOpsKernelsArray.nlerpShortest_scalar(dest, destOffset, src, srcOffset, target, targetOffset, alpha);
    }
    ...
    /** {@link #nlerpShortest(double[], int, double[], int, double[], int, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] slerp(double[] dest, int destOffset, double[] src, int srcOffset, double targetX, double targetY, double targetZ, double targetW, double alpha) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.slerp(dest, destOffset, src, srcOffset, targetX, targetY, targetZ, targetW, alpha);
        return DoubleQuatOpsKernelsArray.slerp_scalar(dest, destOffset, src, srcOffset, targetX, targetY, targetZ, targetW, alpha);
    }
    ...
    public static double[] slerp(double[] dest, int destOffset, double[] src, int srcOffset, double[] target, int targetOffset, double alpha) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.slerp(dest, destOffset, src, srcOffset, target, targetOffset, alpha);
        return DoubleQuatOpsKernelsArray.slerp_scalar(dest, destOffset, src, srcOffset, target, targetOffset, alpha);
    }
    ...
    /** {@link #slerpShortest(double[], int, double[], int, double, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] slerpShortest(double[] dest, int destOffset, double[] src, int srcOffset, double[] target, int targetOffset, double alpha) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.slerpShortest(dest, destOffset, src, srcOffset, target, targetOffset, alpha);
        return DoubleQuatOpsKernelsArray.slerpShortest_scalar(dest, destOffset, src, srcOffset, target, targetOffset, alpha);
    }
    ...
    /** {@link #slerpShortest(double[], int, double[], int, double[], int, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #squad(double[], int, double[], int, double, double, double, double, double, double, double, double, double, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #squad(double[], int, double[], int, double[], int, double[], int, double[], int, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] mul(double[] dest, int destOffset, double[] src, int srcOffset, double otherX, double otherY, double otherZ, double otherW) {
        ...
        dest[destOffset + 3] = Math.fma(otherW, _selfw, -(otherX * _selfx)) - Math.fma(otherY, _selfy, otherZ * _selfz);
        return dest;
    }
    ...
    public static double[] mul(double[] dest, int destOffset, double[] src, int srcOffset, double[] other, int otherOffset) {
        ...
        dest[destOffset + 3] = Math.fma(_otherw, _selfw, -(_otherx * _selfx)) - Math.fma(_othery, _selfy, _otherz * _selfz);
        return dest;
    }
    ...
    /** {@link #preMul(double[], int, double[], int, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
     ...
     * @return {@code dest}
     */
    public static double[] addScaled(double[] dest, int destOffset, double[] src, int srcOffset, double otherX, double otherY, double otherZ, double otherW, double weight) {
        double _selfx = src[srcOffset + 0];
        double _selfy = src[srcOffset + 1];
        double _selfz = src[srcOffset + 2];
        double _selfw = src[srcOffset + 3];
    ...
    public static java.nio.DoubleBuffer addScaled(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, double otherX, double otherY, double otherZ, double otherW, double weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.addScaled_unsafe(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW, weight);
        return DoubleQuatOpsKernelsTypedBuffer.addScaled_api(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW, weight);
    }
    ...
    public static java.nio.ByteBuffer addScaled(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double otherX, double otherY, double otherZ, double otherW, double weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.addScaled_unsafe(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW, weight);
        return DoubleQuatOpsKernelsByteBuffer.addScaled_api(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW, weight);
    }
    ...
    public static java.lang.foreign.MemorySegment addScaled(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double otherX, double otherY, double otherZ, double otherW, double weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return DoubleQuatOpsKernelsSegment.addScaled_unsafe(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW, weight);
        return DoubleQuatOpsKernelsSegment.addScaled_api(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, otherW, weight);
    }
    ...
    public static long addScaled(long dest, long src, double otherX, double otherY, double otherZ, double otherW, double weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.addScaled_unsafe(dest, src, otherX, otherY, otherZ, otherW, weight);
        addScaled(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 32L), 0L, otherX, otherY, otherZ, otherW, weight);
        return dest;
    }
    ...
    public static double[] addScaled(double[] dest, int destOffset, double[] src, int srcOffset, double[] other, int otherOffset, double weight) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.addScaled(dest, destOffset, src, srcOffset, other, otherOffset, weight);
        return DoubleQuatOpsKernelsArray.addScaled_scalar(dest, destOffset, src, srcOffset, other, otherOffset, weight);
    }
    ...
    public static java.nio.DoubleBuffer addScaled(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, java.nio.DoubleBuffer other, int otherOffset, double weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder() && other.isDirect() && other.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.addScaled_unsafe(dest, destOffset, src, srcOffset, other, otherOffset, weight);
        return DoubleQuatOpsKernelsTypedBuffer.addScaled_api(dest, destOffset, src, srcOffset, other, otherOffset, weight);
    }
    ...
    public static java.nio.ByteBuffer addScaled(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer other, int otherOffset, double weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder() && other.isDirect() && other.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.addScaled_unsafe(dest, destOffset, src, srcOffset, other, otherOffset, weight);
        return DoubleQuatOpsKernelsByteBuffer.addScaled_api(dest, destOffset, src, srcOffset, other, otherOffset, weight);
    }
    ...
    public static java.lang.foreign.MemorySegment addScaled(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment other, long otherOffset, double weight) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.addScaled(dest, destOffset, src, srcOffset, other, otherOffset, weight);
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative() && other.isNative()) return DoubleQuatOpsKernelsSegment.addScaled_unsafe(dest, destOffset, src, srcOffset, other, otherOffset, weight);
        return DoubleQuatOpsKernelsSegment.addScaled_api(dest, destOffset, src, srcOffset, other, otherOffset, weight);
    }
    ...
    public static long addScaled(long dest, long src, long other, double weight) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.addScaled_unsafe(dest, src, other, weight);
    ...
    /** {@link #angle(double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #angleTo(double[], int, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #angleTo(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #axis(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] calculateW(double[] dest, int destOffset, double[] src, int srcOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.calculateW(dest, destOffset, src, srcOffset);
        return DoubleQuatOpsKernelsArray.calculateW_scalar(dest, destOffset, src, srcOffset);
    }
    ...
    /** {@link #calculateW(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #conjugate(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] conjugateBy(double[] dest, int destOffset, double[] src, int srcOffset, double qX, double qY, double qZ, double qW) {
        ...
        dest[destOffset + 0] = Math.fma(qY, _t20, -(qZ * _t21)) + Math.fma(qW, _t22, -(qX * _t23));
        dest[destOffset + 1] = Math.fma(qZ, _t22, -(qY * _t23)) + Math.fma(qW, _t21, -(qX * _t20));
        dest[destOffset + 2] = Math.fma(qX, _t21, qW * _t20) + Math.fma(-qY, _t22, -(qZ * _t23));
        dest[destOffset + 3] = Math.fma(qX, _t22, qW * _t23) - Math.fma(-qZ, _t20, -(qY * _t21));
        return dest;
    }
    ...
    /** {@link #conjugateBy(double[], int, double[], int, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] conjugateBy(double[] dest, int destOffset, double[] src, int srcOffset, double[] q, int qOffset) {
        ...
        dest[destOffset + 0] = Math.fma(_qy, _t20, -(_qz * _t21)) + Math.fma(_qw, _t22, -(_qx * _t23));
        dest[destOffset + 1] = Math.fma(_qz, _t22, -(_qy * _t23)) + Math.fma(_qw, _t21, -(_qx * _t20));
        dest[destOffset + 2] = Math.fma(_qx, _t21, _qw * _t20) + Math.fma(-_qy, _t22, -(_qz * _t23));
        dest[destOffset + 3] = Math.fma(_qx, _t22, _qw * _t23) - Math.fma(-_qz, _t20, -(_qy * _t21));
        return dest;
    }
    ...
    /** {@link #conjugateBy(double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #difference(double[], int, double[], int, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #difference(double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] exp(double[] dest, int destOffset, double[] src, int srcOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.exp(dest, destOffset, src, srcOffset);
        return DoubleQuatOpsKernelsArray.exp_scalar(dest, destOffset, src, srcOffset);
    }
    ...
    public static double[] integrate(double[] dest, int destOffset, double[] src, int srcOffset, double angularVelX, double angularVelY, double angularVelZ, double dt) {
        ...
        dest[destOffset + 0] = Math.fma(_selfx, _t10, _selfw * _t15) + Math.fma(_selfz, _t16, -(_selfy * _t17));
        dest[destOffset + 1] = Math.fma(_selfx, _t17, _selfw * _t16) + Math.fma(_selfy, _t10, -(_selfz * _t15));
        dest[destOffset + 2] = Math.fma(_selfy, _t15, _selfz * _t10) + Math.fma(_selfw, _t17, -(_selfx * _t16));
        dest[destOffset + 3] = Math.fma(_selfw, _t10, -(_selfx * _t15)) - Math.fma(_selfy, _t16, _selfz * _t17);
        return dest;
    }
    ...
    /** {@link #integrate(double[], int, double[], int, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #integrate(double[], int, double[], int, double[], int, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNegativeX(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNegativeY(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNegativeZ(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNormalizedNegativeX(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNormalizedNegativeY(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNormalizedNegativeZ(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNormalizedPositiveX(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNormalizedPositiveY(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invNormalizedPositiveZ(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invPositiveX(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invPositiveY(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #invPositiveZ(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] log(double[] dest, int destOffset, double[] src, int srcOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.log(dest, destOffset, src, srcOffset);
        return DoubleQuatOpsKernelsArray.log_scalar(dest, destOffset, src, srcOffset);
    }
    ...
    /** {@link #negativeX(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #negativeY(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #negativeZ(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] normalize(double[] dest, int destOffset, double[] src, int srcOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.normalize(dest, destOffset, src, srcOffset);
        return DoubleQuatOpsKernelsArray.normalize_scalar(dest, destOffset, src, srcOffset);
    }
    ...
    /** {@link #normalizedNegativeX(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #normalizedNegativeY(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #normalizedNegativeZ(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #normalizedPositiveX(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #normalizedPositiveY(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #normalizedPositiveZ(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #positiveX(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #positiveY(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #positiveZ(double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #rotateTowards(double[], int, double[], int, double, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] rotateTowards(double[] dest, int destOffset, double[] src, int srcOffset, double[] target, int targetOffset, double step) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.rotateTowards(dest, destOffset, src, srcOffset, target, targetOffset, step);
        return DoubleQuatOpsKernelsArray.rotateTowards_scalar(dest, destOffset, src, srcOffset, target, targetOffset, step);
    }
    ...
    /** {@link #rotateTowards(double[], int, double[], int, double[], int, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] lookAlong(double[] dest, int destOffset, double[] src, int srcOffset, double dirX, double dirY, double dirZ, double upX, double upY, double upZ) {
        ...
        dest[destOffset + 3] = Math.fma(_selfw, _t110, -(_selfx * _t111)) - Math.fma(_selfy, _t109, _selfz * _t108);
        return dest;
    }
    ...
    public static double[] makeRotationAxis(double[] dest, int destOffset, double angle, double axisX, double axisY, double axisZ) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.makeRotationAxis(dest, destOffset, angle, axisX, axisY, axisZ);
        return DoubleQuatOpsKernelsArray.makeRotationAxis_scalar(dest, destOffset, angle, axisX, axisY, axisZ);
    }
    ...
    public static double[] makeRotationAxis(double[] dest, int destOffset, double[] axis, int axisOffset, double angle) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.makeRotationAxis(dest, destOffset, axis, axisOffset, angle);
        return DoubleQuatOpsKernelsArray.makeRotationAxis_scalar(dest, destOffset, axis, axisOffset, angle);
    }
    ...
    public static double[] makeRotationXYZ(double[] dest, int destOffset, double angleX, double angleY, double angleZ) {
        ...
        dest[destOffset + 2] = Math.fma(_t9, _t7, _t12 * _t5);
        dest[destOffset + 3] = Math.fma(_t12, _t7, -(_t9 * _t5));
        return dest;
    }
    ...
    public static double[] makeRotationXZY(double[] dest, int destOffset, double angleX, double angleZ, double angleY) {
        ...
        double _t12 = _t8 * _t6;
        dest[destOffset + 0] = Math.fma(_t10, _t7, -(_t11 * _t5));
        dest[destOffset + 1] = Math.fma(_t12, _t5, -(_t9 * _t7));
        dest[destOffset + 2] = Math.fma(_t10, _t5, _t11 * _t7);
    ...
    public static java.nio.DoubleBuffer makeRotationXZY(java.nio.DoubleBuffer dest, int destOffset, double angleX, double angleZ, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.makeRotationXZY_unsafe(dest, destOffset, angleX, angleZ, angleY);
        return DoubleQuatOpsKernelsTypedBuffer.makeRotationXZY_api(dest, destOffset, angleX, angleZ, angleY);
    }
    ...
    public static java.nio.ByteBuffer makeRotationXZY(java.nio.ByteBuffer dest, int destOffset, double angleX, double angleZ, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.makeRotationXZY_unsafe(dest, destOffset, angleX, angleZ, angleY);
        return DoubleQuatOpsKernelsByteBuffer.makeRotationXZY_api(dest, destOffset, angleX, angleZ, angleY);
    }
    ...
    public static java.lang.foreign.MemorySegment makeRotationXZY(java.lang.foreign.MemorySegment dest, long destOffset, double angleX, double angleZ, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly()) return DoubleQuatOpsKernelsSegment.makeRotationXZY_unsafe(dest, destOffset, angleX, angleZ, angleY);
        return DoubleQuatOpsKernelsSegment.makeRotationXZY_api(dest, destOffset, angleX, angleZ, angleY);
    }
    ...
    public static long makeRotationXZY(long dest, double angleX, double angleZ, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.makeRotationXZY_unsafe(dest, angleX, angleZ, angleY);
        makeRotationXZY(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, angleX, angleZ, angleY);
        return dest;
    }
    ...
    public static double[] makeRotationYXZ(double[] dest, int destOffset, double angleY, double angleX, double angleZ) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.makeRotationYXZ(dest, destOffset, angleY, angleX, angleZ);
        return DoubleQuatOpsKernelsArray.makeRotationYXZ_scalar(dest, destOffset, angleY, angleX, angleZ);
    }
    ...
    public static java.nio.DoubleBuffer makeRotationYXZ(java.nio.DoubleBuffer dest, int destOffset, double angleY, double angleX, double angleZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.makeRotationYXZ_unsafe(dest, destOffset, angleY, angleX, angleZ);
        return DoubleQuatOpsKernelsTypedBuffer.makeRotationYXZ_api(dest, destOffset, angleY, angleX, angleZ);
    }
    ...
    public static java.nio.ByteBuffer makeRotationYXZ(java.nio.ByteBuffer dest, int destOffset, double angleY, double angleX, double angleZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.makeRotationYXZ_unsafe(dest, destOffset, angleY, angleX, angleZ);
        return DoubleQuatOpsKernelsByteBuffer.makeRotationYXZ_api(dest, destOffset, angleY, angleX, angleZ);
    }
    ...
    public static java.lang.foreign.MemorySegment makeRotationYXZ(java.lang.foreign.MemorySegment dest, long destOffset, double angleY, double angleX, double angleZ) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.makeRotationYXZ(dest, destOffset, angleY, angleX, angleZ);
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly()) return DoubleQuatOpsKernelsSegment.makeRotationYXZ_unsafe(dest, destOffset, angleY, angleX, angleZ);
        return DoubleQuatOpsKernelsSegment.makeRotationYXZ_api(dest, destOffset, angleY, angleX, angleZ);
    }
    ...
    public static long makeRotationYXZ(long dest, double angleY, double angleX, double angleZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.makeRotationYXZ_unsafe(dest, angleY, angleX, angleZ);
        makeRotationYXZ(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, angleY, angleX, angleZ);
        return dest;
    }
    ...
    public static double[] makeRotationYZX(double[] dest, int destOffset, double angleY, double angleZ, double angleX) {
        ...
        double _t11 = _t4 * _t7;
        double _t12 = _t7 * _t8;
        dest[destOffset + 0] = Math.fma(_t9, _t6, _t12 * _t5);
        dest[destOffset + 1] = Math.fma(_t10, _t6, _t11 * _t5);
        dest[destOffset + 2] = Math.fma(_t11, _t6, -(_t10 * _t5));
        dest[destOffset + 3] = Math.fma(_t12, _t6, -(_t9 * _t5));
        return dest;
    }
    ...
    public static java.nio.DoubleBuffer makeRotationYZX(java.nio.DoubleBuffer dest, int destOffset, double angleY, double angleZ, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.makeRotationYZX_unsafe(dest, destOffset, angleY, angleZ, angleX);
        return DoubleQuatOpsKernelsTypedBuffer.makeRotationYZX_api(dest, destOffset, angleY, angleZ, angleX);
    }
    ...
    public static java.nio.ByteBuffer makeRotationYZX(java.nio.ByteBuffer dest, int destOffset, double angleY, double angleZ, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.makeRotationYZX_unsafe(dest, destOffset, angleY, angleZ, angleX);
        return DoubleQuatOpsKernelsByteBuffer.makeRotationYZX_api(dest, destOffset, angleY, angleZ, angleX);
    }
    ...
    public static java.lang.foreign.MemorySegment makeRotationYZX(java.lang.foreign.MemorySegment dest, long destOffset, double angleY, double angleZ, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly()) return DoubleQuatOpsKernelsSegment.makeRotationYZX_unsafe(dest, destOffset, angleY, angleZ, angleX);
        return DoubleQuatOpsKernelsSegment.makeRotationYZX_api(dest, destOffset, angleY, angleZ, angleX);
    }
    ...
    public static long makeRotationYZX(long dest, double angleY, double angleZ, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.makeRotationYZX_unsafe(dest, angleY, angleZ, angleX);
        makeRotationYZX(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, angleY, angleZ, angleX);
        return dest;
    }
    ...
    public static double[] makeRotationZXY(double[] dest, int destOffset, double angleZ, double angleX, double angleY) {
        ...
        double _t12 = _t8 * _t6;
        dest[destOffset + 0] = Math.fma(_t10, _t7, -(_t11 * _t5));
        dest[destOffset + 1] = Math.fma(_t9, _t7, _t12 * _t5);
        dest[destOffset + 2] = Math.fma(_t10, _t5, _t11 * _t7);
        dest[destOffset + 3] = Math.fma(_t12, _t7, -(_t9 * _t5));
        return dest;
    }
    ...
    public static java.nio.DoubleBuffer makeRotationZXY(java.nio.DoubleBuffer dest, int destOffset, double angleZ, double angleX, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.makeRotationZXY_unsafe(dest, destOffset, angleZ, angleX, angleY);
        return DoubleQuatOpsKernelsTypedBuffer.makeRotationZXY_api(dest, destOffset, angleZ, angleX, angleY);
    }
    ...
    public static java.nio.ByteBuffer makeRotationZXY(java.nio.ByteBuffer dest, int destOffset, double angleZ, double angleX, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.makeRotationZXY_unsafe(dest, destOffset, angleZ, angleX, angleY);
        return DoubleQuatOpsKernelsByteBuffer.makeRotationZXY_api(dest, destOffset, angleZ, angleX, angleY);
    }
    ...
    public static java.lang.foreign.MemorySegment makeRotationZXY(java.lang.foreign.MemorySegment dest, long destOffset, double angleZ, double angleX, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly()) return DoubleQuatOpsKernelsSegment.makeRotationZXY_unsafe(dest, destOffset, angleZ, angleX, angleY);
        return DoubleQuatOpsKernelsSegment.makeRotationZXY_api(dest, destOffset, angleZ, angleX, angleY);
    }
    ...
    public static long makeRotationZXY(long dest, double angleZ, double angleX, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.makeRotationZXY_unsafe(dest, angleZ, angleX, angleY);
        makeRotationZXY(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, angleZ, angleX, angleY);
        return dest;
    }
    ...
    public static double[] makeRotationZYX(double[] dest, int destOffset, double angleZ, double angleY, double angleX) {
        ...
        double _t11 = _t4 * _t6;
        double _t12 = _t6 * _t7;
        dest[destOffset + 0] = Math.fma(_t12, _t5, -(_t9 * _t8));
        dest[destOffset + 1] = Math.fma(_t10, _t8, _t11 * _t5);
        dest[destOffset + 2] = Math.fma(_t11, _t8, -(_t10 * _t5));
        dest[destOffset + 3] = Math.fma(_t9, _t5, _t12 * _t8);
        return dest;
    }
    ...
    public static java.nio.DoubleBuffer makeRotationZYX(java.nio.DoubleBuffer dest, int destOffset, double angleZ, double angleY, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.makeRotationZYX_unsafe(dest, destOffset, angleZ, angleY, angleX);
        return DoubleQuatOpsKernelsTypedBuffer.makeRotationZYX_api(dest, destOffset, angleZ, angleY, angleX);
    }
    ...
    public static java.nio.ByteBuffer makeRotationZYX(java.nio.ByteBuffer dest, int destOffset, double angleZ, double angleY, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.makeRotationZYX_unsafe(dest, destOffset, angleZ, angleY, angleX);
        return DoubleQuatOpsKernelsByteBuffer.makeRotationZYX_api(dest, destOffset, angleZ, angleY, angleX);
    }
    ...
    public static java.lang.foreign.MemorySegment makeRotationZYX(java.lang.foreign.MemorySegment dest, long destOffset, double angleZ, double angleY, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly()) return DoubleQuatOpsKernelsSegment.makeRotationZYX_unsafe(dest, destOffset, angleZ, angleY, angleX);
        return DoubleQuatOpsKernelsSegment.makeRotationZYX_api(dest, destOffset, angleZ, angleY, angleX);
    }
    ...
    public static long makeRotationZYX(long dest, double angleZ, double angleY, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.makeRotationZYX_unsafe(dest, angleZ, angleY, angleX);
        makeRotationZYX(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, angleZ, angleY, angleX);
        return dest;
    }
    ...
    public static double[] preRotateX(double[] dest, int destOffset, double[] src, int srcOffset, double angle) {
        ...
        dest[destOffset + 0] = Math.fma(_selfx, _t2, _selfw * _t1);
        dest[destOffset + 1] = Math.fma(_selfy, _t2, -(_selfz * _t1));
        dest[destOffset + 2] = Math.fma(_selfy, _t1, _selfz * _t2);
        dest[destOffset + 3] = Math.fma(_selfw, _t2, -(_selfx * _t1));
        return dest;
    }
    ...
    public static double[] preRotateY(double[] dest, int destOffset, double[] src, int srcOffset, double angle) {
        ...
        double _t1 = Math.sin(_t0);
        double _t2 = Math.cosFromSin(_t1, _t0);
        dest[destOffset + 0] = Math.fma(_selfx, _t2, _selfz * _t1);
        dest[destOffset + 1] = Math.fma(_selfy, _t2, _selfw * _t1);
        dest[destOffset + 2] = Math.fma(_selfz, _t2, -(_selfx * _t1));
        dest[destOffset + 3] = Math.fma(_selfw, _t2, -(_selfy * _t1));
        return dest;
    }
    ...
    public static double[] preRotateZ(double[] dest, int destOffset, double[] src, int srcOffset, double angle) {
        ...
        double _t1 = Math.sin(_t0);
        double _t2 = Math.cosFromSin(_t1, _t0);
        dest[destOffset + 0] = Math.fma(_selfx, _t2, -(_selfy * _t1));
        dest[destOffset + 1] = Math.fma(_selfx, _t1, _selfy * _t2);
        dest[destOffset + 2] = Math.fma(_selfz, _t2, _selfw * _t1);
        dest[destOffset + 3] = Math.fma(_selfw, _t2, -(_selfz * _t1));
        return dest;
    }
    ...
    public static double[] rotateAxis(double[] dest, int destOffset, double[] src, int srcOffset, double angle, double axisX, double axisY, double axisZ) {
        ...
        dest[destOffset + 0] = Math.fma(_selfx, _t5, _selfw * _t2) + Math.fma(_selfy, _t3, -(_selfz * _t4));
        dest[destOffset + 1] = Math.fma(_selfy, _t5, _selfz * _t2) + Math.fma(_selfw, _t4, -(_selfx * _t3));
        dest[destOffset + 2] = Math.fma(_selfx, _t4, _selfw * _t3) + Math.fma(_selfz, _t5, -(_selfy * _t2));
        dest[destOffset + 3] = Math.fma(_selfw, _t5, -(_selfx * _t2)) - Math.fma(_selfy, _t4, _selfz * _t3);
        return dest;
    }
    ...
    public static double[] rotateTo(double[] dest, int destOffset, double[] src, int srcOffset, double fromDirX, double fromDirY, double fromDirZ, double toDirX, double toDirY, double toDirZ) {
        ...
        dest[destOffset + 0] = Math.fma(_selfx, _t41, _selfw * _t45) + Math.fma(_selfy, _t46, -(_selfz * _t47));
        dest[destOffset + 1] = Math.fma(_selfy, _t41, _selfz * _t45) + Math.fma(_selfw, _t47, -(_selfx * _t46));
        dest[destOffset + 2] = Math.fma(_selfx, _t47, _selfw * _t46) + Math.fma(_selfz, _t41, -(_selfy * _t45));
        dest[destOffset + 3] = Math.fma(_selfw, _t41, -(_selfx * _t45)) - Math.fma(_selfy, _t47, _selfz * _t46);
        return dest;
    }
    ...
    /** {@link #rotateTo(double[], int, double[], int, double, double, double, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #rotateTo(double[], int, double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] rotateX(double[] dest, int destOffset, double[] src, int srcOffset, double angle) {
        ...
        dest[destOffset + 0] = Math.fma(_selfx, _t2, _selfw * _t1);
        dest[destOffset + 1] = Math.fma(_selfy, _t2, _selfz * _t1);
        dest[destOffset + 2] = Math.fma(_selfz, _t2, -(_selfy * _t1));
        dest[destOffset + 3] = Math.fma(_selfw, _t2, -(_selfx * _t1));
        return dest;
    }
    ...
    public static double[] rotateXYZ(double[] dest, int destOffset, double[] src, int srcOffset, double angleX, double angleY, double angleZ) {
        ...
        dest[destOffset + 3] = Math.fma(_selfw, _t21, -(_selfx * _t19)) - Math.fma(_selfy, _t22, _selfz * _t20);
        return dest;
    }
    ...
    public static double[] rotateXZY(double[] dest, int destOffset, double[] src, int srcOffset, double angleX, double angleZ, double angleY) {
        ...
        dest[destOffset + 3] = Math.fma(_selfw, _t19, -(_selfx * _t21)) - Math.fma(_selfy, _t22, _selfz * _t20);
        return dest;
    }
    ...
    public static java.nio.DoubleBuffer rotateXZY(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, double angleX, double angleZ, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.rotateXZY_unsafe(dest, destOffset, src, srcOffset, angleX, angleZ, angleY);
        return DoubleQuatOpsKernelsTypedBuffer.rotateXZY_api(dest, destOffset, src, srcOffset, angleX, angleZ, angleY);
    }
    ...
    public static java.nio.ByteBuffer rotateXZY(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double angleX, double angleZ, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.rotateXZY_unsafe(dest, destOffset, src, srcOffset, angleX, angleZ, angleY);
        return DoubleQuatOpsKernelsByteBuffer.rotateXZY_api(dest, destOffset, src, srcOffset, angleX, angleZ, angleY);
    }
    ...
    public static java.lang.foreign.MemorySegment rotateXZY(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double angleX, double angleZ, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return DoubleQuatOpsKernelsSegment.rotateXZY_unsafe(dest, destOffset, src, srcOffset, angleX, angleZ, angleY);
        return DoubleQuatOpsKernelsSegment.rotateXZY_api(dest, destOffset, src, srcOffset, angleX, angleZ, angleY);
    }
    ...
    public static long rotateXZY(long dest, long src, double angleX, double angleZ, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.rotateXZY_unsafe(dest, src, angleX, angleZ, angleY);
        rotateXZY(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 32L), 0L, angleX, angleZ, angleY);
        return dest;
    }
    ...
    public static double[] rotateY(double[] dest, int destOffset, double[] src, int srcOffset, double angle) {
        ...
        dest[destOffset + 0] = Math.fma(_selfx, _t2, -(_selfz * _t1));
        dest[destOffset + 1] = Math.fma(_selfy, _t2, _selfw * _t1);
        dest[destOffset + 2] = Math.fma(_selfx, _t1, _selfz * _t2);
        dest[destOffset + 3] = Math.fma(_selfw, _t2, -(_selfy * _t1));
        return dest;
    }
    ...
    public static double[] rotateYXZ(double[] dest, int destOffset, double[] src, int srcOffset, double angleY, double angleX, double angleZ) {
        ...
        dest[destOffset + 3] = Math.fma(_selfw, _t19, -(_selfx * _t20)) - Math.fma(_selfy, _t22, _selfz * _t21);
        return dest;
    }
    ...
    public static java.nio.DoubleBuffer rotateYXZ(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, double angleY, double angleX, double angleZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.rotateYXZ_unsafe(dest, destOffset, src, srcOffset, angleY, angleX, angleZ);
        return DoubleQuatOpsKernelsTypedBuffer.rotateYXZ_api(dest, destOffset, src, srcOffset, angleY, angleX, angleZ);
    }
    ...
    public static java.nio.ByteBuffer rotateYXZ(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double angleY, double angleX, double angleZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.rotateYXZ_unsafe(dest, destOffset, src, srcOffset, angleY, angleX, angleZ);
        return DoubleQuatOpsKernelsByteBuffer.rotateYXZ_api(dest, destOffset, src, srcOffset, angleY, angleX, angleZ);
    }
    ...
    public static java.lang.foreign.MemorySegment rotateYXZ(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double angleY, double angleX, double angleZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return DoubleQuatOpsKernelsSegment.rotateYXZ_unsafe(dest, destOffset, src, srcOffset, angleY, angleX, angleZ);
        return DoubleQuatOpsKernelsSegment.rotateYXZ_api(dest, destOffset, src, srcOffset, angleY, angleX, angleZ);
    }
    ...
    public static long rotateYXZ(long dest, long src, double angleY, double angleX, double angleZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.rotateYXZ_unsafe(dest, src, angleY, angleX, angleZ);
        rotateYXZ(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 32L), 0L, angleY, angleX, angleZ);
        return dest;
    }
    ...
    public static double[] rotateYZX(double[] dest, int destOffset, double[] src, int srcOffset, double angleY, double angleZ, double angleX) {
        ...
        dest[destOffset + 3] = Math.fma(_selfw, _t21, -(_selfx * _t19)) - Math.fma(_selfy, _t20, _selfz * _t22);
        return dest;
    }
    ...
    public static java.nio.DoubleBuffer rotateYZX(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, double angleY, double angleZ, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.rotateYZX_unsafe(dest, destOffset, src, srcOffset, angleY, angleZ, angleX);
        return DoubleQuatOpsKernelsTypedBuffer.rotateYZX_api(dest, destOffset, src, srcOffset, angleY, angleZ, angleX);
    }
    ...
    public static java.nio.ByteBuffer rotateYZX(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double angleY, double angleZ, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.rotateYZX_unsafe(dest, destOffset, src, srcOffset, angleY, angleZ, angleX);
        return DoubleQuatOpsKernelsByteBuffer.rotateYZX_api(dest, destOffset, src, srcOffset, angleY, angleZ, angleX);
    }
    ...
    public static java.lang.foreign.MemorySegment rotateYZX(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double angleY, double angleZ, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return DoubleQuatOpsKernelsSegment.rotateYZX_unsafe(dest, destOffset, src, srcOffset, angleY, angleZ, angleX);
        return DoubleQuatOpsKernelsSegment.rotateYZX_api(dest, destOffset, src, srcOffset, angleY, angleZ, angleX);
    }
    ...
    public static long rotateYZX(long dest, long src, double angleY, double angleZ, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.rotateYZX_unsafe(dest, src, angleY, angleZ, angleX);
        rotateYZX(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 32L), 0L, angleY, angleZ, angleX);
        return dest;
    }
    ...
    public static double[] rotateZ(double[] dest, int destOffset, double[] src, int srcOffset, double angle) {
        ...
        double _t2 = Math.cosFromSin(_t1, _t0);
        dest[destOffset + 0] = Math.fma(_selfx, _t2, _selfy * _t1);
        dest[destOffset + 1] = Math.fma(_selfy, _t2, -(_selfx * _t1));
        dest[destOffset + 2] = Math.fma(_selfz, _t2, _selfw * _t1);
        dest[destOffset + 3] = Math.fma(_selfw, _t2, -(_selfz * _t1));
        return dest;
    }
    ...
    public static double[] rotateZXY(double[] dest, int destOffset, double[] src, int srcOffset, double angleZ, double angleX, double angleY) {
        ...
        dest[destOffset + 3] = Math.fma(_selfw, _t21, -(_selfx * _t22)) - Math.fma(_selfy, _t20, _selfz * _t19);
        return dest;
    }
    ...
    public static java.nio.DoubleBuffer rotateZXY(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, double angleZ, double angleX, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.rotateZXY_unsafe(dest, destOffset, src, srcOffset, angleZ, angleX, angleY);
        return DoubleQuatOpsKernelsTypedBuffer.rotateZXY_api(dest, destOffset, src, srcOffset, angleZ, angleX, angleY);
    }
    ...
    public static java.nio.ByteBuffer rotateZXY(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double angleZ, double angleX, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.rotateZXY_unsafe(dest, destOffset, src, srcOffset, angleZ, angleX, angleY);
        return DoubleQuatOpsKernelsByteBuffer.rotateZXY_api(dest, destOffset, src, srcOffset, angleZ, angleX, angleY);
    }
    ...
    public static java.lang.foreign.MemorySegment rotateZXY(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double angleZ, double angleX, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return DoubleQuatOpsKernelsSegment.rotateZXY_unsafe(dest, destOffset, src, srcOffset, angleZ, angleX, angleY);
        return DoubleQuatOpsKernelsSegment.rotateZXY_api(dest, destOffset, src, srcOffset, angleZ, angleX, angleY);
    }
    ...
    public static long rotateZXY(long dest, long src, double angleZ, double angleX, double angleY) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.rotateZXY_unsafe(dest, src, angleZ, angleX, angleY);
        rotateZXY(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 32L), 0L, angleZ, angleX, angleY);
        return dest;
    }
    ...
    public static double[] rotateZYX(double[] dest, int destOffset, double[] src, int srcOffset, double angleZ, double angleY, double angleX) {
        ...
        dest[destOffset + 3] = Math.fma(_selfw, _t19, -(_selfx * _t21)) - Math.fma(_selfy, _t20, _selfz * _t22);
        return dest;
    }
    ...
    public static java.nio.DoubleBuffer rotateZYX(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, double angleZ, double angleY, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsTypedBuffer.rotateZYX_unsafe(dest, destOffset, src, srcOffset, angleZ, angleY, angleX);
        return DoubleQuatOpsKernelsTypedBuffer.rotateZYX_api(dest, destOffset, src, srcOffset, angleZ, angleY, angleX);
    }
    ...
    public static java.nio.ByteBuffer rotateZYX(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double angleZ, double angleY, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsKernelsByteBuffer.rotateZYX_unsafe(dest, destOffset, src, srcOffset, angleZ, angleY, angleX);
        return DoubleQuatOpsKernelsByteBuffer.rotateZYX_api(dest, destOffset, src, srcOffset, angleZ, angleY, angleX);
    }
    ...
    public static java.lang.foreign.MemorySegment rotateZYX(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double angleZ, double angleY, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isNative() && !dest.isReadOnly() && src.isNative()) return DoubleQuatOpsKernelsSegment.rotateZYX_unsafe(dest, destOffset, src, srcOffset, angleZ, angleY, angleX);
        return DoubleQuatOpsKernelsSegment.rotateZYX_api(dest, destOffset, src, srcOffset, angleZ, angleY, angleX);
    }
    ...
    public static long rotateZYX(long dest, long src, double angleZ, double angleY, double angleX) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return DoubleQuatOpsKernelsAddress.rotateZYX_unsafe(dest, src, angleZ, angleY, angleX);
        rotateZYX(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 32L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 32L), 0L, angleZ, angleY, angleX);
        return dest;
    }
    ...
    /** {@link #transform(double[], int, double[], int, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #transform(double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #transformInverse(double[], int, double[], int, double, double, double)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    /** {@link #transformInverse(double[], int, double[], int, double[], int)} on {@link java.lang.foreign.MemorySegment} storage; the {@code *Offset} parameters are byte offsets, not element indices. */
    ...
    public static double[] copy(double[] dest, int destOffset, double[] src, int srcOffset) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.copy(dest, destOffset, src, srcOffset);
    ...
    public static double[] copy(double[] dest, int destOffset, double[] src, int srcOffset, int count) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.copy(dest, destOffset, src, srcOffset, count);
    ...
    public static double[] copy(double[] dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset) {
        if (SimdSupport.VECTOR_API && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsSimd.copy(dest, destOffset, src, srcOffset);
        return copy(dest, destOffset, src, srcOffset, 1);
    }
    ...
    public static double[] copy(double[] dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, int count) {
        if (SimdSupport.VECTOR_API && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsSimd.copy(dest, destOffset, src, srcOffset, count);
    ...
    public static java.nio.DoubleBuffer copy(java.nio.DoubleBuffer dest, int destOffset, double[] src, int srcOffset) {
        if (SimdSupport.VECTOR_API && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsSimd.copy(dest, destOffset, src, srcOffset);
        return copy(dest, destOffset, src, srcOffset, 1);
    }
    ...
    public static java.nio.DoubleBuffer copy(java.nio.DoubleBuffer dest, int destOffset, double[] src, int srcOffset, int count) {
        if (SimdSupport.VECTOR_API && dest.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsSimd.copy(dest, destOffset, src, srcOffset, count);
    ...
    public static java.nio.DoubleBuffer copy(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset) {
        if (SimdSupport.VECTOR_API && dest.order() == java.nio.ByteOrder.nativeOrder() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsSimd.copy(dest, destOffset, src, srcOffset);
        return copy(dest, destOffset, src, srcOffset, 1);
    }
    ...
    public static java.nio.DoubleBuffer copy(java.nio.DoubleBuffer dest, int destOffset, java.nio.DoubleBuffer src, int srcOffset, int count) {
        if (SimdSupport.VECTOR_API && dest.order() == java.nio.ByteOrder.nativeOrder() && src.order() == java.nio.ByteOrder.nativeOrder()) return DoubleQuatOpsSimd.copy(dest, destOffset, src, srcOffset, count);
