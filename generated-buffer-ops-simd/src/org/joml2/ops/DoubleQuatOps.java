...
public final class DoubleQuatOps {
    ...
    public static double[] makeRotationYXZ(double[] dest, int destOffset, double angleX, double angleY, double angleZ) {
        if (SimdSupport.VECTOR_API) return DoubleQuatOpsSimd.makeRotationYXZ(dest, destOffset, angleX, angleY, angleZ);
        return DoubleQuatOpsKernelsArray.makeRotationYXZ_scalar(dest, destOffset, angleX, angleY, angleZ);
    }
