...
public final class Double3x4OpsSimd {
    ...
    public static double[] composeTRSMul_fma(double[] dest, int destOffset, double[] m, int mOffset, double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ) {
        ...
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, translationX).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationZ, _t3) * _t0), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationY, -_t5) * _t2), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(rotationY, rotationY, _t4), _t1, scaleX))))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, translationY).fma(UNIT_W, _sv2.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationY, _t5) * _t1), _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationY, rotationZ, -(rotationX * rotationW)) * _t0), _sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(rotationX, rotationX, _t4), _t2, scaleY))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, translationZ).fma(UNIT_W, _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationW, rotationY * rotationZ) * _t2), _sv2.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationZ, -_t3) * _t1), _sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(rotationX, rotationX, rotationY * rotationY), _t0, scaleZ))))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] composeTRSMul_mulAdd(double[] dest, int destOffset, double[] m, int mOffset, double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ) {
        ...
        var _sv1 = DoubleVector.fromArray(SIMD_SPECIES, m, mOffset + 4);
        var _sv2 = DoubleVector.fromArray(SIMD_SPECIES, m, mOffset);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, translationX).mul(UNIT_W).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationZ, _t3) * _t0)).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationY, -_t5) * _t2)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(rotationY, rotationY, _t4), _t1, scaleX))))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, translationY).mul(UNIT_W).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationY, _t5) * _t1)).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationY, rotationZ, -(rotationX * rotationW)) * _t0)).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(rotationX, rotationX, _t4), _t2, scaleY))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, translationZ).mul(UNIT_W).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationW, rotationY * rotationZ) * _t2)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(rotationX, rotationZ, -_t3) * _t1)).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(rotationX, rotationX, rotationY * rotationY), _t0, scaleZ))))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] composeTRSMul_fma(double[] dest, int destOffset, double[] translation, int translationOffset, double[] rotation, int rotationOffset, double[] scale, int scaleOffset, double[] m, int mOffset) {
        ...
        var _sv1 = DoubleVector.fromArray(SIMD_SPECIES, m, mOffset + 4);
        var _sv2 = DoubleVector.fromArray(SIMD_SPECIES, m, mOffset);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, translation[translationOffset + 0]).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationz, _t3) * _t0), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationy, -_t5) * _t2), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationy, _rotationy, _t4), _t1, _scalex))))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, translation[translationOffset + 1]).fma(UNIT_W, _sv2.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationy, _t5) * _t1), _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationy, _rotationz, -(_rotationx * _rotationw)) * _t0), _sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationx, _rotationx, _t4), _t2, _scaley))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, translation[translationOffset + 2]).fma(UNIT_W, _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationw, _rotationy * _rotationz) * _t2), _sv2.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationz, -_t3) * _t1), _sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationx, _rotationx, _rotationy * _rotationy), _t0, _scalez))))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] composeTRSMul_mulAdd(double[] dest, int destOffset, double[] translation, int translationOffset, double[] rotation, int rotationOffset, double[] scale, int scaleOffset, double[] m, int mOffset) {
        ...
        var _sv1 = DoubleVector.fromArray(SIMD_SPECIES, m, mOffset + 4);
        var _sv2 = DoubleVector.fromArray(SIMD_SPECIES, m, mOffset);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, translation[translationOffset + 0]).mul(UNIT_W).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationz, _t3) * _t0)).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationy, -_t5) * _t2)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationy, _rotationy, _t4), _t1, _scalex))))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, translation[translationOffset + 1]).mul(UNIT_W).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationy, _t5) * _t1)).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationy, _rotationz, -(_rotationx * _rotationw)) * _t0)).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationx, _rotationx, _t4), _t2, _scaley))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, translation[translationOffset + 2]).mul(UNIT_W).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationw, _rotationy * _rotationz) * _t2)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationz, -_t3) * _t1)).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationx, _rotationx, _rotationy * _rotationy), _t0, _scalez))))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static java.lang.foreign.MemorySegment composeTRSMul_fma_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment translation, long translationOffset, java.lang.foreign.MemorySegment rotation, long rotationOffset, java.lang.foreign.MemorySegment scale, long scaleOffset, java.lang.foreign.MemorySegment m, long mOffset) {
        ...
        var _sv1 = DoubleVector.fromMemorySegment(SIMD_SPECIES, m, mOffset + 32L, java.nio.ByteOrder.nativeOrder());
        var _sv2 = DoubleVector.fromMemorySegment(SIMD_SPECIES, m, mOffset, java.nio.ByteOrder.nativeOrder());
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_translationBase + 0L)).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationz, _t3) * _t0), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationy, -_t5) * _t2), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationy, _rotationy, _t4), _t1, _scalex))))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_translationBase + 8L)).fma(UNIT_W, _sv2.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationy, _t5) * _t1), _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationy, _rotationz, -(_rotationx * _rotationw)) * _t0), _sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationx, _rotationx, _t4), _t2, _scaley))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_translationBase + 16L)).fma(UNIT_W, _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationw, _rotationy * _rotationz) * _t2), _sv2.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationz, -_t3) * _t1), _sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationx, _rotationx, _rotationy * _rotationy), _t0, _scalez))))));
        _c0.intoMemorySegment(dest, destOffset, java.nio.ByteOrder.nativeOrder());
        _c1.intoMemorySegment(dest, destOffset + 32L, java.nio.ByteOrder.nativeOrder());
        _c2.intoMemorySegment(dest, destOffset + 64L, java.nio.ByteOrder.nativeOrder());
        return dest;
    ...
    public static java.lang.foreign.MemorySegment composeTRSMul_fma_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment translation, long translationOffset, java.lang.foreign.MemorySegment rotation, long rotationOffset, java.lang.foreign.MemorySegment scale, long scaleOffset, java.lang.foreign.MemorySegment m, long mOffset) {
        ...
        var _sv1 = DoubleVector.fromMemorySegment(SIMD_SPECIES, m, mOffset + 32L, java.nio.ByteOrder.nativeOrder());
        var _sv2 = DoubleVector.fromMemorySegment(SIMD_SPECIES, m, mOffset, java.nio.ByteOrder.nativeOrder());
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, translation.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, translationOffset + 0L)).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationz, _t3) * _t0), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationy, -_t5) * _t2), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationy, _rotationy, _t4), _t1, _scalex))))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, translation.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, translationOffset + 8L)).fma(UNIT_W, _sv2.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationy, _t5) * _t1), _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationy, _rotationz, -(_rotationx * _rotationw)) * _t0), _sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationx, _rotationx, _t4), _t2, _scaley))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, translation.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, translationOffset + 16L)).fma(UNIT_W, _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationw, _rotationy * _rotationz) * _t2), _sv2.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_rotationx, _rotationz, -_t3) * _t1), _sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-Math.fma(_rotationx, _rotationx, _rotationy * _rotationy), _t0, _scalez))))));
        _c0.intoMemorySegment(dest, destOffset, java.nio.ByteOrder.nativeOrder());
        _c1.intoMemorySegment(dest, destOffset + 32L, java.nio.ByteOrder.nativeOrder());
        _c2.intoMemorySegment(dest, destOffset + 64L, java.nio.ByteOrder.nativeOrder());
        return dest;
    ...
    public static double[] preRotateAround_fma(double[] dest, int destOffset, double[] src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv1 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset);
        var _sv2 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset + 4);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t2, _t16, Math.fma(pivotX, Math.fma(rotY, _t5, _t9), -(pivotY * _t19)))).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, _t16), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t0, _t5, _t14)), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t19)))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t2, _t20, Math.fma(pivotY, Math.fma(rotX, _t4, _t9), -(pivotX * _t17)))).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, _t20), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, _t17), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t3, _t4, _t14))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-pivotY, _t18, Math.fma(pivotZ, Math.fma(rotX, _t4, rotY * _t5), -(pivotX * _t21)))).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t3, _t4, Math.fma(_t0, _t5, 1.0))), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, _t21), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t18)))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] preRotateAround_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv1 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset);
        var _sv2 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset + 4);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t2, _t16, Math.fma(pivotX, Math.fma(rotY, _t5, _t9), -(pivotY * _t19)))).mul(UNIT_W).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, _t16)).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t0, _t5, _t14))).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t19)))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t2, _t20, Math.fma(pivotY, Math.fma(rotX, _t4, _t9), -(pivotX * _t17)))).mul(UNIT_W).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, _t20)).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, _t17)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t3, _t4, _t14))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-pivotY, _t18, Math.fma(pivotZ, Math.fma(rotX, _t4, rotY * _t5), -(pivotX * _t21)))).mul(UNIT_W).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t3, _t4, Math.fma(_t0, _t5, 1.0)))).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, _t21)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t18)))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] preRotateAround_fma(double[] dest, int destOffset, double[] src, int srcOffset, double[] rot, int rotOffset, double[] pivot, int pivotOffset) {
        ...
        var _sv1 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset);
        var _sv2 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset + 4);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t2, _t16, Math.fma(_pivotx, Math.fma(_roty, _t5, _t9), -(_pivoty * _t19)))).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, _t16), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t0, _t5, _t14)), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t19)))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t2, _t20, Math.fma(_pivoty, Math.fma(_rotx, _t4, _t9), -(_pivotx * _t17)))).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, _t20), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, _t17), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t3, _t4, _t14))))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(-_pivoty, _t18, Math.fma(_pivotz, Math.fma(_rotx, _t4, _roty * _t5), -(_pivotx * _t21)))).fma(UNIT_W, _sv0.fma(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t3, _t4, Math.fma(_t0, _t5, 1.0))), _sv1.fma(DoubleVector.broadcast(SIMD_SPECIES, _t21), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t18)))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] preRotateAround_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset, double[] rot, int rotOffset, double[] pivot, int pivotOffset) {
        ...
        var _sv1 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset);
        var _sv2 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset + 4);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t2, _t16, Math.fma(_pivotx, Math.fma(_roty, _t5, _t9), -(_pivoty * _t19)))).mul(UNIT_W).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, _t16)).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t0, _t5, _t14))).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t19)))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t2, _t20, Math.fma(_pivoty, Math.fma(_rotx, _t4, _t9), -(_pivotx * _t17)))).mul(UNIT_W).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, _t20)).add(_sv1.mul(DoubleVector.broadcast(SIMD_SPECIES, _t17)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, Math.fma(_t3, _t4, _t14))))));
    ...
    public static double[] rotateAround_fma(double[] dest, int destOffset, double[] src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv2 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t18).withLane(1, _t28).withLane(2, _t26).withLane(3, _t39);
        var _sv3 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t24).withLane(1, _t19).withLane(2, _t29);
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _self10);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _self20);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 3]).fma(UNIT_W, _sv0.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self01).withLane(3, _self00).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self01 * _t40 + _self02 * _t41).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self02).mul(_sv3))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 7]).fma(UNIT_W, _sv4.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self11).withLane(3, _self10).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self11 * _t40 + _self12 * _t41).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self12).mul(_sv3))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 11]).fma(UNIT_W, _sv5.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self21).withLane(3, _self20).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self21 * _t40 + _self22 * _t41).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self22).mul(_sv3))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] rotateAround_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _self10);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _self20);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 3]).mul(UNIT_W).add(_sv0.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self01).withLane(3, _self00).mul(_sv2).add(DoubleVector.broadcast(SIMD_SPECIES, _self01 * _t40 + _self02 * _t41).mul(UNIT_W).add(DoubleVector.broadcast(SIMD_SPECIES, _self02).mul(_sv3))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 7]).mul(UNIT_W).add(_sv4.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self11).withLane(3, _self10).mul(_sv2).add(DoubleVector.broadcast(SIMD_SPECIES, _self11 * _t40 + _self12 * _t41).mul(UNIT_W).add(DoubleVector.broadcast(SIMD_SPECIES, _self12).mul(_sv3))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 11]).mul(UNIT_W).add(_sv5.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self21).withLane(3, _self20).mul(_sv2).add(DoubleVector.broadcast(SIMD_SPECIES, _self21 * _t40 + _self22 * _t41).mul(UNIT_W).add(DoubleVector.broadcast(SIMD_SPECIES, _self22).mul(_sv3))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static java.lang.foreign.MemorySegment rotateAround_fma_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _self10);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _self20);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_srcBase + 24L)).fma(UNIT_W, _sv0.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self01).withLane(3, _self00).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self01 * _t40 + _self02 * _t41).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self02).mul(_sv3))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_srcBase + 56L)).fma(UNIT_W, _sv4.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self11).withLane(3, _self10).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self11 * _t40 + _self12 * _t41).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self12).mul(_sv3))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_srcBase + 88L)).fma(UNIT_W, _sv5.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self21).withLane(3, _self20).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self21 * _t40 + _self22 * _t41).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self22).mul(_sv3))));
        _c0.intoMemorySegment(dest, destOffset, java.nio.ByteOrder.nativeOrder());
        _c1.intoMemorySegment(dest, destOffset + 32L, java.nio.ByteOrder.nativeOrder());
        _c2.intoMemorySegment(dest, destOffset + 64L, java.nio.ByteOrder.nativeOrder());
        return dest;
    ...
    public static java.lang.foreign.MemorySegment rotateAround_fma_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, srcOffset + 56L)).fma(UNIT_W, _sv4.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self11).withLane(3, _self10).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self11 * _t40 + _self12 * _t41).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self12).mul(_sv3))));
