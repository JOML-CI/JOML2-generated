...
public final class Double3x4OpsSimd {
    ...
    public static double[] mulMat2x3(double[] dest, int destOffset, double[] src, int srcOffset, double[] right, int rightOffset) {
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, right[rightOffset + 0]).withLane(1, right[rightOffset + 2]).mul(DoubleVector.broadcast(SIMD_SPECIES, src[(srcOffset + _li * 4) + 0])).withLane(2, src[(srcOffset + _li * 4) + 2]).add(DoubleVector.broadcast(SIMD_SPECIES, right[rightOffset + 1]).withLane(1, right[rightOffset + 3]).mul(DoubleVector.broadcast(SIMD_SPECIES, src[(srcOffset + _li * 4) + 1])).withLane(2, right[rightOffset + 4] * src[(srcOffset + _li * 4) + 0] + right[rightOffset + 5] * src[(srcOffset + _li * 4) + 1])).withLane(3, src[(srcOffset + _li * 4) + 3]);
            _c.intoArray(dest, destOffset + _li * 4);
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment mulMat2x3_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment right, long rightOffset) {
        ...
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_rightBase + 0L)).withLane(1, UnsafeOpsHolder.U.getDouble(_rightBase + 16L)).mul(DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 0L))).withLane(2, UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 16L)).add(DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_rightBase + 8L)).withLane(1, UnsafeOpsHolder.U.getDouble(_rightBase + 24L)).mul(DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 8L))).withLane(2, UnsafeOpsHolder.U.getDouble(_rightBase + 32L) * UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 0L) + UnsafeOpsHolder.U.getDouble(_rightBase + 40L) * UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 8L))).withLane(3, UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 24L));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment mulMat2x3_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment right, long rightOffset) {
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, right.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, rightOffset + 0L)).withLane(1, right.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, rightOffset + 16L)).mul(DoubleVector.broadcast(SIMD_SPECIES, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 0L))).withLane(2, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 16L)).add(DoubleVector.broadcast(SIMD_SPECIES, right.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, rightOffset + 8L)).withLane(1, right.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, rightOffset + 24L)).mul(DoubleVector.broadcast(SIMD_SPECIES, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 8L))).withLane(2, right.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, rightOffset + 32L) * src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 0L) + right.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, rightOffset + 40L) * src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 8L))).withLane(3, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 24L));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static double[] preRotateAround_fma(double[] dest, int destOffset, double[] src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv0 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset + 8);
        var _sv1 = DoubleVector.broadcast(SIMD_SPECIES, _t21);
        var _sv2 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset + 4);
        var _sv3 = DoubleVector.fromArray(SIMD_SPECIES, src, srcOffset);
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _t22);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _t23);
        var _c0 = _sv0.mul(_sv1).withLane(3, pivotX).add(_sv2.withLane(3, _t2).fma(DoubleVector.broadcast(SIMD_SPECIES, _t24).withLane(3, _t21), _sv3.mul(DoubleVector.broadcast(SIMD_SPECIES, _t27)).withLane(3, _self23 * _t21 + (_t1 * _t24 + (_self13 * _t24 + (_t0 * _t27 + _self03 * _t27))))));
        var _c1 = _sv3.mul(_sv4).withLane(3, pivotY).add(_sv0.withLane(3, _t0).fma(DoubleVector.broadcast(SIMD_SPECIES, _t25).withLane(3, _t22), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t28)).withLane(3, _self03 * _t22 + (_t2 * _t25 + (_self23 * _t25 + (_t1 * _t28 + _self13 * _t28))))));
        var _c2 = _sv2.mul(_sv5).withLane(3, pivotZ).add(_sv3.withLane(3, _t1).fma(DoubleVector.broadcast(SIMD_SPECIES, _t26).withLane(3, _t23), _sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, _t29)).withLane(3, _self13 * _t23 + (_t0 * _t26 + (_self03 * _t26 + (_t2 * _t29 + _self23 * _t29))))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] preRotateAround_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _t22);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _t23);
        var _c0 = _sv0.mul(_sv1).withLane(3, pivotX).add(_sv2.withLane(3, _t2).mul(DoubleVector.broadcast(SIMD_SPECIES, _t24).withLane(3, _t21)).add(_sv3.mul(DoubleVector.broadcast(SIMD_SPECIES, _t27)).withLane(3, _self23 * _t21 + (_t1 * _t24 + (_self13 * _t24 + (_t0 * _t27 + _self03 * _t27))))));
        var _c1 = _sv3.mul(_sv4).withLane(3, pivotY).add(_sv0.withLane(3, _t0).mul(DoubleVector.broadcast(SIMD_SPECIES, _t25).withLane(3, _t22)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t28)).withLane(3, _self03 * _t22 + (_t2 * _t25 + (_self23 * _t25 + (_t1 * _t28 + _self13 * _t28))))));
        var _c2 = _sv2.mul(_sv5).withLane(3, pivotZ).add(_sv3.withLane(3, _t1).mul(DoubleVector.broadcast(SIMD_SPECIES, _t26).withLane(3, _t23)).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, _t29)).withLane(3, _self13 * _t23 + (_t0 * _t26 + (_self03 * _t26 + (_t2 * _t29 + _self23 * _t29))))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static java.lang.foreign.MemorySegment preRotateAround_fma_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        long _srcBase = src.address() + srcOffset;
        double _self23 = UnsafeOpsHolder.U.getDouble(_srcBase + 88L);
        double _self13 = UnsafeOpsHolder.U.getDouble(_srcBase + 56L);
        double _self03 = UnsafeOpsHolder.U.getDouble(_srcBase + 24L);
    ...
    public static java.lang.foreign.MemorySegment preRotateAround_fma_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        double _self23 = src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, srcOffset + 88L);
        double _self13 = src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, srcOffset + 56L);
        double _self03 = src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, srcOffset + 24L);
        double _t0 = -pivotX;
    ...
    public static java.lang.foreign.MemorySegment preRotateAround_mulAdd_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        long _srcBase = src.address() + srcOffset;
        double _self23 = UnsafeOpsHolder.U.getDouble(_srcBase + 88L);
        double _self13 = UnsafeOpsHolder.U.getDouble(_srcBase + 56L);
        double _self03 = UnsafeOpsHolder.U.getDouble(_srcBase + 24L);
    ...
    public static java.lang.foreign.MemorySegment preRotateAround_mulAdd_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        double _self23 = src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, srcOffset + 88L);
        double _self13 = src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, srcOffset + 56L);
        double _self03 = src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, srcOffset + 24L);
        double _t0 = -pivotX;
    ...
    public static double[] preRotateAround_fma(double[] dest, int destOffset, double[] src, int srcOffset, double[] rot, int rotOffset, double[] pivot, int pivotOffset) {
        ...
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _t22);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _t23);
        var _c0 = _sv0.mul(_sv1).withLane(3, _pivotx).add(_sv2.withLane(3, _t2).fma(DoubleVector.broadcast(SIMD_SPECIES, _t24).withLane(3, _t21), _sv3.mul(DoubleVector.broadcast(SIMD_SPECIES, _t27)).withLane(3, _self23 * _t21 + (_t1 * _t24 + (_self13 * _t24 + (_t0 * _t27 + _self03 * _t27))))));
        var _c1 = _sv3.mul(_sv4).withLane(3, _pivoty).add(_sv0.withLane(3, _t0).fma(DoubleVector.broadcast(SIMD_SPECIES, _t25).withLane(3, _t22), _sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t28)).withLane(3, _self03 * _t22 + (_t2 * _t25 + (_self23 * _t25 + (_t1 * _t28 + _self13 * _t28))))));
        var _c2 = _sv2.mul(_sv5).withLane(3, _pivotz).add(_sv3.withLane(3, _t1).fma(DoubleVector.broadcast(SIMD_SPECIES, _t26).withLane(3, _t23), _sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, _t29)).withLane(3, _self13 * _t23 + (_t0 * _t26 + (_self03 * _t26 + (_t2 * _t29 + _self23 * _t29))))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] preRotateAround_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset, double[] rot, int rotOffset, double[] pivot, int pivotOffset) {
        ...
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _t22);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _t23);
        var _c0 = _sv0.mul(_sv1).withLane(3, _pivotx).add(_sv2.withLane(3, _t2).mul(DoubleVector.broadcast(SIMD_SPECIES, _t24).withLane(3, _t21)).add(_sv3.mul(DoubleVector.broadcast(SIMD_SPECIES, _t27)).withLane(3, _self23 * _t21 + (_t1 * _t24 + (_self13 * _t24 + (_t0 * _t27 + _self03 * _t27))))));
        var _c1 = _sv3.mul(_sv4).withLane(3, _pivoty).add(_sv0.withLane(3, _t0).mul(DoubleVector.broadcast(SIMD_SPECIES, _t25).withLane(3, _t22)).add(_sv2.mul(DoubleVector.broadcast(SIMD_SPECIES, _t28)).withLane(3, _self03 * _t22 + (_t2 * _t25 + (_self23 * _t25 + (_t1 * _t28 + _self13 * _t28))))));
        var _c2 = _sv2.mul(_sv5).withLane(3, _pivotz).add(_sv3.withLane(3, _t1).mul(DoubleVector.broadcast(SIMD_SPECIES, _t26).withLane(3, _t23)).add(_sv0.mul(DoubleVector.broadcast(SIMD_SPECIES, _t29)).withLane(3, _self13 * _t23 + (_t0 * _t26 + (_self03 * _t26 + (_t2 * _t29 + _self23 * _t29))))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] rotateAround_fma(double[] dest, int destOffset, double[] src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv1 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t27).withLane(1, _t25).withLane(2, _t23);
        var _sv2 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t21).withLane(1, _t28).withLane(2, _t26).withLane(3, _t36);
        var _sv3 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t24).withLane(1, _t22).withLane(2, _t29);
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _self10);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _self20);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 3]).fma(UNIT_W, _sv0.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self01).withLane(3, _self00).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self01 * _t37 + _self02 * _t38).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self02).mul(_sv3))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 7]).fma(UNIT_W, _sv4.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self11).withLane(3, _self10).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self11 * _t37 + _self12 * _t38).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self12).mul(_sv3))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 11]).fma(UNIT_W, _sv5.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self21).withLane(3, _self20).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self21 * _t37 + _self22 * _t38).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self22).mul(_sv3))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] rotateAround_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _self10);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _self20);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 3]).mul(UNIT_W).add(_sv0.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self01).withLane(3, _self00).mul(_sv2).add(DoubleVector.broadcast(SIMD_SPECIES, _self01 * _t37 + _self02 * _t38).mul(UNIT_W).add(DoubleVector.broadcast(SIMD_SPECIES, _self02).mul(_sv3))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 7]).mul(UNIT_W).add(_sv4.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self11).withLane(3, _self10).mul(_sv2).add(DoubleVector.broadcast(SIMD_SPECIES, _self11 * _t37 + _self12 * _t38).mul(UNIT_W).add(DoubleVector.broadcast(SIMD_SPECIES, _self12).mul(_sv3))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, src[srcOffset + 11]).mul(UNIT_W).add(_sv5.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self21).withLane(3, _self20).mul(_sv2).add(DoubleVector.broadcast(SIMD_SPECIES, _self21 * _t37 + _self22 * _t38).mul(UNIT_W).add(DoubleVector.broadcast(SIMD_SPECIES, _self22).mul(_sv3))));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static java.lang.foreign.MemorySegment rotateAround_fma_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _sv4 = DoubleVector.broadcast(SIMD_SPECIES, _self10);
        var _sv5 = DoubleVector.broadcast(SIMD_SPECIES, _self20);
        var _c0 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_srcBase + 24L)).fma(UNIT_W, _sv0.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self01).withLane(3, _self00).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self01 * _t37 + _self02 * _t38).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self02).mul(_sv3))));
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_srcBase + 56L)).fma(UNIT_W, _sv4.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self11).withLane(3, _self10).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self11 * _t37 + _self12 * _t38).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self12).mul(_sv3))));
        var _c2 = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble(_srcBase + 88L)).fma(UNIT_W, _sv5.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self21).withLane(3, _self20).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self21 * _t37 + _self22 * _t38).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self22).mul(_sv3))));
        _c0.intoMemorySegment(dest, destOffset, java.nio.ByteOrder.nativeOrder());
        _c1.intoMemorySegment(dest, destOffset + 32L, java.nio.ByteOrder.nativeOrder());
        _c2.intoMemorySegment(dest, destOffset + 64L, java.nio.ByteOrder.nativeOrder());
        return dest;
    ...
    public static java.lang.foreign.MemorySegment rotateAround_fma_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        var _c1 = DoubleVector.broadcast(SIMD_SPECIES, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, srcOffset + 56L)).fma(UNIT_W, _sv4.mul(_sv1)).add(DoubleVector.broadcast(SIMD_SPECIES, _self11).withLane(3, _self10).fma(_sv2, DoubleVector.broadcast(SIMD_SPECIES, _self11 * _t37 + _self12 * _t38).fma(UNIT_W, DoubleVector.broadcast(SIMD_SPECIES, _self12).mul(_sv3))));
    ...
    public static java.lang.foreign.MemorySegment scale_fma_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment v, long vOffset) {
        ...
        long _vBase = v.address() + vOffset;
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 24L)).fma(UNIT_W, DoubleVector.fromMemorySegment(SIMD_SPECIES, src, (srcOffset + _li * 32L), java.nio.ByteOrder.nativeOrder()).mul(DoubleVector.zero(SIMD_SPECIES).withLane(0, UnsafeOpsHolder.U.getDouble(_vBase + 0L)).withLane(1, UnsafeOpsHolder.U.getDouble(_vBase + 8L)).withLane(2, UnsafeOpsHolder.U.getDouble(_vBase + 16L))));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment scale_fma_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment v, long vOffset) {
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 24L)).fma(UNIT_W, DoubleVector.fromMemorySegment(SIMD_SPECIES, src, (srcOffset + _li * 32L), java.nio.ByteOrder.nativeOrder()).mul(DoubleVector.zero(SIMD_SPECIES).withLane(0, v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 0L)).withLane(1, v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 8L)).withLane(2, v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 16L))));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment scale_mulAdd_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment v, long vOffset) {
        ...
        long _vBase = v.address() + vOffset;
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 24L)).mul(UNIT_W).add(DoubleVector.fromMemorySegment(SIMD_SPECIES, src, (srcOffset + _li * 32L), java.nio.ByteOrder.nativeOrder()).mul(DoubleVector.zero(SIMD_SPECIES).withLane(0, UnsafeOpsHolder.U.getDouble(_vBase + 0L)).withLane(1, UnsafeOpsHolder.U.getDouble(_vBase + 8L)).withLane(2, UnsafeOpsHolder.U.getDouble(_vBase + 16L))));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment scale_mulAdd_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment v, long vOffset) {
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 24L)).mul(UNIT_W).add(DoubleVector.fromMemorySegment(SIMD_SPECIES, src, (srcOffset + _li * 32L), java.nio.ByteOrder.nativeOrder()).mul(DoubleVector.zero(SIMD_SPECIES).withLane(0, v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 0L)).withLane(1, v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 8L)).withLane(2, v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 16L))));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static double[] translate_fma(double[] dest, int destOffset, double[] src, int srcOffset, double[] v, int vOffset) {
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, src[(srcOffset + _li * 4) + 0] * v[vOffset + 0] + (src[(srcOffset + _li * 4) + 1] * v[vOffset + 1] + src[(srcOffset + _li * 4) + 2] * v[vOffset + 2])).fma(UNIT_W, DoubleVector.fromArray(SIMD_SPECIES, src, (srcOffset + _li * 4)));
            _c.intoArray(dest, destOffset + _li * 4);
        }
        return dest;
    }
    ...
    public static double[] translate_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset, double[] v, int vOffset) {
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, src[(srcOffset + _li * 4) + 0] * v[vOffset + 0] + (src[(srcOffset + _li * 4) + 1] * v[vOffset + 1] + src[(srcOffset + _li * 4) + 2] * v[vOffset + 2])).mul(UNIT_W).add(DoubleVector.fromArray(SIMD_SPECIES, src, (srcOffset + _li * 4)));
            _c.intoArray(dest, destOffset + _li * 4);
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment translate_fma_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment v, long vOffset) {
        ...
        long _vBase = v.address() + vOffset;
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 0L) * UnsafeOpsHolder.U.getDouble(_vBase + 0L) + (UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 8L) * UnsafeOpsHolder.U.getDouble(_vBase + 8L) + UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 16L) * UnsafeOpsHolder.U.getDouble(_vBase + 16L))).fma(UNIT_W, DoubleVector.fromMemorySegment(SIMD_SPECIES, src, (srcOffset + _li * 32L), java.nio.ByteOrder.nativeOrder()));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment translate_fma_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment v, long vOffset) {
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 0L) * v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 0L) + (src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 8L) * v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 8L) + src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 16L) * v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 16L))).fma(UNIT_W, DoubleVector.fromMemorySegment(SIMD_SPECIES, src, (srcOffset + _li * 32L), java.nio.ByteOrder.nativeOrder()));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment translate_mulAdd_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment v, long vOffset) {
        ...
        long _vBase = v.address() + vOffset;
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 0L) * UnsafeOpsHolder.U.getDouble(_vBase + 0L) + (UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 8L) * UnsafeOpsHolder.U.getDouble(_vBase + 8L) + UnsafeOpsHolder.U.getDouble((_srcBase + _li * 32L) + 16L) * UnsafeOpsHolder.U.getDouble(_vBase + 16L))).mul(UNIT_W).add(DoubleVector.fromMemorySegment(SIMD_SPECIES, src, (srcOffset + _li * 32L), java.nio.ByteOrder.nativeOrder()));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
    ...
    public static java.lang.foreign.MemorySegment translate_mulAdd_api(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment src, long srcOffset, java.lang.foreign.MemorySegment v, long vOffset) {
        for (int _li = 0; _li < 3; _li++) {
            var _c = DoubleVector.broadcast(SIMD_SPECIES, src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 0L) * v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 0L) + (src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 8L) * v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 8L) + src.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, (srcOffset + _li * 32L) + 16L) * v.get(java.lang.foreign.ValueLayout.JAVA_DOUBLE_UNALIGNED, vOffset + 16L))).mul(UNIT_W).add(DoubleVector.fromMemorySegment(SIMD_SPECIES, src, (srcOffset + _li * 32L), java.nio.ByteOrder.nativeOrder()));
            _c.intoMemorySegment(dest, destOffset + _li * 32L, java.nio.ByteOrder.nativeOrder());
        }
        return dest;
    }
