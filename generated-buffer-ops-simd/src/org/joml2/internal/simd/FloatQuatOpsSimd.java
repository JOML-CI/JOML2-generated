...
public final class FloatQuatOpsSimd {
    ...
    public static float[] makeRotationTo_fma(float[] dest, int destOffset, float[] fromDir, int fromDirOffset, float[] toDir, int toDirOffset) {
    ...
    public static float[] makeRotationTo_mulAdd(float[] dest, int destOffset, float[] fromDir, int fromDirOffset, float[] toDir, int toDirOffset) {
        float _fromDirz = fromDir[fromDirOffset + 2];
        float _toDirz = toDir[toDirOffset + 2];
        float _fromDirx = fromDir[fromDirOffset + 0];
        float _toDirx = toDir[toDirOffset + 0];
    ...
    public static java.lang.foreign.MemorySegment makeRotationTo_fma_unsafe(java.lang.foreign.MemorySegment dest, long destOffset, java.lang.foreign.MemorySegment fromDir, long fromDirOffset, java.lang.foreign.MemorySegment toDir, long toDirOffset) {
        ...
        float _fromDirz = UnsafeOpsHolder.U.getFloat(_fromDirBase + 8L);
        float _toDirz = UnsafeOpsHolder.U.getFloat(_toDirBase + 8L);
        float _fromDirx = UnsafeOpsHolder.U.getFloat(_fromDirBase + 0L);
