...
public final class Double3OpsKernelsAddress {
    ...
    public static long makeUniformDirection_unsafe(long dest, double u, double v) {
        ...
        UnsafeOpsHolder.U.putDouble(dest + 0L, _t5 * Math.cosFromSin(_t2, _t1));
    ...
    public static long slerp_unsafe(long dest, long src, double otherX, double otherY, double otherZ, double t) {
        ...
        if (!(_ct0 > 2.2250738585072014E-308 && _ct0 < Double.POSITIVE_INFINITY)) return Double3OpsKernelsAddress.slerp_degenerate(dest, src, otherX, otherY, otherZ, t);
        double _t6 = _ct0;
        double _ct1 = Math.fma(otherZ, otherZ, Math.fma(otherX, otherX, otherY * otherY));
        if (!(_ct1 > 2.2250738585072014E-308 && _ct1 < Double.POSITIVE_INFINITY)) return Double3OpsKernelsAddress.slerp_degenerate(dest, src, otherX, otherY, otherZ, t);
        double _t7 = _ct1;
        ...
        if (!(_ct2 > 2.2250738585072014E-308 && _ct2 < Double.POSITIVE_INFINITY)) return Double3OpsKernelsAddress.slerp_degenerate(dest, src, otherX, otherY, otherZ, t);
        double _t42 = _ct2;
        ...
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t12, _t50, _sp0 * _t37));
        UnsafeOpsHolder.U.putDouble(dest + 8L, Math.fma(_t17, _t50, _sp0 * _t38));
        UnsafeOpsHolder.U.putDouble(dest + 16L, Math.fma(_t14, _t50, _sp0 * _t36));
        return dest;
    }

    public static long slerp_degenerate(long dest, long src, double otherX, double otherY, double otherZ, double t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Double3OpsKernelsAddress.slerp_degenerate_unsafe(dest, src, otherX, otherY, otherZ, t);
        Double3OpsKernelsSegment.slerp_degenerate(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 24L), 0L, otherX, otherY, otherZ, t);
        return dest;
    }
    ...
    public static long slerp_degenerate_unsafe(long dest, long src, double otherX, double otherY, double otherZ, double t) {
        ...
        if (_t36 > 0.0) {
            if (_t76 > 0.0) {
                UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t82, _t78 * _t72, _t84 * _t29));
                UnsafeOpsHolder.U.putDouble(dest + 8L, Math.fma(_t82, _t78 * _t73, _t84 * _t31));
                UnsafeOpsHolder.U.putDouble(dest + 16L, Math.fma(_t82, _t78 * _t71, _t84 * _t27));
            } else {
                UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t82, _t59 * _t40, _t84 * _t29));
                UnsafeOpsHolder.U.putDouble(dest + 8L, Math.fma(_t82, _t59 * _t43, _t84 * _t31));
                UnsafeOpsHolder.U.putDouble(dest + 16L, Math.fma(_t82, _t59 * _t41, _t84 * _t27));
            }
        } else {
            UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(t, otherX - _selfx, _selfx));
            UnsafeOpsHolder.U.putDouble(dest + 8L, Math.fma(t, otherY - _selfy, _selfy));
    ...
    public static long slerp_unsafe(long dest, long src, long other, double t) {
        ...
        double _otherz = UnsafeOpsHolder.U.getDouble(other + 16L);
        double _ct0 = Math.fma(_selfz, _selfz, Math.fma(_selfx, _selfx, _selfy * _selfy));
        if (!(_ct0 > 2.2250738585072014E-308 && _ct0 < Double.POSITIVE_INFINITY)) return Double3OpsKernelsAddress.slerp_degenerate(dest, src, other, t);
        double _t6 = _ct0;
        double _ct1 = Math.fma(_otherz, _otherz, Math.fma(_otherx, _otherx, _othery * _othery));
        if (!(_ct1 > 2.2250738585072014E-308 && _ct1 < Double.POSITIVE_INFINITY)) return Double3OpsKernelsAddress.slerp_degenerate(dest, src, other, t);
        double _t7 = _ct1;
        double _t10 = Math.sqrt(_t6);
        double _t8 = 1.0 / _t10;
        double _t11 = (1.0 / Math.sqrt(_t7));
        ...
        double _t38 = Math.fma(_t35, _t17, _t31);
        double _ct2 = Math.fma(_t36, _t36, Math.fma(_t37, _t37, _t38 * _t38));
        if (!(_ct2 > 2.2250738585072014E-308 && _ct2 < Double.POSITIVE_INFINITY)) return Double3OpsKernelsAddress.slerp_degenerate(dest, src, other, t);
        double _t42 = _ct2;
        double _t46 = t * Math.atan2(Math.sqrt(_t42), _t22);
        double _t47 = Math.sin(_t46);
        double _sp0 = _t20 * _t47 * (1.0 / Math.sqrt(_t42));
    ...
    public static long slerp_degenerate(long dest, long src, long other, double t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE) return Double3OpsKernelsAddress.slerp_degenerate_unsafe(dest, src, other, t);
        Double3OpsKernelsSegment.slerp_degenerate(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(other, 24L), 0L, t);
        return dest;
    }
    ...
    public static double angleBetween_degenerate(long src, double otherX, double otherY, double otherZ) {
        ...
        return Double3OpsKernelsSegment.angleBetween_degenerate(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 24L), 0L, otherX, otherY, otherZ);
    }
    ...
    public static double angleBetween_degenerate(long src, long other) {
        ...
        return Double3OpsKernelsSegment.angleBetween_degenerate(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(other, 24L), 0L);
    }
    ...
    public static double orientedAngle_degenerate(long src, double otherX, double otherY, double otherZ, double normalX, double normalY, double normalZ) {
        ...
        return Double3OpsKernelsSegment.orientedAngle_degenerate(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 24L), 0L, otherX, otherY, otherZ, normalX, normalY, normalZ);
    }
    ...
    public static double orientedAngle_degenerate(long src, long other, long normal) {
        ...
        return Double3OpsKernelsSegment.orientedAngle_degenerate(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(other, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(normal, 24L), 0L);
    }
    ...
    public static long triangleNormal_degenerate(long dest, long src, double p1X, double p1Y, double p1Z, double p2X, double p2Y, double p2Z) {
        ...
        Double3OpsKernelsSegment.triangleNormal_degenerate(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 24L), 0L, p1X, p1Y, p1Z, p2X, p2Y, p2Z);
        return dest;
    }
    ...
    public static long triangleNormal_degenerate(long dest, long src, long p1, long p2) {
        ...
        Double3OpsKernelsSegment.triangleNormal_degenerate(VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(dest, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(src, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(p1, 24L), 0L, VirtualMemoryHolder.VIRTUAL_MEMORY.asSlice(p2, 24L), 0L);
        return dest;
    }
    ...
    public static long rotateAround_unsafe(long dest, long src, double quatX, double quatY, double quatZ, double quatW, double pivotX, double pivotY, double pivotZ) {
        ...
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(quatY, _t12, Math.fma(-quatZ, _t13, Math.fma(quatW, _t14, pivotX + _selfx - pivotX))));
        UnsafeOpsHolder.U.putDouble(dest + 8L, Math.fma(quatZ, _t14, Math.fma(-quatX, _t12, Math.fma(quatW, _t13, pivotY + _selfy - pivotY))));
        UnsafeOpsHolder.U.putDouble(dest + 16L, Math.fma(quatX, _t13, Math.fma(-quatY, _t14, Math.fma(quatW, _t12, pivotZ + _selfz - pivotZ))));
        return dest;
    }
    ...
    public static long rotateAround_unsafe(long dest, long src, long quat, long pivot) {
        ...
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_quaty, _t12, Math.fma(-_quatz, _t13, Math.fma(_quatw, _t14, _pivotx + _selfx - _pivotx))));
        UnsafeOpsHolder.U.putDouble(dest + 8L, Math.fma(_quatz, _t14, Math.fma(-_quatx, _t12, Math.fma(_quatw, _t13, _pivoty + _selfy - _pivoty))));
        UnsafeOpsHolder.U.putDouble(dest + 16L, Math.fma(_quatx, _t13, Math.fma(-_quaty, _t14, Math.fma(_quatw, _t12, _pivotz + _selfz - _pivotz))));
        return dest;
    }
    ...
    public static long rotateAxis_unsafe(long dest, long src, double angle, double axisX, double axisY, double axisZ) {
        ...
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t3, axisX * _t5, Math.fma(_selfx, _t1, Math.fma(axisY, _selfz, -(axisZ * _selfy)) * _t0)));
    ...
    public static long rotateAxis_unsafe(long dest, long src, long axis, double angle) {
        ...
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t3, _axisx * _t5, Math.fma(_selfx, _t1, Math.fma(_axisy, _selfz, -(_axisz * _selfy)) * _t0)));
    ...
    public static long rotateAxisAround_unsafe(long dest, long src, double angle, double axisX, double axisY, double axisZ, double pivotX, double pivotY, double pivotZ) {
        ...
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t2, _t1, Math.fma(Math.fma(axisY, _t3, -(axisZ * _t4)), _t0, Math.fma(_t5, axisX * _t8, pivotX))));
    ...
    public static long rotateAxisAround_unsafe(long dest, long src, long axis, long pivot, double angle) {
        ...
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t2, _t1, Math.fma(Math.fma(_axisy, _t3, -(_axisz * _t4)), _t0, Math.fma(_t5, _axisx * _t8, _pivotx))));
    ...
    public static long rotateXAround_unsafe(long dest, long src, double angle, double pivotX, double pivotY, double pivotZ) {
        double _selfx = UnsafeOpsHolder.U.getDouble(src + 0L);
        double _selfy = UnsafeOpsHolder.U.getDouble(src + 8L);
        double _selfz = UnsafeOpsHolder.U.getDouble(src + 16L);
        double _t0 = Math.sin(angle);
        ...
        double _t3 = _selfz - pivotZ;
        UnsafeOpsHolder.U.putDouble(dest + 0L, pivotX + (_selfx - pivotX));
    ...
    public static long rotateXAround_unsafe(long dest, long src, long pivot, double angle) {
        ...
        double _t3 = _selfz - _pivotz;
        UnsafeOpsHolder.U.putDouble(dest + 0L, _pivotx + (_selfx - _pivotx));
    ...
    public static long rotateY_unsafe(long dest, long src, double angle) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_selfx, _t1, _selfz * _t0));
        UnsafeOpsHolder.U.putDouble(dest + 8L, _selfy);
        UnsafeOpsHolder.U.putDouble(dest + 16L, Math.fma(_selfz, _t1, -(_selfx * _t0)));
        return dest;
    }

    public static long rotateYAround_unsafe(long dest, long src, double angle, double pivotX, double pivotY, double pivotZ) {
        double _selfx = UnsafeOpsHolder.U.getDouble(src + 0L);
        double _selfy = UnsafeOpsHolder.U.getDouble(src + 8L);
        double _selfz = UnsafeOpsHolder.U.getDouble(src + 16L);
        double _t0 = Math.sin(angle);
        ...
        double _t2 = _selfx - pivotX;
        double _t3 = _selfz - pivotZ;
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t2, _t1, Math.fma(_t3, _t0, pivotX)));
        UnsafeOpsHolder.U.putDouble(dest + 8L, pivotY + (_selfy - pivotY));
    ...
    public static long rotateYAround_unsafe(long dest, long src, long pivot, double angle) {
        ...
        double _t2 = _selfx - _pivotx;
        double _t3 = _selfz - _pivotz;
        UnsafeOpsHolder.U.putDouble(dest + 0L, Math.fma(_t2, _t1, Math.fma(_t3, _t0, _pivotx)));
        UnsafeOpsHolder.U.putDouble(dest + 8L, _pivoty + (_selfy - _pivoty));
    ...
    public static long rotateZAround_unsafe(long dest, long src, double angle, double pivotX, double pivotY, double pivotZ) {
        double _selfx = UnsafeOpsHolder.U.getDouble(src + 0L);
        double _selfy = UnsafeOpsHolder.U.getDouble(src + 8L);
        double _selfz = UnsafeOpsHolder.U.getDouble(src + 16L);
        double _t0 = Math.sin(angle);
        ...
        UnsafeOpsHolder.U.putDouble(dest + 16L, pivotZ + (_selfz - pivotZ));
        return dest;
    }
    ...
    public static long rotateZAround_unsafe(long dest, long src, long pivot, double angle) {
        ...
        UnsafeOpsHolder.U.putDouble(dest + 16L, _pivotz + (_selfz - _pivotz));
        return dest;
    }
