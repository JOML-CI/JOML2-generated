...
public final class FloatQuatOpsKernelsAddress {
    ...
    public static long slerp_unsafe(long dest, long src, float targetX, float targetY, float targetZ, float targetW, float alpha) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_selfx, _t27, targetX * _t26));
    ...
    public static long slerp_unsafe(long dest, long src, long target, float alpha) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_selfx, _t27, _targetx * _t26));
    ...
    public static long squad_unsafe(long dest, long src, float control0X, float control0Y, float control0Z, float control0W, float control1X, float control1Y, float control1Z, float control1W, float targetX, float targetY, float targetZ, float targetW, float t) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_t67, _t98, _t72 * _t99));
    ...
    public static long exp_unsafe(long dest, long src) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 12L, (float) Math.cosFromSin(_t6, _t4) * _t0);
        return dest;
    }
    ...
    public static long getEulerAnglesXYZ_unsafe(long dest, long src) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 4L, (float) Math.atan2(_t8, (float) Math.sqrt(_t12)));
        return dest;
    }
    ...
    public static long getEulerAnglesXZY_unsafe(long dest, long src) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 8L, (float) Math.atan2(_t8, (float) Math.sqrt(_t11)));
        return dest;
    }
    ...
    public static long getEulerAnglesYXZ_unsafe(long dest, long src) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 0L, (float) Math.atan2(_t9, (float) Math.sqrt(_t12)));
        return dest;
    }
    ...
    public static long getEulerAnglesYZX_unsafe(long dest, long src) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 8L, (float) Math.atan2(_t7, (float) Math.sqrt(_t11)));
        return dest;
    }
    ...
    public static long getEulerAnglesZXY_unsafe(long dest, long src) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 0L, (float) Math.atan2(_t7, (float) Math.sqrt(_t11)));
        return dest;
    }
    ...
    public static long getEulerAnglesZYX_unsafe(long dest, long src) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 4L, (float) Math.atan2(_t8, (float) Math.sqrt(_t11)));
        return dest;
    }
    ...
    public static long integrate_unsafe(long dest, long src, float angularVelX, float angularVelY, float angularVelZ, float dt) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_selfx, _t10, _selfw * _t15) + Math.fma(_selfz, _t16, -(_selfy * _t17)));
    ...
    public static long log_unsafe(long dest, long src) {
        ...
        if (_t2 > 0.0f) {
            UnsafeOpsHolder.U.putFloat(dest + 0L, _selfx * _t6);
        ...
        UnsafeOpsHolder.U.putFloat(dest + 12L, (float) Math.log((float) Math.sqrt(Math.fma(_selfw, _selfw, _t2))));
        return dest;
    }
    ...
    public static long pow_unsafe(long dest, long src, float t) {
        ...
        if (_t23 > 0.0f) {
            UnsafeOpsHolder.U.putFloat(dest + 0L, _t19 * _t28);
            UnsafeOpsHolder.U.putFloat(dest + 4L, _t20 * _t28);
            UnsafeOpsHolder.U.putFloat(dest + 8L, _t18 * _t28);
        } else {
            UnsafeOpsHolder.U.putFloat(dest + 0L, 0.0f);
            UnsafeOpsHolder.U.putFloat(dest + 4L, 0.0f);
            UnsafeOpsHolder.U.putFloat(dest + 8L, 0.0f);
        }
        UnsafeOpsHolder.U.putFloat(dest + 12L, (float) Math.cosFromSin(_t26, _t24) * _t10);
        return dest;
    }
    ...
    public static long rotateTowards_unsafe(long dest, long src, float targetX, float targetY, float targetZ, float targetW, float step) {
        ...
        if (_t72 != 0.0f) {
            UnsafeOpsHolder.U.putFloat(dest + 0L, _t73 * _t67);
    ...
    public static long makeRotationAxis_unsafe(long dest, float angle, float axisX, float axisY, float axisZ) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 12L, (float) Math.cosFromSin(_t1, _t0));
        return dest;
    }
    ...
    public static long makeRotationLookAlong_unsafe(long dest, float dirX, float dirY, float dirZ, float upX, float upY, float upZ) {
        ...
        if (_t59 > 0.0f) {
            UnsafeOpsHolder.U.putFloat(dest + 0L, _sp0 * _t55);
            UnsafeOpsHolder.U.putFloat(dest + 4L, _sp0 * _t38);
            UnsafeOpsHolder.U.putFloat(dest + 8L, _sp0 * _t58);
            ...
            if (_t31 > _t56) {
                ...
                UnsafeOpsHolder.U.putFloat(dest + 4L, _sp3 * _t57);
                UnsafeOpsHolder.U.putFloat(dest + 8L, _sp3 * _t37);
                UnsafeOpsHolder.U.putFloat(dest + 12L, _sp3 * _t55);
            } else {
                if (_t49 > _t7) {
                    UnsafeOpsHolder.U.putFloat(dest + 0L, _sp1 * _t57);
                    UnsafeOpsHolder.U.putFloat(dest + 4L, 0.5f * (float) Math.sqrt(_t62));
                    UnsafeOpsHolder.U.putFloat(dest + 8L, _sp1 * _t54);
                    UnsafeOpsHolder.U.putFloat(dest + 12L, _sp1 * _t38);
                } else {
                    UnsafeOpsHolder.U.putFloat(dest + 0L, _sp2 * _t37);
                    UnsafeOpsHolder.U.putFloat(dest + 4L, _sp2 * _t54);
                    UnsafeOpsHolder.U.putFloat(dest + 8L, 0.5f * (float) Math.sqrt(_t63));
                    UnsafeOpsHolder.U.putFloat(dest + 12L, _sp2 * _t58);
                }
            }
        }
        return dest;
    ...
    public static long makeRotationTo_unsafe(long dest, float fromDirX, float fromDirY, float fromDirZ, float toDirX, float toDirY, float toDirZ) {
        ...
        if (_t23 > 6.0E-8f) {
            ...
            UnsafeOpsHolder.U.putFloat(dest + 12L, _t23 * _t32);
        } else {
            if (_t29 != 0.0f) {
    ...
    public static long makeRotationXYZ_unsafe(long dest, float angleX, float angleY, float angleZ) {
        ...
        float _t11 = _t4 * _t8;
        float _t12 = _t8 * _t6;
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_t10, _t7, _t11 * _t5));
    ...
    public static long makeRotationYZX_unsafe(long dest, float angleY, float angleZ, float angleX) {
        ...
        float _t11 = _t4 * _t7;
        float _t12 = _t7 * _t8;
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_t9, _t6, _t12 * _t5));
    ...
    public static long makeRotationZYX_unsafe(long dest, float angleZ, float angleY, float angleX) {
        ...
        float _t11 = _t4 * _t6;
        float _t12 = _t6 * _t7;
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_t12, _t5, -(_t9 * _t8)));
    ...
    public static long preRotateX_unsafe(long dest, long src, float angle) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_selfx, _t2, _selfw * _t1));
    ...
    public static long preRotateY_unsafe(long dest, long src, float angle) {
        ...
        float _t1 = (float) Math.sin(_t0);
        float _t2 = (float) Math.cosFromSin(_t1, _t0);
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_selfx, _t2, _selfz * _t1));
    ...
    public static long preRotateZ_unsafe(long dest, long src, float angle) {
        ...
        float _t1 = (float) Math.sin(_t0);
        float _t2 = (float) Math.cosFromSin(_t1, _t0);
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_selfx, _t2, -(_selfy * _t1)));
    ...
    public static long rotateAxis_unsafe(long dest, long src, float angle, float axisX, float axisY, float axisZ) {
        ...
        UnsafeOpsHolder.U.putFloat(dest + 0L, Math.fma(_selfx, _t5, _selfw * _t2) + Math.fma(_selfy, _t3, -(_selfz * _t4)));
