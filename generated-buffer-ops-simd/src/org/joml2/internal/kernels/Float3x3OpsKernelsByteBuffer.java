...
public final class Float3x3OpsKernelsByteBuffer {
    ...
    public static java.nio.ByteBuffer getEulerAnglesXYZ_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        dest.putFloat(destOffset + 4, (float) Math.atan2(_self02, (float) Math.sqrt(_t1)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer getEulerAnglesXZY_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        dest.putFloat(destOffset + 8, (float) Math.atan2(-_self01, (float) Math.sqrt(_t1)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer getEulerAnglesYXZ_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        dest.putFloat(destOffset + 0, (float) Math.atan2(-_self12, (float) Math.sqrt(_t1)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer getEulerAnglesYZX_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        dest.putFloat(destOffset + 8, (float) Math.atan2(_self10, (float) Math.sqrt(_t1)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer getEulerAnglesZXY_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        dest.putFloat(destOffset + 0, (float) Math.atan2(_self21, (float) Math.sqrt(_t1)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer getEulerAnglesZYX_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        dest.putFloat(destOffset + 4, (float) Math.atan2(-_self20, (float) Math.sqrt(_t1)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer getNormalizedRotation_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        if (_t58 > 0.0f) {
            dest.putFloat(destOffset + 0, _sp0 * _t36);
            ...
            if (_t49 > _t37) {
                ...
                if (_t23 > _t26) {
                    dest.putFloat(destOffset + 0, _sp1 * _t53);
                    ...
                    dest.putFloat(destOffset + 0, _sp2 * _t55);
    ...
    public static java.nio.ByteBuffer toDualQuat_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        float _sp3 = 0.5f * (1.0f / (float) Math.sqrt(_t15));
        if (_t13 > 0.0f) {
            dest.putFloat(destOffset + 0, _sp0 * _t3);
            dest.putFloat(destOffset + 4, _sp0 * _t7);
            dest.putFloat(destOffset + 8, _sp0 * _t9);
            dest.putFloat(destOffset + 12, 0.5f * (float) Math.sqrt(_t14));
        } else {
            if (_self00 > _t4) {
                dest.putFloat(destOffset + 0, 0.5f * (float) Math.sqrt(_t15));
                dest.putFloat(destOffset + 4, _sp3 * _t5);
                dest.putFloat(destOffset + 8, _sp3 * _t6);
                dest.putFloat(destOffset + 12, _sp3 * _t3);
            } else {
                if (_self11 > _self22) {
                    dest.putFloat(destOffset + 0, _sp1 * _t5);
                    dest.putFloat(destOffset + 4, 0.5f * (float) Math.sqrt(_t16));
                    dest.putFloat(destOffset + 8, _sp1 * _t8);
                    dest.putFloat(destOffset + 12, _sp1 * _t7);
                } else {
    ...
    public static java.nio.ByteBuffer toRigid_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        if (_t59 > 0.0f) {
            dest.putFloat(destOffset + 12, _sp0 * _t32);
            dest.putFloat(destOffset + 16, _sp0 * _t53);
            dest.putFloat(destOffset + 20, _sp0 * _t54);
            dest.putFloat(destOffset + 24, 0.5f * (float) Math.sqrt(_t60));
        } else {
            if (_t44 > _t33) {
                dest.putFloat(destOffset + 12, 0.5f * (float) Math.sqrt(_t64));
                dest.putFloat(destOffset + 16, _sp3 * _t51);
                dest.putFloat(destOffset + 20, _sp3 * _t52);
                dest.putFloat(destOffset + 24, _sp3 * _t32);
            } else {
                if (_t21 > _t16) {
                    dest.putFloat(destOffset + 12, _sp1 * _t51);
                    dest.putFloat(destOffset + 16, 0.5f * (float) Math.sqrt(_t62));
                    dest.putFloat(destOffset + 20, _sp1 * _t28);
                    dest.putFloat(destOffset + 24, _sp1 * _t53);
                } else {
                    dest.putFloat(destOffset + 12, _sp2 * _t52);
                    dest.putFloat(destOffset + 16, _sp2 * _t28);
                    dest.putFloat(destOffset + 20, 0.5f * (float) Math.sqrt(_t63));
                    dest.putFloat(destOffset + 24, _sp2 * _t54);
                }
            }
        }
        dest.putFloat(destOffset + 0, 0.0f);
    ...
    public static java.nio.ByteBuffer toTransform_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        dest.putFloat(destOffset + 4, 0.0f);
        dest.putFloat(destOffset + 8, 0.0f);
        dest.putFloat(destOffset + 12, _t60 > 0.0f ? _sp0 * _t33 : _t45 > _t34 ? 0.5f * (float) Math.sqrt(_t65) : _t22 > _t17 ? _sp1 * _t52 : _sp2 * _t53);
        dest.putFloat(destOffset + 16, _t60 > 0.0f ? _sp0 * _t54 : _t45 > _t34 ? _sp3 * _t52 : _t22 > _t17 ? 0.5f * (float) Math.sqrt(_t63) : _sp2 * _t29);
        dest.putFloat(destOffset + 20, _t60 > 0.0f ? _sp0 * _t55 : _t45 > _t34 ? _sp3 * _t53 : _t22 > _t17 ? _sp1 * _t29 : 0.5f * (float) Math.sqrt(_t64));
        dest.putFloat(destOffset + 24, _t60 > 0.0f ? 0.5f * (float) Math.sqrt(_t61) : _t45 > _t34 ? _sp3 * _t33 : _t22 > _t17 ? _sp1 * _t54 : _sp2 * _t55);
    ...
    public static java.nio.ByteBuffer decomposeRotation_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        if (_t82 > 0.0f) {
            dest.putFloat(destOffset + 0, _sp0 * _t60);
            ...
            if (_t73 > _t61) {
                ...
                if (_t36 > _t56) {
                    dest.putFloat(destOffset + 0, _sp1 * _t77);
                    ...
                    dest.putFloat(destOffset + 0, _sp2 * _t80);
    ...
    public static java.nio.ByteBuffer makeFromDualQuat_api(java.nio.ByteBuffer dest, int destOffset, float dqRX, float dqRY, float dqRZ, float dqRW, float dqDX, float dqDY, float dqDZ, float dqDW) {
        ...
        dest.putFloat(destOffset + 8, Math.fma(-2.0f, _t3, _sp0 * dqRZ));
        dest.putFloat(destOffset + 12, Math.fma(-2.0f, _t2, _sp0 * dqRY));
        ...
        dest.putFloat(destOffset + 28, Math.fma(-2.0f, dqRX * dqRW, _t5 + _t5));
    ...
    public static java.nio.ByteBuffer makeRotationAxis_api(java.nio.ByteBuffer dest, int destOffset, float angle, float axisX, float axisY, float axisZ) {
        ...
        float _t5 = 1.0f - _t1;
        dest.putFloat(destOffset + 0, Math.fma(_t5, axisX * axisX, _t1));
        dest.putFloat(destOffset + 4, Math.fma(axisZ, _t0, _t5 * _t2));
        dest.putFloat(destOffset + 8, Math.fma(_t5, _t3, -(axisY * _t0)));
        dest.putFloat(destOffset + 12, Math.fma(_t5, _t2, -(axisZ * _t0)));
        dest.putFloat(destOffset + 16, Math.fma(_t5, axisY * axisY, _t1));
        dest.putFloat(destOffset + 20, Math.fma(axisX, _t0, _t5 * _t4));
        dest.putFloat(destOffset + 24, Math.fma(axisY, _t0, _t5 * _t3));
        dest.putFloat(destOffset + 28, Math.fma(_t5, _t4, -(axisX * _t0)));
        dest.putFloat(destOffset + 32, Math.fma(_t5, axisZ * axisZ, _t1));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer makeRotationAxis_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer axis, int axisOffset, float angle) {
        ...
        float _t5 = 1.0f - _t1;
        dest.putFloat(destOffset + 0, Math.fma(_t5, _axisx * _axisx, _t1));
        dest.putFloat(destOffset + 4, Math.fma(_axisz, _t0, _t5 * _t2));
        dest.putFloat(destOffset + 8, Math.fma(_t5, _t3, -(_axisy * _t0)));
        dest.putFloat(destOffset + 12, Math.fma(_t5, _t2, -(_axisz * _t0)));
        dest.putFloat(destOffset + 16, Math.fma(_t5, _axisy * _axisy, _t1));
        dest.putFloat(destOffset + 20, Math.fma(_axisx, _t0, _t5 * _t4));
        dest.putFloat(destOffset + 24, Math.fma(_axisy, _t0, _t5 * _t3));
        dest.putFloat(destOffset + 28, Math.fma(_t5, _t4, -(_axisx * _t0)));
        dest.putFloat(destOffset + 32, Math.fma(_t5, _axisz * _axisz, _t1));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer makeRotationXYZ_api(java.nio.ByteBuffer dest, int destOffset, float angleX, float angleY, float angleZ) {
        ...
        float _t6 = _t2 * _t0;
        float _t7 = _t0 * _t5;
        dest.putFloat(destOffset + 0, _t3 * _t4);
        dest.putFloat(destOffset + 4, Math.fma(_t6, _t4, _t1 * _t5));
        dest.putFloat(destOffset + 8, Math.fma(_t2, _t1, -(_t7 * _t4)));
        dest.putFloat(destOffset + 12, -(_t1 * _t3));
        dest.putFloat(destOffset + 16, Math.fma(_t5, _t4, -(_t6 * _t1)));
        dest.putFloat(destOffset + 20, Math.fma(_t7, _t1, _t2 * _t4));
        dest.putFloat(destOffset + 24, _t0);
        dest.putFloat(destOffset + 28, -(_t2 * _t3));
    ...
    public static java.nio.ByteBuffer makeRotationXZY_api(java.nio.ByteBuffer dest, int destOffset, float angleX, float angleZ, float angleY) {
        ...
        float _t7 = _t1 * _t5;
        dest.putFloat(destOffset + 0, _t3 * _t4);
        dest.putFloat(destOffset + 4, Math.fma(_t7, _t3, _t2 * _t0));
        dest.putFloat(destOffset + 8, Math.fma(_t6, _t3, -(_t0 * _t5)));
        dest.putFloat(destOffset + 12, -_t1);
        dest.putFloat(destOffset + 16, _t5 * _t4);
        dest.putFloat(destOffset + 20, _t2 * _t4);
        dest.putFloat(destOffset + 24, _t0 * _t4);
        dest.putFloat(destOffset + 28, Math.fma(_t7, _t0, -(_t2 * _t3)));
        dest.putFloat(destOffset + 32, Math.fma(_t6, _t0, _t5 * _t3));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer makeRotationYZX_api(java.nio.ByteBuffer dest, int destOffset, float angleY, float angleZ, float angleX) {
        ...
        dest.putFloat(destOffset + 12, Math.fma(_t2, _t0, -(_t7 * _t5)));
        dest.putFloat(destOffset + 16, _t5 * _t4);
        dest.putFloat(destOffset + 20, Math.fma(_t6, _t5, _t2 * _t3));
        dest.putFloat(destOffset + 24, Math.fma(_t7, _t2, _t0 * _t5));
        dest.putFloat(destOffset + 28, -(_t2 * _t4));
        dest.putFloat(destOffset + 32, Math.fma(_t5, _t3, -(_t6 * _t2)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer makeRotationZXY_api(java.nio.ByteBuffer dest, int destOffset, float angleZ, float angleX, float angleY) {
        ...
        float _t6 = _t2 * _t1;
        float _t7 = _t2 * _t4;
        dest.putFloat(destOffset + 0, Math.fma(_t3, _t4, -(_t6 * _t0)));
        dest.putFloat(destOffset + 4, Math.fma(_t7, _t0, _t1 * _t3));
        dest.putFloat(destOffset + 8, -(_t0 * _t5));
        dest.putFloat(destOffset + 12, -(_t1 * _t5));
        dest.putFloat(destOffset + 16, _t5 * _t4);
        dest.putFloat(destOffset + 20, _t2);
        dest.putFloat(destOffset + 24, Math.fma(_t6, _t3, _t0 * _t4));
        dest.putFloat(destOffset + 28, Math.fma(_t0, _t1, -(_t7 * _t3)));
        dest.putFloat(destOffset + 32, _t5 * _t3);
        return dest;
    }
    ...
    public static java.nio.ByteBuffer makeRotationZYX_api(java.nio.ByteBuffer dest, int destOffset, float angleZ, float angleY, float angleX) {
        ...
        dest.putFloat(destOffset + 8, -_t0);
        dest.putFloat(destOffset + 12, Math.fma(_t7, _t2, -(_t1 * _t5)));
        dest.putFloat(destOffset + 16, Math.fma(_t6, _t2, _t5 * _t4));
        dest.putFloat(destOffset + 20, _t2 * _t3);
        dest.putFloat(destOffset + 24, Math.fma(_t7, _t5, _t2 * _t1));
        dest.putFloat(destOffset + 28, Math.fma(_t6, _t5, -(_t2 * _t4)));
        dest.putFloat(destOffset + 32, _t5 * _t3);
        return dest;
    }
    ...
    public static java.nio.ByteBuffer makeView_api(java.nio.ByteBuffer dest, int destOffset, float left, float right, float bottom, float top) {
        ...
        dest.putFloat(destOffset + 0, _t0_inv + _t0_inv);
        dest.putFloat(destOffset + 4, 0.0f);
        dest.putFloat(destOffset + 8, 0.0f);
        dest.putFloat(destOffset + 12, 0.0f);
        dest.putFloat(destOffset + 16, _t1_inv + _t1_inv);
        dest.putFloat(destOffset + 20, 0.0f);
    ...
    public static java.nio.ByteBuffer preRotate_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle) {
        ...
        dest.putFloat(destOffset + 4, Math.fma(_self00, _t0, _self10 * _t1));
        dest.putFloat(destOffset + 8, _self20);
        dest.putFloat(destOffset + 12, Math.fma(_self01, _t1, -(_self11 * _t0)));
        dest.putFloat(destOffset + 16, Math.fma(_self01, _t0, _self11 * _t1));
        dest.putFloat(destOffset + 20, _self21);
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t1, -(_self12 * _t0)));
        dest.putFloat(destOffset + 28, Math.fma(_self02, _t0, _self12 * _t1));
        dest.putFloat(destOffset + 32, _self22);
        return dest;
    }
    ...
    public static java.nio.ByteBuffer preRotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(_self20, _t9, Math.fma(_self00, _t3, -(_self10 * _t0))));
        dest.putFloat(destOffset + 4, Math.fma(_self20, _t10, Math.fma(_self00, _t0, _self10 * _t3)));
        dest.putFloat(destOffset + 8, _self20);
        dest.putFloat(destOffset + 12, Math.fma(_self21, _t9, Math.fma(_self01, _t3, -(_self11 * _t0))));
        dest.putFloat(destOffset + 16, Math.fma(_self21, _t10, Math.fma(_self01, _t0, _self11 * _t3)));
        dest.putFloat(destOffset + 20, _self21);
        dest.putFloat(destOffset + 24, Math.fma(_self22, _t9, Math.fma(_self02, _t3, -(_self12 * _t0))));
        dest.putFloat(destOffset + 28, Math.fma(_self22, _t10, Math.fma(_self02, _t0, _self12 * _t3)));
        dest.putFloat(destOffset + 32, _self22);
        return dest;
    }
    ...
    public static java.nio.ByteBuffer preRotateX_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle) {
        ...
        float _t1 = (float) Math.cosFromSin(_t0, angle);
        dest.putFloat(destOffset + 0, _self00);
        dest.putFloat(destOffset + 4, Math.fma(_self10, _t1, -(_self20 * _t0)));
        dest.putFloat(destOffset + 8, Math.fma(_self10, _t0, _self20 * _t1));
        dest.putFloat(destOffset + 12, _self01);
        dest.putFloat(destOffset + 16, Math.fma(_self11, _t1, -(_self21 * _t0)));
        dest.putFloat(destOffset + 20, Math.fma(_self11, _t0, _self21 * _t1));
        dest.putFloat(destOffset + 24, _self02);
        dest.putFloat(destOffset + 28, Math.fma(_self12, _t1, -(_self22 * _t0)));
        dest.putFloat(destOffset + 32, Math.fma(_self12, _t0, _self22 * _t1));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer preRotateY_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle) {
        ...
        dest.putFloat(destOffset + 4, _self10);
        dest.putFloat(destOffset + 8, Math.fma(_self20, _t1, -(_self00 * _t0)));
        dest.putFloat(destOffset + 12, Math.fma(_self01, _t1, _self21 * _t0));
        dest.putFloat(destOffset + 16, _self11);
        dest.putFloat(destOffset + 20, Math.fma(_self21, _t1, -(_self01 * _t0)));
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t1, _self22 * _t0));
        dest.putFloat(destOffset + 28, _self12);
        dest.putFloat(destOffset + 32, Math.fma(_self22, _t1, -(_self02 * _t0)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer preScaleAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float s, float pivotX, float pivotY) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(s, _self00, _self20 * _t1));
        dest.putFloat(destOffset + 4, Math.fma(s, _self10, _self20 * _t2));
        dest.putFloat(destOffset + 8, _self20);
        dest.putFloat(destOffset + 12, Math.fma(s, _self01, _self21 * _t1));
        dest.putFloat(destOffset + 16, Math.fma(s, _self11, _self21 * _t2));
        dest.putFloat(destOffset + 20, _self21);
        dest.putFloat(destOffset + 24, Math.fma(s, _self02, _self22 * _t1));
        dest.putFloat(destOffset + 28, Math.fma(s, _self12, _self22 * _t2));
        dest.putFloat(destOffset + 32, _self22);
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotate_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle) {
        ...
        dest.putFloat(destOffset + 4, Math.fma(_self10, _t1, _self11 * _t0));
        dest.putFloat(destOffset + 8, Math.fma(_self20, _t1, _self21 * _t0));
        dest.putFloat(destOffset + 12, Math.fma(_self01, _t1, -(_self00 * _t0)));
        dest.putFloat(destOffset + 16, Math.fma(_self11, _t1, -(_self10 * _t0)));
        dest.putFloat(destOffset + 20, Math.fma(_self21, _t1, -(_self20 * _t0)));
        dest.putFloat(destOffset + 24, _self02);
        dest.putFloat(destOffset + 28, _self12);
        dest.putFloat(destOffset + 32, _self22);
        return dest;
    ...
    public static java.nio.ByteBuffer rotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY) {
        ...
        float _t9 = Math.fma(pivotX, _t8, pivotY * _t0);
        float _t10 = Math.fma(pivotY, _t8, -(pivotX * _t0));
        dest.putFloat(destOffset + 0, Math.fma(_self00, _t2, _self01 * _t0));
        dest.putFloat(destOffset + 4, Math.fma(_self10, _t2, _self11 * _t0));
        dest.putFloat(destOffset + 8, Math.fma(_self20, _t2, _self21 * _t0));
        dest.putFloat(destOffset + 12, Math.fma(_self01, _t2, -(_self00 * _t0)));
        dest.putFloat(destOffset + 16, Math.fma(_self11, _t2, -(_self10 * _t0)));
        dest.putFloat(destOffset + 20, Math.fma(_self21, _t2, -(_self20 * _t0)));
        dest.putFloat(destOffset + 24, Math.fma(_self00, _t9, Math.fma(_self01, _t10, _self02)));
        dest.putFloat(destOffset + 28, Math.fma(_self10, _t9, Math.fma(_self11, _t10, _self12)));
        dest.putFloat(destOffset + 32, Math.fma(_self20, _t9, Math.fma(_self21, _t10, _self22)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateX_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle) {
        ...
        dest.putFloat(destOffset + 4, _self10);
        dest.putFloat(destOffset + 8, _self20);
        dest.putFloat(destOffset + 12, Math.fma(_self01, _t1, _self02 * _t0));
        dest.putFloat(destOffset + 16, Math.fma(_self11, _t1, _self12 * _t0));
        dest.putFloat(destOffset + 20, Math.fma(_self21, _t1, _self22 * _t0));
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t1, -(_self01 * _t0)));
        dest.putFloat(destOffset + 28, Math.fma(_self12, _t1, -(_self11 * _t0)));
        dest.putFloat(destOffset + 32, Math.fma(_self22, _t1, -(_self21 * _t0)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateXYZ_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angleX, float angleY, float angleZ) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(_self02, _t20, Math.fma(_self00, _t13, _self01 * _t18)));
        dest.putFloat(destOffset + 4, Math.fma(_self12, _t20, Math.fma(_self10, _t13, _self11 * _t18)));
        dest.putFloat(destOffset + 8, Math.fma(_self22, _t20, Math.fma(_self20, _t13, _self21 * _t18)));
        dest.putFloat(destOffset + 12, Math.fma(_self02, _t19, Math.fma(_self01, _t21, -(_self00 * _t10))));
        dest.putFloat(destOffset + 16, Math.fma(_self12, _t19, Math.fma(_self11, _t21, -(_self10 * _t10))));
        dest.putFloat(destOffset + 20, Math.fma(_self22, _t19, Math.fma(_self21, _t21, -(_self20 * _t10))));
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t15, Math.fma(_self00, _t2, -(_self01 * _t11))));
        dest.putFloat(destOffset + 28, Math.fma(_self12, _t15, Math.fma(_self10, _t2, -(_self11 * _t11))));
        dest.putFloat(destOffset + 32, Math.fma(_self22, _t15, Math.fma(_self20, _t2, -(_self21 * _t11))));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateXZY_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angleX, float angleZ, float angleY) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(_self02, _t20, Math.fma(_self00, _t15, _self01 * _t18)));
        dest.putFloat(destOffset + 4, Math.fma(_self12, _t20, Math.fma(_self10, _t15, _self11 * _t18)));
        dest.putFloat(destOffset + 8, Math.fma(_self22, _t20, Math.fma(_self20, _t15, _self21 * _t18)));
        dest.putFloat(destOffset + 12, Math.fma(_self02, _t10, Math.fma(_self01, _t16, -(_self00 * _t1))));
        dest.putFloat(destOffset + 16, Math.fma(_self12, _t10, Math.fma(_self11, _t16, -(_self10 * _t1))));
        dest.putFloat(destOffset + 20, Math.fma(_self22, _t10, Math.fma(_self21, _t16, -(_self20 * _t1))));
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t19, Math.fma(_self00, _t11, _self01 * _t21)));
        dest.putFloat(destOffset + 28, Math.fma(_self12, _t19, Math.fma(_self10, _t11, _self11 * _t21)));
        dest.putFloat(destOffset + 32, Math.fma(_self22, _t19, Math.fma(_self20, _t11, _self21 * _t21)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateY_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle) {
        ...
        dest.putFloat(destOffset + 4, Math.fma(_self10, _t1, -(_self12 * _t0)));
        dest.putFloat(destOffset + 8, Math.fma(_self20, _t1, -(_self22 * _t0)));
        dest.putFloat(destOffset + 12, _self01);
        dest.putFloat(destOffset + 16, _self11);
        dest.putFloat(destOffset + 20, _self21);
        dest.putFloat(destOffset + 24, Math.fma(_self00, _t0, _self02 * _t1));
        dest.putFloat(destOffset + 28, Math.fma(_self10, _t0, _self12 * _t1));
    ...
    public static java.nio.ByteBuffer rotateYXZ_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angleY, float angleX, float angleZ) {
        ...
        dest.putFloat(destOffset + 12, Math.fma(_self02, _t19, Math.fma(_self00, _t21, _self01 * _t16)));
        dest.putFloat(destOffset + 16, Math.fma(_self12, _t19, Math.fma(_self10, _t21, _self11 * _t16)));
        dest.putFloat(destOffset + 20, Math.fma(_self22, _t19, Math.fma(_self20, _t21, _self21 * _t16)));
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t17, Math.fma(_self00, _t12, -(_self01 * _t0))));
        dest.putFloat(destOffset + 28, Math.fma(_self12, _t17, Math.fma(_self10, _t12, -(_self11 * _t0))));
        dest.putFloat(destOffset + 32, Math.fma(_self22, _t17, Math.fma(_self20, _t12, -(_self21 * _t0))));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateYZX_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angleY, float angleZ, float angleX) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(-_self02, _t7, Math.fma(_self00, _t13, _self01 * _t1)));
        dest.putFloat(destOffset + 4, Math.fma(-_self12, _t7, Math.fma(_self10, _t13, _self11 * _t1)));
        dest.putFloat(destOffset + 8, Math.fma(-_self22, _t7, Math.fma(_self20, _t13, _self21 * _t1)));
        dest.putFloat(destOffset + 12, Math.fma(_self02, _t18, Math.fma(_self00, _t20, _self01 * _t14)));
        dest.putFloat(destOffset + 16, Math.fma(_self12, _t18, Math.fma(_self10, _t20, _self11 * _t14)));
        dest.putFloat(destOffset + 20, Math.fma(_self22, _t18, Math.fma(_self20, _t20, _self21 * _t14)));
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t21, Math.fma(_self00, _t19, -(_self01 * _t11))));
        dest.putFloat(destOffset + 28, Math.fma(_self12, _t21, Math.fma(_self10, _t19, -(_self11 * _t11))));
        dest.putFloat(destOffset + 32, Math.fma(_self22, _t21, Math.fma(_self20, _t19, -(_self21 * _t11))));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateZXY_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angleZ, float angleX, float angleY) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(-_self02, _t7, Math.fma(_self00, _t20, _self01 * _t18)));
        dest.putFloat(destOffset + 4, Math.fma(-_self12, _t7, Math.fma(_self10, _t20, _self11 * _t18)));
        dest.putFloat(destOffset + 8, Math.fma(-_self22, _t7, Math.fma(_self20, _t20, _self21 * _t18)));
        dest.putFloat(destOffset + 12, Math.fma(_self02, _t1, Math.fma(_self01, _t14, -(_self00 * _t10))));
        dest.putFloat(destOffset + 16, Math.fma(_self12, _t1, Math.fma(_self11, _t14, -(_self10 * _t10))));
        dest.putFloat(destOffset + 20, Math.fma(_self22, _t1, Math.fma(_self21, _t14, -(_self20 * _t10))));
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t15, Math.fma(_self00, _t19, _self01 * _t21)));
        dest.putFloat(destOffset + 28, Math.fma(_self12, _t15, Math.fma(_self10, _t19, _self11 * _t21)));
        dest.putFloat(destOffset + 32, Math.fma(_self22, _t15, Math.fma(_self20, _t19, _self21 * _t21)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateZYX_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angleZ, float angleY, float angleX) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(-_self02, _t0, Math.fma(_self00, _t15, _self01 * _t8)));
        dest.putFloat(destOffset + 4, Math.fma(-_self12, _t0, Math.fma(_self10, _t15, _self11 * _t8)));
        dest.putFloat(destOffset + 8, Math.fma(-_self22, _t0, Math.fma(_self20, _t15, _self21 * _t8)));
        dest.putFloat(destOffset + 12, Math.fma(_self02, _t9, Math.fma(_self00, _t20, _self01 * _t18)));
        dest.putFloat(destOffset + 16, Math.fma(_self12, _t9, Math.fma(_self10, _t20, _self11 * _t18)));
        dest.putFloat(destOffset + 20, Math.fma(_self22, _t9, Math.fma(_self20, _t20, _self21 * _t18)));
        dest.putFloat(destOffset + 24, Math.fma(_self02, _t17, Math.fma(_self00, _t19, _self01 * _t21)));
        dest.putFloat(destOffset + 28, Math.fma(_self12, _t17, Math.fma(_self10, _t19, _self11 * _t21)));
        dest.putFloat(destOffset + 32, Math.fma(_self22, _t17, Math.fma(_self20, _t19, _self21 * _t21)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer scaleAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float s, float pivotX, float pivotY) {
        ...
        dest.putFloat(destOffset + 16, s * _self11);
        dest.putFloat(destOffset + 20, s * _self21);
        dest.putFloat(destOffset + 24, Math.fma(_self00, _t1, Math.fma(_self01, _t2, _self02)));
        dest.putFloat(destOffset + 28, Math.fma(_self10, _t1, Math.fma(_self11, _t2, _self12)));
        dest.putFloat(destOffset + 32, Math.fma(_self20, _t1, Math.fma(_self21, _t2, _self22)));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer view_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float left, float right, float bottom, float top) {
        ...
        dest.putFloat(destOffset + 0, _sp0 * _self00);
        dest.putFloat(destOffset + 4, _sp0 * _self10);
        dest.putFloat(destOffset + 8, _sp0 * _self20);
        dest.putFloat(destOffset + 12, _sp1 * _self01);
        dest.putFloat(destOffset + 16, _sp1 * _self11);
        dest.putFloat(destOffset + 20, _sp1 * _self21);
        dest.putFloat(destOffset + 24, _self02 + (-(_self00 * _sp2) - _self01 * _sp3));
        dest.putFloat(destOffset + 28, _self12 + (-(_self10 * _sp2) - _self11 * _sp3));
        dest.putFloat(destOffset + 32, _self22 + (-(_self20 * _sp2) - _self21 * _sp3));
        return dest;
    }
