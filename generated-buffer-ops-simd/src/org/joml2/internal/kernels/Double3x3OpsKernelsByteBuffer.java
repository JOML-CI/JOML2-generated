...
public final class Double3x3OpsKernelsByteBuffer {
    ...
    public static java.nio.ByteBuffer preRotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double angle, double pivotX, double pivotY) {
        ...
        dest.putDouble(destOffset + 0, Math.fma(_self20, _t6, Math.fma(_self00, _t1, -(_self10 * _t0))));
        dest.putDouble(destOffset + 8, Math.fma(_self20, _t7, Math.fma(_self00, _t0, _self10 * _t1)));
        dest.putDouble(destOffset + 16, _self20);
        dest.putDouble(destOffset + 24, Math.fma(_self21, _t6, Math.fma(_self01, _t1, -(_self11 * _t0))));
        dest.putDouble(destOffset + 32, Math.fma(_self21, _t7, Math.fma(_self01, _t0, _self11 * _t1)));
        dest.putDouble(destOffset + 40, _self21);
        dest.putDouble(destOffset + 48, Math.fma(_self22, _t6, Math.fma(_self02, _t1, -(_self12 * _t0))));
        dest.putDouble(destOffset + 56, Math.fma(_self22, _t7, Math.fma(_self02, _t0, _self12 * _t1)));
        dest.putDouble(destOffset + 64, _self22);
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double angle, double pivotX, double pivotY) {
        ...
        dest.putDouble(destOffset + 32, Math.fma(_self11, _t0, -(_self10 * _t1)));
        dest.putDouble(destOffset + 40, Math.fma(_self21, _t0, -(_self20 * _t1)));
        dest.putDouble(destOffset + 48, Math.fma(_self00, _t6, Math.fma(_self01, _t7, _self02)));
        dest.putDouble(destOffset + 56, Math.fma(_self10, _t6, Math.fma(_self11, _t7, _self12)));
        dest.putDouble(destOffset + 64, Math.fma(_self20, _t6, Math.fma(_self21, _t7, _self22)));
        return dest;
    }
