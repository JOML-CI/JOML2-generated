...
public final class Float3OpsKernelsByteBuffer {
    ...
    public static java.nio.ByteBuffer makeUniformDirection_api(java.nio.ByteBuffer dest, int destOffset, float u, float v) {
        ...
        dest.putFloat(destOffset + 0, _t5 * (float) Math.cosFromSin(_t2, _t1));
    ...
    public static java.nio.ByteBuffer slerp_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float otherX, float otherY, float otherZ, float t) {
        ...
        if (!(_ct0 > 1.1754944E-38f && _ct0 < Float.POSITIVE_INFINITY)) return Float3OpsKernelsByteBuffer.slerp_degenerate(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, t);
        float _t6 = _ct0;
        float _ct1 = Math.fma(otherZ, otherZ, Math.fma(otherX, otherX, otherY * otherY));
        if (!(_ct1 > 1.1754944E-38f && _ct1 < Float.POSITIVE_INFINITY)) return Float3OpsKernelsByteBuffer.slerp_degenerate(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, t);
        float _t7 = _ct1;
        ...
        if (!(_ct2 > 1.1754944E-38f && _ct2 < Float.POSITIVE_INFINITY)) return Float3OpsKernelsByteBuffer.slerp_degenerate(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, t);
        float _t42 = _ct2;
        ...
        dest.putFloat(destOffset + 0, Math.fma(_t12, _t50, _sp0 * _t37));
        dest.putFloat(destOffset + 4, Math.fma(_t17, _t50, _sp0 * _t38));
        dest.putFloat(destOffset + 8, Math.fma(_t14, _t50, _sp0 * _t36));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer slerp_degenerate(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float otherX, float otherY, float otherZ, float t) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float3OpsKernelsByteBuffer.slerp_degenerate_unsafe(dest, destOffset, src, srcOffset, otherX, otherY, otherZ, t);
    ...
    public static java.nio.ByteBuffer slerp_degenerate_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float otherX, float otherY, float otherZ, float t) {
        ...
        if (_t36 > 0.0f) {
            if (_t76 > 0.0f) {
                dest.putFloat(destOffset + 0, Math.fma(_t82, _t78 * _t72, _t84 * _t29));
                dest.putFloat(destOffset + 4, Math.fma(_t82, _t78 * _t73, _t84 * _t31));
                dest.putFloat(destOffset + 8, Math.fma(_t82, _t78 * _t71, _t84 * _t27));
            } else {
                dest.putFloat(destOffset + 0, Math.fma(_t82, _t59 * _t40, _t84 * _t29));
                dest.putFloat(destOffset + 4, Math.fma(_t82, _t59 * _t43, _t84 * _t31));
                dest.putFloat(destOffset + 8, Math.fma(_t82, _t59 * _t41, _t84 * _t27));
            }
        } else {
            dest.putFloat(destOffset + 0, Math.fma(t, otherX - _selfx, _selfx));
            dest.putFloat(destOffset + 4, Math.fma(t, otherY - _selfy, _selfy));
    ...
    public static java.nio.ByteBuffer slerp_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer other, int otherOffset, float t) {
        ...
        float _otherz = other.getFloat(otherOffset + 8);
        float _ct0 = Math.fma(_selfz, _selfz, Math.fma(_selfx, _selfx, _selfy * _selfy));
        if (!(_ct0 > 1.1754944E-38f && _ct0 < Float.POSITIVE_INFINITY)) return Float3OpsKernelsByteBuffer.slerp_degenerate(dest, destOffset, src, srcOffset, other, otherOffset, t);
        float _t6 = _ct0;
        float _ct1 = Math.fma(_otherz, _otherz, Math.fma(_otherx, _otherx, _othery * _othery));
        if (!(_ct1 > 1.1754944E-38f && _ct1 < Float.POSITIVE_INFINITY)) return Float3OpsKernelsByteBuffer.slerp_degenerate(dest, destOffset, src, srcOffset, other, otherOffset, t);
        float _t7 = _ct1;
        float _t10 = (float) Math.sqrt(_t6);
        float _t8 = 1.0f / _t10;
        float _t11 = (1.0f / (float) Math.sqrt(_t7));
        ...
        float _t38 = Math.fma(_t35, _t17, _t31);
        float _ct2 = Math.fma(_t36, _t36, Math.fma(_t37, _t37, _t38 * _t38));
        if (!(_ct2 > 1.1754944E-38f && _ct2 < Float.POSITIVE_INFINITY)) return Float3OpsKernelsByteBuffer.slerp_degenerate(dest, destOffset, src, srcOffset, other, otherOffset, t);
        float _t42 = _ct2;
        float _t46 = t * (float) Math.atan2((float) Math.sqrt(_t42), _t22);
        float _t47 = (float) Math.sin(_t46);
        float _sp0 = _t20 * _t47 * (1.0f / (float) Math.sqrt(_t42));
    ...
    public static float angleBetween_degenerate(java.nio.ByteBuffer src, int srcOffset, float otherX, float otherY, float otherZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float3OpsKernelsByteBuffer.angleBetween_degenerate_unsafe(src, srcOffset, otherX, otherY, otherZ);
    ...
    public static float angleBetween_degenerate(java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer other, int otherOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder() && other.isDirect() && other.order() == java.nio.ByteOrder.nativeOrder()) return Float3OpsKernelsByteBuffer.angleBetween_degenerate_unsafe(src, srcOffset, other, otherOffset);
    ...
    public static float orientedAngle_degenerate(java.nio.ByteBuffer src, int srcOffset, float otherX, float otherY, float otherZ, float normalX, float normalY, float normalZ) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float3OpsKernelsByteBuffer.orientedAngle_degenerate_unsafe(src, srcOffset, otherX, otherY, otherZ, normalX, normalY, normalZ);
    ...
    public static java.nio.ByteBuffer triangleNormal_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float p1X, float p1Y, float p1Z, float p2X, float p2Y, float p2Z) {
        ...
        dest.putFloat(destOffset + 0, _t12 * _t19);
    ...
    public static java.nio.ByteBuffer triangleNormal_degenerate(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float p1X, float p1Y, float p1Z, float p2X, float p2Y, float p2Z) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Float3OpsKernelsByteBuffer.triangleNormal_degenerate_unsafe(dest, destOffset, src, srcOffset, p1X, p1Y, p1Z, p2X, p2Y, p2Z);
    ...
    public static java.nio.ByteBuffer triangleNormal_degenerate_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float p1X, float p1Y, float p1Z, float p2X, float p2Y, float p2Z) {
        ...
        if (_t38 != 0.0f) {
            dest.putFloat(destOffset + 0, _t39 * _t34);
            dest.putFloat(destOffset + 4, _t39 * _t35);
            dest.putFloat(destOffset + 8, _t39 * _t33);
        } else {
            dest.putFloat(destOffset + 0, 0.0f);
            dest.putFloat(destOffset + 4, 0.0f);
            dest.putFloat(destOffset + 8, 0.0f);
    ...
    public static java.nio.ByteBuffer rotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float quatX, float quatY, float quatZ, float quatW, float pivotX, float pivotY, float pivotZ) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(quatY, _t12, Math.fma(-quatZ, _t13, Math.fma(quatW, _t14, pivotX + _selfx - pivotX))));
        dest.putFloat(destOffset + 4, Math.fma(quatZ, _t14, Math.fma(-quatX, _t12, Math.fma(quatW, _t13, pivotY + _selfy - pivotY))));
        dest.putFloat(destOffset + 8, Math.fma(quatX, _t13, Math.fma(-quatY, _t14, Math.fma(quatW, _t12, pivotZ + _selfz - pivotZ))));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer quat, int quatOffset, java.nio.ByteBuffer pivot, int pivotOffset) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(_quaty, _t12, Math.fma(-_quatz, _t13, Math.fma(_quatw, _t14, _pivotx + _selfx - _pivotx))));
        dest.putFloat(destOffset + 4, Math.fma(_quatz, _t14, Math.fma(-_quatx, _t12, Math.fma(_quatw, _t13, _pivoty + _selfy - _pivoty))));
        dest.putFloat(destOffset + 8, Math.fma(_quatx, _t13, Math.fma(-_quaty, _t14, Math.fma(_quatw, _t12, _pivotz + _selfz - _pivotz))));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateAxisAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float axisX, float axisY, float axisZ, float pivotX, float pivotY, float pivotZ) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(_t2, _t1, Math.fma(Math.fma(axisY, _t3, -(axisZ * _t4)), _t0, Math.fma(_t5, axisX * _t8, pivotX))));
    ...
    public static java.nio.ByteBuffer rotateAxisAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer axis, int axisOffset, java.nio.ByteBuffer pivot, int pivotOffset, float angle) {
        ...
        dest.putFloat(destOffset + 0, Math.fma(_t2, _t1, Math.fma(Math.fma(_axisy, _t3, -(_axisz * _t4)), _t0, Math.fma(_t5, _axisx * _t8, _pivotx))));
    ...
    public static java.nio.ByteBuffer rotateXAround_unsafe(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY, float pivotZ) {
        long _destBase = UnsafeOpsHolder.U.getLong(dest, UnsafeCopy.BB_ADDRESS_OFFSET) + destOffset;
        long _srcBase = UnsafeOpsHolder.U.getLong(src, UnsafeCopy.BB_ADDRESS_OFFSET) + srcOffset;
    ...
    public static java.nio.ByteBuffer rotateXAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY, float pivotZ) {
        float _selfx = src.getFloat(srcOffset + 0);
        float _selfy = src.getFloat(srcOffset + 4);
        float _selfz = src.getFloat(srcOffset + 8);
        float _t0 = (float) Math.sin(angle);
        ...
        float _t3 = _selfz - pivotZ;
        dest.putFloat(destOffset + 0, pivotX + (_selfx - pivotX));
    ...
    public static java.nio.ByteBuffer rotateXAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer pivot, int pivotOffset, float angle) {
        ...
        float _t3 = _selfz - _pivotz;
        dest.putFloat(destOffset + 0, _pivotx + (_selfx - _pivotx));
    ...
    public static java.nio.ByteBuffer rotateYAround_unsafe(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY, float pivotZ) {
        long _destBase = UnsafeOpsHolder.U.getLong(dest, UnsafeCopy.BB_ADDRESS_OFFSET) + destOffset;
        long _srcBase = UnsafeOpsHolder.U.getLong(src, UnsafeCopy.BB_ADDRESS_OFFSET) + srcOffset;
    ...
    public static java.nio.ByteBuffer rotateYAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY, float pivotZ) {
        float _selfx = src.getFloat(srcOffset + 0);
        float _selfy = src.getFloat(srcOffset + 4);
        float _selfz = src.getFloat(srcOffset + 8);
        float _t0 = (float) Math.sin(angle);
        ...
        float _t2 = _selfx - pivotX;
        float _t3 = _selfz - pivotZ;
        dest.putFloat(destOffset + 0, Math.fma(_t2, _t1, Math.fma(_t3, _t0, pivotX)));
        dest.putFloat(destOffset + 4, pivotY + (_selfy - pivotY));
    ...
    public static java.nio.ByteBuffer rotateYAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer pivot, int pivotOffset, float angle) {
        ...
        float _t2 = _selfx - _pivotx;
        float _t3 = _selfz - _pivotz;
        dest.putFloat(destOffset + 0, Math.fma(_t2, _t1, Math.fma(_t3, _t0, _pivotx)));
        dest.putFloat(destOffset + 4, _pivoty + (_selfy - _pivoty));
    ...
    public static java.nio.ByteBuffer rotateZAround_unsafe(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY, float pivotZ) {
        long _destBase = UnsafeOpsHolder.U.getLong(dest, UnsafeCopy.BB_ADDRESS_OFFSET) + destOffset;
        long _srcBase = UnsafeOpsHolder.U.getLong(src, UnsafeCopy.BB_ADDRESS_OFFSET) + srcOffset;
    ...
    public static java.nio.ByteBuffer rotateZAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, float angle, float pivotX, float pivotY, float pivotZ) {
        float _selfx = src.getFloat(srcOffset + 0);
        float _selfy = src.getFloat(srcOffset + 4);
        float _selfz = src.getFloat(srcOffset + 8);
        float _t0 = (float) Math.sin(angle);
        ...
        dest.putFloat(destOffset + 8, pivotZ + (_selfz - pivotZ));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer rotateZAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, java.nio.ByteBuffer pivot, int pivotOffset, float angle) {
        ...
        dest.putFloat(destOffset + 8, _pivotz + (_selfz - _pivotz));
        return dest;
    }
