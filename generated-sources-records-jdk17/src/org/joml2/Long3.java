...
/**
 * Immutable 3D vector of {@code long} components.
 * <p>
 ...
 */
public record Long3(long x, long y, long z) {
    ...
    public Long3 ceilDiv(long otherX, long otherY, long otherZ) {
        return new Long3(Math.ceilDiv(this.x, otherX), Math.ceilDiv(this.y, otherY), Math.ceilDiv(this.z, otherZ));
    }
    ...
    public Long3 ceilMod(long otherX, long otherY, long otherZ) {
        return new Long3(Math.ceilMod(this.x, otherX), Math.ceilMod(this.y, otherY), Math.ceilMod(this.z, otherZ));
    }
