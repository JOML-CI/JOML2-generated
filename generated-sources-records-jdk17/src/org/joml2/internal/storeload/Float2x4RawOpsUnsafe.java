...
public final class Float2x4RawOpsUnsafe implements Float2x4RawOps {
    ...
    public Float2x4 loadCMUnsafe(long address) {
        ...
        float _c5 = U.getFloat(address + 12L);
        float _c2 = U.getFloat(address + 16L);
        float _c6 = U.getFloat(address + 20L);
        float _c3 = U.getFloat(address + 24L);
    ...
    public Float2x4 loadCMDoubleUnsafe(long address) {
        ...
        float _c5 = (float) U.getDouble(address + 24L);
        float _c2 = (float) U.getDouble(address + 32L);
        float _c6 = (float) U.getDouble(address + 40L);
        float _c3 = (float) U.getDouble(address + 48L);
