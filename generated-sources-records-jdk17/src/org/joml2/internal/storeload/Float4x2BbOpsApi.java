...
public final class Float4x2BbOpsApi implements Float4x2BbOps {
    public FloatBuffer storeCMAbsolute(Float4x2 self, int index, FloatBuffer buf) {
    ...
    public Float4x2 loadCMAbsolute(int index, FloatBuffer buf) {
        float _c0 = buf.get(index + 0);
        float _c2 = buf.get(index + 1);
        float _c4 = buf.get(index + 2);
        float _c6 = buf.get(index + 3);
        float _c1 = buf.get(index + 4);
        float _c3 = buf.get(index + 5);
        float _c5 = buf.get(index + 6);
        float _c7 = buf.get(index + 7);
        return new Float4x2(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public ByteBuffer storeCMAbsolute(Float4x2 self, int index, ByteBuffer buf) {
    ...
    public Float4x2 loadCMAbsolute(int index, ByteBuffer buf) {
        ...
        float _c6 = buf.getFloat(index + 12);
        float _c1 = buf.getFloat(index + 16);
        float _c3 = buf.getFloat(index + 20);
        float _c5 = buf.getFloat(index + 24);
        float _c7 = buf.getFloat(index + 28);
        return new Float4x2(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public DoubleBuffer storeCMAbsolute(Float4x2 self, int index, DoubleBuffer buf) {
        buf.put(index + 0, self.m00());
        buf.put(index + 1, self.m10());
        buf.put(index + 2, self.m20());
        buf.put(index + 3, self.m30());
    ...
    public Float4x2 loadCMAbsolute(int index, DoubleBuffer buf) {
        float _c0 = (float) buf.get(index + 0);
        float _c2 = (float) buf.get(index + 1);
        float _c4 = (float) buf.get(index + 2);
        float _c6 = (float) buf.get(index + 3);
        float _c1 = (float) buf.get(index + 4);
        float _c3 = (float) buf.get(index + 5);
        float _c5 = (float) buf.get(index + 6);
        float _c7 = (float) buf.get(index + 7);
        return new Float4x2(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public ByteBuffer storeCMDoubleAbsolute(Float4x2 self, int index, ByteBuffer buf) {
    ...
    public Float4x2 loadCMDoubleAbsolute(int index, ByteBuffer buf) {
        ...
        float _c6 = (float) buf.getDouble(index + 24);
        float _c1 = (float) buf.getDouble(index + 32);
        float _c3 = (float) buf.getDouble(index + 40);
        float _c5 = (float) buf.getDouble(index + 48);
        float _c7 = (float) buf.getDouble(index + 56);
        return new Float4x2(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public FloatBuffer storeRMAbsolute(Float4x2 self, int index, FloatBuffer buf) {
        buf.put(index + 0, self.m00());
    ...
    public Float4x2 loadRMAbsolute(int index, FloatBuffer buf) {
        float _c0 = buf.get(index + 0);
    ...
    public ByteBuffer storeRMAbsolute(Float4x2 self, int index, ByteBuffer buf) {
        buf.putFloat(index + 0, self.m00());
    ...
    public DoubleBuffer storeRMAbsolute(Float4x2 self, int index, DoubleBuffer buf) {
        buf.put(index + 0, self.m00());
        buf.put(index + 1, self.m01());
        buf.put(index + 2, self.m10());
        buf.put(index + 3, self.m11());
    ...
    public Float4x2 loadRMAbsolute(int index, DoubleBuffer buf) {
        float _c0 = (float) buf.get(index + 0);
    ...
    public ByteBuffer storeRMDoubleAbsolute(Float4x2 self, int index, ByteBuffer buf) {
        buf.putDouble(index + 0, self.m00());
    ...
    public FloatBuffer storeCMAbsolute(Float4x2 self, int index, FloatBuffer buf, int stride) {
    ...
    public Float4x2 loadCMAbsolute(int index, FloatBuffer buf, int stride) {
        int _p1 = index + stride;
    ...
    public ByteBuffer storeCMAbsolute(Float4x2 self, int index, ByteBuffer buf, int stride) {
        int _ps = stride * 4;
        int _p1 = index + _ps;
    ...
    public DoubleBuffer storeCMAbsolute(Float4x2 self, int index, DoubleBuffer buf, int stride) {
        int _p1 = index + stride;
        buf.put(index, self.m00());
        buf.put(index + 1, self.m10());
        buf.put(index + 2, self.m20());
    ...
    public Float4x2 loadCMAbsolute(int index, DoubleBuffer buf, int stride) {
        int _p1 = index + stride;
    ...
    public ByteBuffer storeCMDoubleAbsolute(Float4x2 self, int index, ByteBuffer buf, int stride) {
        int _ps = stride * 8;
        int _p1 = index + _ps;
    ...
    public FloatBuffer storeRMAbsolute(Float4x2 self, int index, FloatBuffer buf, int stride) {
        int _p1 = index + stride;
        int _p2 = _p1 + stride;
        int _p3 = _p2 + stride;
        buf.put(index, self.m00());
    ...
    public Float4x2 loadRMAbsolute(int index, FloatBuffer buf, int stride) {
        int _p1 = index + stride;
        int _p2 = _p1 + stride;
        int _p3 = _p2 + stride;
        float _c0 = buf.get(index);
        ...
        float _c6 = buf.get(_p3);
        float _c7 = buf.get(_p3 + 1);
        return new Float4x2(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public ByteBuffer storeRMAbsolute(Float4x2 self, int index, ByteBuffer buf, int stride) {
        int _ps = stride * 4;
        int _p1 = index + _ps;
        int _p2 = _p1 + _ps;
        int _p3 = _p2 + _ps;
    ...
    public Float4x2 loadRMAbsolute(int index, ByteBuffer buf, int stride) {
        ...
        float _c6 = buf.getFloat(_p3);
        float _c7 = buf.getFloat(_p3 + 4);
        return new Float4x2(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public DoubleBuffer storeRMAbsolute(Float4x2 self, int index, DoubleBuffer buf, int stride) {
        int _p1 = index + stride;
        int _p2 = _p1 + stride;
        int _p3 = _p2 + stride;
        buf.put(index, self.m00());
    ...
    public Float4x2 loadRMAbsolute(int index, DoubleBuffer buf, int stride) {
        int _p1 = index + stride;
        int _p2 = _p1 + stride;
        int _p3 = _p2 + stride;
        float _c0 = (float) buf.get(index);
        ...
        float _c6 = (float) buf.get(_p3);
        float _c7 = (float) buf.get(_p3 + 1);
        return new Float4x2(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7);
    }
    public ByteBuffer storeRMDoubleAbsolute(Float4x2 self, int index, ByteBuffer buf, int stride) {
        int _ps = stride * 8;
        int _p1 = index + _ps;
        int _p2 = _p1 + _ps;
        int _p3 = _p2 + _ps;
    ...
    public Float4x2 loadRMDoubleAbsolute(int index, ByteBuffer buf, int stride) {
        ...
        float _c6 = (float) buf.getDouble(_p3);
