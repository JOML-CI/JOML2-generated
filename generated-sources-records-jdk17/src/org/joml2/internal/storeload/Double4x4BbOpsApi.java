...
public final class Double4x4BbOpsApi implements Double4x4BbOps {
    ...
    public Double4x4 loadCMAbsolute(int index, DoubleBuffer buf) {
        ...
        double _c12 = buf.get(index + 3);
        double _c1 = buf.get(index + 4);
        double _c5 = buf.get(index + 5);
        double _c9 = buf.get(index + 6);
        double _c13 = buf.get(index + 7);
        double _c2 = buf.get(index + 8);
        double _c6 = buf.get(index + 9);
        double _c10 = buf.get(index + 10);
        double _c14 = buf.get(index + 11);
        double _c3 = buf.get(index + 12);
        double _c7 = buf.get(index + 13);
        double _c11 = buf.get(index + 14);
        double _c15 = buf.get(index + 15);
    ...
    public Double4x4 loadCMAbsolute(int index, ByteBuffer buf) {
        ...
        double _c12 = buf.getDouble(index + 24);
        double _c1 = buf.getDouble(index + 32);
        double _c5 = buf.getDouble(index + 40);
        double _c9 = buf.getDouble(index + 48);
        double _c13 = buf.getDouble(index + 56);
        double _c2 = buf.getDouble(index + 64);
        double _c6 = buf.getDouble(index + 72);
        double _c10 = buf.getDouble(index + 80);
        double _c14 = buf.getDouble(index + 88);
        double _c3 = buf.getDouble(index + 96);
        double _c7 = buf.getDouble(index + 104);
        double _c11 = buf.getDouble(index + 112);
        double _c15 = buf.getDouble(index + 120);
        return new Double4x4(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7, _c8, _c9, _c10, _c11, _c12, _c13, _c14, _c15);
    }
    public FloatBuffer storeCMAbsolute(Double4x4 self, int index, FloatBuffer buf) {
        ...
        buf.put(index + 15, (float) self.m33());
        return buf;
    }
    ...
    public ByteBuffer storeCMFloatAbsolute(Double4x4 self, int index, ByteBuffer buf) {
        ...
        buf.putFloat(index + 60, (float) self.m33());
        return buf;
    }
    public Double4x4 loadCMFloatAbsolute(int index, ByteBuffer buf) {
        ...
        double _c12 = buf.getFloat(index + 12);
        double _c1 = buf.getFloat(index + 16);
        double _c5 = buf.getFloat(index + 20);
        double _c9 = buf.getFloat(index + 24);
        double _c13 = buf.getFloat(index + 28);
        double _c2 = buf.getFloat(index + 32);
        double _c6 = buf.getFloat(index + 36);
        double _c10 = buf.getFloat(index + 40);
        double _c14 = buf.getFloat(index + 44);
        double _c3 = buf.getFloat(index + 48);
        double _c7 = buf.getFloat(index + 52);
        double _c11 = buf.getFloat(index + 56);
        double _c15 = buf.getFloat(index + 60);
        return new Double4x4(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7, _c8, _c9, _c10, _c11, _c12, _c13, _c14, _c15);
    }
    ...
    public FloatBuffer storeRMAbsolute(Double4x4 self, int index, FloatBuffer buf) {
        ...
        buf.put(index + 12, (float) self.m30());
        buf.put(index + 13, (float) self.m31());
        buf.put(index + 14, (float) self.m32());
        buf.put(index + 15, (float) self.m33());
        return buf;
    }
    ...
    public ByteBuffer storeRMFloatAbsolute(Double4x4 self, int index, ByteBuffer buf) {
        ...
        buf.putFloat(index + 48, (float) self.m30());
        buf.putFloat(index + 52, (float) self.m31());
        buf.putFloat(index + 56, (float) self.m32());
        buf.putFloat(index + 60, (float) self.m33());
        return buf;
    }
    ...
    public ByteBuffer storeCMFloatAbsolute(Double4x4 self, int index, ByteBuffer buf, int stride) {
        ...
        buf.putFloat(_p3 + 12, (float) self.m33());
        return buf;
    }
    ...
    public Double4x4 loadRMAbsolute(int index, DoubleBuffer buf, int stride) {
        ...
        double _c12 = buf.get(_p3);
        double _c13 = buf.get(_p3 + 1);
        double _c14 = buf.get(_p3 + 2);
        double _c15 = buf.get(_p3 + 3);
        return new Double4x4(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7, _c8, _c9, _c10, _c11, _c12, _c13, _c14, _c15);
    }
    ...
    public Double4x4 loadRMAbsolute(int index, ByteBuffer buf, int stride) {
        ...
        double _c12 = buf.getDouble(_p3);
        double _c13 = buf.getDouble(_p3 + 8);
        double _c14 = buf.getDouble(_p3 + 16);
        double _c15 = buf.getDouble(_p3 + 24);
        return new Double4x4(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7, _c8, _c9, _c10, _c11, _c12, _c13, _c14, _c15);
    }
    ...
    public Double4x4 loadRMFloatAbsolute(int index, ByteBuffer buf, int stride) {
        ...
        double _c12 = buf.getFloat(_p3);
        double _c13 = buf.getFloat(_p3 + 4);
        double _c14 = buf.getFloat(_p3 + 8);
        double _c15 = buf.getFloat(_p3 + 12);
        return new Double4x4(_c0, _c1, _c2, _c3, _c4, _c5, _c6, _c7, _c8, _c9, _c10, _c11, _c12, _c13, _c14, _c15);
    }
}
