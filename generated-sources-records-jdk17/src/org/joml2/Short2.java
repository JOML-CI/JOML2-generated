...
/**
 * Immutable 2D vector of {@code short} components.
 * <p>
 ...
 */
public record Short2(short x, short y) {
    ...
    public Short2 ceilDiv(short otherX, short otherY) {
        return new Short2((short) (Math.ceilDiv(this.x, otherX)), (short) (Math.ceilDiv(this.y, otherY)));
    }
    ...
    public Short2 ceilMod(short otherX, short otherY) {
        return new Short2((short) (Math.ceilMod(this.x, otherX)), (short) (Math.ceilMod(this.y, otherY)));
    }
     ...
     */
    public long cross(Short2 other) {
     ...
     */
    public long distanceSquared(Short2 other) {
     ...
     */
    public int manhattanDistance(Short2 other) {
