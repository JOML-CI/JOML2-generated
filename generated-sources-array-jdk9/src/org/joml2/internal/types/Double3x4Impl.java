...
public class Double3x4Impl implements Double3x4 {
    ...
    @Mutated public Double3x4 makeFromTransform(double tTX, double tTY, double tTZ, double tRX, double tRY, double tRZ, double tRW, double tSX, double tSY, double tSZ) {
        ...
        dd[1] = Math.fma(tRX, tRY, -_t4) * _t1;
        dd[2] = Math.fma(tRX, tRZ, _t5) * _t2;
        dd[3] = tTX;
        dd[4] = Math.fma(tRX, tRY, _t4) * _t0;
        dd[5] = Math.fma(-Math.fma(tRX, tRX, _t3), _t1, tSY);
        dd[6] = Math.fma(tRY, tRZ, -(tRX * tRW)) * _t2;
        dd[7] = tTY;
        dd[8] = Math.fma(tRX, tRZ, -_t5) * _t0;
        dd[9] = Math.fma(tRX, tRW, tRY * tRZ) * _t1;
        dd[10] = Math.fma(-Math.fma(tRX, tRX, tRY * tRY), _t2, tSZ);
        dd[11] = tTZ;
    ...
    @Mutated public Double3x4 composeTRS(double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ) {
        ...
        dd[0] = Math.fma(-Math.fma(rotationY, rotationY, _t3), _t0, scaleX);
        dd[1] = Math.fma(rotationX, rotationY, -_t4) * _t1;
        dd[2] = Math.fma(rotationX, rotationZ, _t5) * _t2;
        dd[3] = translationX;
        dd[4] = Math.fma(rotationX, rotationY, _t4) * _t0;
        dd[5] = Math.fma(-Math.fma(rotationX, rotationX, _t3), _t1, scaleY);
        dd[6] = Math.fma(rotationY, rotationZ, -(rotationX * rotationW)) * _t2;
        dd[7] = translationY;
        dd[8] = Math.fma(rotationX, rotationZ, -_t5) * _t0;
        dd[9] = Math.fma(rotationX, rotationW, rotationY * rotationZ) * _t1;
        dd[10] = Math.fma(-Math.fma(rotationX, rotationX, rotationY * rotationY), _t2, scaleZ);
        dd[11] = translationZ;
        ((Double3x4Impl) this).properties = Joml.BIT_AFFINE;
        return this;
    }
    ...
    @Mutated public Double3x4 composeTRSMul(double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ, Double3x4R m) {
        ...
        double _buf0 = Math.fma(mData[8], _t24, Math.fma(mData[0], _t30, mData[4] * _t27));
        double _buf1 = Math.fma(mData[9], _t24, Math.fma(mData[1], _t30, mData[5] * _t27));
        double _buf2 = Math.fma(mData[10], _t24, Math.fma(mData[2], _t30, mData[6] * _t27));
        double _buf3 = Math.fma(mData[3], _t30, Math.fma(mData[7], _t27, Math.fma(mData[11], _t24, translationX)));
        double _buf4 = Math.fma(mData[8], _t28, Math.fma(mData[0], _t25, mData[4] * _t31));
        double _buf5 = Math.fma(mData[9], _t28, Math.fma(mData[1], _t25, mData[5] * _t31));
        double _buf6 = Math.fma(mData[10], _t28, Math.fma(mData[2], _t25, mData[6] * _t31));
        double _buf7 = Math.fma(mData[3], _t25, Math.fma(mData[7], _t31, Math.fma(mData[11], _t28, translationY)));
        dd[8] = Math.fma(mData[8], _t32, Math.fma(mData[0], _t29, mData[4] * _t26));
        dd[9] = Math.fma(mData[9], _t32, Math.fma(mData[1], _t29, mData[5] * _t26));
        dd[10] = Math.fma(mData[10], _t32, Math.fma(mData[2], _t29, mData[6] * _t26));
        dd[11] = Math.fma(mData[3], _t29, Math.fma(mData[7], _t26, Math.fma(mData[11], _t32, translationZ)));
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[3] = _buf3;
    ...
    @Mutated public Double3x4 makeRotationAxis(double angle, double axisX, double axisY, double axisZ) {
        ...
        dd[1] = Math.fma(_t5, _t2, -(axisZ * _t0));
        dd[2] = Math.fma(axisY, _t0, _t5 * _t3);
        dd[3] = 0.0;
        dd[4] = Math.fma(axisZ, _t0, _t5 * _t2);
        dd[5] = Math.fma(_t5, axisY * axisY, _t1);
        dd[6] = Math.fma(_t5, _t4, -(axisX * _t0));
        dd[7] = 0.0;
        dd[8] = Math.fma(_t5, _t3, -(axisY * _t0));
        dd[9] = Math.fma(axisX, _t0, _t5 * _t4);
        dd[10] = Math.fma(_t5, axisZ * axisZ, _t1);
        dd[11] = 0.0;
        ((Double3x4Impl) this).properties = Joml.BIT_ORTHOGONAL;
        return this;
    }
    ...
    @Mutated public Double3x4 makeRotationXYZ(double angleX, double angleY, double angleZ) {
        ...
        dd[2] = _t0;
        dd[3] = 0.0;
        dd[4] = Math.fma(_t6, _t4, _t1 * _t5);
        dd[5] = Math.fma(_t5, _t4, -(_t6 * _t1));
        dd[6] = -(_t2 * _t3);
        dd[7] = 0.0;
        dd[8] = Math.fma(_t2, _t1, -(_t7 * _t4));
        dd[9] = Math.fma(_t7, _t1, _t2 * _t4);
        dd[10] = _t5 * _t3;
        dd[11] = 0.0;
        ((Double3x4Impl) this).properties = Joml.BIT_ORTHOGONAL;
        return this;
    ...
    @Mutated public Double3x4 makeRotationXZY(double angleX, double angleZ, double angleY) {
        ...
        dd[2] = _t0 * _t4;
        dd[3] = 0.0;
        dd[4] = Math.fma(_t7, _t3, _t2 * _t0);
        dd[5] = _t5 * _t4;
        dd[6] = Math.fma(_t7, _t0, -(_t2 * _t3));
        dd[7] = 0.0;
        dd[8] = Math.fma(_t6, _t3, -(_t0 * _t5));
        dd[9] = _t2 * _t4;
        dd[10] = Math.fma(_t6, _t0, _t5 * _t3);
        dd[11] = 0.0;
        ((Double3x4Impl) this).properties = Joml.BIT_ORTHOGONAL;
        return this;
    }
    ...
    @Mutated public Double3x4 makeRotationYZX(double angleY, double angleZ, double angleX) {
        ...
        double _t7 = _t1 * _t3;
        dd[0] = _t3 * _t4;
        dd[1] = Math.fma(_t2, _t0, -(_t7 * _t5));
        dd[2] = Math.fma(_t7, _t2, _t0 * _t5);
        dd[3] = 0.0;
        dd[4] = _t1;
        dd[5] = _t5 * _t4;
        dd[6] = -(_t2 * _t4);
        dd[7] = 0.0;
        dd[8] = -(_t0 * _t4);
        dd[9] = Math.fma(_t6, _t5, _t2 * _t3);
        dd[10] = Math.fma(_t5, _t3, -(_t6 * _t2));
        dd[11] = 0.0;
        ((Double3x4Impl) this).properties = Joml.BIT_ORTHOGONAL;
        return this;
    }
    ...
    @Mutated public Double3x4 makeRotationZXY(double angleZ, double angleX, double angleY) {
        ...
        dd[1] = -(_t1 * _t5);
        dd[2] = Math.fma(_t6, _t3, _t0 * _t4);
        dd[3] = 0.0;
        dd[4] = Math.fma(_t7, _t0, _t1 * _t3);
        dd[5] = _t5 * _t4;
        dd[6] = Math.fma(_t0, _t1, -(_t7 * _t3));
        dd[7] = 0.0;
        dd[8] = -(_t0 * _t5);
        dd[9] = _t2;
        dd[10] = _t5 * _t3;
    ...
    @Mutated public Double3x4 makeRotationZYX(double angleZ, double angleY, double angleX) {
        ...
        double _t7 = _t0 * _t4;
        dd[0] = _t3 * _t4;
        dd[1] = Math.fma(_t7, _t2, -(_t1 * _t5));
        dd[2] = Math.fma(_t7, _t5, _t2 * _t1);
        dd[3] = 0.0;
        dd[4] = _t1 * _t3;
        dd[5] = Math.fma(_t6, _t2, _t5 * _t4);
        dd[6] = Math.fma(_t6, _t5, -(_t2 * _t4));
        dd[7] = 0.0;
        dd[8] = -_t0;
        dd[9] = _t2 * _t3;
        dd[10] = _t5 * _t3;
    ...
    private Double3x4 preRotateAround_identity(double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ, @Mutated Double3x4 dest) {
        ...
        dd[0] = Math.fma(_t0, _t4, _t14);
        dd[1] = _t18;
        dd[2] = _t15;
        dd[3] = Math.fma(_t2, _t15, Math.fma(pivotX, Math.fma(rotY, _t4, _t9), -(pivotY * _t18)));
        dd[4] = _t16;
        dd[5] = Math.fma(_t3, _t6, _t14);
        dd[6] = _t19;
        dd[7] = Math.fma(_t2, _t19, Math.fma(pivotY, Math.fma(rotX, _t6, _t9), -(pivotX * _t16)));
        dd[8] = _t20;
        dd[9] = _t17;
        dd[10] = Math.fma(_t3, _t6, Math.fma(_t0, _t4, 1.0));
        dd[11] = Math.fma(-pivotY, _t17, Math.fma(pivotZ, Math.fma(rotX, _t6, rotY * _t4), -(pivotX * _t20)));
        ((Double3x4Impl) dest).properties = Joml.BIT_ORTHOGONAL;
        return dest;
    }
    ...
    private Double3x4 preRotateAround_translation(double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ, @Mutated Double3x4 dest) {
        ...
        dd[1] = _t19;
        dd[2] = _t16;
        double _buf0 = Math.fma(sd[11], _t16, Math.fma(sd[3], _t22, sd[7] * _t19)) + Math.fma(_t2, _t16, Math.fma(pivotX, Math.fma(rotY, _t4, _t9), -(pivotY * _t19)));
        dd[4] = _t17;
        dd[5] = _t23;
        dd[6] = _t20;
        double _buf1 = Math.fma(sd[11], _t20, Math.fma(sd[3], _t17, sd[7] * _t23)) + Math.fma(_t2, _t20, Math.fma(pivotY, Math.fma(rotX, _t6, _t9), -(pivotX * _t17)));
        dd[8] = _t21;
        dd[9] = _t18;
        dd[10] = _t24;
        dd[11] = Math.fma(sd[11], _t24, Math.fma(sd[3], _t21, sd[7] * _t18)) + Math.fma(-pivotY, _t18, Math.fma(pivotZ, Math.fma(rotX, _t6, rotY * _t4), -(pivotX * _t21)));
        dd[3] = _buf0;
        dd[7] = _buf1;
        ((Double3x4Impl) dest).properties = Joml.BIT_ORTHOGONAL;
        return dest;
    ...
    private Double3x4 preRotateAround_orthogonal(double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ, @Mutated Double3x4 dest) {
        ...
        double _buf0 = Math.fma(sd[8], _t16, Math.fma(sd[0], _t22, sd[4] * _t19));
        double _buf1 = Math.fma(sd[9], _t16, Math.fma(sd[1], _t22, sd[5] * _t19));
        double _buf2 = Math.fma(sd[10], _t16, Math.fma(sd[2], _t22, sd[6] * _t19));
        double _buf3 = Math.fma(sd[11], _t16, Math.fma(sd[3], _t22, sd[7] * _t19)) + Math.fma(_t2, _t16, Math.fma(pivotX, Math.fma(rotY, _t5, _t9), -(pivotY * _t19)));
        double _buf4 = Math.fma(sd[8], _t20, Math.fma(sd[0], _t17, sd[4] * _t23));
        double _buf5 = Math.fma(sd[9], _t20, Math.fma(sd[1], _t17, sd[5] * _t23));
        double _buf6 = Math.fma(sd[10], _t20, Math.fma(sd[2], _t17, sd[6] * _t23));
        double _buf7 = Math.fma(sd[11], _t20, Math.fma(sd[3], _t17, sd[7] * _t23)) + Math.fma(_t2, _t20, Math.fma(pivotY, Math.fma(rotX, _t4, _t9), -(pivotX * _t17)));
        dd[8] = Math.fma(sd[8], _t24, Math.fma(sd[0], _t21, sd[4] * _t18));
        dd[9] = Math.fma(sd[9], _t24, Math.fma(sd[1], _t21, sd[5] * _t18));
        dd[10] = Math.fma(sd[10], _t24, Math.fma(sd[2], _t21, sd[6] * _t18));
        dd[11] = Math.fma(sd[11], _t24, Math.fma(sd[3], _t21, sd[7] * _t18)) + Math.fma(-pivotY, _t18, Math.fma(pivotZ, Math.fma(rotX, _t4, rotY * _t5), -(pivotX * _t21)));
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[3] = _buf3;
    ...
    private Double3x4 preRotateQuat_identity(double qX, double qY, double qZ, double qW, @Mutated Double3x4 dest) {
        ...
        dd[0] = Math.fma(_t0, _t3, _t9);
        dd[1] = Math.fma(qY, _t5, -_t6);
        dd[2] = Math.fma(qZ, _t5, _t7);
        dd[3] = 0.0;
        dd[4] = Math.fma(qY, _t5, _t6);
        dd[5] = Math.fma(_t2, _t5, _t9);
        dd[6] = Math.fma(qZ, _t3, -_t8);
        dd[7] = 0.0;
        dd[8] = Math.fma(qZ, _t5, -_t7);
        dd[9] = Math.fma(qZ, _t3, _t8);
        dd[10] = Math.fma(_t2, _t5, Math.fma(_t0, _t3, 1.0));
        dd[11] = 0.0;
        ((Double3x4Impl) dest).properties = Joml.BIT_ORTHOGONAL;
        return dest;
    }
    ...
    private Double3x4 preRotateQuat_translation(double qX, double qY, double qZ, double qW, @Mutated Double3x4 dest) {
        ...
        dd[1] = _t17;
        dd[2] = _t14;
        double _buf0 = Math.fma(sd[11], _t14, Math.fma(sd[3], _t20, sd[7] * _t17));
        dd[4] = _t15;
        dd[5] = _t21;
        dd[6] = _t18;
        double _buf1 = Math.fma(sd[11], _t18, Math.fma(sd[3], _t15, sd[7] * _t21));
        dd[8] = _t19;
        dd[9] = _t16;
        dd[10] = _t22;
        dd[11] = Math.fma(sd[11], _t22, Math.fma(sd[3], _t19, sd[7] * _t16));
        dd[3] = _buf0;
        dd[7] = _buf1;
        ((Double3x4Impl) dest).properties = Joml.BIT_ORTHOGONAL;
        return dest;
    ...
    private Double3x4 preRotateQuat_orthogonal(double qX, double qY, double qZ, double qW, @Mutated Double3x4 dest) {
        ...
        double _buf0 = Math.fma(sd[8], _t14, Math.fma(sd[0], _t20, sd[4] * _t17));
        double _buf1 = Math.fma(sd[9], _t14, Math.fma(sd[1], _t20, sd[5] * _t17));
        double _buf2 = Math.fma(sd[10], _t14, Math.fma(sd[2], _t20, sd[6] * _t17));
        double _buf3 = Math.fma(sd[11], _t14, Math.fma(sd[3], _t20, sd[7] * _t17));
        double _buf4 = Math.fma(sd[8], _t18, Math.fma(sd[0], _t15, sd[4] * _t21));
        double _buf5 = Math.fma(sd[9], _t18, Math.fma(sd[1], _t15, sd[5] * _t21));
        double _buf6 = Math.fma(sd[10], _t18, Math.fma(sd[2], _t15, sd[6] * _t21));
        double _buf7 = Math.fma(sd[11], _t18, Math.fma(sd[3], _t15, sd[7] * _t21));
        dd[8] = Math.fma(sd[8], _t22, Math.fma(sd[0], _t19, sd[4] * _t16));
        dd[9] = Math.fma(sd[9], _t22, Math.fma(sd[1], _t19, sd[5] * _t16));
        dd[10] = Math.fma(sd[10], _t22, Math.fma(sd[2], _t19, sd[6] * _t16));
        dd[11] = Math.fma(sd[11], _t22, Math.fma(sd[3], _t19, sd[7] * _t16));
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
    ...
    private Double3x4 preRotateX_orthogonal_general(double angle, @Mutated Double3x4 dest, int _props) {
        ...
        dd[2] = sd[2];
        dd[3] = sd[3];
        double _buf0 = Math.fma(sd[4], _t1, -(sd[8] * _t0));
        double _buf1 = Math.fma(sd[5], _t1, -(sd[9] * _t0));
        double _buf2 = Math.fma(sd[6], _t1, -(sd[10] * _t0));
        double _buf3 = Math.fma(sd[7], _t1, -(sd[11] * _t0));
        dd[8] = Math.fma(sd[4], _t0, sd[8] * _t1);
        dd[9] = Math.fma(sd[5], _t0, sd[9] * _t1);
        dd[10] = Math.fma(sd[6], _t0, sd[10] * _t1);
        dd[11] = Math.fma(sd[7], _t0, sd[11] * _t1);
        dd[4] = _buf0;
        dd[5] = _buf1;
        dd[6] = _buf2;
        dd[7] = _buf3;
    ...
    private Double3x4 preRotateX_translation(double angle, @Mutated Double3x4 dest) {
        ...
        dd[5] = _t1;
        dd[6] = -_t0;
        double _buf0 = Math.fma(sd[7], _t1, -(sd[11] * _t0));
        dd[8] = 0.0;
        dd[9] = _t0;
        dd[10] = _t1;
        dd[11] = Math.fma(sd[7], _t0, sd[11] * _t1);
    ...
    private Double3x4 preRotateY_orthogonal_general(double angle, @Mutated Double3x4 dest, int _props) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _buf0 = Math.fma(sd[0], _t1, sd[8] * _t0);
        double _buf1 = Math.fma(sd[1], _t1, sd[9] * _t0);
        double _buf2 = Math.fma(sd[2], _t1, sd[10] * _t0);
        double _buf3 = Math.fma(sd[3], _t1, sd[11] * _t0);
        dd[4] = sd[4];
        dd[5] = sd[5];
        dd[6] = sd[6];
        dd[7] = sd[7];
        dd[8] = Math.fma(sd[8], _t1, -(sd[0] * _t0));
        dd[9] = Math.fma(sd[9], _t1, -(sd[1] * _t0));
        dd[10] = Math.fma(sd[10], _t1, -(sd[2] * _t0));
        dd[11] = Math.fma(sd[11], _t1, -(sd[3] * _t0));
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[3] = _buf3;
    ...
    private Double3x4 preRotateY_translation(double angle, @Mutated Double3x4 dest) {
        ...
        dd[1] = 0.0;
        dd[2] = _t0;
        double _buf0 = Math.fma(sd[3], _t1, sd[11] * _t0);
        dd[4] = 0.0;
        dd[5] = 1.0;
        dd[6] = 0.0;
        dd[7] = sd[7];
    ...
    private Double3x4 preRotateZ_orthogonal_general(double angle, @Mutated Double3x4 dest, int _props) {
        ...
        double _t0 = Math.sin(angle);
        double _t1 = Math.cosFromSin(_t0, angle);
        double _buf0 = Math.fma(sd[0], _t1, -(sd[4] * _t0));
        double _buf1 = Math.fma(sd[1], _t1, -(sd[5] * _t0));
        double _buf2 = Math.fma(sd[2], _t1, -(sd[6] * _t0));
        double _buf3 = Math.fma(sd[3], _t1, -(sd[7] * _t0));
        dd[4] = Math.fma(sd[0], _t0, sd[4] * _t1);
        dd[5] = Math.fma(sd[1], _t0, sd[5] * _t1);
        dd[6] = Math.fma(sd[2], _t0, sd[6] * _t1);
        dd[7] = Math.fma(sd[3], _t0, sd[7] * _t1);
        dd[8] = sd[8];
        dd[9] = sd[9];
        dd[10] = sd[10];
        dd[11] = sd[11];
    ...
    private Double3x4 preRotateZ_translation(double angle, @Mutated Double3x4 dest) {
        ...
        dd[1] = -_t0;
        dd[2] = 0.0;
        double _buf0 = Math.fma(sd[3], _t1, -(sd[7] * _t0));
        dd[4] = _t0;
        dd[5] = _t1;
        dd[6] = 0.0;
        dd[7] = Math.fma(sd[3], _t0, sd[7] * _t1);
    ...
    private Double3x4 rotateAround_translation(double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ, @Mutated Double3x4 dest) {
        ...
        dd[0] = Math.fma(_t0, _t6, _t16);
        dd[1] = _t20;
        dd[2] = _t17;
        dd[3] = Math.fma(pivotX, Math.fma(rotY, _t6, _t11), Math.fma(_t2, _t20, Math.fma(_t3, _t17, sd[3])));
        dd[4] = _t18;
        dd[5] = Math.fma(_t4, _t8, _t16);
        dd[6] = _t21;
        dd[7] = Math.fma(pivotY, Math.fma(rotX, _t8, _t11), Math.fma(_t5, _t18, Math.fma(_t3, _t21, sd[7])));
        dd[8] = _t22;
        dd[9] = _t19;
        dd[10] = Math.fma(_t4, _t8, Math.fma(_t0, _t6, 1.0));
        dd[11] = Math.fma(pivotZ, Math.fma(rotX, _t8, rotY * _t6), Math.fma(_t5, _t22, Math.fma(_t2, _t19, sd[11])));
        ((Double3x4Impl) dest).properties = Joml.BIT_ORTHOGONAL;
        return dest;
    }
    ...
    private Double3x4 rotateAround_orthogonal(double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ, @Mutated Double3x4 dest) {
        ...
        double _buf0 = Math.fma(sd[2], _t24, Math.fma(sd[0], _t27, sd[1] * _t18));
        double _buf1 = Math.fma(sd[2], _t19, Math.fma(sd[0], _t25, sd[1] * _t28));
        double _buf2 = Math.fma(sd[2], _t29, Math.fma(sd[0], _t20, sd[1] * _t26));
        dd[3] = Math.fma(sd[0], _t39, Math.fma(sd[1], _t40, Math.fma(sd[2], _t41, sd[3])));
        double _buf3 = Math.fma(sd[6], _t24, Math.fma(sd[4], _t27, sd[5] * _t18));
        double _buf4 = Math.fma(sd[6], _t19, Math.fma(sd[4], _t25, sd[5] * _t28));
        double _buf5 = Math.fma(sd[6], _t29, Math.fma(sd[4], _t20, sd[5] * _t26));
        dd[7] = Math.fma(sd[4], _t39, Math.fma(sd[5], _t40, Math.fma(sd[6], _t41, sd[7])));
        double _buf6 = Math.fma(sd[10], _t24, Math.fma(sd[8], _t27, sd[9] * _t18));
        double _buf7 = Math.fma(sd[10], _t19, Math.fma(sd[8], _t25, sd[9] * _t28));
        double _buf8 = Math.fma(sd[10], _t29, Math.fma(sd[8], _t20, sd[9] * _t26));
        dd[11] = Math.fma(sd[8], _t39, Math.fma(sd[9], _t40, Math.fma(sd[10], _t41, sd[11])));
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[4] = _buf3;
    ...
    private Double3x4 rotateQuat_orthogonal(double qX, double qY, double qZ, double qW, @Mutated Double3x4 dest) {
        ...
        double _t21 = Math.fma(_t2, _t3, _t12);
        double _t22 = Math.fma(_t2, _t3, Math.fma(_t0, _t4, 1.0));
        double _buf0 = Math.fma(sd[2], _t17, Math.fma(sd[0], _t20, sd[1] * _t14));
        double _buf1 = Math.fma(sd[2], _t15, Math.fma(sd[0], _t18, sd[1] * _t21));
        dd[2] = Math.fma(sd[2], _t22, Math.fma(sd[0], _t16, sd[1] * _t19));
        dd[3] = sd[3];
        double _buf2 = Math.fma(sd[6], _t17, Math.fma(sd[4], _t20, sd[5] * _t14));
        double _buf3 = Math.fma(sd[6], _t15, Math.fma(sd[4], _t18, sd[5] * _t21));
        dd[6] = Math.fma(sd[6], _t22, Math.fma(sd[4], _t16, sd[5] * _t19));
        dd[7] = sd[7];
        double _buf4 = Math.fma(sd[10], _t17, Math.fma(sd[8], _t20, sd[9] * _t14));
        double _buf5 = Math.fma(sd[10], _t15, Math.fma(sd[8], _t18, sd[9] * _t21));
        dd[10] = Math.fma(sd[10], _t22, Math.fma(sd[8], _t16, sd[9] * _t19));
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[4] = _buf2;
    ...
    private Double3x4 rotateX_orthogonal_general(double angle, @Mutated Double3x4 dest, int _props) {
        ...
        dd[2] = Math.fma(sd[2], _t1, -(sd[1] * _t0));
        dd[3] = sd[3];
        dd[4] = sd[4];
        double _buf1 = Math.fma(sd[5], _t1, sd[6] * _t0);
        dd[6] = Math.fma(sd[6], _t1, -(sd[5] * _t0));
        dd[7] = sd[7];
        dd[8] = sd[8];
        double _buf2 = Math.fma(sd[9], _t1, sd[10] * _t0);
        dd[10] = Math.fma(sd[10], _t1, -(sd[9] * _t0));
        dd[11] = sd[11];
        dd[1] = _buf0;
        dd[5] = _buf1;
        dd[9] = _buf2;
    ...
    private Double3x4 rotateXYZ_orthogonal_general(double angleX, double angleY, double angleZ, @Mutated Double3x4 dest, int _props) {
        ...
        double _buf0 = Math.fma(sd[2], _t20, Math.fma(sd[0], _t13, sd[1] * _t18));
        double _buf1 = Math.fma(sd[2], _t19, Math.fma(sd[1], _t21, -(sd[0] * _t10)));
        dd[2] = Math.fma(sd[2], _t15, Math.fma(sd[0], _t2, -(sd[1] * _t11)));
        dd[3] = sd[3];
        double _buf2 = Math.fma(sd[6], _t20, Math.fma(sd[4], _t13, sd[5] * _t18));
        double _buf3 = Math.fma(sd[6], _t19, Math.fma(sd[5], _t21, -(sd[4] * _t10)));
        dd[6] = Math.fma(sd[6], _t15, Math.fma(sd[4], _t2, -(sd[5] * _t11)));
        dd[7] = sd[7];
        double _buf4 = Math.fma(sd[10], _t20, Math.fma(sd[8], _t13, sd[9] * _t18));
        double _buf5 = Math.fma(sd[10], _t19, Math.fma(sd[9], _t21, -(sd[8] * _t10)));
        dd[10] = Math.fma(sd[10], _t15, Math.fma(sd[8], _t2, -(sd[9] * _t11)));
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[4] = _buf2;
    ...
    private Double3x4 rotateXZY_orthogonal_general(double angleX, double angleZ, double angleY, @Mutated Double3x4 dest, int _props) {
        ...
        double _buf0 = Math.fma(sd[2], _t20, Math.fma(sd[0], _t15, sd[1] * _t18));
        double _buf1 = Math.fma(sd[2], _t10, Math.fma(sd[1], _t16, -(sd[0] * _t1)));
        dd[2] = Math.fma(sd[2], _t19, Math.fma(sd[0], _t11, sd[1] * _t21));
        dd[3] = sd[3];
        double _buf2 = Math.fma(sd[6], _t20, Math.fma(sd[4], _t15, sd[5] * _t18));
        double _buf3 = Math.fma(sd[6], _t10, Math.fma(sd[5], _t16, -(sd[4] * _t1)));
        dd[6] = Math.fma(sd[6], _t19, Math.fma(sd[4], _t11, sd[5] * _t21));
        dd[7] = sd[7];
        double _buf4 = Math.fma(sd[10], _t20, Math.fma(sd[8], _t15, sd[9] * _t18));
        double _buf5 = Math.fma(sd[10], _t10, Math.fma(sd[9], _t16, -(sd[8] * _t1)));
        dd[10] = Math.fma(sd[10], _t19, Math.fma(sd[8], _t11, sd[9] * _t21));
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[4] = _buf2;
    ...
    private Double3x4 rotateY_orthogonal_general(double angle, @Mutated Double3x4 dest, int _props) {
        ...
        dd[1] = sd[1];
        dd[2] = Math.fma(sd[0], _t0, sd[2] * _t1);
        dd[3] = sd[3];
        double _buf1 = Math.fma(sd[4], _t1, -(sd[6] * _t0));
        dd[5] = sd[5];
        dd[6] = Math.fma(sd[4], _t0, sd[6] * _t1);
        dd[7] = sd[7];
        double _buf2 = Math.fma(sd[8], _t1, -(sd[10] * _t0));
        dd[9] = sd[9];
        dd[10] = Math.fma(sd[8], _t0, sd[10] * _t1);
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[4] = _buf1;
        dd[8] = _buf2;
    ...
    private Double3x4 rotateYXZ_orthogonal_general(double angleY, double angleX, double angleZ, @Mutated Double3x4 dest, int _props) {
        ...
        double _buf1 = Math.fma(sd[2], _t19, Math.fma(sd[0], _t21, sd[1] * _t16));
        dd[2] = Math.fma(sd[2], _t17, Math.fma(sd[0], _t12, -(sd[1] * _t0)));
        dd[3] = sd[3];
        double _buf2 = Math.fma(sd[6], _t20, Math.fma(sd[4], _t18, sd[5] * _t10));
        double _buf3 = Math.fma(sd[6], _t19, Math.fma(sd[4], _t21, sd[5] * _t16));
        dd[6] = Math.fma(sd[6], _t17, Math.fma(sd[4], _t12, -(sd[5] * _t0)));
        dd[7] = sd[7];
        double _buf4 = Math.fma(sd[10], _t20, Math.fma(sd[8], _t18, sd[9] * _t10));
        double _buf5 = Math.fma(sd[10], _t19, Math.fma(sd[8], _t21, sd[9] * _t16));
        dd[10] = Math.fma(sd[10], _t17, Math.fma(sd[8], _t12, -(sd[9] * _t0)));
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[4] = _buf2;
    ...
    private Double3x4 rotateYZX_orthogonal_general(double angleY, double angleZ, double angleX, @Mutated Double3x4 dest, int _props) {
        ...
        double _buf0 = Math.fma(-sd[2], _t7, Math.fma(sd[0], _t13, sd[1] * _t1));
        double _buf1 = Math.fma(sd[2], _t18, Math.fma(sd[0], _t20, sd[1] * _t14));
        dd[2] = Math.fma(sd[2], _t21, Math.fma(sd[0], _t19, -(sd[1] * _t11)));
        dd[3] = sd[3];
        double _buf2 = Math.fma(-sd[6], _t7, Math.fma(sd[4], _t13, sd[5] * _t1));
        double _buf3 = Math.fma(sd[6], _t18, Math.fma(sd[4], _t20, sd[5] * _t14));
        dd[6] = Math.fma(sd[6], _t21, Math.fma(sd[4], _t19, -(sd[5] * _t11)));
        dd[7] = sd[7];
        double _buf4 = Math.fma(-sd[10], _t7, Math.fma(sd[8], _t13, sd[9] * _t1));
        double _buf5 = Math.fma(sd[10], _t18, Math.fma(sd[8], _t20, sd[9] * _t14));
        dd[10] = Math.fma(sd[10], _t21, Math.fma(sd[8], _t19, -(sd[9] * _t11)));
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[4] = _buf2;
    ...
    private Double3x4 rotateZ_orthogonal_general(double angle, @Mutated Double3x4 dest, int _props) {
        ...
        dd[1] = Math.fma(sd[1], _t1, -(sd[0] * _t0));
        dd[2] = sd[2];
        dd[3] = sd[3];
        double _buf1 = Math.fma(sd[4], _t1, sd[5] * _t0);
        dd[5] = Math.fma(sd[5], _t1, -(sd[4] * _t0));
        dd[6] = sd[6];
        dd[7] = sd[7];
        double _buf2 = Math.fma(sd[8], _t1, sd[9] * _t0);
        dd[9] = Math.fma(sd[9], _t1, -(sd[8] * _t0));
        dd[10] = sd[10];
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[4] = _buf1;
    ...
    private Double3x4 rotateZXY_orthogonal_general(double angleZ, double angleX, double angleY, @Mutated Double3x4 dest, int _props) {
        ...
        double _buf0 = Math.fma(-sd[2], _t7, Math.fma(sd[0], _t20, sd[1] * _t18));
        double _buf1 = Math.fma(sd[2], _t1, Math.fma(sd[1], _t14, -(sd[0] * _t10)));
        dd[2] = Math.fma(sd[2], _t15, Math.fma(sd[0], _t19, sd[1] * _t21));
        dd[3] = sd[3];
        double _buf2 = Math.fma(-sd[6], _t7, Math.fma(sd[4], _t20, sd[5] * _t18));
        double _buf3 = Math.fma(sd[6], _t1, Math.fma(sd[5], _t14, -(sd[4] * _t10)));
        dd[6] = Math.fma(sd[6], _t15, Math.fma(sd[4], _t19, sd[5] * _t21));
        dd[7] = sd[7];
        double _buf4 = Math.fma(-sd[10], _t7, Math.fma(sd[8], _t20, sd[9] * _t18));
        double _buf5 = Math.fma(sd[10], _t1, Math.fma(sd[9], _t14, -(sd[8] * _t10)));
        dd[10] = Math.fma(sd[10], _t15, Math.fma(sd[8], _t19, sd[9] * _t21));
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[4] = _buf2;
    ...
    private Double3x4 rotateZYX_orthogonal_general(double angleZ, double angleY, double angleX, @Mutated Double3x4 dest, int _props) {
        ...
        double _buf0 = Math.fma(-sd[2], _t0, Math.fma(sd[0], _t15, sd[1] * _t8));
        double _buf1 = Math.fma(sd[2], _t9, Math.fma(sd[0], _t20, sd[1] * _t18));
        dd[2] = Math.fma(sd[2], _t17, Math.fma(sd[0], _t19, sd[1] * _t21));
        dd[3] = sd[3];
        double _buf2 = Math.fma(-sd[6], _t0, Math.fma(sd[4], _t15, sd[5] * _t8));
        double _buf3 = Math.fma(sd[6], _t9, Math.fma(sd[4], _t20, sd[5] * _t18));
        dd[6] = Math.fma(sd[6], _t17, Math.fma(sd[4], _t19, sd[5] * _t21));
        dd[7] = sd[7];
        double _buf4 = Math.fma(-sd[10], _t0, Math.fma(sd[8], _t15, sd[9] * _t8));
        double _buf5 = Math.fma(sd[10], _t9, Math.fma(sd[8], _t20, sd[9] * _t18));
        dd[10] = Math.fma(sd[10], _t17, Math.fma(sd[8], _t19, sd[9] * _t21));
        dd[11] = sd[11];
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[4] = _buf2;
