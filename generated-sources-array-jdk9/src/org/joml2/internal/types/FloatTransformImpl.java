...
/**
 * Generated implementation of {@link FloatTransform} backed by a {@code float[]} array.
 * <p>
...
public final class FloatTransformImpl implements FloatTransform {
    ...
    @Mutated public FloatTransform makeFromMatrix(Float3x3R m) {
        ...
        float _t0 = -mData[4];
        float _t1 = -mData[8];
        float _t9 = Math.fma(mData[5], mData[5], Math.fma(mData[3], mData[3], mData[4] * mData[4]));
        float _t10 = Math.fma(mData[8], mData[8], Math.fma(mData[6], mData[6], mData[7] * mData[7]));
        float _t11 = Math.fma(mData[2], mData[2], Math.fma(mData[0], mData[0], mData[1] * mData[1]));
        ...
        float _t16 = mData[1] * _t14;
        float _t17 = mData[8] * _t13;
        float _t18 = mData[7] * _t13;
        float _t19 = mData[2] * _t14;
        float _t21 = mData[5] * _t12;
        float _t22 = mData[4] * _t12;
        float _t24 = mData[0] * _t14;
        float _t29 = Math.fma(mData[7], _t13, _t21);
        float _t33 = Math.fma(mData[5], _t12, -_t18);
        float _t34 = Math.max(_t22, _t17);
        float _t44 = Math.fma(-Math.fma(_t16, _t17, -(_t18 * _t19)), mData[3] * _t12, Math.fma(Math.fma(_t16, _t21, -(_t22 * _t19)), mData[6] * _t13, Math.fma(_t22, _t17, -(_t18 * _t21)) * _t24));
        ...
        float _t52 = Math.fma(mData[3], _t12, _t46);
        float _t53 = Math.fma(mData[6], _t13, _t47);
        float _t54 = Math.fma(mData[6], _t13, -_t47);
        float _t55 = Math.fma(-mData[3], _t12, _t46);
        float _t60 = Math.fma(mData[4], _t12, Math.fma(mData[8], _t13, _t45));
        float _t61 = Math.fma(mData[4], _t12, Math.fma(mData[8], _t13, _t49));
        float _t62 = (1.0f / (float) Math.sqrt(_t61));
        float _t63 = Math.fma(mData[4], _t12, Math.fma(_t1, _t13, _t50));
        float _t64 = Math.fma(mData[8], _t13, Math.fma(_t0, _t12, _t50));
    ...
    @Mutated public FloatTransform makeFromMatrix(Float3x4R m) {
        ...
        float _t0 = -mData[5];
        float _t1 = -mData[10];
        float _t9 = Math.fma(mData[9], mData[9], Math.fma(mData[1], mData[1], mData[5] * mData[5]));
        float _t10 = Math.fma(mData[10], mData[10], Math.fma(mData[2], mData[2], mData[6] * mData[6]));
        float _t11 = Math.fma(mData[8], mData[8], Math.fma(mData[0], mData[0], mData[4] * mData[4]));
        float _t12 = (1.0f / (float) Math.sqrt(_t9));
        float _t13 = (1.0f / (float) Math.sqrt(_t10));
        float _t14 = (1.0f / (float) Math.sqrt(_t11));
        float _t15 = (float) Math.sqrt(_t11);
        float _t16 = mData[4] * _t14;
        float _t17 = mData[10] * _t13;
        float _t18 = mData[6] * _t13;
        float _t19 = mData[8] * _t14;
        float _t21 = mData[9] * _t12;
        float _t22 = mData[5] * _t12;
        float _t24 = mData[0] * _t14;
        float _t29 = Math.fma(mData[6], _t13, _t21);
        float _t33 = Math.fma(mData[9], _t12, -_t18);
        float _t34 = Math.max(_t22, _t17);
        float _t44 = Math.fma(-Math.fma(_t16, _t17, -(_t18 * _t19)), mData[1] * _t12, Math.fma(Math.fma(_t16, _t21, -(_t22 * _t19)), mData[2] * _t13, Math.fma(_t22, _t17, -(_t18 * _t21)) * _t24));
        float _t45, _t46, _t47;
        if (_t44 < 0.0f) {
            _t45 = -_t24;
            _t46 = -_t16;
        ...
        float _t49 = 1.0f + _t45;
        float _t50 = 1.0f - _t45;
        float _t52 = Math.fma(mData[1], _t12, _t46);
        float _t53 = Math.fma(mData[2], _t13, _t47);
        float _t54 = Math.fma(mData[2], _t13, -_t47);
        float _t55 = Math.fma(-mData[1], _t12, _t46);
        float _t60 = Math.fma(mData[5], _t12, Math.fma(mData[10], _t13, _t45));
        float _t61 = Math.fma(mData[5], _t12, Math.fma(mData[10], _t13, _t49));
        float _t62 = (1.0f / (float) Math.sqrt(_t61));
        float _t63 = Math.fma(mData[5], _t12, Math.fma(_t1, _t13, _t50));
        float _t64 = Math.fma(mData[10], _t13, Math.fma(_t0, _t12, _t50));
        float _t65 = Math.fma(_t0, _t12, Math.fma(_t1, _t13, _t49));
        float _t66 = (1.0f / (float) Math.sqrt(_t63));
        float _t67 = (1.0f / (float) Math.sqrt(_t64));
        float _t68 = (1.0f / (float) Math.sqrt(_t65));
    ...
    @Mutated public FloatTransform makeFromMatrix(Float4x4R m) {
        ...
        float _t0 = -mData[5];
        float _t1 = -mData[10];
        float _t9 = Math.fma(mData[6], mData[6], Math.fma(mData[4], mData[4], mData[5] * mData[5]));
        float _t10 = Math.fma(mData[10], mData[10], Math.fma(mData[8], mData[8], mData[9] * mData[9]));
        float _t11 = Math.fma(mData[2], mData[2], Math.fma(mData[0], mData[0], mData[1] * mData[1]));
        float _t12 = (1.0f / (float) Math.sqrt(_t9));
        float _t13 = (1.0f / (float) Math.sqrt(_t10));
        float _t14 = (1.0f / (float) Math.sqrt(_t11));
        ...
        float _t16 = mData[1] * _t14;
        float _t17 = mData[10] * _t13;
        float _t18 = mData[9] * _t13;
        float _t19 = mData[2] * _t14;
        float _t21 = mData[6] * _t12;
        float _t22 = mData[5] * _t12;
        float _t24 = mData[0] * _t14;
        float _t29 = Math.fma(mData[9], _t13, _t21);
        float _t33 = Math.fma(mData[6], _t12, -_t18);
        float _t34 = Math.max(_t22, _t17);
        float _t44 = Math.fma(-Math.fma(_t16, _t17, -(_t18 * _t19)), mData[4] * _t12, Math.fma(Math.fma(_t16, _t21, -(_t22 * _t19)), mData[8] * _t13, Math.fma(_t22, _t17, -(_t18 * _t21)) * _t24));
        float _t45, _t46, _t47;
        if (_t44 < 0.0f) {
            _t45 = -_t24;
            _t46 = -_t16;
        ...
        float _t49 = 1.0f + _t45;
        float _t50 = 1.0f - _t45;
        float _t52 = Math.fma(mData[4], _t12, _t46);
        float _t53 = Math.fma(mData[8], _t13, _t47);
        float _t54 = Math.fma(mData[8], _t13, -_t47);
        float _t55 = Math.fma(-mData[4], _t12, _t46);
        float _t60 = Math.fma(mData[5], _t12, Math.fma(mData[10], _t13, _t45));
        float _t61 = Math.fma(mData[5], _t12, Math.fma(mData[10], _t13, _t49));
        float _t62 = (1.0f / (float) Math.sqrt(_t61));
        float _t63 = Math.fma(mData[5], _t12, Math.fma(_t1, _t13, _t50));
    ...
    public FloatTransform difference(float otherTX, float otherTY, float otherTZ, float otherRX, float otherRY, float otherRZ, float otherRW, float otherSX, float otherSY, float otherSZ, @Mutated FloatTransform dest) {
        ...
        float _t30 = 2.0f * (otherTZ * sd[3] * _rcp0 - otherTX * sd[5] * _rcp1);
        float _t31 = 2.0f * (otherTX * sd[4] * _rcp1 - otherTY * sd[3] * _rcp2);
        float _t32 = 2.0f * (otherTY * sd[5] * _rcp2 - otherTZ * sd[4] * _rcp0);
        float _t33 = 2.0f * (sd[0] * sd[5] * _rcp1 - sd[2] * sd[3] * _rcp0);
        float _t34 = 2.0f * (sd[1] * sd[3] * _rcp2 - sd[0] * sd[4] * _rcp1);
        float _t35 = 2.0f * (sd[2] * sd[4] * _rcp0 - sd[1] * sd[5] * _rcp2);
    ...
    public FloatTransform invert(@Mutated FloatTransform dest) {
        ...
        float _t1 = -sd[5];
        float _t2 = -sd[3];
        float _t18 = 2.0f * (sd[0] * sd[5] * _rcp0 - sd[2] * sd[3] * _rcp1);
        float _t19 = 2.0f * (sd[1] * sd[3] * _rcp2 - sd[0] * sd[4] * _rcp0);
        float _t20 = 2.0f * (sd[2] * sd[4] * _rcp1 - sd[1] * sd[5] * _rcp2);
    ...
    public FloatTransform rotateAxis(float angle, float axisX, float axisY, float axisZ, @Mutated FloatTransform dest) {
        ...
        dd[1] = sd[1];
        dd[2] = sd[2];
        float _buf0 = Math.fma(sd[3], _t5, sd[6] * _t2) + Math.fma(sd[4], _t3, -(sd[5] * _t4));
        float _buf1 = Math.fma(sd[4], _t5, sd[6] * _t4) + Math.fma(sd[5], _t2, -(sd[3] * _t3));
        float _buf2 = Math.fma(sd[5], _t5, sd[6] * _t3) + Math.fma(sd[3], _t4, -(sd[4] * _t2));
