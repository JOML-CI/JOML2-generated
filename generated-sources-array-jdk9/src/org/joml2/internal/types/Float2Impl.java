...
/**
 * Generated implementation of {@link Float2} backed by a {@code float[]} array.
 * <p>
...
public final class Float2Impl implements Float2 {
    ...
    public Float2Impl(float x, float y) {
        float[] dd = this.data = new float[2];
        dd[0] = x;
        dd[1] = y;
    }
    ...
    @Mutated public Float2 makeUniformDirection(float u) {
        ...
        dd[0] = (float) Math.cosFromSin(_t1, _t0);
        dd[1] = _t1;
        return this;
    }
    ...
    public Float2 slerp(float otherX, float otherY, float t, @Mutated Float2 dest) {
        float[] sd = this.data;
        float[] dd = ((Float2Impl) dest).data;
        float _ct0 = Math.fma(sd[0], sd[0], sd[1] * sd[1]);
        ...
        dd[0] = Math.fma(_t10, _t39, _sp0 * _t27);
        dd[1] = Math.fma(_t13, _t39, _sp0 * _t28);
        return dest;
    }
    ...
    private Float2 slerp_degenerate(float otherX, float otherY, float t, @Mutated Float2 dest) {
        ...
        float _t1 = unitScale(sd[0], sd[1], sd[0]);
        ...
        if (_t24 > 0.0f) {
            if (_t48 > 0.0f) {
                dd[0] = Math.fma(_t54, _t50 * _t45, _t56 * _t21);
                dd[1] = Math.fma(_t54, _t50 * _t46, _t56 * _t23);
            } else {
                dd[0] = Math.fma(_t54, -_t23, _t56 * _t21);
                dd[1] = Math.fma(_t54, _t21, _t56 * _t23);
            }
        } else {
            dd[0] = Math.fma(t, otherX - sd[0], sd[0]);
            dd[1] = Math.fma(t, otherY - sd[1], sd[1]);
    ...
    public float cross(float otherX, float otherY) {
        float[] sd = this.data;
        return Math.fma(otherY, sd[0], -(otherX * sd[1]));
    }
    ...
    public Float2 project(float ontoX, float ontoY, @Mutated Float2 dest) {
        float[] sd = this.data;
        float[] dd = ((Float2Impl) dest).data;
        float _sp0 = Math.fma(ontoX, sd[0], ontoY * sd[1]) / Math.fma(ontoX, ontoX, ontoY * ontoY);
        dd[0] = ontoX * _sp0;
        dd[1] = ontoY * _sp0;
        return dest;
    }
    ...
    public Float2 preMulDirection(Float3x3R mat, @Mutated Float2 dest) {
        ...
        float[] dd = ((Float2Impl) dest).data;
        float _buf0 = Math.fma(matData[0], sd[0], matData[3] * sd[1]);
        dd[1] = Math.fma(matData[1], sd[0], matData[4] * sd[1]);
        dd[0] = _buf0;
        return dest;
    }
    ...
    public Float2 preMulPosition(Float4x4R mat, @Mutated Float2 dest) {
        ...
        float[] dd = ((Float2Impl) dest).data;
        float _buf0 = Math.fma(matData[0], sd[0], Math.fma(matData[4], sd[1], matData[12]));
        dd[1] = Math.fma(matData[1], sd[0], Math.fma(matData[5], sd[1], matData[13]));
        dd[0] = _buf0;
        return dest;
    }
    ...
    public Float2 preMulPosition(Float3x3R mat, @Mutated Float2 dest) {
        ...
        float[] matData = ((Float3x3Impl) mat).data;
        float[] dd = ((Float2Impl) dest).data;
        float _buf0 = Math.fma(matData[0], sd[0], Math.fma(matData[3], sd[1], matData[6]));
        dd[1] = Math.fma(matData[1], sd[0], Math.fma(matData[4], sd[1], matData[7]));
        dd[0] = _buf0;
        return dest;
    }
