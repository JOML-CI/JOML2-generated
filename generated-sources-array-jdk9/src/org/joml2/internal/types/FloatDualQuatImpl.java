...
public final class FloatDualQuatImpl implements FloatDualQuat {
    ...
    public FloatDualQuat sclerp(float otherRX, float otherRY, float otherRZ, float otherRW, float otherDX, float otherDY, float otherDZ, float otherDW, float t, @Mutated FloatDualQuat dest) {
        ...
        float _buf0 = Math.fma(sd[0], _t135, sd[3] * _t144) + Math.fma(sd[1], _t145, -(sd[2] * _t146));
        float _buf1 = Math.fma(sd[1], _t135, sd[2] * _t144) + Math.fma(sd[3], _t146, -(sd[0] * _t145));
        float _buf2 = Math.fma(sd[0], _t146, sd[3] * _t145) + Math.fma(sd[2], _t135, -(sd[1] * _t144));
        float _buf3 = Math.fma(sd[3], _t135, -(sd[0] * _t144)) - Math.fma(sd[1], _t146, sd[2] * _t145);
        float _buf4 = Math.fma(sd[0], _t153, sd[3] * _t160) + Math.fma(sd[1], _t161, -(sd[2] * _t162)) + (Math.fma(sd[4], _t135, sd[7] * _t144) + Math.fma(sd[5], _t145, -(sd[6] * _t146)));
        float _buf5 = Math.fma(sd[1], _t153, sd[2] * _t160) + Math.fma(sd[3], _t162, -(sd[0] * _t161)) + (Math.fma(sd[5], _t135, sd[6] * _t144) + Math.fma(sd[7], _t146, -(sd[4] * _t145)));
        dd[6] = Math.fma(sd[0], _t162, sd[3] * _t161) + Math.fma(sd[2], _t153, -(sd[1] * _t160)) + (Math.fma(sd[4], _t146, sd[7] * _t145) + Math.fma(sd[6], _t135, -(sd[5] * _t144)));
        dd[7] = Math.fma(sd[3], _t153, -(sd[0] * _t160)) + Math.fma(_t0, _t161, -(sd[1] * _t162)) + (Math.fma(sd[7], _t135, -(sd[4] * _t144)) + Math.fma(_t2, _t145, -(sd[5] * _t146)));
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[3] = _buf3;
    ...
    public FloatDualQuat rotateAxis(float angle, float axisX, float axisY, float axisZ, @Mutated FloatDualQuat dest) {
        ...
        dd[7] = Math.fma(sd[7], _t1, -(sd[4] * _t3)) - Math.fma(sd[5], _t5, sd[6] * _t4);
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[4] = _buf3;
