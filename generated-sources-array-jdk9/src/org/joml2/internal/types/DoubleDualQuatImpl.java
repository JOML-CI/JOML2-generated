...
public final class DoubleDualQuatImpl implements DoubleDualQuat {
    ...
    public DoubleDualQuat exp(@Mutated DoubleDualQuat dest) {
        ...
        if (_t4 < 1.0E-28) {
            ...
            dd[2] = _t11 * _t8;
            dd[3] = _t13;
            dd[4] = Math.fma(_t9, _t14, Math.fma(-_t9, _t12, sd[4]) * _t6 * _t8);
            dd[5] = Math.fma(_t10, _t14, Math.fma(-_t10, _t12, sd[5]) * _t6 * _t8);
            dd[6] = Math.fma(_t11, _t14, Math.fma(-_t11, _t12, sd[6]) * _t6 * _t8);
            dd[7] = -(_t12 * _t8);
        }
        return dest;
    }
    ...
    public Double3x3 toMatrix3x3(@Mutated Double3x3 dest) {
        ...
        double _buf1 = 2.0 * Math.fma(sd[0], sd[1], _t2);
        dd[2] = Math.fma(-2.0, _t3, (sd[0] + sd[0]) * sd[2]);
        dd[3] = Math.fma(-2.0, _t2, (sd[0] + sd[0]) * sd[1]);
    ...
    public DoubleDualQuat lookAlong(double dirX, double dirY, double dirZ, double upX, double upY, double upZ, @Mutated DoubleDualQuat dest) {
        ...
        dd[7] = Math.fma(sd[7], _t110, -(sd[4] * _t111)) - Math.fma(sd[5], _t109, sd[6] * _t108);
        dd[0] = _buf0;
        dd[1] = _buf1;
        dd[2] = _buf2;
        dd[4] = _buf3;
