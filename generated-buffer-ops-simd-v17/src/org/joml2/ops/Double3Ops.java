...
public final class Double3Ops {
    ...
    public static java.nio.ByteBuffer copy(java.nio.ByteBuffer dest, int destOffset, long src) {
        ...
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.hasArray() && dest.order() == java.nio.ByteOrder.nativeOrder() && destOffset >= 0 && destOffset <= dest.limit() - 24) {
    ...
    public static java.nio.ByteBuffer copy(java.nio.ByteBuffer dest, int destOffset, long src, int count) {
        ...
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.hasArray() && dest.order() == java.nio.ByteOrder.nativeOrder() && destOffset >= 0 && (count > 89478485 ? -1 : count * 24) >= 0 && destOffset <= dest.limit() - (count > 89478485 ? -1 : count * 24)) {
    ...
    public static long copy(long dest, java.nio.ByteBuffer src, int srcOffset) {
        ...
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.hasArray() && src.order() == java.nio.ByteOrder.nativeOrder() && srcOffset >= 0 && srcOffset <= src.limit() - 24) {
    ...
    public static long copy(long dest, java.nio.ByteBuffer src, int srcOffset, int count) {
        ...
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && src.hasArray() && src.order() == java.nio.ByteOrder.nativeOrder() && srcOffset >= 0 && (count > 89478485 ? -1 : count * 24) >= 0 && srcOffset <= src.limit() - (count > 89478485 ? -1 : count * 24)) {
