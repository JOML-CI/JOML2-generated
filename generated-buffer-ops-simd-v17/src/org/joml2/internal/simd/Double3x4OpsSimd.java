...
public final class Double3x4OpsSimd {
    ...
    public static double[] invert_fma(double[] dest, int destOffset, double[] src, int srcOffset) {
        ...
        var _c0 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t20).withLane(1, _t23).withLane(2, _t24).fma(_sv0, _sv1.withLane(3, -(Math.fma(_self23, _t24, Math.fma(_self03, _t20, _self13 * _t23)) * _t33_inv)));
        var _c1 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t25).withLane(1, _t26).withLane(2, _t27).fma(_sv0, _sv1.withLane(3, -(Math.fma(_self23, _t27, Math.fma(_self03, _t25, _self13 * _t26)) * _t33_inv)));
        var _c2 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t21).withLane(1, _t28).withLane(2, _t29).fma(_sv0, _sv1.withLane(3, -(Math.fma(_self23, _t29, Math.fma(_self03, _t21, _self13 * _t28)) * _t33_inv)));
        _c0.intoArray(dest, destOffset);
    ...
    public static double[] invert_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset) {
        ...
        var _sv0 = DoubleVector.broadcast(SIMD_SPECIES, _t33_inv);
        var _sv1 = DoubleVector.broadcast(SIMD_SPECIES, 0.0);
        var _c0 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t20).withLane(1, _t23).withLane(2, _t24).mul(_sv0).add(_sv1.withLane(3, -(Math.fma(_self23, _t24, Math.fma(_self03, _t20, _self13 * _t23)) * _t33_inv)));
        var _c1 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t25).withLane(1, _t26).withLane(2, _t27).mul(_sv0).add(_sv1.withLane(3, -(Math.fma(_self23, _t27, Math.fma(_self03, _t25, _self13 * _t26)) * _t33_inv)));
        var _c2 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t21).withLane(1, _t28).withLane(2, _t29).mul(_sv0).add(_sv1.withLane(3, -(Math.fma(_self23, _t29, Math.fma(_self03, _t21, _self13 * _t28)) * _t33_inv)));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] invertProduct_fma(double[] dest, int destOffset, double[] src, int srcOffset, double[] other, int otherOffset) {
        ...
        var _sv1 = DoubleVector.broadcast(SIMD_SPECIES, 0.0);
        var _c0 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t56).withLane(1, _t59).withLane(2, _t60).fma(_sv0, _sv1.withLane(3, -(Math.fma(_t33, _t60, Math.fma(_t34, _t56, _t35 * _t59)) * _t69_inv)));
        var _c1 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t61).withLane(1, _t62).withLane(2, _t63).fma(_sv0, _sv1.withLane(3, -(Math.fma(_t33, _t63, Math.fma(_t34, _t61, _t35 * _t62)) * _t69_inv)));
        var _c2 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t57).withLane(1, _t64).withLane(2, _t65).fma(_sv0, _sv1.withLane(3, -(Math.fma(_t33, _t65, Math.fma(_t34, _t57, _t35 * _t64)) * _t69_inv)));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
    ...
    public static double[] invertProduct_mulAdd(double[] dest, int destOffset, double[] src, int srcOffset, double[] other, int otherOffset) {
        ...
        var _sv0 = DoubleVector.broadcast(SIMD_SPECIES, _t69_inv);
        var _sv1 = DoubleVector.broadcast(SIMD_SPECIES, 0.0);
        var _c0 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t56).withLane(1, _t59).withLane(2, _t60).mul(_sv0).add(_sv1.withLane(3, -(Math.fma(_t33, _t60, Math.fma(_t34, _t56, _t35 * _t59)) * _t69_inv)));
        var _c1 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t61).withLane(1, _t62).withLane(2, _t63).mul(_sv0).add(_sv1.withLane(3, -(Math.fma(_t33, _t63, Math.fma(_t34, _t61, _t35 * _t62)) * _t69_inv)));
        var _c2 = DoubleVector.zero(SIMD_SPECIES).withLane(0, _t57).withLane(1, _t64).withLane(2, _t65).mul(_sv0).add(_sv1.withLane(3, -(Math.fma(_t33, _t65, Math.fma(_t34, _t57, _t35 * _t64)) * _t69_inv)));
        _c0.intoArray(dest, destOffset);
        _c1.intoArray(dest, destOffset + 4);
        _c2.intoArray(dest, destOffset + 8);
        return dest;
