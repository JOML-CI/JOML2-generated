...
public final class FloatQuatOpsKernelsAddress {
    ...
    public static long invNegativeX_unsafe(long dest, long src) {
        ...
        if (_t12 > 0.0f) {
            UnsafeOpsHolder.U.putFloat(dest + 0L, -(_t9 * _t13));
    ...
    public static long invNegativeY_unsafe(long dest, long src) {
        ...
        float _t13 = (1.0f / (float) Math.sqrt(_t12));
        if (_t12 > 0.0f) {
            UnsafeOpsHolder.U.putFloat(dest + 0L, -(_t7 * _t13));
            UnsafeOpsHolder.U.putFloat(dest + 4L, -(_t9 * _t13));
            UnsafeOpsHolder.U.putFloat(dest + 8L, -(_t8 * _t13));
        } else {
            UnsafeOpsHolder.U.putFloat(dest + 0L, -0.0f);
            UnsafeOpsHolder.U.putFloat(dest + 4L, -0.0f);
            UnsafeOpsHolder.U.putFloat(dest + 8L, -0.0f);
    ...
    public static long invNegativeZ_unsafe(long dest, long src) {
        ...
        float _t13 = (1.0f / (float) Math.sqrt(_t12));
        if (_t12 > 0.0f) {
            UnsafeOpsHolder.U.putFloat(dest + 0L, -(_t8 * _t13));
            UnsafeOpsHolder.U.putFloat(dest + 4L, -(_t7 * _t13));
            UnsafeOpsHolder.U.putFloat(dest + 8L, -(_t9 * _t13));
        } else {
            UnsafeOpsHolder.U.putFloat(dest + 0L, -0.0f);
            UnsafeOpsHolder.U.putFloat(dest + 4L, -0.0f);
            UnsafeOpsHolder.U.putFloat(dest + 8L, -0.0f);
