...
public final class DoubleQuatImpl implements DoubleQuat {
    ...
    public DoubleQuat rotateTo(double fromDirX, double fromDirY, double fromDirZ, double toDirX, double toDirY, double toDirZ, @Mutated DoubleQuat dest) {
        ...
        double _buf0 = Math.fma(this.x, _t42, this.w * _t46) + Math.fma(this.y, _t47, -(this.z * _t48));
        double _buf1 = Math.fma(this.y, _t42, this.z * _t46) + Math.fma(this.w, _t48, -(this.x * _t47));
        double _buf2 = Math.fma(this.x, _t48, this.w * _t47) + Math.fma(this.z, _t42, -(this.y * _t46));
