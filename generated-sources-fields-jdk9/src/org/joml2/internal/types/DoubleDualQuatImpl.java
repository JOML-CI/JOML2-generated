...
public final class DoubleDualQuatImpl implements DoubleDualQuat {
    ...
    public DoubleDualQuat sclerp(double otherRX, double otherRY, double otherRZ, double otherRW, double otherDX, double otherDY, double otherDZ, double otherDW, double t, @Mutated DoubleDualQuat dest) {
        ...
        double _buf0 = Math.fma(this.rX, _t135, this.rW * _t144) + Math.fma(this.rY, _t145, -(this.rZ * _t146));
        double _buf1 = Math.fma(this.rY, _t135, this.rZ * _t144) + Math.fma(this.rW, _t146, -(this.rX * _t145));
        double _buf2 = Math.fma(this.rX, _t146, this.rW * _t145) + Math.fma(this.rZ, _t135, -(this.rY * _t144));
        double _buf3 = Math.fma(this.rW, _t135, -(this.rX * _t144)) - Math.fma(this.rY, _t146, this.rZ * _t145);
        double _buf4 = Math.fma(this.rX, _t153, this.rW * _t160) + Math.fma(this.rY, _t161, -(this.rZ * _t162)) + (Math.fma(this.dX, _t135, this.dW * _t144) + Math.fma(this.dY, _t145, -(this.dZ * _t146)));
        double _buf5 = Math.fma(this.rY, _t153, this.rZ * _t160) + Math.fma(this.rW, _t162, -(this.rX * _t161)) + (Math.fma(this.dY, _t135, this.dZ * _t144) + Math.fma(this.dW, _t146, -(this.dX * _t145)));
        d.dZ = Math.fma(this.rX, _t162, this.rW * _t161) + Math.fma(this.rZ, _t153, -(this.rY * _t160)) + (Math.fma(this.dX, _t146, this.dW * _t145) + Math.fma(this.dZ, _t135, -(this.dY * _t144)));
        d.dW = Math.fma(this.rW, _t153, -(this.rX * _t160)) + Math.fma(_t0, _t161, -(this.rY * _t162)) + (Math.fma(this.dW, _t135, -(this.dX * _t144)) + Math.fma(_t2, _t145, -(this.dY * _t146)));
        d.rX = _buf0;
        d.rY = _buf1;
        d.rZ = _buf2;
        d.rW = _buf3;
    ...
    public DoubleDualQuat rotateAxis(double angle, double axisX, double axisY, double axisZ, @Mutated DoubleDualQuat dest) {
        ...
        d.dW = Math.fma(this.dW, _t1, -(this.dX * _t3)) - Math.fma(this.dY, _t5, this.dZ * _t4);
        d.rX = _buf0;
        d.rY = _buf1;
        d.rZ = _buf2;
        d.dX = _buf3;
