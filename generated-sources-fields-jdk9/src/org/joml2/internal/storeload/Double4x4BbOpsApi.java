...
public final class Double4x4BbOpsApi implements Double4x4BbOps {
    ...
    public Double4x4 loadCMAbsolute(Double4x4Impl self, int index, ByteBuffer buf) {
        ...
        self.m30 = buf.getDouble(index + 24);
        self.m01 = buf.getDouble(index + 32);
        self.m11 = buf.getDouble(index + 40);
        self.m21 = buf.getDouble(index + 48);
        self.m31 = buf.getDouble(index + 56);
        self.m02 = buf.getDouble(index + 64);
        self.m12 = buf.getDouble(index + 72);
        self.m22 = buf.getDouble(index + 80);
        self.m32 = buf.getDouble(index + 88);
        self.m03 = buf.getDouble(index + 96);
        self.m13 = buf.getDouble(index + 104);
        self.m23 = buf.getDouble(index + 112);
        self.m33 = buf.getDouble(index + 120);
        self.properties = self.determineProperties();
        return self;
    }
    ...
    public Double4x4 loadRMAbsolute(Double4x4Impl self, int index, ByteBuffer buf) {
        ...
        self.m30 = buf.getDouble(index + 96);
        self.m31 = buf.getDouble(index + 104);
        self.m32 = buf.getDouble(index + 112);
        self.m33 = buf.getDouble(index + 120);
        self.properties = self.determineProperties();
        return self;
    }
    ...
    public Double4x4 loadRMAbsolute(Double4x4Impl self, int index, ByteBuffer buf, int stride) {
        ...
        self.m30 = buf.getDouble(_p3);
        self.m31 = buf.getDouble(_p3 + 8);
        self.m32 = buf.getDouble(_p3 + 16);
        self.m33 = buf.getDouble(_p3 + 24);
        self.properties = self.determineProperties();
        return self;
    }
