...
inline operator fun Double2x2.times(scalar: Double): Double2x2 = mul(scalar)
/** [Double2x2.mul] with the scalar on the left, so `s * v` reads like `v * s`. */
inline operator fun Double.times(v: Double2x2): Double2x2 = v.mul(this)
