...
public final class Double3x4OpsKernelsByteBuffer {
    ...
    public static java.nio.ByteBuffer invNegativeX_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        dest.putDouble(destOffset + 0, -(_t6 * _t13));
    ...
    public static java.nio.ByteBuffer invNegativeX_degenerate(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Double3x4OpsKernelsByteBuffer.invNegativeX_degenerate_unsafe(dest, destOffset, src, srcOffset);
    ...
    public static java.nio.ByteBuffer invNegativeX_degenerate_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        if (_t25 != 0.0) {
            dest.putDouble(destOffset + 0, -(_t21 * _t26));
    ...
    public static java.nio.ByteBuffer invNegativeY_degenerate(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Double3x4OpsKernelsByteBuffer.invNegativeY_degenerate_unsafe(dest, destOffset, src, srcOffset);
    ...
    public static java.nio.ByteBuffer invNegativeY_degenerate_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        double _t26 = (1.0 / Math.sqrt(_t25));
        if (_t25 != 0.0) {
            dest.putDouble(destOffset + 0, -(_t22 * _t26));
    ...
    public static java.nio.ByteBuffer invNegativeZ_degenerate(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Double3x4OpsKernelsByteBuffer.invNegativeZ_degenerate_unsafe(dest, destOffset, src, srcOffset);
    ...
    public static java.nio.ByteBuffer invPositiveX_degenerate(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Double3x4OpsKernelsByteBuffer.invPositiveX_degenerate_unsafe(dest, destOffset, src, srcOffset);
    ...
    public static java.nio.ByteBuffer invPositiveY_degenerate(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Double3x4OpsKernelsByteBuffer.invPositiveY_degenerate_unsafe(dest, destOffset, src, srcOffset);
    ...
    public static java.nio.ByteBuffer invPositiveZ_degenerate(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset) {
        if (Joml.STORE_LOAD_BACKEND == StoreLoadBackend.UNSAFE && dest.isDirect() && !dest.isReadOnly() && dest.order() == java.nio.ByteOrder.nativeOrder() && src.isDirect() && src.order() == java.nio.ByteOrder.nativeOrder()) return Double3x4OpsKernelsByteBuffer.invPositiveZ_degenerate_unsafe(dest, destOffset, src, srcOffset);
    ...
    public static java.nio.ByteBuffer decomposeTRS_api(java.nio.ByteBuffer translation, int translationOffset, java.nio.ByteBuffer rotation, int rotationOffset, java.nio.ByteBuffer scale, int scaleOffset, java.nio.ByteBuffer src, int srcOffset) {
        ...
        if (_t83 > 0.0) {
            rotation.putDouble(rotationOffset + 0, _sp0 * _t61);
            ...
            if (_t74 > _t62) {
                ...
                if (_t37 > _t57) {
                    rotation.putDouble(rotationOffset + 0, _sp1 * _t78);
                    ...
                    rotation.putDouble(rotationOffset + 0, _sp2 * _t81);
    ...
    public static java.nio.ByteBuffer composeTRS_api(java.nio.ByteBuffer dest, int destOffset, double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ) {
        ...
        dest.putDouble(destOffset + 0, Math.fma(-Math.fma(rotationY, rotationY, _t3), _t0, scaleX));
    ...
    public static java.nio.ByteBuffer composeTRS_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer translation, int translationOffset, java.nio.ByteBuffer rotation, int rotationOffset, java.nio.ByteBuffer scale, int scaleOffset) {
        ...
        dest.putDouble(destOffset + 0, Math.fma(-Math.fma(_rotationy, _rotationy, _t3), _t0, _scalex));
    ...
    public static java.nio.ByteBuffer composeTRSAround_api(java.nio.ByteBuffer dest, int destOffset, double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ, double pivotX, double pivotY, double pivotZ) {
        ...
        dest.putDouble(destOffset + 0, _t33);
        dest.putDouble(destOffset + 8, _t30);
        dest.putDouble(destOffset + 16, _t27);
        dest.putDouble(destOffset + 24, Math.fma(_t0, _t33, Math.fma(_t1, _t30, Math.fma(_t2, _t27, pivotX + translationX))));
        dest.putDouble(destOffset + 32, _t28);
        dest.putDouble(destOffset + 40, _t34);
        dest.putDouble(destOffset + 48, _t31);
        dest.putDouble(destOffset + 56, Math.fma(_t0, _t28, Math.fma(_t1, _t34, Math.fma(_t2, _t31, pivotY + translationY))));
        dest.putDouble(destOffset + 64, _t32);
        dest.putDouble(destOffset + 72, _t29);
        dest.putDouble(destOffset + 80, _t35);
        dest.putDouble(destOffset + 88, Math.fma(_t0, _t32, Math.fma(_t1, _t29, Math.fma(_t2, _t35, pivotZ + translationZ))));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer composeTRSAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer translation, int translationOffset, java.nio.ByteBuffer rotation, int rotationOffset, java.nio.ByteBuffer scale, int scaleOffset, java.nio.ByteBuffer pivot, int pivotOffset) {
        ...
        dest.putDouble(destOffset + 8, _t30);
        dest.putDouble(destOffset + 16, _t27);
        dest.putDouble(destOffset + 24, Math.fma(_t0, _t33, Math.fma(_t1, _t30, Math.fma(_t2, _t27, _pivotx + _translationx))));
        dest.putDouble(destOffset + 32, _t28);
        dest.putDouble(destOffset + 40, _t34);
        dest.putDouble(destOffset + 48, _t31);
        dest.putDouble(destOffset + 56, Math.fma(_t0, _t28, Math.fma(_t1, _t34, Math.fma(_t2, _t31, _pivoty + _translationy))));
        dest.putDouble(destOffset + 64, _t32);
        dest.putDouble(destOffset + 72, _t29);
        dest.putDouble(destOffset + 80, _t35);
        dest.putDouble(destOffset + 88, Math.fma(_t0, _t32, Math.fma(_t1, _t29, Math.fma(_t2, _t35, _pivotz + _translationz))));
        return dest;
    }
    ...
    public static java.nio.ByteBuffer composeTRSMul_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer m, int mOffset, double translationX, double translationY, double translationZ, double rotationX, double rotationY, double rotationZ, double rotationW, double scaleX, double scaleY, double scaleZ) {
        ...
        dest.putDouble(destOffset + 0, Math.fma(_m20, _t24, Math.fma(_m00, _t30, _m10 * _t27)));
    ...
    public static java.nio.ByteBuffer makeBillboardSphericalShortest_api(java.nio.ByteBuffer dest, int destOffset, double objPosX, double objPosY, double objPosZ, double targetPosX, double targetPosY, double targetPosZ) {
        ...
        dest.putDouble(destOffset + 0, _t32);
    ...
    public static java.nio.ByteBuffer preRotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        dest.putDouble(destOffset + 0, Math.fma(_self20, _t16, Math.fma(_self00, _t22, _self10 * _t19)));
    ...
    public static java.nio.ByteBuffer preRotateQuat_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double qX, double qY, double qZ, double qW) {
        ...
        dest.putDouble(destOffset + 0, Math.fma(_self20, _t14, Math.fma(_self00, _t20, _self10 * _t17)));
    ...
    public static java.nio.ByteBuffer rotateAround_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double rotX, double rotY, double rotZ, double rotW, double pivotX, double pivotY, double pivotZ) {
        ...
        dest.putDouble(destOffset + 0, Math.fma(_self02, _t24, Math.fma(_self00, _t27, _self01 * _t18)));
    ...
    public static java.nio.ByteBuffer rotateQuat_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double qX, double qY, double qZ, double qW) {
        ...
        double _t21 = Math.fma(_t2, _t3, _t12);
        double _t22 = Math.fma(_t2, _t3, Math.fma(_t0, _t4, 1.0));
        dest.putDouble(destOffset + 0, Math.fma(_self02, _t17, Math.fma(_self00, _t20, _self01 * _t14)));
    ...
    public static java.nio.ByteBuffer transformAabb_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
        ...
        if (_t22 < 0.0) {
            dest.putDouble(destOffset + 0, Double.POSITIVE_INFINITY);
            ...
            dest.putDouble(destOffset + 0, _self03 + Math.min(_t3, _t4) + Math.min(_t5, _t6) + Math.min(_t7, _t8));
            dest.putDouble(destOffset + 8, _self13 + Math.min(_t9, _t10) + Math.min(_t11, _t12) + Math.min(_t13, _t14));
            dest.putDouble(destOffset + 16, _self23 + Math.min(_t15, _t16) + Math.min(_t17, _t18) + Math.min(_t19, _t20));
            dest.putDouble(destOffset + 24, _self03 + Math.max(_t3, _t4) + Math.max(_t5, _t6) + Math.max(_t7, _t8));
            dest.putDouble(destOffset + 32, _self13 + Math.max(_t9, _t10) + Math.max(_t11, _t12) + Math.max(_t13, _t14));
            dest.putDouble(destOffset + 40, _self23 + Math.max(_t15, _t16) + Math.max(_t17, _t18) + Math.max(_t19, _t20));
        }
        return dest;
    }
    ...
    public static java.nio.ByteBuffer lerpComposeTRSMul_unsafe(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer t1, int t1Offset, java.nio.ByteBuffer t2, int t2Offset, java.nio.ByteBuffer q1, int q1Offset, java.nio.ByteBuffer q2, int q2Offset, java.nio.ByteBuffer s1, int s1Offset, java.nio.ByteBuffer s2, int s2Offset, java.nio.ByteBuffer m, int mOffset, double alpha, int count) {
    ...
    public static java.nio.ByteBuffer lerpComposeTRSMul_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer t1, int t1Offset, java.nio.ByteBuffer t2, int t2Offset, java.nio.ByteBuffer q1, int q1Offset, java.nio.ByteBuffer q2, int q2Offset, java.nio.ByteBuffer s1, int s1Offset, java.nio.ByteBuffer s2, int s2Offset, java.nio.ByteBuffer m, int mOffset, double alpha, int count) {
        for (int _i = 0; _i < count; _i++) {
