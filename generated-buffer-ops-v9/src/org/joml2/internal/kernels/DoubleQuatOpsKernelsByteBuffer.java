...
public final class DoubleQuatOpsKernelsByteBuffer {
    ...
    public static java.nio.ByteBuffer makeRotationTo_api(java.nio.ByteBuffer dest, int destOffset, double fromDirX, double fromDirY, double fromDirZ, double toDirX, double toDirY, double toDirZ) {
        ...
        if (_t23 > 1.0E-6) {
            dest.putDouble(destOffset + 0, _t15 * _t33);
            dest.putDouble(destOffset + 8, _t16 * _t33);
            dest.putDouble(destOffset + 16, _t17 * _t33);
            dest.putDouble(destOffset + 24, 0.5 * _t22 * _t33);
        } else {
            if (_t29 > 0.0) {
                dest.putDouble(destOffset + 0, _t30 * _t18);
                dest.putDouble(destOffset + 8, _t30 * _t20);
                dest.putDouble(destOffset + 16, _t30 * _t19);
                dest.putDouble(destOffset + 24, 0.0);
            } else {
                dest.putDouble(destOffset + 0, 0.0);
                dest.putDouble(destOffset + 8, 0.0);
    ...
    public static java.nio.ByteBuffer rotateTo_api(java.nio.ByteBuffer dest, int destOffset, java.nio.ByteBuffer src, int srcOffset, double fromDirX, double fromDirY, double fromDirZ, double toDirX, double toDirY, double toDirZ) {
        ...
        dest.putDouble(destOffset + 0, Math.fma(_selfx, _t42, _selfw * _t46) + Math.fma(_selfy, _t47, -(_selfz * _t48)));
        dest.putDouble(destOffset + 8, Math.fma(_selfy, _t42, _selfz * _t46) + Math.fma(_selfw, _t48, -(_selfx * _t47)));
        dest.putDouble(destOffset + 16, Math.fma(_selfx, _t48, _selfw * _t47) + Math.fma(_selfz, _t42, -(_selfy * _t46)));
        dest.putDouble(destOffset + 24, Math.fma(-_selfz, _t47, Math.fma(-_selfy, _t48, Math.fma(_selfw, _t42, -(_selfx * _t46)))));
        return dest;
    }
